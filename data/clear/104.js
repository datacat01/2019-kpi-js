if (function() {
        ...
        window.site = {
                getPlatform: function(e, t) {
                    return t = "" === t ? "" : t || navigator.platform, e = e || navigator.userAgent, /Win(16|9[x58]|NT( [1234]| 5\.0| [^0-9]|[^ -]|$))/.test(e) || /Windows ([MC]E|9[x58]|3\.1|4\.10|NT( [1234]\D| 5\.0| [^0-9]|[^ ]|$))/.test(e) || /Windows_95/.test(e) ? "oldwin" : -1 !== t.indexOf("Win32") || -1 !== t.indexOf("Win64") ? "windows" : /android/i.test(e) ? "android" : /linux/i.test(t) || /linux/i.test(e) ? "linux" : -1 !== t.indexOf("MacPPC") ? "oldmac" : /Mac OS X 10.[0-8]\D/.test(e) ? "oldmac" : -1 !== t.indexOf("iPhone") || -1 !== t.indexOf("iPad") || -1 !== t.indexOf("iPod") ? "ios" : -1 !== e.indexOf("Mac OS X") ? "osx" : -1 !== e.indexOf("MSIE 5.2") ? "oldmac" : -1 !== t.indexOf("Mac") ? "oldmac" : "" === t && /Firefox/.test(e) ? "fxos" : "other"
                },
            ...
            function() {
                var e = document.documentElement,
                    ...
                    a = o ? parseFloat(o) : 0;
                "windows" === t ? (5.1 <= a && a <= 6 && (e.className += " xpvista"), 6.1 <= a && (e.className += " win7up")) : e.className = e.className.replace("windows", t);
                var i = window.site.archType = window.site.getArchType(),
                    n = window.site.archSize = window.site.getArchSize(),
                    r = i.match(/armv(\d+)/);
                "x86" !== i && (e.className = e.className.replace("x86", i), r && (e.className += " arm", 7 <= parseFloat(r[1]) && (e.className += " armv7up"))), 64 === n && (e.className += " x64"), /\s(Firefox|FxiOS)/.test(navigator.userAgent) && !/Iceweasel|IceCat|SeaMonkey|Camino|like\ Firefox/i.test(navigator.userAgent) && (e.className += " is-firefox"), e.className = e.className.replace(/\bno-js\b/, "js")
            }()
    }(), void 0 === Mozilla) var Mozilla = {};
if (Mozilla.dntEnabled = function(e, t) {
        "use strict";
        var o = e || navigator.doNotTrack || window.doNotTrack || navigator.msDoNotTrack,
            a = t || navigator.userAgent,
            i = a.match(/Firefox\/(\d+)/),
            n = /MSIE|Trident/i.test(a),
            r = a.match(/Windows.+?(?=;)/g);
        return (!n || "function" == typeof Array.prototype.indexOf) && "Enabled" === (o = i && parseInt(i[1], 10) < 32 ? "Unspecified" : n && r && -1 !== ["Windows NT 6.1", "Windows NT 6.2", "Windows NT 6.3"].indexOf(r.toString()) ? "Unspecified" : {
            0: "Disabled",
            1: "Enabled"
        } [o] || "Unspecified")
...
if (Mozilla.Cookies = {
        ...
        setItem: function(e, t, o, a, i, n) {
            ...
            return document.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + r + (i ? "; domain=" + i : "") + (a ? "; path=" + a : "") + (n ? "; secure" : ""), !0
        },
