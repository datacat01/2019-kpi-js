(function() {
    ...
    if (!document.getElementById("botr_Q4mwbo8B_kB6jnsQ1_div")) {
        document.write("<div id='botr_Q4mwbo8B_kB6jnsQ1_div'></div>");
    }

    var jwConfig = {
        "abouttext": "Myspace.com",
        "advertising": {
            "admessage": "This video will resume in xx seconds",
            "adscheduleid": "AAfzfnWR",
            ...
            "schedule": [{
                ...
                "skipoffset": 0,
                "tag": [
                    "https://x.vindicosuite.com/?lc=560564-1099647&t=x&surl=__page-url__&rnd=__random-number__"
                ],
                "type": "linear"
            }],
        ...
        "displaytitle": false,
        "flashplayer": "//ssl.p.jwpcdn.com/player/v/8.8.2/jwplayer.flash.swf",
        "floating": {},
        "height": 360,
        "key": "0vLpsK3TSsacE5s02LCU/6d50mRBoeh4XzFJwc8RFbyANOli0C0Mc+ayvM6cnhDI",
        "mute": true,
        "ph": 3,
        "pid": "kB6jnsQ1",
        "playbackRateControls": false,
        "playlist": "//cdn.jwplayer.com/v2/playlists/Q4mwbo8B?recommendations_playlist_id=Tzip4PbC",
        "preload": "metadata",
        "repeat": false,
        "stagevideo": false,
        "stretching": "uniform",
    ...
    (function(playerConfig, testConfig) {
        ...
        var PlaylistTest = {
                validatePing: function() {
                    return this.used
                },
                addConfig: function(e, t) {
                    this.used = !1;
                    if (new RegExp("//[^/]*.(" + ["jwplatform.com", "longtailvideo.com", "jwplayer.com"].join("|") + ")/").test(e.playlist)) {
                        var n = document.createElement("a");
                        n.href = e.playlist;
                        var a = n.search ? n.search.substring(1).split("&") : [];
                        a.reduce(function(e, n, i) {
                            var r = n.split("=");
                            return "ab" === r[0] ? (r[1] = r[1].concat(",", t), a[i] = r.join("="), !0) : e
                        }, !1) || a.push("ab=" + t), n.search = "?" + a.join("&"), e.playlist = n.href, this.used = !0
                    }
                    return this.used
                }
            },
            RecTest = {
                addConfig: function(e, t) {
                    if (e.related) {
                        var n = e.related.requestOptions = assignDefault(e.related.requestOptions, {}),
                            a = n.queryParams = assignDefault(n.queryParams, {});
                        a.ab = a.ab ? a.ab.concat(",", t) : t
                    }
                },
                validatePing: function(e) {
                    return "related" in e && "requestOptions" in e.related && "queryParams" in e.related.requestOptions && "ab" in e.related.requestOptions.queryParams
                }
            },
            RandomTest = {
                isRandom: function() {
                ...
                validatePing: function(e) {
                    return RecTest.validatePing(e)
                },
                addConfig: function(e, t) {
                    if (e.related) {
                        var n = e.related.requestOptions = assignDefault(e.related.requestOptions, {}),
                            a = n.queryParams = assignDefault(n.queryParams, {});
                        a.ab = a.ab ? a.ab.concat(",", t) : t, t.indexOf("epsilon_greedy") > -1 && RandomTest.isRandom() && (a.cache_buster = RandomTest.getCacheBuster())
                    }
                }
            },
            ArticlePlaylistTest = {
                ...
                addConfig: function(e, t) {
                    return this.used = !1, /\/\/[^/]*\/.*search=__CONTEXTUAL/.test(e.playlist) && (this.used = PlaylistTest.addConfig(e, t)), this.used
                }
            },
            RecPersonalizedTest = {
                addConfig: function(e, t) {
                    if (RecTest.addConfig(e, t), e.related) {
                        var n = e.related.requestOptions = assignDefault(e.related.requestOptions, {});
                        (n.queryParams = assignDefault(n.queryParams, {})).local_id = e.ab.clientId
                    }
                },
                validatePing: function(e) {
                    return RecTest.validatePing(e) && "local_id" in e.related.requestOptions.queryParams
                }
            },
            ShelfDisplayModeTest = {
                addConfig: function(e, t) {
                    var n, a = e.related;
                    a && (t.indexOf("shelf_widget") > -1 ? n = "shelfWidget" : /\d+_shelf$/.test(t) && (n = "shelf"), a.displayMode = a.displayMode || n)
                },
                validatePing: function(e) {
                    return "related" in e && "displayMode" in e.related
                }
            },
            floatOnScrollTest = {
                addConfig: function(e, t) {
                    void 0 === e.floating && (t.indexOf("floatingIsEnabled") > -1 ? e.floating = {} : t.indexOf("floatingIsNotEnabled") > -1 && (e.floating = {
                        disabled: !0
                    }), e.__abFloatingTestOn = !0)
                },
                validatePing: function(e) {
                    return "__abFloatingTestOn" in e
                }
            };

        function vpbTestConfiguration(e, t) {
            return {
                addConfig: function(n, a) {
                    var i = n.advertising;
                    if (i && i.bids && i.bids.bidders && t()) {
                        if (a.indexOf("vpb_config_on") > -1) return void(n.__vpb_config = !0);
                        a.indexOf("vpb_config_off") > -1 && (n.__vpb_config = !0, i.bids.bidders = i.bids.bidders.filter(function(e) {
                            return "SpotX" === e.name
                        }), i.tag ? i.tag = e : i.schedule && (Array.isArray(i.schedule) ? i.schedule.forEach(function(t) {
                            "pre" !== t.offset && 0 !== parseInt(t.offset) || (t.tag = e)
                        }) : Object.keys(i.schedule).forEach(function(t) {
                            var n = i.schedule[t];
                            "pre" !== n.offset && 0 !== parseInt(n.offset) || (n.tag = e)
                        })))
                    }
                },
                validatePing: function(e) {
                    return !!e.__vpb_config
                }
            }
        }

        function checkUSATDomain() {
            return "mmajunkie.com" === window.location.host
        }

        function returnTrue() {
            return !0
        }
        var trialPlayerBiddingTest = vpbTestConfiguration("http://playertest.longtailvideo.com/pre-60s.xml", returnTrue),
            liquorPlayerBiddingTest = vpbTestConfiguration(["https://vid.springserve.com/vast/364804?w=__player-width__&h=__player-height__&url=__page-url__&cb=__random-number__", "https://vid.springserve.com/vast/364806?w=__player-width__&h=__player-height__&url=__page-url__&cb=__random-number__"], returnTrue),
            usaTodayPlayerBiddingTest = vpbTestConfiguration("https://pubads.g.doubleclick.net/gampad/ads?iu=/7103/SMG_MMAJunkie/preroll/jw_header&description_url=https%3A%2F%2Fmmajunkie.com&env=vp&impl=s&correlator=&tfcd=0&npa=0&gdfp_req=1&output=vast&sz=640x480&unviewed_position_start=1", checkUSATDomain),
            enableDefaultCaptionsTest = {
                addConfig: function(e, t) {
                    e.autostart && void 0 === e.enableDefaultCaptions && (t.indexOf("enable_default_captions_on") > -1 ? e.enableDefaultCaptions = !0 : t.indexOf("enable_default_captions_off") > -1 && (e.enableDefaultCaptions = !1))
                },
                validatePing: function(e) {
                    return "enableDefaultCaptions" in e
                }
            },
            nextUpDisplayTest = {
                addConfig: function(e, t) {
                    !1 !== e.nextUpDisplay && (t.indexOf("nextUpDisplayEnabled") > -1 ? e.nextUpDisplay = !0 : t.indexOf("nextUpDisplayDisabled") > -1 && (e.nextUpDisplay = !1))
                },
                validatePing: function(e) {
                    return "nextUpDisplay" in e
                }
            },
            TEST_DEFINITIONS = {
                recommendations: RecTest,
                personalizedRecs: RecPersonalizedTest,
                playlist: PlaylistTest,
                article: ArticlePlaylistTest,
                shelfDisplayMode: ShelfDisplayModeTest,
                floatOnScroll: floatOnScrollTest,
                enableDefaultCaptions: enableDefaultCaptionsTest,
                nextUpDisplay: nextUpDisplayTest,
                trialPlayerBiddingTest: trialPlayerBiddingTest,
                liquorPlayerBidding: liquorPlayerBiddingTest,
                usaTodayPlayerBidding: usaTodayPlayerBiddingTest,
                random: RandomTest
            },
            foreach = jwplayer.utils.foreach,
            extend = jwplayer.utils.extend;

        function randomAlphaNumericString() {
            try {
                var e = window.crypto || window.msCrypto;
                if (e && e.getRandomValues) return e.getRandomValues(new window.Uint32Array(1))[0].toString(36)
            } catch (e) {}
            return Math.random().toString(36).slice(2, 9)
        }

        function genId(e) {
            for (var t = ""; t.length < e;) t += randomAlphaNumericString();
            return t.slice(0, e)
        }
        ...
        function getClientId() {
            var e = {};
            try {
                var t = (e = window.localStorage).jwplayerLocalId;
                return t || (e.jwplayerLocalId = genId(12), e.jwplayerLocalId)
            } catch (e) {}
            return null
        }

        function hashFnv32a(e) {
            var t, n, a = 1794770992;
            for (t = 0, n = e.length; t < n; t++) a ^= e.charCodeAt(t), a += (a << 1) + (a << 4) + (a << 7) + (a << 8) + (a << 24);
            return a >>> 0
        }

        function selectVariant(e, t) {
            for (var n = hashFnv32a(e) % 2520, a = Object.keys(t).map(function(e) {
                    return {
                        variant: e,
                        weight: t[e]
                    }
                    ...
                    return e + t.weight
                }, 0), r = 0, s = 0; s < a.length; s++) {
                var o = a[s];
                if ((r += 2520 * o.weight / i) > n) return o.variant
            }
        }
        var AB = function(e) {
            var t = this.clientId = e.clientId || getClientId() || genId(12),
                n = this.tests = {};
            e.tests ? foreach(e.tests, function(e, t) {
                n[e] = t.map(function(e) {
                    return extend({}, e)
                })
            }) : foreach(e, function(e, a) {
                foreach(a, function(a, i) {
                    var r = Object.keys(i);
                    if (r.length) {
                        var s = r[0].split("_")[0],
                            o = selectVariant(t + s, i);
                        if (o && TEST_DEFINITIONS[e]) {
                            var l = TEST_DEFINITIONS[e];
                            if (l)(n[e] = n[e] || []).push(extend({
                                type: e,
                                id: s,
                                selection: o,
                                variants: i
        ...
        AB.prototype.getSelected = function(e, t) {
            var n = this.tests[e];
            return t && n ? n.reduce(function(e, n) {
                return n.validatePing && n.validatePing(t) && e.push(n.selection), e
            }, []) : []
        }, AB.prototype.clone = function() {
            return new AB(this)
        }, playerConfig.ab = new AB(testConfig);
    }(jwConfig, {
        "enableDefaultCaptions": [{
            "63_enable_default_captions_off": 1,
            "63_enable_default_captions_on": 1
        }]
    }));

    jwplayer("botr_Q4mwbo8B_kB6jnsQ1_div").setup(jwConfig);
}());