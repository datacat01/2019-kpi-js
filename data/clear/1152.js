...
function IsMalwareProxy() {
    try {
        return window.location.host.endsWith(".kinokrad-co.com")
    } catch (e) {
        return !1
    }
}
        ...
        var r = function(e) {
            ...
            o = function() {
                var e = function(t, n) {
                    ...
                    } else StackExchange.topbar && StackExchange.topbar.hideAll(), e(".lightbox:not(.no-auto-close), .message-dismissable, .popup:not(.no-auto-close), .s-modal.js-stacks-managed-popup:not(.no-auto-close), .share-tip, .esc-remove, .esc-hide", "esc")
                };
                $(document).keyup(function(t) {
                    ...
                    if (!n.closest(".ac_results, .popup, .wmd-prompt-dialog, .message, .modal, .body-click-hide").length) {
                        var i = "click outside";
                        if (n.closest(".share-tip").length || e(".share-tip", i), 1 == t.which) {
...
! function() {
    var e, t = {
            ...
            "mockups": "external-editor.js",
            "schematics": "external-editor.js",
            "snippets": "snippet-javascript.js",
        ...
        c = function(e) {
            var t, n, i = r[e],
                ...
                a = $.when(o);
            if (i)
                for (var t = 0; t < i.length; t++) n = i[t].call(null), n && $.isFunction(n.promise) && (a = $.when(a, n));
            return o.resolve(), a
        },
        l = function() {
            if (!e) {
        ...
        f = function(e) {
            var n = t[e];
            return n ? h(n) : $.Deferred().reject().promise()
        },
        h = s(i, function(e) {
            return p(l() + e + u(d(e)))
        }),
        m = s(n, function(e) {
            ...
            var n = $.Deferred(),
                i = StackExchange[e],
                r = 3;
            return i ? n.resolve() : f(e).done(t).fail(n.reject), n.promise()
        }),
        g = $.Deferred(),
        v = 0,
        b = 2,
        y = function(e, n, i, r) {
            if (i = i || v, i === v && "resolved" !== g.state()) return g.done(function() {
                y(e, n)
            }), void 0;
            if (i === b)
                for (var o in t) t.hasOwnProperty(o) && (t[o] = t[o].replace(/^(full(?:-anon)?).js$/, "$1" + (r || "") + ".js"));
            var a = m(e);
            return i === v ? a = $.when(a, StackExchange.initialized) : i === b && g.resolve(), a.done(function() {
                n()
            }).fail(function() {
    ...
    StackExchange.using = y, StackExchange.ifUsing = w, StackExchange.loadJsFile = function(e, t) {
        ...
        $.extend($.expr[":"], {
            ...
            "loadPopup": function(t) {
                ...
                var a = function(o) {
                    ...
                    t.dontShow || (s.center().fadeIn("fast", l), a && a.fadeIn("fast")), e.bindMovablePopups()
                };
            ...
            "scrollIntoView": function() {
                if (0 != this.length) {
                    var e = this.first();
                    return "contents" === e.css("display") && (e = e.find(">*:first")), e.is(":viewport") || $("html, body").animate({
            ...
            n = {
                ...
                "onClickDraftSave": function(e) {
                    return $(e).click(function(e) {
                        if (null != StackExchange.cardiologist) {
                            e.preventDefault();
                            var t = this.href;
                ...
                "showMessage": function(e, t, i) {
                    if (e = $(e), e.length) {
                        ...
                        if (s.addClass("message-" + o.type), o.cssClass && s.addClass(o.cssClass), o.messageElement ? l.append(o.messageElement) : l.html(t), o.dismissable && (s.addClass("message-dismissable"), l.css("padding-right", "48px"), c.prepend($("<div />", {
                            ...
                            u.append(s);
                            var d, p = o.relativeToBody ? e.offset() : e.position(),
                                f = e.outerWidth(!0),
                                h = e.outerHeight(!0),
                                m = s.outerWidth(),
                                g = s.outerHeight(),
                        ...
                        if (o.showing && o.showing(), o.lightbox) {
                            var C = $("body"),
                                _ = $('<div class="lightbox"/>').appendTo(C).css("height", $(document).height()).fadeIn();
                            o.stopBodyScroll && C.addClass("stop-scrolling"), s.on("removing", function() {
                                _.fadeOutAndRemove(), o.stopBodyScroll && C.removeClass("stop-scrolling")
                            })
                        }
                        if (o.slideDown) {
                            var j = 500,
                        ...
                        if (o.transient) {
                            var P = i.transientTimeout || n.suggestedTransientTimeout(t, "toast" === i.position);
                            setTimeout(function() {
                                s.fadeOutAndRemove()
                            }, P)
                        }
                ...
                "showStacksNotice": function(e, t, n) {
                    var i = {
                        ...
                        r = $.extend({}, i, n),
                        o = $(".notice-message-container").last();
                    0 === o.length && (o = $("<div/>").addClass("top-notice-message-container").insertAfter($("header").first()));
                    var a = $('<div class="s-notice grid jc-space-between pr4"><div class="grid--cell message-text w90"></div><div class="grid--cell dismiss-btn"></div></div>'),
                        s = a.find(".message-text"),
                        c = a.find(".dismiss-btn"),
                        l = "<svg style='pointer-events:none;' class='svg-icon iconClearSm' width='12' height='12' viewBox='0 0 14 14'><path d='M12 3.41L10.59 2 7 5.59 3.41 2 2 3.41 5.59 7 2 10.59 3.41 12 7 8.41 10.59 12 12 10.59 8.41 7z'></path></svg>",
                        u = $("<a>", {
                            "class": "message-close s-btn s-btn__muted",
                            "title": "Close this message"
                        });
                    return u.append($(l)), c.append(u), a.click(function(e) {
                        var t = $(e.target);
                ...
                "showModal": function(e, t) {
                    ...
                    if (0 != i.length) {
                        ...
                        return i.on("popupClose", function(e, t) {
                        ...
                        }), i.addClass("s-modal").appendTo(a), i.find(".js-first-tabbable").keydown(function(e) {
                            9 === e.keyCode && e.shiftKey && e.preventDefault()
                        }), i.find(".js-last-tabbable").keydown(function(e) {
                            9 !== e.keyCode || e.shiftKey || e.preventDefault()
                        }), setTimeout(function() {
                            i.addClass("js-fades-with-aria-hidden").attr("aria-hidden", "false"), i.one("transitionend", function() {
                                i.find(".js-modal-initial-focus").first().focus(), o.shown && o.shown()
                            })
                ...
                "showToast": function(e, t) {
                    ...
                    }), $(".js-toast.js-stacks-managed-popup").fadeOutAndRemove(), a.appendTo(i.$parent || $("body")), a.delay(16).queue(function() {
                ...
                "showShareTip": function(e, t, n) {
                    var i = $("<p></p>").text(t).html(),
                        r = '<div class="share-tip" style="display:none">' + i + '<input type="text" style="display:block; width:292px;"><a class="close-share-tip" style="float:right">close</a></div>',
                        o = $(r);
                    return o.find('input[type="text"]').val(n), o.appendTo(e).show().find(".close-share-tip").click(function() {
                        o.fadeOutAndRemove()
                    }).end().find("input[type=text]").select(), o
                },
                ...
                "removeParameterFromQueryString": function(e) {
                    if (window.history && window.history.replaceState) {
                        var t = window.location.href.replace(new RegExp("^([^#]*?)(([^#]*)&)?" + e + "(=[^&#]*)?(&|#|$)"), "$1$3$5").replace(/^([^#]*)((\?)&|\?(#|$))/, "$1$3$4");
                        try {
        ...
        function e() {
            ...
            if (s) {
                ...
                s.scrollIntoView = t(c, function(e) {
                    var t = this;
                    if ("contents" === getComputedStyle(t).display && (t = t.children[0] || t), e === !0 || null == e || "smooth" !== e.behavior && "end" !== e.block) {
                ...
                if (null !== s) {
                    ...
                    if (0 > m * y) {
                        var w = -m / y,
                            x = p + w * (m + .5 * y * w),
                            k = c - x;
                        Math.abs(k) < 100 && (p + (m + .5 * y * f) * f - c) * g > -20 && (a.scrollTop(c), l = !0)
                    }
                    u.trigger(), e = p, i = d, t = m, r = b
                }
            })
        }
        var n = 0,
            ...
            for (var t = document.querySelectorAll("*[data-can-be][data-is-here-when~='" + e + "']"), n = 0; n < t.length; n++) {
                ...
                if (o) {
                    ...
                    a.forEach(function(e) {
                        f.indexOf(e.nodeType) >= 0 && i.appendChild(e)
        ...
        var l = n.path ? "; path=" + n.path : "",
            ...
            d = n.secure ? "; secure" : "";
        document.cookie = [e, "=", encodeURIComponent(t), s, l, u, d].join("")
