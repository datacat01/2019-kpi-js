jQuery(document).ready(function() {
    ...
    function b() {
        ...
        jQuery("body").bind("touchmove", function(a) {
            ...
            display: "flex"
        })) : b = c.find(".fusion-flyout-menu"), jQuery(".fusion-header-has-flyout-menu .fusion-secondary-header").length && (d = jQuery(".fusion-header-has-flyout-menu .fusion-secondary-header").outerHeight()), window.$wpadminbarHeight = jQuery("#wpadminbar").length ? jQuery("#wpadminbar").height() : 0, a = jQuery(".fusion-header-has-flyout-menu-content").height() + jQuery(".fusion-secondary-header").height() + window.$wpadminbarHeight, c.hasClass("fusion-flyout-menu-active") && (b.css({
            height: "calc(100% - " + a + "px)",
            "margin-top": a
        }), b.find(".fusion-menu").height() > b.height() && b.css("display", "flex")), "0" == avadaMenuVars.header_sticky ? (c.find(".fusion-header").css({
            position: "fixed",
            width: "100%",
            "max-width": "100%",
    ...
    function c() {
        setTimeout(function() {
            var a = jQuery(".fusion-header-has-flyout-menu"),
                b = 0;
            jQuery(".fusion-header-has-flyout-menu .fusion-secondary-header").length && (b = jQuery(".fusion-header-has-flyout-menu .fusion-secondary-header").outerHeight()), a.find(".fusion-flyout-menu").css("display", ""), "0" == avadaMenuVars.header_sticky ? (a.find(".fusion-header").attr("style", ""), jQuery(".fusion-header-sticky-height").attr("style", "")) : "fixed" === a.find(".fusion-header").css("position") && (a.find(".fusion-header").css("position", ""), a.find(".fusion-header").offset().top > b && a.find(".fusion-header").css("top", window.$wpadminbarHeight), jQuery(window).trigger("scroll")), jQuery("body").unbind("touchmove")
        }, 250)
    }
    var d;
    jQuery(".fusion-dropdown-svg").length && jQuery(".fusion-dropdown-svg").each(function() {
        ...
        "" !== jQuery(this.hash).length && this.hash.slice(1) && (jQuery(this).parents(".fusion-mobile-menu-design-classic").length ? (jQuery(this).parents(".fusion-menu, .menu").hide().removeClass("mobile-menu-expanded"), jQuery(".fusion-mobile-menu-search").hide()) : jQuery(this).parents(".fusion-mobile-nav-holder").hide())
        ...
        var a = "fusion-mobile-nav-item";
        jQuery(this).data("classes") && (a += " " + jQuery(this).data("classes")), jQuery(this).find("img").hasClass("wpml-ls-flag") && (a += " wpml-ls-item"), (jQuery(this).hasClass("current-menu-item") || jQuery(this).hasClass("current-menu-parent") || jQuery(this).hasClass("current-menu-ancestor") || jQuery(this).hasClass("fusion-mobile-current-nav-item")) && (a += " fusion-mobile-current-nav-item"), jQuery(this).hasClass("menu-item-has-children") && (a += " menu-item-has-children"), jQuery(this).attr("class", a), jQuery(this).find(" > ul").length && (jQuery(this).find("> a").after('<button href="#" aria-label="' + avadaMenuVars.mobile_submenu_open + '" aria-expanded="false" class="fusion-open-submenu"></button>'), jQuery(this).find(" > ul").hide())
