...
(function($, Drupal, window, document, undefined) {
	...
	$('.cam-quicklinks-list').clone().appendTo(projectlight.$quicklinks).addClass("column12 clearfix");*/
        ...
        projectlight.setNavigationColumnHeight = function() {
            ...
            $('.cam-global-navigation li a').css({
                'min-height': maxColumnHeight
            })
        };
        ...
        projectlight.setContentColumnHeight = function() {
            ...
            if ($('.cam-tertiary-navigation').length > 0) {
                $('.cam-tertiary-navigation, .cam-secondary-content, .cam-main-content').css({
        ...
        projectlight.localNav = (function() {
            ...
            function setupNavigation() {
                ...
                if (Modernizr.mq('only all')) {
                    $('.cam-sub').children("a").css({
                        "position": "relative"
                    }).append("<span class='cam-menu-indicator cam-fwd-btn'></span>")
                }
        ...
        projectlight.createCarousel = function() {
            ...
            carousel.init = function() {
                ...
                if (this.maxSlides > 1) {
                    this.slides.css({
                        'width': (this.carouselWidth * (this.maxSlides + 2)) + this.carouselWidth + 'px',
            ...
            projectlight.resetCarousel = function() {
                ...
                if (carousel.maxSlides > 1) {
                    carousel.slides.css({
                        'width': (carousel.carouselWidth * (carousel.maxSlides + 2)) + carousel.carouselWidth + 'px',
                        'left': '-' + (carousel.carouselWidth * carousel.currentSlide) + 'px'
                    });
                }

                // reset width and position of slides when page is changed
                carousel.slides.children().css({
