(function(globals) {
    ...
    django.catalog = {
        ...
        "# Attendees": "# Attendees",
        "$0": "$0",
        "${ccType} ending in ${ccMask}": "${ccType} ending in ${ccMask}",
        ...
        "%(attendeeCountLocalized)s going": "%(attendeeCountLocalized)s going",
        ...
        "%(categoryName)s background image.": "%(categoryName)s background image.",
        "%(city)s, %(region)s": "%(city)s, %(region)s",
        "%(collectionName)s is now live": "%(collectionName)s is now live",
        ...
        "%(eventName)s (Already Published)": "%(eventName)s (Already Published)",
        "%(eventName)s - %(ticketClassName)s": "%(eventName)s - %(ticketClassName)s",
        "%(eventName)s image": "%(eventName)s image",
        ...
        "%(location)s All Events | Eventbrite": "%(location)s All Events | Eventbrite",
        ...
        "%(organizerName)s Logo": "%(organizerName)s Logo",
        ...
        "%(price)s %(location)s %(titleFilter)s Events %(date)s | Eventbrite": "%(price)s %(location)s %(titleFilter)s Events %(date)s | Eventbrite",
        "%(price)s %(query)s %(category)s events %(date)s in %(location)s": "%(price)s %(query)s %(category)s events %(date)s in %(location)s",
        ...
        "%(startDate)s to %(endDate)s": "%(startDate)s to %(endDate)s",
        ...
        "\u0026 1 other": "\u0026 1 other",
        "'Unavailable' Page Event Suggestions": "'Unavailable' Page Event Suggestions",
        ...
        "* You can no longer unlink your event because of processed ticket sales on Facebook. If you would like to stop selling tickets on Facebook then de-select all ticket-types in the list above.": "* You can no longer unlink your event because of processed ticket sales on Facebook. If you would like to stop selling tickets on Facebook then de-select all ticket types in the list above.",
        "* You can no longer unpublish your event because of processed ticket sales on Facebook. If you would like to stop selling tickets on Facebook then de-select all ticket-types in the list above.": "* You can no longer unpublish your event because of processed ticket sales on Facebook. If you would like to stop selling tickets on Facebook then de-select all ticket types in the list above.",
        ...
        "/mo": "/ mo",
        "/mo billed montly": "/mo billed monthly",
        "0": "0",
        ...
        "1-100": "1-100",
        "1. Choose the right event image": "1. Choose the right event image",
        "1. Connect to Facebook": "1. Connect to Facebook",
        "10 digit phone number required.": "10-digit phone number required.",
        "10 miles": "10 miles",
        "100": "100",
        "100 miles": "100 miles",
        ...
        "2 miles": "2 miles",
        "2-3": "2-3",
        "2. Select the Facebook Page that's hosting the event": "2. Select the Facebook Page that's hosting the event",
        "2. Shorten your event title": "2. Shorten your event title",
        "20 miles": "20 miles",
        ...
        "2nd day": "2nd day",
        "3 months": "3 months",
        "3. Publish your new event on Facebook or link to an existing event": "3. Publish your new event on Facebook or link to an existing event",
        "3. Publish your new event or add tickets to an existing one": "3. Publish your new event or add tickets to an existing one",
        "3. Upgrade your event description": "3. Upgrade your event description",
        ...
        "4th day": "4th day",
        "5 miles": "5 miles",
        "5-20 digit phone number required.": "5-20 digit phone number required.",
        "50": "50",
        "50 miles": "50 miles",
        "5001+": "5001+",
        "501-1000": "501-1000",
        ...
        "7-9 digit phone number required.": "7-9 digit phone number required.",
        "7th": "7th",
        "8 digit phone number required.": "8-digit phone number required.",
        "8-10": "8-10",
        "8th": "8th",
        "9 digit phone number required.": "9-digit phone number required.",
        "9-10 digit phone number required.": "9- or 10-digit phone number required.",
        "9th": "9th",
        ...
        "\u003cspan class='text-body--faint'\u003eLogged in as - \u003c/span\u003e\u003cspan class='facebook_user_name'\u003e%(user_name)s\u003c/span\u003e": "\u003cspan class='text-body--faint'\u003eLogged in as - \u003c/span\u003e\u003cspan class='facebook_user_name'\u003e%(user_name)s\u003c/span\u003e",
        ...
        "\u003cstrong\u003eBy clicking purchase, I agree to the \u003ca href=\"/support/articleredirect?anum=8477\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Terms of Service\u003c/a\u003e. I have read the \u003ca href=\"/support/articleredirect?anum=8478\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Privacy Policy\u003c/a\u003e, and I understand that my subscription payment is nonrefundable and will automatically renew each year. I authorize Eventbrite to charge the payment method provided above or another payment method on file on an annual basis until I cancel. I may \u003ca href=\"/support/articleredirect?anum=41510\" target=\"_blank\" rel=\"noopener noreferrer\"\u003ecancel\u003c/a\u003e anytime or manage my subscription preferences and payment information by visiting my \u003ca href=\"/account-settings/plan\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eManage Subscription\u003c/a\u003e.\u003cstrong\u003e": "\u003cstrong\u003eBy clicking purchase, I agree to the \u003ca href=\"/support/articleredirect?anum=8477\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Terms of Service\u003c/a\u003e. I have read the \u003ca href=\"/support/articleredirect?anum=8478\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Privacy Policy\u003c/a\u003e, and I understand that my subscription payment is nonrefundable and will automatically renew each year. I authorise Eventbrite to charge the payment method provided above or another payment method on file on an annual basis until I cancel. I may \u003ca href=\"/support/articleredirect?anum=41510\" target=\"_blank\" rel=\"noopener noreferrer\"\u003ecancel\u003c/a\u003e anytime or manage my subscription preferences and payment information by visiting my \u003ca href=\"/account-settings/plan\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eManage Subscription\u003c/a\u003e.\u003cstrong\u003e",
        "\u003cstrong\u003eYour card will be charged %(chargeAmountForOrganizer)s\u003c/strong\u003e to cover the cost of refunding the buyer. Do not enter the buyers card number. Eventbrite refunds the fees portion of this order.": "\u003cstrong\u003eYour card will be charged %(chargeAmountForOrganizer)s\u003c/strong\u003e to cover the cost of refunding the buyer. Do not enter the buyers card number. Eventbrite refunds the fees portion of this order.",
        "\u003cstrong\u003eYour card will be charged %(chargeAmountForOrganizer)s\u003c/strong\u003e to cover the cost of refunding the buyer. Do not enter the buyers card number. Eventbrite's fees are nonrefundable.": "\u003cstrong\u003eYour card will be charged %(chargeAmountForOrganizer)s\u003c/strong\u003e to cover the cost of refunding the buyer. Do not enter the buyers card number. Eventbrite's fees are nonrefundable.",
        ...
        "Accelerate your tickets sales": "Accelerate your ticket sales",
        "Accept": "Accept",
        ...
        "Add Campaign Image": "Add Campaign Image",
        "Add Card": "Add Card",
        ...
        "Add a new Facebook event": "Add a new Facebook event",
        ...
        "Add artists performing at the show and get wider distribution through our partners.": "Add artists performing at the show and get wider distribution through our partners.",
        "Add bank account": "Add bank account",
        "Add contacts": "Add contacts",
        "Add domain": "Add domain",
        "Add event to Facebook": "Add event to Facebook",
        "Add event to a collection": "Add event to a collection",
        ...
        "Add multiple images to your description to bring your event to life. Table stakes: Write at least 100-200 words \u2014 creators sell 1.5X more tickets when they do. Include details that attendees care most about, like event FAQs, company info, and social media links. Get more tips ": "Add multiple images to your description to bring your event to life. Table stakes: Write at least 100-200 words \u2014 creators sell 1.5X more tickets when they do. Include details that attendees care most about, like event FAQs, company info, and social media links. Get more tips ",
        "Add new card": "Add new card",
        "Add new payout method": "Add new payout method",
        "Add new pixel": "Add new pixel",
        "Add performance": "Add performance",
        "Add some artists above and let's get this show on the road.": "Add some artists above and let's get this show on the road.",
        "Add text": "Add text",
        ...
        "Add this page to your home screen to easily access all the latest and greatest events in %(city)s.": "Add this page to your home screen to easily access all the latest and greatest events in %(city)s.",
        ...
        "Add tickets to an existing Facebook event": "Add tickets to an existing Facebook event",
        ...
        "Adding your event to Facebook allows people to checkout without leaving your Facebook Event.": "Adding your event to Facebook allows people to checkout without leaving your Facebook Event.",
        ...
        "Affiliate code for Wanderlust to use Order Service APIs on wanderlust.com": "Affiliate code for Wanderlust to use Order Service APIs on wanderlust.com",
        "Affiliate+Program": "Affiliate+Programme",
        ...
        "After you connect to your Facebook account, you can view and edit details before publishing.": "After you connect to your Facebook account, you can view and edit details before publishing.",
        ...
        "All other event details, including the event image, must be updated directly within Facebook.": "All other event details, including the event image, must be updated directly within Facebook.",
        "All pages are mobile optimized to look great on both desktop and mobile devices.": "All pages are mobile-optimised to look great on both desktop and mobile devices.",
        ...
        "An Eventbrite representative will contact you via email within 48 hours to further discuss your acceptance of this offer.": "An Eventbrite representative will contact you via email within 48 hours to further discuss your acceptance of this offer.",
        ...
        "An error occured when trying to communicate with Facebook. Try disabling any ad blocker extension you may have installed and reload this page.": "An error occured when trying to communicate with Facebook. Try disabling any ad blocker extension you may have installed and reload this page.",
        ...
        "An error occurred.": "An error occurred.",
        "An error ocurred, please, try again later.": "An error ocurred, please, try again later.",
        ...
        "An event is required to link.": "An event is required to link.",
        ...
        "Anyone with this link can view the event.": "Anyone with this link can view the event.",
        ...
        "Apply for daily advance payouts in the payout schedule section below.": "Apply for daily advance payouts in the payout schedule section below.",
        "Apply now": "Apply now",
        ...
        "Are you a GST-registered business with a Singapore UEN number?": "Are you a GST-registered business with a Singapore UEN number?",
        ...
        "Are you registered for amusement tax with the City of Chicago Deparment of Finance?": "Are you registered for amusement tax with the City of Chicago Deparment of Finance?",
        ...
        "Are you sure you want to copy this list?": "Are you sure you want to copy this list?",
        ...
        "Are you sure you want to delete %(name)s collection?": "Are you sure you want to delete %(name)s collection?",
        ...
        "Are you sure you want to delete these %(count)s lists?": "Are you sure you want to delete these %(count)s lists?",
        ...
        "Are you sure you want to unlink this event from Facebook?": "Are you sure you want to unlink this event from Facebook?",
        ...
        "Artist's Name:": "Artist's Name:",
        "Artist's Social Media Image Url": "Artist's Social Media Image Url",
        ...
        "Artist's Social Thumbnail Image Url": "Artist's Social Thumbnail Image Url",
        "Artist's name": "Artist's name",
        "Artists": "Artists",
        ...
        "Atendee Newletter": "Attendee Newsletter",
        "Atlanta City Browse Promoted Listing": "Atlanta City Browse Promoted Listing",
        "Atlanta Directory Promoted Listings": "Atlanta Directory Promoted Listings",
        "Atlanta Homepage Promoted Listings": "Atlanta Homepage Promoted Listings",
        "Atlanta Related Events (expired listing) Promoted Listings": "Atlanta Related Events (expired listing) Promoted Listings",
        ...
        "Attendee Moments": "Attendee Moments",
        ...
        "Attendees have ordered tickets for your event. Refund or cancel all orders to cancel your event.": "Attendees have ordered tickets for your event. Refund or cancel all orders to cancel your event.",
        ...
        "Automatic": "Automatic",
        "Automatic Listing on About the Journey": "Automatic Listing on About the Journey",
        ...
        "Automatic Listing on Chumi": "Automatic Listing on Chumi",
        "Automatic Listing on City Spark": "Automatic Listing on City Spark",
        "Automatic Listing on CitySpark": "Automatic Listing on CitySpark",
        "Automatic Listing on Cliq.FM": "Automatic Listing on Cliq.FM",
        "Automatic Listing on Comedyseekr": "Automatic Listing on Comedyseekr",
        ...
        "Automatic Listing on Dallas Observer": "Automatic Listing on Dallas Observer",
        "Automatic Listing on Denver Westword": "Automatic Listing on Denver Westword",
        ...
        "Automatic Listing on Ellenwood EP\t": "Automatic Listing on Ellenwood EP\t",
        "Automatic Listing on Emerald City EDM": "Automatic Listing on Emerald City EDM",
        ...
        "Automatic Listing on Evvnt": "Automatic Listing on Evvnt",
        ...
        "Automatic Listing on Fuloop": "Automatic Listing on Fuloop",
        "Automatic Listing on Gigseekr": "Automatic Listing on Gigseekr",
        ...
        "Automatic Listing on Houston Press": "Automatic Listing on Houston Press",
        ...
        "Automatic Listing on Kanev": "Automatic Listing on Kanev",
        "Automatic Listing on LA Weekly": "Automatic Listing on LA Weekly",
        "Automatic Listing on LinkedIn": "Automatic Listing on LinkedIn",
        "Automatic Listing on LiveBy": "Automatic Listing on LiveBy",
        "Automatic Listing on Livy Technologies": "Automatic Listing on Livy Technologies",
        "Automatic Listing on Metro": "Automatic Listing on Metro",
        "Automatic Listing on Miami New Times": "Automatic Listing on Miami New Times",
        "Automatic Listing on Mr. Trance Movement": "Automatic Listing on Mr. Trance Movement",
        "Automatic Listing on Music Festivals Canada": "Automatic Listing on Music Festivals Canada",
        "Automatic Listing on New Times Broward-Palm Beach": "Automatic Listing on New Times Broward-Palm Beach",
        "Automatic Listing on Nextdoor": "Automatic Listing on Nextdoor",
        ...
        "Automatic Listing on PartyFixx\t": "Automatic Listing on PartyFixx\t",
        "Automatic Listing on Pawzr\t": "Automatic Listing on Pawzr\t",
        "Automatic Listing on Payrange\t": "Automatic Listing on Payrange\t",
        "Automatic Listing on Pearachute": "Automatic Listing on Pearachute",
        "Automatic Listing on People App": "Automatic Listing on People App",
        "Automatic Listing on Phoenix New Times": "Automatic Listing on Phoenix New Times",
        "Automatic Listing on Pre-order.Me\t": "Automatic Listing on Pre-order.Me\t",
        "Automatic Listing on Pulcity": "Automatic Listing on Pulcity",
        "Automatic Listing on SF Station": "Automatic Listing on SF Station",
        "Automatic Listing on SFGate": "Automatic Listing on SFGate",
        "Automatic Listing on Samsung Calendar": "Automatic Listing on Samsung Calendar",
        ...
        "Automatic Listing on Spotify": "Automatic Listing on Spotify",
        "Automatic Listing on Stanza": "Automatic Listing on Stanza",
        "Automatic Listing on StubHub": "Automatic Listing on StubHub",
        "Automatic Listing on Surf\t": "Automatic Listing on Surf\t",
        "Automatic Listing on Taquilla.com": "Automatic Listing on Taquilla.com",
        "Automatic Listing on The 20x20 Podcast": "Automatic Listing on The 20x20 Podcast",
        ...
        "Automatic Listing on TodayTix": "Automatic Listing on TodayTix",
        "Automatic Listing on Travelux": "Automatic Listing on Travelux",
        "Automatic Listing on TripAdvisor": "Automatic Listing on TripAdvisor",
        "Automatic Listing on Vegas Party VIP": "Automatic Listing on Vegas Party VIP",
        "Automatic Listing on Viator": "Automatic Listing on Viator",
        "Automatic Listing on Viberate": "Automatic Listing on Viberate",
        "Automatic Listing on Weather.com": "Automatic Listing on Weather.com",
        "Automatic Listing on WhatsOut": "Automatic Listing on WhatsOut",
        "Automatic Listing on WhereTraveler": "Automatic Listing on WhereTraveler",
        "Automatic Listing on Wyd App\t": "Automatic Listing on Wyd App\t",
        "Automatic Listing on Yelp": "Automatic Listing on Yelp",
        "Automatic Listing on YoTixxy": "Automatic Listing on YoTixxy",
        "Automatic Listing on iFun\t": "Automatic Listing on iFun\t",
        "Automatic Listing on seattlepi.com": "Automatic Listing on seattlepi.com",
        "Automatic Listing on theBlueUnderground": "Automatic Listing on theBlueUnderground",
        "Automatic Listing on thelist.ie": "Automatic Listing on thelist.ie",
        "Automatic Listing via DoStuff Media": "Automatic Listing via DoStuff Media",
        "Automatic Listing via EDM Calendar": "Automatic Listing via EDM Calendar",
        "Automatic Listing via Electronic Midwest": "Automatic Listing via Electronic Midwest",
        "Automatic Listing via Electronic Vegas": "Automatic Listing via Electronic Vegas",
        ...
        "Automatic listing on Hoodline": "Automatic listing on Hoodline",
        "Automatic listing on KPN": "Automatic listing on KPN",
        "Automatic listing on Pandora": "Automatic listing on Pandora",
        ...
        "Beauty": "Beauty",
        "Beer": "Beer",
        "Before publishing you'll need to select a plan and checkout.": "Before publishing you'll need to select a plan and checkout.",
        "Before you can get paid out...": "Before you can get paid out...",
        "Before you go, could you let us know how to improve?": "Before you go, could you let us know how to improve?",
        ...
        "Billing Zip/Postal": "Billing Zip/Postal Code",
        "Biography": "Biography",
        "Biography is empty for this artist.": "Biography is empty for this artist.",
        "Biography:": "Biography:",
        ...
        "Boston City Browse Promoted Listing": "Boston City Browse Promoted Listing",
        "Boston Directory Promoted Listings": "Boston Directory Promoted Listings",
        "Boston Homepage Promoted Listings": "Boston Homepage Promoted Listings",
        "Boston Related Events (expired listing) Promoted Listings": "Boston Related Events (expired listing) Promoted Listings",
        ...
        "BriteTV Mobile View": "BriteTV Mobile View",
        ...
        "By clicking Continue, you agree to the ": "By clicking Continue, you agree to the ",
        "By clicking purchase, I request to begin my subscription immediately. I agree that my subscription payment is nonrefundable except where required by law, and that Eventbrite may deduct from any refund an amount proportional to the services supplied during the subscription period up until the time I cancel.": "By clicking purchase, I request to begin my subscription immediately. I agree that my subscription payment is nonrefundable except where required by law, and that Eventbrite may deduct from any refund an amount proportional to the services supplied during the subscription period up until the time I cancel.",
        "By clicking purchase, I request to begin my subscription immediately. I agree that my subscription payment is nonrefundable unless I cancel my subscription within 14 days, in which case Eventbrite may deduct from any refund an amount proportional to the services supplied during that period.": "By clicking purchase, I request to begin my subscription immediately. I agree that my subscription payment is nonrefundable unless I cancel my subscription within 14 days, in which case Eventbrite may deduct from any refund an amount proportional to the services supplied during that period.",
        "By clicking purchase, I request to initiate my subscription and agree that my subscription payment is nonrefundable except where required by law.": "By clicking purchase, I request to initiate my subscription and agree that my subscription payment is nonrefundable except where required by law.",
        "By clicking purchase, I request to initiate my subscription, and I agree that my subscription payment is nonrefundable.": "By clicking purchase, I request to initiate my subscription, and I agree that my subscription payment is nonrefundable.",
        "By clicking purchase, you agree that your subscription will renew automatically on an annual basis until you cancel. You authorize Eventbrite to charge subscription fees to the payment method provided above or another payment method on file each year until you cancel. You may cancel your subscription anytime or manage your subscription preferences and payment information by visiting your \u003ca href=\"/account-settings/plan\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eaccount settings\u003c/a\u003e.": "By clicking purchase, you agree that your subscription will renew automatically on an annual basis until you cancel. You authorise Eventbrite to charge subscription fees to the payment method provided above or another payment method on file each year until you cancel. You may cancel your subscription anytime or manage your subscription preferences and payment information by visiting your \u003ca href=\"/account-settings/plan\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eaccount settings\u003c/a\u003e.",
        "By continuing, I accept the Eventbrite \u003ca href=\"/tos\" class=\"eds-link\" target=\"_blank\" name=\"tos\" rel=\"noopener noreferrer\"\u003eterms of service\u003c/a\u003e, \u003ca href=\"/community-guidelines\" class=\"eds-link\" name=\"community-guidelines\" target=\"_blank\" rel=\"noopener noreferrer\"\u003ecommunity guidelines\u003c/a\u003e and have read the \u003ca href=\"/privacypolicy\" class=\"eds-link\" name=\"privacy-policy\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eprivacy policy\u003c/a\u003e.": "By continuing, I accept the Eventbrite \u003ca href=\"/tos\" class=\"eds-link\" target=\"_blank\" name=\"tos\" rel=\"noopener noreferrer\"\u003eterms of service\u003c/a\u003e, \u003ca href=\"/community-guidelines\" class=\"eds-link\" name=\"community-guidelines\" target=\"_blank\" rel=\"noopener noreferrer\"\u003ecommunity guidelines\u003c/a\u003e and have read the \u003ca href=\"/privacypolicy\" class=\"eds-link\" name=\"privacy-policy\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eprivacy policy\u003c/a\u003e.",
        ...
        "By following these tips, events like yours can show higher in search results, interest more buyers, and sell up to 1.5X more tickets on average.": "By following these tips, events like yours can show higher in search results, interest more buyers, and sell up to 1.5X more tickets on average.",
        ...
        "Campaign": "Campaign",
        "Campaign Colors": "Campaign Colours",
        ...
        "Can't be after show time.": "Can't be after show time.",
        ...
        "Charge:": "Charge:",
        "Charged by FanShield": "Charged by FanShield",
        ...
        "Chicago Directory Promoted Listing": "Chicago Directory Promoted Listing",
        "Chicago Homepage Promoted Listing": "Chicago Homepage Promoted Listing",
        "Chicago Related Events (expired listing) Promoted Listings": "Chicago Related Events (expired listing) Promoted Listings",
        "Chicago Tech Events": "Chicago Tech Events",
        "Chicago music": "Chicago music",
        ...
        "City focused discovery pages showing events and categories that users can browse.": "City-focused discovery pages showing events and categories that users can browse.",
        ...
        "Click on Share on Facebook button on register page": "Click on Share on Facebook button on register page",
        "Click on a charge schedule to see the detail.": "Click on a charge schedule to see the detail.",
        "Click on lightbox Share on Facebook button on register page": "Click on lightbox Share on Facebook button on register page",
        "Click on the button below": "Click on the button below",
        ...
        "Clicks:": "Clicks:",
        "Climbing": "Climbing",
        "Clipboard Share Tools": "Clipboard Share Tools",
        "Close": "Close",
        ...
        "Complete the 3 tips below to improve your event page!": "Complete the 3 tips below to improve your event page!",
        ...
        "Confirmation message must be 250 characters or less.": "Confirmation message must be 250 characters or fewer.",
        "Confirmed": "Confirmed",
        "Congo": "Congo",
        ...
        "Congratulations! You successfully published your event. ": "Congratulations! You successfully published your event. ",
        ...
        "Connect with your spirituality": "Connect with your spirituality",
        "Connected": "Connected",
        "Considering downgrading to Essentials": "Considering downgrading to Essentials",
        "Constant Contact Email Integration": "Constant Contact Email Integration",
        "Consumer Content - Chicago": "Consumer Content - Chicago",
        "Consumer content - DC": "Consumer content - DC",
        "Contact": "Contact",
        ...
        "Contacts": "Contacts",
        "Content required for the campaign is complete and ready. You can run the send process now!": "Content required for the campaign is complete and ready. You can run the send process now!",
        "Continue": "Continue",
        ...
        "Create a group": "Create a group",
        "Create a list and get the party started!": "Create a list and get the party started!",
        ...
        "Create new Facebook event": "Create new Facebook event",
        ...
        "Created the first event in its category in the region.": "Created the first event in its category in the region.",
        ...
        "Customization Assets Uploaded": "Customisation Assets Uploaded",
        "Customize": "Customise",
        "Customize Campaign": "Customise Campaign",
        ...
        "Description must be 250 characters or less.": "Description must be 250 characters or fewer.",
        ...
        "Despegar Newsletter ": "Despegar Newsletter ",
        "Despegar experiment ": "Despegar experiment ",
        ...
        "Did you know that event creators like you average 2x more free ticket sales using this Facebook integration?": "Did you know that event creators like you average 2x more free ticket sales using this Facebook integration?",
        ...
        "Directory": "Directory",
        "Directory Promoted Listings": "Directory Promoted Listings",
        "Disable": "Disable",
        ...
        "Discounted events": "Discounted events",
        ...
        "Display Gross Cash vs Credit (Box Office Sales Only)": "Display Gross Cash vs Credit (Box Office Sales Only)",
        ...
        "Do you want to create a new Facebook event?": "Do you want to create a new Facebook event?",
        ...
        "Don't miss these new events": "Don't miss these new events",
        ...
        "EIN/BN should be 9 digits long.": "EIN/BN should be 9 digits long.",
        ...
        "Editing: ${artist.name}": "Editing: ${artist.name}",
        ...
        "Email Share Tools": "Email Share Tools",
        "Email address": "Email address",
        ...
        "Email notification to your followers when you announce a new event": "Email notification to your followers when you announce a new event",
        ...
        "Embedded Checkout for EB.com": "Embedded Checkout for EB.com",
        ...
        "Enhanced Checkout on Instagram": "Enhanced Checkout on Instagram",
        "Enrich your career": "Enrich your career",
        "Enrich your life": "Enrich your life",
        ...
        "Enter Affiliation": "Enter Affiliation",
        ...
        "Enter company password": "Enter company password",
        "Enter email if you want to send guest a ticket": "Enter email if you want to send guest a ticket",
        ...
        "Enter event ID, organizer email, etc.": "Enter event ID, organiser email, etc.",
        "Enter group name": "Enter group name",
        "Enter group password": "Enter group password",
        "Enter height in pixels": "Enter height in pixels",
        ...
        "Enter the URL of the artist's image": "Enter the URL of the artist's image",
        "Enter the URL of the social link": "Enter the URL of the social link",
        "Enter the URL of the thumb image.": "Enter the URL of the thumb image.",
        ...
        "Enter width in pixels": "Enter width in pixels",
        ...
        "Enter your email to sign up or log in.": "Enter your email to sign up or log in.",
        ...
        "Epic night out": "Epic night out",
        "Equatorial Guinea": "Equatorial Guinea",
        "Equipment rentals": "Equipment rentals",
        "Eritrea": "Eritrea",
        "Error": "Error",
        "Error on saving tickets": "Error on saving tickets",
        ...
        "Error trying to uncheck user, please try again!": "Error trying to uncheck user, please try again!",
        ...
        "Event Page Score": "Event Page Score",
        "Event Page Score:": "Event Page Score:",
        ...
        "Event Publish Follow Notification for Android": "Event Publish Follow Notification for Android",
        "Event Recommendations on Eventbrite": "Event Recommendations on Eventbrite",
        ...
        "Event added to \u003ca href=%(href)s\u003e%(name)s\u003c/a\u003e.": "Event added to \u003ca href=%(href)s\u003e%(name)s\u003c/a\u003e.",
        ...
        "Event publish notification on android attendee app for users following organizers.": "Event publish notification on android attendee app for users following organisers.",
        "Event removed from": "Event removed from",
        "Event removed from \u003ca href=%(href)s\u003e%(name)s\u003c/a\u003e.": "Event removed from \u003ca href=%(href)s\u003e%(name)s\u003c/a\u003e.",
        ...
        "Eventbrite AMP Listing": "Eventbrite AMP Listing",
        "Eventbrite API": "Eventbrite API",
        "Eventbrite Advertising Partners": "Eventbrite Advertising Partners",
        "Eventbrite Affiliate Referral Program": "Eventbrite Affiliate Referral Programme",
        "Eventbrite Android App": "Eventbrite Android App",
        "Eventbrite Android Push Notification": "Eventbrite Android Push Notification",
        "Eventbrite Attendee Email Newsletters": "Eventbrite Attendee Email Newsletters",
        "Eventbrite Attendee Newsletter Editorial Content": "Eventbrite Attendee Newsletter Editorial Content",
        "Eventbrite Attendee Newsletter Promoted Events": "Eventbrite Attendee Newsletter Promoted Events",
        "Eventbrite Attendee Newsletter Recommendations": "Eventbrite Attendee Newsletter Recommendations",
        "Eventbrite Attendee Newsletter Saved Events": "Eventbrite Attendee Newsletter Saved Events",
        "Eventbrite Attendee Newsletter Subscribe Confirmation Email": "Eventbrite Attendee Newsletter Subscribe Confirmation Email",
        "Eventbrite Attendee Newsletter Top Free Events": "Eventbrite Attendee Newsletter Top Free Events",
        "Eventbrite Attendee Newsletter Weekend Events": "Eventbrite Attendee Newsletter Weekend Events",
        "Eventbrite Box Office": "Eventbrite Box Office",
        "Eventbrite Button": "Eventbrite Button",
        "Eventbrite Buy on Facebook Integration": "Eventbrite Buy on Facebook Integration",
        "Eventbrite Calendar": "Eventbrite Calendar",
        "Eventbrite Channels": "Eventbrite Channels",
        "Eventbrite Countdown": "Eventbrite Countdown",
        "Eventbrite Cross-Promotion": "Eventbrite Cross-Promotion",
        "Eventbrite Email Invitations from the Organizer": "Eventbrite Email Invitations from the Organiser",
        "Eventbrite Embedded Checkout": "Eventbrite Embedded Checkout",
        ...
        "Eventbrite Event Page": "Eventbrite Event Page",
        "Eventbrite Events surfaced in Uber Feed": "Eventbrite Events surfaced in Uber Feed",
        "Eventbrite Facebook Integration": "Eventbrite Facebook Integration",
        "Eventbrite Facebook Integration - Native": "Eventbrite Facebook Integration - Native",
        "Eventbrite Facebook Integration - Redirect": "Eventbrite Facebook Integration - Redirect",
        "Eventbrite Fee": "Eventbrite Fee",
        "Eventbrite Homepage": "Eventbrite Homepage",
        "Eventbrite Incomplete Registration Emails": "Eventbrite Incomplete Registration Emails",
        "Eventbrite LinkedIn integration": "Eventbrite LinkedIn integration",
        "Eventbrite New Year's Resolution Campaign": "Eventbrite New Year's Resolution Campaign",
        "Eventbrite Order Confirmation Email": "Eventbrite Order Confirmation Email",
        "Eventbrite Organizer": "Eventbrite Organiser",
        "Eventbrite Organizer Profile Page": "Eventbrite Organiser Profile Page",
        ...
        "Eventbrite Picks - City Marketing Managers": "Eventbrite Picks - City Marketing Managers",
        "Eventbrite Picks - Event Theme Pages": "Eventbrite Picks - Event Theme Pages",
        ...
        "Eventbrite RSS Feed": "Eventbrite RSS Feed",
        "Eventbrite Rally": "Eventbrite Rally",
        "Eventbrite Reminder Email": "Eventbrite Reminder Email",
        "Eventbrite Save Event Feature": "Eventbrite Save Event Feature",
        "Eventbrite Saved Events Reminder Push Notification": "Eventbrite Saved Events Reminder Push Notification",
        "Eventbrite Search \u0026 Directory": "Eventbrite Search \u0026 Directory",
        "Eventbrite Service Fee": "Eventbrite Service Fee",
        "Eventbrite Service fee": "Eventbrite Service fee",
        "Eventbrite Social Links": "Eventbrite Social Links",
        "Eventbrite Social Media Promo ": "Eventbrite Social Media Promo ",
        "Eventbrite Social Notification Emails": "Eventbrite Social Notification Emails",
        "Eventbrite Social Push Notification": "Eventbrite Social Push Notification",
        "Eventbrite Sponsorships": "Eventbrite Sponsorships",
        "Eventbrite Staff Picks": "Eventbrite Staff Picks",
        "Eventbrite Terms of Service": "Eventbrite Terms of Service",
        "Eventbrite Text Link": "Eventbrite Text Link",
        "Eventbrite Text Link on Digg": "Eventbrite Text Link on Digg",
        "Eventbrite Text Link on Facebook": "Eventbrite Text Link on Facebook",
        "Eventbrite Text Link on LinkedIn": "Eventbrite Text Link on LinkedIn",
        "Eventbrite Text Link on Myspace": "Eventbrite Text Link on Myspace",
        "Eventbrite Text Link on Twitter": "Eventbrite Text Link on Twitter",
        "Eventbrite Ticket Form": "Eventbrite Ticket Form",
        "Eventbrite Venue": "Eventbrite Venue",
        "Eventbrite Website Integration": "Eventbrite Website Integration",
        "Eventbrite Wordpress Plug-In": "Eventbrite Wordpress Plug-In",
        "Eventbrite YouTube Integration - Buy Tickets button": "Eventbrite YouTube Integration - Buy Tickets button",
        "Eventbrite YouTube Integration - Video Card\t": "Eventbrite YouTube Integration - Video Card\t",
        ...
        "Eventbrite checkout widget not eligible": "Eventbrite checkout widget not eligible",
        ...
        "Eventbrite's fee is nonrefundable and won't be included in any approved refunds. Your order's fee was ": "Eventbrite's fee is nonrefundable and won't be included in any approved refunds. Your order's fee was ",
        ...
        "Eventful": "Eventful",
        "Eventful Auto-Listing": "Eventful Auto-Listing",
        "Events": "Events",
        ...
        "Events left in your free trial": "Events left in your free trial",
        "Events on ": "Events on ",
        "Events shown on an error page for broken or deleted links.": "Events shown on an error page for broken or deleted links.",
        "Events using %(bankName)s": "Events using %(bankName)s",
        "Events!": "Events!",
        "Every day": "Every day",
        ...
        "Explore %(categoryName)s events. %(subtitle)s.": "Explore %(categoryName)s events. %(subtitle)s.",
        "Explore events Near Me": "Explore events Near Me",
        "Explore the arts": "Explore the arts",
        "Expo": "Expo",
        "Export": "Export",
        ...
        "Export is taking longer than expected! Please check back soon.": "Export is taking longer than expected! Please check back soon.",
        ...
        "Facebook Register Lightbox": "Facebook Register Lightbox",
        "Facebook Register Page": "Facebook Register Page",
        "Facebook Share Tools": "Facebook Share Tools",
        ...
        "Facebook doesn't support creation of an Official Event that lasts longer than 4 months for single instance events or a year for repeating events.": "Facebook doesn't support creation of an Official Event that lasts longer than 4 months for single instance events or a year for repeating events.",
        ...
        "Family-friendly experiences": "Family-friendly experiences",
        ...
        "Featured Event Card": "Featured Event Card",
        "Features": "Features",
        ...
        "Fee:": "Fee:",
        "Feed - Auto Boat and Air events bucket": "Feed - Auto Boat and Air events bucket",
        "Feed - Based on who you follow events bucket": "Feed - Based on who you follow events bucket",
        "Feed - Because you liked bucket": "Feed - Because you liked bucket",
        "Feed - Because you purchased events bucket": "Feed - Because you purchased events bucket",
        "Feed - Business and Professional events bucket": "Feed - Business and Professional events bucket",
        "Feed - Charity and Causes evenst events bucket": "Feed - Charity and Causes evenst events bucket",
        "Feed - Community and Culture events bucket": "Feed - Community and Culture events bucket",
        "Feed - Custom Liked events bucket": "Feed - Custom Liked events bucket",
        "Feed - Discounted events bucket": "Feed - Discounted events bucket",
        "Feed - Editor's Picks bucket": "Feed - Editor's Picks bucket",
        "Feed - Family and education events bucket": "Feed - Family and education events bucket",
        "Feed - Fashion and Beauty events bucket": "Feed - Fashion and Beauty events bucket",
        "Feed - Film and media entertainment events bucket": "Feed - Film and media entertainment events bucket",
        "Feed - Food \u0026 Drink events bucket": "Feed - Food \u0026 Drink events bucket",
        "Feed - Free Events bucket": "Feed - Free Events bucket",
        "Feed - Government \u0026 Politics events bucket": "Feed - Government \u0026 Politics events bucket",
        "Feed - Health \u0026 Wellness events bucket": "Feed - Health \u0026 Wellness events bucket",
        "Feed - Hobbies and Special Interest events bucket": "Feed - Hobbies and Special Interest events bucket",
        "Feed - Home and Lifestyle events bucket": "Feed - Home and Lifestyle events bucket",
        "Feed - Liked events bucket": "Feed - Liked events bucket",
        "Feed - Music events bucket": "Feed - Music events bucket",
        "Feed - Nearby cities bucket": "Feed - Nearby cities bucket",
        "Feed - Nearby cities events bucket": "Feed - Nearby cities events bucket",
        "Feed - Online events bucket": "Feed - Online events bucket",
        "Feed - Other events events bucket": "Feed - Other events events bucket",
        "Feed - Performing \u0026 Visual Arts events bucket": "Feed - Performing \u0026 Visual Arts events bucket",
        "Feed - Personalized Food and Drink events bucket": "Feed - Personalised Food and Drink events bucket",
        "Feed - Personalized music events bucket": "Feed - Personalised music events bucket",
        "Feed - Popular events bucket": "Feed - Popular events bucket",
        "Feed - Religion and Spirituality events bucket": "Feed - Religion and Spirituality events bucket",
        "Feed - School Activities events bucket": "Feed - School Activities events bucket",
        "Feed - Science \u0026 Technology bucket": "Feed - Science \u0026 Technology bucket",
        "Feed - Seasonal events bucket": "Feed - Seasonal events bucket",
        "Feed - Small city bucket": "Feed - Small city bucket",
        "Feed - Sports and Fitness events bucket": "Feed - Sports and Fitness events bucket",
        "Feed - This weekend events bucket": "Feed - This weekend events bucket",
        "Feed - Travel and Outdoor events bucket": "Feed - Travel and Outdoor events bucket",
        "Feed - Trending Topic events bucket": "Feed - Trending Topic events bucket",
        "Feed - What's new events bucket": "Feed - What's new events bucket",
        "Feedback": "Feedback",
        "Fees": "Fees",
        ...
        "Food \u0026 Drink Category Page": "Food \u0026 Drink Category Page",
        "Food \u0026 drink": "Food \u0026 drink",
        "Food \u0026 drink events": "Food \u0026 drink events",
        "Food \u0026 drink events you'll love": "Food \u0026 drink events you'll love",
        ...
        "For film lovers": "For film lovers",
        ...
        "Free order #%(id)s on %(dateCreated)s": "Free order no. %(id)s on %(dateCreated)s",
        ...
        "Free popular events": "Free popular events",
        ...
        "Fri": "Fri",
        "Friday": "Friday",
        "Friends' Events on Eventbrite": "Friends' Events on Eventbrite",
        "From": "From",
        "From Name": "From Name",
        ...
        "Full price": "Full price",
        "Fun on a budget": "Fun on a budget",
        "Fundly": "Fundly",
        ...
        "Get a new hobby": "Get a new hobby",
        ...
        "Get the best events and inspiration every week": "Get the best events and inspiration every week",
        ...
        "Goes to more that 50 events in a year.": "Goes to more that 50 events in a year.",
        ...
        "Guest Email (optional)": "Guest Email (optional)",
        ...
        "Handpicked Event card\t": "Handpicked Event card\t",
        "Hangtime": "Hangtime",
        "Happening this weekend": "Happening this weekend",
        ...
        "Heritage": "Heritage",
        "Hex": "Hex",
        "Hey %(firstName)s, we're testing out a new event page! Want the old event page? Contact us at \u003ca href=\"mailto:v1@eventbrite.com\"\u003ev1@eventbrite.com\u003c/a\u003e": "Hey %(firstName)s, we're testing out a new event page! Want the old event page? Contact us at \u003ca href=\"mailto:v1@eventbrite.com\"\u003ev1@eventbrite.com\u003c/a\u003e",
        "Hey! Let's find Events": "Hey! Let's find Events",
        "Hi!": "Hello",
        "Hi, %s!": "Hi, %s",
        "Hidden": "Hidden",
        ...
        "Hip-Hop": "Hip-Hop",
        "Hipercard": "Hipercard",
        "Hive.co Email Integration": "Hive.co Email Integration",
        ...
        "Home address": "Home address",
        "Homepage": "Homepage",
        "Homepage Promoted Listings": "Homepage Promoted Listings",
        "Homepage v2 Calendar Section Event Card": "Homepage v2 Calendar Section Event Card",
        "Homepage v2 Moods Section Event Card": "Homepage v2 Moods Section Event Card",
        "Homepage v2 Search Autocomplete": "Homepage v2 Search Autocomplete",
        "Honduras": "Honduras",
        ...
        "I aggree not to send email marketing to attendees who purchase a ticket through Facebook, unless I already had the attendees's email in my database": "I agree not to send email marketing to attendees who purchase a ticket through Facebook, unless I already had the attendees's email in my database",
        ...
        "I agree that my annual subscription will automatically renew each year, and I authorize Eventbrite to charge the payment method provided above or another payment method on file on an annual basis until I cancel.": "I agree that my annual subscription will automatically renew each year, and I authorise Eventbrite to charge the payment method provided above or another payment method on file on an annual basis until I cancel.",
        "I agree to the \u003ca href=\"/support/articleredirect?anum=8477\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Terms of Service\u003c/a\u003e and have read the \u003ca href=\"/support/articleredirect?anum=8478\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Privacy Policy\u003c/a\u003e.": "I agree to the \u003ca href=\"/support/articleredirect?anum=8477\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Terms of Service\u003c/a\u003e and have read the \u003ca href=\"/support/articleredirect?anum=8478\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Privacy Policy\u003c/a\u003e.",
        "I agree to the above transfer policy": "I agree to the above transfer policy",
        "I agree to these conditions": "I agree to these conditions",
        ...
        "I request to begin my annual subscription immediately. I agree that my subscription fee is nonrefundable unless I cancel within 14 days, in which case Eventbrite may deduct from any refund an amount proportional to the services supplied during that period.": "I request to begin my annual subscription immediately. I agree that my subscription fee is nonrefundable unless I cancel within 14 days, in which case Eventbrite may deduct from any refund an amount proportional to the services supplied during that period.",
        ...
        "I want events\u0026nbsp;\u003cspan class=\"eds-text-color--edgy-yellow\"\u003eNearMe\u003c/span\u003e": "I want events\u0026nbsp;\u003cspan class=\"eds-text-color--edgy-yellow\"\u003enear me\u003c/span\u003e",
        ...
        "If you accept this offer, you will be agreeing to put this sponsor's advertising at your event.": "If you accept this offer, you will be agreeing to put this sponsor's advertising at your event.",
        ...
        "If you change your mind, just update your settings on the \u003ca href=\"#\"\u003eemail preferences page\u003c/a\u003e": "If you change your mind, just update your settings on the \u003ca href=\"#\"\u003eemail preferences page\u003c/a\u003e",
        ...
        "If you need a break, you can put these newsletters on pause instead of unsubscribing": "If you need a break, you can put these newsletters on pause instead of unsubscribing",
        ...
        "Import Subscribers via CSV": "Import Subscribers via CSV",
        ...
        "Improve the quality of your event page in 3 quick ways.": "Improve the quality of your event page in 3 quick ways.",
        ...
        "Include fees in donation amount": "Include fees in donation amount",
        "Include fees in ticket price": "Include fees in ticket price",
        ...
        "Include tax in the ticket price.": "Include tax in the ticket price.",
        "Include tax in ticket price": "Include tax in ticket price",
        "Included": "Included",
        "Includes Eventbrite Payment Processing": "Includes Eventbrite Payment Processing",
        ...
        "Infinight": "Infinight",
        "Infinight will be using the Order Service APIs to build a custom checkout experience for it's attendees.": "Infinight will be using the Order Service APIs to build a custom checkout experience for its attendees.",
        ...
        "Integration with Mailchimp email marketing": "Integration with Mailchimp email marketing",
        ...
        "It's a ghost town here. Spooky!": "It's pretty dead around here.",
        ...
        "JPEG, PNG, GIF, no larger than 10MB": "JPEG, PNG, GIF, no larger than 10MB",
        "JPEG, PNG, GIF, no larger than 4MB.": "JPEG, PNG, GIF, no larger than 4MB.",
        "Jamaica": "Jamaica",
        "Jan": "Jan",
        ...
        "Jul": "Jul",
        "July": "July",
        "Jump to Calendar Section": "Jump to Calendar Section",
        "Jump to Categories Section": "Jump to Categories Section",
        "Jump to Moods Section": "Jump to Moods Section",
        "Jun": "Jun",
        "June": "June",
        "Justified": "Justified",
        "Kayaking": "Kayaking",
        ...
        "Keep your event title to 40 characters or less so it\u2019s readable in Google search results and on phones. No need to include information found above the fold, like event date and location. Get more SEO tips ": "Keep your event title to 40 characters or less so it\u2019s readable in Google search results and on phones. No need to include information found above the fold, like event date and location. Get more SEO tips ",
        ...
        "Kiribati": "Kiribati",
        "Knitting": "Knitting",
        "Knows where to find a good party": "Knows where to find a good party",
        ...
        "LA music": "LA music",
        "LA music calendar affiliate code": "LA music calendar affiliate code",
        "LAST NAME": "SURNAME",
        ...
        "Last Name:": "Surname:",
        "Last Touch Timestamp": "Last Touch Timestamp",
        "Last name": "Surname",
        ...
        "Last saved on %(changedDate)s at %(changedTime)s": "Last saved on %(changedDate)s at %(changedTime)s",
        "Last updated": "Last updated",
        "Last updated: %(eventPublishedDate)s": "Last updated: %(eventPublishedDate)s",
        "Latin": "Latin",
        "Latvia": "Latvia",
        ...
        "Let yourself be surprised with the best events in your area.": "Let yourself be surprised with the best events in your area.",
        "Let's Go": "Let's Go",
        "Let's find some events you'll remember": "Let's find some events you'll remember",
        ...
        "Light": "Light",
        "Like Event": "Like Event",
        "Liked": "Liked",
        "Liked (%(numSavedEvents)s)": "Liked (%(numSavedEvents)s)",
        "Liked Event Notification": "Liked Event Notification",
        "Liked Event Reminder": "Liked Event Reminder",
        "Likes": "Likes",
        "Likes \u0026 Collections": "Likes \u0026 Collections",
        "Limit": "Limit",
        ...
        "LinkedIn Share Tools": "LinkedIn Share Tools",
        "Links": "Links",
        "List": "List",
        "List Name": "List Name",
        ...
        "Loading...": "Loading...",
        "Local Events Newsletter": "Local Events Newsletter",
        "Locale": "Locale",
        "Location": "Location",
        "Location 1": "Location 1",
        "Location 2": "Location 2",
        "Location 3": "Location 3",
        "Location Access Blocked": "Location Access Blocked",
        ...
        "Log in.": "Log in.",
        "Log out": "Log out",
        "Logged in as %(userName)s": "Logged in as %(userName)s",
        "Login": "Login",
        "Login failed": "Login failed",
        "Logout Now": "Log out Now",
        "London City Browse Promoted Listing": "London City Browse Promoted Listing",
        "London Directory Promoted Listing": "London Directory Promoted Listing",
        "London Homepage Promoted Listing": "London Homepage Promoted Listing",
        "London Related Events (expired listing) Promoted Listings": "London Related Events (expired listing) Promoted Listings",
        ...
        "Los Angeles Directory Promoted Listing": "Los Angeles Directory Promoted Listing",
        "Los Angeles Homepage Promoted Listing": "Los Angeles Homepage Promoted Listing",
        "Los Angeles Related Events (expired listing) Promoted Listings": "Los Angeles Related Events (expired listing) Promoted Listings",
        "Lost/Damaged Items": "Lost/Damaged Items",
        "Loves going to music events": "Loves going to music events",
        ...
        "Mailchimp": "Mailchimp",
        "Mailchimp Emails from the Organizer": "Mailchimp Emails from the Organiser",
        "Mailing address": "Mailing address",
        "Main Event Image": "Main Event Image",
        "Main Image": "Main Image",
        "Make Headliner": "Make Headliner",
        "Make Support": "Make Support",
        "Make a date of it": "Make a date of it",
        "Make a difference": "Make a difference",
        "Make an impact with lasting, memorable, and differentiated event pages.": "Make an impact with lasting, memorable and differentiated event pages.",
        "Make informed decisions with data, insights, and reports.": "Make informed decisions with data, insights and reports.",
        "Make plans and share them with friends!": "Make plans and share them with friends!",
        ...
        "Make sure you're using an accepted file format. There's no need to label your columns\u2014just start with your first email address in the first cell (A1), first name in the second column cell (B1), and last name in the third column cell (C1). If you only have email addresses, that's fine.": "Make sure you're using an accepted file format. There's no need to label your columns\u2014just start with your first email address in the first cell (A1), first name in the second column cell (B1), and surname in the third column cell (C1). If you only have email addresses, that's fine.",
        ...
        "Make this ticket free": "Make this ticket free",
        ...
        "Miami Directory Promoted Listings": "Miami Directory Promoted Listings",
        "Miami Homepage Promoted Listings": "Miami Homepage Promoted Listings",
        "Miami Related Events (expired listing) Promoted Listings": "Miami Related Events (expired listing) Promoted Listings",
        ...
        "Modified": "Modified",
        "Modify or cancel your \u003ca href=\"${subscription}\" target=\"_blank\" rel=\"noopener noreferrer\"\u003esubscription\u003c/a\u003e anytime by visiting your \u003ca href=\"${ACCOUNT_SETTINGS_PLAN_PATH}\"\u003eaccount settings\u003c/a\u003e. For more details, refer to the \u003ca href=\"${termsOfService}\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Terms of Service\u003c/a\u003e.": "Modify or cancel your \u003ca href=\"${subscription}\" target=\"_blank\" rel=\"noopener noreferrer\"\u003esubscription\u003c/a\u003e anytime by visiting your \u003ca href=\"${ACCOUNT_SETTINGS_PLAN_PATH}\"\u003eaccount settings\u003c/a\u003e. For more details, refer to the \u003ca href=\"${termsOfService}\" target=\"_blank\" rel=\"noopener noreferrer\"\u003eEventbrite Terms of Service\u003c/a\u003e.",
        "Moldova": "Moldova",
        ...
        "Music Category Page": "Music Category Page",
        "Music Events": "Music Events",
        "Music Performances": "Music Performances",
        "Music affiliate code for DC": "Music affiliate code for DC",
        "Music calendar tracking aff code": "Music calendar tracking aff code",
        ...
        "NYC music": "NYC music",
        "NYC music calendar affiliate code": "NYC music calendar affiliate code",
        "NYE Event Card": "NYE Event Card",
        ...
        "Name must contain more than 4 characters": "Name must contain more than 4 characters",
        ...
        "New York City Directory Promoted Listing": "New York City Directory Promoted Listing",
        "New York City Homepage Promoted Listing": "New York City Homepage Promoted Listing",
        "New York City Related Events (expired listing) Promoted Listings": "New York City Related Events (expired listing) Promoted Listings",
        "New York Directory Promoted Listing": "New York Directory Promoted Listing",
        "New York Homepage Promoted Listings": "New York Homepage Promoted Listings",
        ...
        "No excuse to stay in: free events": "No excuse to stay in: free events",
        ...
        "Not connected": "Not connected",
        "Not interested in recommendations": "Not interested in recommendations",
        ...
        "Note that audience size is an estimate based on information we currently have available.": "Note that audience size is an estimate based on information we currently have available.",
        ...
        "Note: This event will be created on Facebook, but tickets will be available until the event is live on Eventbrite.": "Note: This event will be created on Facebook, but tickets will be available until the event is live on Eventbrite.",
        ...
        "Offer %(offerId)s": "Offer %(offerId)s",
        ...
        "Oh no! Zero results found!": "Oh no! Zero results found!",
        "Ok": "Ok",
        ...
        "Order #%(id)s for %(orderAmount)s purchased on %(dateCreated)s": "Order no. %(id)s for %(orderAmount)s purchased on %(dateCreated)s",
        ...
        "Order for \u003ca href=\"%(url)s\"\u003e%(title)s\u003c/a\u003e": "Order for \u003ca href=\"%(url)s\"\u003e%(title)s\u003c/a\u003e",
        ...
        "Org id must contain more than 10 characters": "Org id must contain more than 10 characters",
        "Org. ID": "Org. ID",
        ...
        "Organizer Follow Event Publish Email": "Organiser Follow Event Publish Email",
        ...
        "Our editors' picks": "Our editors' picks",
        ...
        "Page art by": "Page art by",
        "Page not found.": "Page not found.",
        "Page views": "Page views",
        "Page without events to Link": "Page without events to Link",
        "Pages": "Pages",
        ...
        "Paperless Post Email Invitations from the Organizer": "Paperless Post Email Invitations from the Organiser",
        ...
        "Paste": "Paste",
        "Patch": "Patch",
        "Pause Newsletter": "Pause Newsletter",
        "Pause background animations": "Pause background animations",
        "Pay Now": "Pay Now",
        ...
        "Payouts start to transfer on the 1st \u0026 15th of every month. Bank transfers take up to %(bankMaxDelayDays)s business days.": "Payouts start to transfer on the 1st \u0026 15th of every month. Bank transfers take up to %(bankMaxDelayDays)s business days.",
        "Payouts will start to transfer \u003cstrong\u003e%(payoutSchedule)s\u003c/strong\u003e. Payouts can take up to %(getPayoutDaysByCountry)s business days to be posted in your bank account.": "Payouts will start to transfer \u003cstrong\u003e%(payoutSchedule)s\u003c/strong\u003e. Payouts can take up to %(getPayoutDaysByCountry)s business days to be posted in your bank account.",
        "Pending": "Pending",
        ...
        "Philadelphia Directory Promoted Listings": "Philadelphia Directory Promoted Listings",
        "Philadelphia Homepage Promoted Listings": "Philadelphia Homepage Promoted Listings",
        "Philadelphia Related Events (expired listing) Promoted Listings": "Philadelphia Related Events (expired listing) Promoted Listings",
        ...
        "Play background animations": "Play background animations",
        "Play hard": "Play hard",
        ...
        "Please check again the campaign settings. There is something wrong there.": "Please check your campaign settings. There seems to be something wrong there.",
        ...
        "Please enter a dollar value of at least $100": "Please enter a dollar value of at least $100",
        ...
        "Please enter a valid monetary value": "Please enter a valid monetary value",
        ...
        "Please enter a zip code.": "Please enter a postcode.",
        ...
        "Please enter the name on card.": "Please enter the name on card.",
        ...
        "Please fill out all of the required fields correctly": "Please fill in all of the required fields correctly",
        ...
        "Please provide yor registration or account ID:": "Please provide yor registration or account ID:",
        ...
        "Pop": "Pop",
        "Popular": "Popular",
        "Popular Event Card": "Popular Event Card",
        ...
        "Price is required. For a free ticket, select the checkbox above": "Price is required. For a free ticket, select the checkbox above",
        ...
        "Processing attendee's payments": "Processing attendee's payments",
        ...
        "Promoted Listing in related events on expired listing in Atlanta": "Promoted Listing in related events on expired listing in Atlanta",
        "Promoted Listing in related events on expired listing in Boston": "Promoted Listing in related events on expired listing in Boston",
        "Promoted Listing in related events on expired listing in Chicago": "Promoted Listing in related events on expired listing in Chicago",
        "Promoted Listing in related events on expired listing in London": "Promoted Listing in related events on expired listing in London",
        "Promoted Listing in related events on expired listing in Los Angeles": "Promoted Listing in related events on expired listing in Los Angeles",
        "Promoted Listing in related events on expired listing in Miami": "Promoted Listing in related events on expired listing in Miami",
        "Promoted Listing in related events on expired listing in New York City": "Promoted Listing in related events on expired listing in New York City",
        "Promoted Listing in related events on expired listing in Philadelphia": "Promoted Listing in related events on expired listing in Philadelphia",
        "Promoted Listing in related events on expired listing in San Francisco": "Promoted Listing in related events on expired listing in San Francisco",
        "Promoted Listing in related events on expired listing in Washington DC": "Promoted Listing in related events on expired listing in Washington DC",
        "Promoted Listing on directory of Atlanta": "Promoted Listing on directory of Atlanta",
        "Promoted Listing on directory of Boston": "Promoted Listing on directory of Boston",
        "Promoted Listing on directory of Chicago": "Promoted Listing on directory of Chicago",
        "Promoted Listing on directory of London": "Promoted Listing on directory of London",
        "Promoted Listing on directory of Los Angeles": "Promoted Listing on directory of Los Angeles",
        "Promoted Listing on directory of Miami": "Promoted Listing on directory of Miami",
        "Promoted Listing on directory of New York": "Promoted Listing on directory of New York",
        "Promoted Listing on directory of New York City": "Promoted Listing on directory of New York City",
        "Promoted Listing on directory of Philadelphia": "Promoted Listing on directory of Philadelphia",
        "Promoted Listing on directory of San Francisco": "Promoted Listing on directory of San Francisco",
        "Promoted Listing on directory of Washington DC": "Promoted Listing on directory of Washington DC",
        "Promoted Listing on homepage of Atlanta": "Promoted Listing on homepage of Atlanta",
        "Promoted Listing on homepage of Boston": "Promoted Listing on homepage of Boston",
        "Promoted Listing on homepage of Chicago": "Promoted Listing on homepage of Chicago",
        "Promoted Listing on homepage of London": "Promoted Listing on homepage of London",
        "Promoted Listing on homepage of Los Angeles": "Promoted Listing on homepage of Los Angeles",
        "Promoted Listing on homepage of Miami": "Promoted Listing on homepage of Miami",
        "Promoted Listing on homepage of New York": "Promoted Listing on homepage of New York",
        "Promoted Listing on homepage of New York City": "Promoted Listing on homepage of New York City",
        "Promoted Listing on homepage of Philadelphia": "Promoted Listing on homepage of Philadelphia",
        "Promoted Listing on homepage of San Francisco": "Promoted Listing on homepage of San Francisco",
        "Promoted Listing on homepage of Washington DC": "Promoted Listing on homepage of Washington DC",
        "Promoted Listings": "Promoted Listings",
        "Promoted listings on the directory page": "Promoted listings on the directory page",
        "Promoted listings on the homepage": "Promoted listings on the homepage",
        ...
        "Publish events to see data here": "Publish events to see data here",
        "Publish now": "Publish now",
        "Publish on": "Publish on",
        "Publish the project": "Publish the project",
        "Publish this Facebook event when my event is live on Eventbrite.": "Publish this Facebook event when my event is live on Eventbrite.",
        "Publish time": "Publish time",
        ...
        "Receipt": "Receipt",
        "Receive emails and notifications about this creator so you don't miss out.": "Receive emails and notifications about this creator so you don't miss out.",
        "Receive timely emails and notifications about events you like so you don't miss out!": "Receive timely emails and notifications about events you like so you don't miss out!",
        "Recent": "Recent",
        ...
        "Refresh this page to try again": "Refresh this page to try again",
        ...
        "Refund orders to cancel": "Refund orders to cancel",
        ...
        "Registration Encouraged": "Registration Encouraged",
        ...
        "Related events": "Related events",
        "Related events based on rating": "Related events based on rating",
        "Related to": "Related to",
        ...
        "Remind Me Email": "Remind Me Email",
        "Remind Me Notification": "Remind Me Notification",
        "Remind me": "Remind me",
        "Reminder Set!": "Reminder Set!",
        "Reminder email sent to users who've asked for a specific reminder about an upcoming onsale": "Reminder email sent to users who've asked for a specific reminder about an upcoming onsale",
        "Reminder email sent to users who've liked your events": "Reminder email sent to users who've liked your events",
        ...
        "Revenue": "Revenue",
        "Review": "Review",
        "Review and update your event details.": "Review and update your event details.",
        ...
        "SEPA": "SEPA",
        "SF music": "SF music",
        "SF music calendar affiliate code": "SF music calendar affiliate code",
        "SSL security included": "SSL security included",
        ...
        "Sales for this event haven't started yet! ": "Sales for this event haven't started yet! ",
        "Sales from events surfaced in the consumer feed by Auto Boat and Air events bucket": "Sales from events surfaced in the consumer feed by Auto Boat and Air events bucket",
        "Sales from events surfaced in the consumer feed by Based on who you follow events bucket": "Sales from events surfaced in the consumer feed by Based on who you follow events bucket",
        "Sales from events surfaced in the consumer feed by Because you liked bucket": "Sales from events surfaced in the consumer feed by Because you liked bucket",
        "Sales from events surfaced in the consumer feed by Because you purchased bucket": "Sales from events surfaced in the consumer feed by Because you purchased bucket",
        "Sales from events surfaced in the consumer feed by Business and Professional bucket": "Sales from events surfaced in the consumer feed by Business and Professional bucket",
        "Sales from events surfaced in the consumer feed by Charity and Causes bucket": "Sales from events surfaced in the consumer feed by Charity and Causes bucket",
        "Sales from events surfaced in the consumer feed by Community and Culture bucket": "Sales from events surfaced in the consumer feed by Community and Culture bucket",
        "Sales from events surfaced in the consumer feed by Discounted events bucket": "Sales from events surfaced in the consumer feed by Discounted events bucket",
        "Sales from events surfaced in the consumer feed by Editor's Picks bucket": "Sales from events surfaced in the consumer feed by Editor's Picks bucket",
        "Sales from events surfaced in the consumer feed by Family and education events bucket": "Sales from events surfaced in the consumer feed by Family and education events bucket",
        "Sales from events surfaced in the consumer feed by Fashion events bucket": "Sales from events surfaced in the consumer feed by Fashion events bucket",
        "Sales from events surfaced in the consumer feed by Film and media bucket": "Sales from events surfaced in the consumer feed by Film and media bucket",
        "Sales from events surfaced in the consumer feed by Food \u0026 Drink events bucket": "Sales from events surfaced in the consumer feed by Food \u0026 Drink events bucket",
        "Sales from events surfaced in the consumer feed by Free Events bucket": "Sales from events surfaced in the consumer feed by Free Events bucket",
        "Sales from events surfaced in the consumer feed by Government \u0026 Politics events bucket": "Sales from events surfaced in the consumer feed by Government \u0026 Politics events bucket",
        "Sales from events surfaced in the consumer feed by Health \u0026 Wellness events bucket": "Sales from events surfaced in the consumer feed by Health \u0026 Wellness events bucket",
        "Sales from events surfaced in the consumer feed by Hobbies and Special Interest bucket": "Sales from events surfaced in the consumer feed by Hobbies and Special Interest bucket",
        "Sales from events surfaced in the consumer feed by Home and Lifestyle Interest bucket": "Sales from events surfaced in the consumer feed by Home and Lifestyle Interest bucket",
        "Sales from events surfaced in the consumer feed by Liked events bucket": "Sales from events surfaced in the consumer feed by Liked events bucket",
        "Sales from events surfaced in the consumer feed by Liked events custom bucket": "Sales from events surfaced in the consumer feed by Liked events custom bucket",
        "Sales from events surfaced in the consumer feed by Music events bucket": "Sales from events surfaced in the consumer feed by Music events bucket",
        "Sales from events surfaced in the consumer feed by Nearby cities bucket": "Sales from events surfaced in the consumer feed by Nearby cities bucket",
        "Sales from events surfaced in the consumer feed by Nearby cities events bucket": "Sales from events surfaced in the consumer feed by Nearby cities events bucket",
        "Sales from events surfaced in the consumer feed by Online events bucket": "Sales from events surfaced in the consumer feed by Online events bucket",
        "Sales from events surfaced in the consumer feed by Other events bucket": "Sales from events surfaced in the consumer feed by Other events bucket",
        "Sales from events surfaced in the consumer feed by Performing \u0026 Visual Arts events bucket": "Sales from events surfaced in the consumer feed by Performing \u0026 Visual Arts events bucket",
        "Sales from events surfaced in the consumer feed by Personalized Food and Drink bucket": "Sales from events surfaced in the consumer feed by Personalised Food and Drink bucket",
        "Sales from events surfaced in the consumer feed by Personalized music events bucket": "Sales from events surfaced in the consumer feed by Personalised music events bucket",
        "Sales from events surfaced in the consumer feed by Popular events bucket": "Sales from events surfaced in the consumer feed by Popular events bucket",
        "Sales from events surfaced in the consumer feed by Religion and Spirituality bucket": "Sales from events surfaced in the consumer feed by Religion and Spirituality bucket",
        "Sales from events surfaced in the consumer feed by School Activities events bucket": "Sales from events surfaced in the consumer feed by School Activities events bucket",
        "Sales from events surfaced in the consumer feed by Science \u0026 Technology bucket": "Sales from events surfaced in the consumer feed by Science \u0026 Technology bucket",
        "Sales from events surfaced in the consumer feed by Seasonal events bucket": "Sales from events surfaced in the consumer feed by Seasonal events bucket",
        "Sales from events surfaced in the consumer feed by Sports and Fitness bucket": "Sales from events surfaced in the consumer feed by Sports and Fitness bucket",
        "Sales from events surfaced in the consumer feed by This weekend events bucket": "Sales from events surfaced in the consumer feed by This weekend events bucket",
        "Sales from events surfaced in the consumer feed by Travel and Outdoor events bucket": "Sales from events surfaced in the consumer feed by Travel and Outdoor events bucket",
        "Sales from events surfaced in the consumer feed by Trending Topic events bucket": "Sales from events surfaced in the consumer feed by Trending Topic events bucket",
        "Sales from events surfaced in the consumer feed by What's new bucket": "Sales from events surfaced in the consumer feed by What's new bucket",
        "Sales from events surfaced in the consumer feed by small city bucket": "Sales from events surfaced in the consumer feed by small city bucket",
        ...
        "San Francisco Directory Promoted Listing": "San Francisco Directory Promoted Listing",
        "San Francisco Homepage Promoted Listing": "San Francisco Homepage Promoted Listing",
        "San Francisco Local Page": "San Francisco Local Page",
        "San Francisco Related Events (expired listing) Promoted Listings": "San Francisco Related Events (expired listing) Promoted Listings",
        ...
        "Save time with a new way to create events.": "Save time with a new way to create events.",
        ...
        "Saved": "Saved",
        "Saved Event Card": "Saved Event Card",
        ...
        "Saving...": "Saving...",
        "Savings": "Savings",
        "Savor the flavor": "Savour the flavour",
        "Scan Mode": "Scan Mode",
        "Schedule": "Schedule",
        ...
        "Schedule for Publish": "Schedule for Publish",
        ...
        "Seat prefix": "Seat prefix",
        "Seat:": "Seat:",
        "SeatGeek Auto-Listing": "SeatGeek Auto-Listing",
        "Seated": "Seated",
        ...
        "Secure connections and keep your customer's data safe from monitoring and tampering.": "Secure connections and keep your customer's data safe from monitoring and tampering.",
        ...
        "See more": "See more",
        "See more %(title)s": "See more %(title)s",
        ...
        "See what's happening near you": "See what's happening near you",
        ...
        "Select billing cycle and subscribe": "Select billing cycle and subscribe",
        ...
        "Selected users will be notified when this guest is checked in via Eventbrite's Android Organizer App.": "Selected users will be notified when this guest is checked in via Eventbrite's Android Organiser App.",
        "Selected: ": "Selected: ",
        ...
        "Share Tools on Eventbrite App": "Share Tools on Eventbrite App",
        ...
        "Share to Snapchat": "Share to Snapchat",
        ...
        "Should select pending hybrid newslwtter before to click on Send button.": "Please select pending hybrid newsletter before clicking the Send button.",
        ...
        "Show me how.": "Show me how.",
        "Show more": "Show more",
        "Show more categories to the left": "Show more categories to the left",
        "Show more categories to the right": "Show more categories to the right",
        ...
        "Showing results for \"%(searchQuery)s\"": "Showing results for \"%(searchQuery)s\"",
        "Showing results in %(locationTerm)s": "Showing results in %(locationTerm)s",
        ...
        "Single payout - Bank transfer starts %(finalPayoutDays)s days after your event ends and takes up to %(bankMaxDelayDays)s business days to complete.": "Single payout - Bank transfer starts %(finalPayoutDays)s days after your event ends and takes up to %(bankMaxDelayDays)s business days to complete.",
        ...
        "Something totally unique": "Something totally unique",
        ...
        "Something went wrong. Please try again.": "Something went wrong. Please try again.",
        "Songkick": "Songkick",
        "Songkick Auto-Listing": "Songkick Auto-Listing",
        ...
        "Spa": "Spa",
        "SpaceCraft Website Integration": "SpaceCraft Website Integration",
        ...
        "Spingo": "Spingo",
        "Spingo Promotion Extension": "Spingo Promotion Extension",
        "Spirits": "Spirits",
        ...
        "Sponsorship Brand": "Sponsorship Brand",
        ...
        "Start building the greatest events of all time!": "Start building the greatest events of all time!",
        "Start date": "Start date",
        ...
        "Started": "Started",
        "Starter subscription": "Starter subscription",
        ...
        "Step ${activeStepIndex + 1} of ${total}": "Step ${activeStepIndex + 1} of ${total}",
        "Step ${activeStep} of ${stepsLength}": "Step ${activeStep} of ${stepsLength}",
        ...
        "Success Revoke and Reissue": "Successful Revoke and Reissue",
        ...
        "Suggested %(formattedPrice)s": "Suggested %(formattedPrice)s",
        ...
        "Tax Name must be 22 characters or fewer.": "Tax Name must be 22 characters or fewer.",
        "Tax Rate": "Tax Rate",
        ...
        "Thailand": "Thailand",
        "Thank you": "Thank you",
        "Thank you for considering this offer. We would love to understand why this opportunity was not a good fit for you. Please take 2 minutes to complete this \u003ca href=\"//goo.gl/forms/aH873G6ShDIubMrI2\" rel=\"noopener noreferrer\" target=\"_blank\"\u003efeedback survey\u003c/a\u003e.": "Thank you for considering this offer. We would love to understand why this opportunity was not a good fit for you. Please take 2 minutes to complete this \u003ca href=\"//goo.gl/forms/aH873G6ShDIubMrI2\" rel=\"noopener noreferrer\" target=\"_blank\"\u003efeedback survey\u003c/a\u003e.",
        ...
        "The best shows in town": "The best shows in town",
        ...
        "The campaign content is incomplete. Click on the \"View\" button and review the content": "The campaign content is incomplete. Click on the \"View\" button and review the content",
        ...
        "The essentials to start customizing your event pages.": "The essentials to start customising your event pages.",
        ...
        "The following tickets are already checked in, if you continue, check in status will be removed:": "The following tickets are already checked in, if you continue, check in status will be removed:",
        ...
        "The guest list creator will be notified when this guest is checked in via Eventbrite's Android Organizer App.": "The guest list creator will be notified when this guest is checked in via Eventbrite's Android Organiser App.",
        ...
        "The recommended events weren't a good match": "The recommended events weren't a good match",
        ...
        "The time zone will be the same as that of your event's.": "The time zone will be the same as your event's.",
        ...
        "There was a problem saving the event": "There was a problem saving the event",
        ...
        "There was an error creating the collection": "There was an error creating the collection",
        ...
        "There was an error saving your description. Please try again.": "There was an error saving your description. Please try again.",
        ...
        "There was an error with the following barcodes: ": "There was an error with the following barcodes: ",
        ...
        "There's no image for this event. Add one before publishing to Facebook or a default will be used.": "There's no image for this event. Add one before publishing to Facebook or a default will be used.",
        ...
        "These events aren't in my area": "These events aren't in my area",
        ...
        "This affiliate code is part of the handpicked experiment.": "This affiliate code is part of the handpicked experiment.",
        "This affiliate code to tracks engagement and sales as a result of the Consumer Content and Brand Team's New Year's Resolutions 2019 campaign.": "This affiliate code to tracks engagement and sales as a result of the Consumer Content and Brand Team's New Year's Resolutions 2019 campaign.",
        ...
        "This is for tracking ticket purchases from the mobile view of Brite TV -- an experimental channel for cross promoting through TVs at venues.": "This is for tracking ticket purchases from the mobile view of Brite TV -- an experimental channel for cross promoting through TVs at venues.",
        "This is for tracking ticket purchases through a QR code within BriteTV -- an R\u0026D initiative meant to explore cross-promoting events with in-venue TVs.": "This is for tracking ticket purchases through a QR code within BriteTV -- an R\u0026D initiative meant to explore cross-promoting events with in-venue TVs.",
        ...
        "This is the aff code that will be used on any consumer social media promotion. It will let organizers see if our social media posts are contributing to their ticket sales": "This is the aff code that will be used on any consumer social media promotion. It will let organisers see if our social media posts are contributing to their ticket sales",
        ...
        "This link must be 5000 characters or less.": "This link must be 5000 characters or less.",
        ...
        "Ticket Protection": "Ticket Protection",
        ...
        "Ticket description must be 250 characters or less.": "Ticket description must be 250 characters or fewer.",
        "Ticket group": "Ticket group",
        "Ticket is invalid and can't be revoked:": "Ticket is invalid and can't be revoked:",
        ...
        "Ticket purchases from emails sent through the Constant Contact integration": "Ticket purchases from emails sent through the Constant Contact integration",
        "Ticket purchases from emails sent through the Hive.co integration": "Ticket purchases from emails sent through the Hive.co integration",
        ...
        "Ticket sales from automatic Listing on Sound Rink": "Ticket sales from automatic Listing on Sound Rink",
        "Ticket sales from automatic listing on Boston Harbor Now": "Ticket sales from automatic listing on Boston Harbor Now",
        "Ticket sales from automatic listing on EDM Train": "Ticket sales from automatic listing on EDM Train",
        "Ticket sales from automatic listing on EventUpon": "Ticket sales from automatic listing on EventUpon",
        "Ticket sales from automatic listing on Eventsfy": "Ticket sales from automatic listing on Eventsfy",
        "Ticket sales from automatic listing on Evvnt": "Ticket sales from automatic listing on Evvnt",
        "Ticket sales from automatic listing on Hoodrich NYC": "Ticket sales from automatic listing on Hoodrich NYC",
        "Ticket sales from automatic listing on Houston on the Cheap": "Ticket sales from automatic listing on Houston on the Cheap",
        "Ticket sales from automatic listing on Jambase": "Ticket sales from automatic listing on Jambase",
        "Ticket sales from automatic listing on Just Shows": "Ticket sales from automatic listing on Just Shows",
        "Ticket sales from automatic listing on Oh My Rockness": "Ticket sales from automatic listing on Oh My Rockness",
        "Ticket sales from automatic listing on ShowAmp": "Ticket sales from automatic listing on ShowAmp",
        "Ticket sales from automatic listing on thelist.ie": "Ticket sales from automatic listing on thelist.ie",
        "Ticket sales from enhanced checkout on Instagram": "Ticket sales from enhanced checkout on Instagram",
        "Ticket sales from event being automatically listed on About the Journey\t": "Ticket sales from event being automatically listed on About the Journey\t",
        "Ticket sales from event being automatically listed on Amplify": "Ticket sales from event being automatically listed on Amplify",
        ...
        "Ticket sales from event being automatically listed on Chumi\t": "Ticket sales from event being automatically listed on Chumi\t",
        ...
        "Ticket sales from event being automatically listed on CitySpark": "Ticket sales from event being automatically listed on CitySpark",
        "Ticket sales from event being automatically listed on Cliq.FM": "Ticket sales from event being automatically listed on Cliq.FM",
        "Ticket sales from event being automatically listed on Comedyseekr": "Ticket sales from event being automatically listed on Comedyseekr",
        ...
        "Ticket sales from event being automatically listed on Dallas Observer": "Ticket sales from event being automatically listed on Dallas Observer",
        "Ticket sales from event being automatically listed on Denver Westword": "Ticket sales from event being automatically listed on Denver Westword",
        "Ticket sales from event being automatically listed on Digital.NYC": "Ticket sales from event being automatically listed on Digital.NYC",
        ...
        "Ticket sales from event being automatically listed on EDM Calendar": "Ticket sales from event being automatically listed on EDM Calendar",
        ...
        "Ticket sales from event being automatically listed on Electronic Festivals": "Ticket sales from event being automatically listed on Electronic Festivals",
        ...
        "Ticket sales from event being automatically listed on Electronic Vegas": "Ticket sales from event being automatically listed on Electronic Vegas",
        "Ticket sales from event being automatically listed on Ellenwood\t": "Ticket sales from event being automatically listed on Ellenwood\t",
        "Ticket sales from event being automatically listed on Emerald City EDM": "Ticket sales from event being automatically listed on Emerald City EDM",
        ...
        "Ticket sales from event being automatically listed on Fans.com": "Ticket sales from event being automatically listed on Fans.com",
        "Ticket sales from event being automatically listed on Fever": "Ticket sales from event being automatically listed on Fever",
        "Ticket sales from event being automatically listed on Flutter": "Ticket sales from event being automatically listed on Flutter",
        "Ticket sales from event being automatically listed on Fuloop": "Ticket sales from event being automatically listed on Fuloop",
        "Ticket sales from event being automatically listed on Gigseekr": "Ticket sales from event being automatically listed on Gigseekr",
        ...
        "Ticket sales from event being automatically listed on Houston Press": "Ticket sales from event being automatically listed on Houston Press",
        ...
        "Ticket sales from event being automatically listed on Kanev": "Ticket sales from event being automatically listed on Kanev",
        "Ticket sales from event being automatically listed on LA Weekly": "Ticket sales from event being automatically listed on LA Weekly",
        ...
        "Ticket sales from event being automatically listed on LiveBy": "Ticket sales from event being automatically listed on LiveBy",
        "Ticket sales from event being automatically listed on Livy Technologies": "Ticket sales from event being automatically listed on Livy Technologies",
        "Ticket sales from event being automatically listed on Metro.us": "Ticket sales from event being automatically listed on Metro.us",
        "Ticket sales from event being automatically listed on Miami New Times": "Ticket sales from event being automatically listed on Miami New Times",
        "Ticket sales from event being automatically listed on Mr. Trance Movement": "Ticket sales from event being automatically listed on Mr. Trance Movement",
        "Ticket sales from event being automatically listed on Music Festivals Canada": "Ticket sales from event being automatically listed on Music Festivals Canada",
        "Ticket sales from event being automatically listed on New Times Broward-Palm Beach": "Ticket sales from event being automatically listed on New Times Broward-Palm Beach",
        ...
        "Ticket sales from event being automatically listed on PartyFixx\t": "Ticket sales from event being automatically listed on PartyFixx\t",
        "Ticket sales from event being automatically listed on Pawzr": "Ticket sales from event being automatically listed on Pawzr",
        "Ticket sales from event being automatically listed on Payrange\t": "Ticket sales from event being automatically listed on Payrange\t",
        "Ticket sales from event being automatically listed on Pearachute": "Ticket sales from event being automatically listed on Pearachute",
        "Ticket sales from event being automatically listed on People App\t": "Ticket sales from event being automatically listed on People App\t",
        "Ticket sales from event being automatically listed on Phoenix New Times": "Ticket sales from event being automatically listed on Phoenix New Times",
        "Ticket sales from event being automatically listed on Pre-order.Me\t\t": "Ticket sales from event being automatically listed on Pre-order.Me\t\t",
        "Ticket sales from event being automatically listed on Pulcity": "Ticket sales from event being automatically listed on Pulcity",
        "Ticket sales from event being automatically listed on REVL": "Ticket sales from event being automatically listed on REVL",
        "Ticket sales from event being automatically listed on SFGate\t": "Ticket sales from event being automatically listed on SFGate\t",
        "Ticket sales from event being automatically listed on Samsung Calendar": "Ticket sales from event being automatically listed on Samsung Calendar",
        ...
        "Ticket sales from event being automatically listed on SceneThink": "Ticket sales from event being automatically listed on SceneThink",
        "Ticket sales from event being automatically listed on SeatGeek": "Ticket sales from event being automatically listed on SeatGeek",
        ...
        "Ticket sales from event being automatically listed on Spotify": "Ticket sales from event being automatically listed on Spotify",
        "Ticket sales from event being automatically listed on Stanza": "Ticket sales from event being automatically listed on Stanza",
        "Ticket sales from event being automatically listed on Surf\t": "Ticket sales from event being automatically listed on Surf\t",
        ...
        "Ticket sales from event being automatically listed on The 20x20 Podcast": "Ticket sales from event being automatically listed on The 20x20 Podcast",
        ...
        "Ticket sales from event being automatically listed on ThrillCall": "Ticket sales from event being automatically listed on ThrillCall",
        ...
        "Ticket sales from event being automatically listed on Travelux": "Ticket sales from event being automatically listed on Travelux",
        "Ticket sales from event being automatically listed on TripAdvisor": "Ticket sales from event being automatically listed on TripAdvisor",
        "Ticket sales from event being automatically listed on Vegas Party VIP": "Ticket sales from event being automatically listed on Vegas Party VIP",
        ...
        "Ticket sales from event being automatically listed on Viberate": "Ticket sales from event being automatically listed on Viberate",
        ...
        "Ticket sales from event being automatically listed on WhatsOut": "Ticket sales from event being automatically listed on WhatsOut",
        "Ticket sales from event being automatically listed on WhereTraveler": "Ticket sales from event being automatically listed on WhereTraveler",
        "Ticket sales from event being automatically listed on Wyd App\t": "Ticket sales from event being automatically listed on Wyd App\t",
        "Ticket sales from event being automatically listed on Yelp": "Ticket sales from event being automatically listed on Yelp",
        "Ticket sales from event being automatically listed on YoTixxy\t": "Ticket sales from event being automatically listed on YoTixxy\t",
        "Ticket sales from event being automatically listed on iFun": "Ticket sales from event being automatically listed on iFun",
        "Ticket sales from event being automatically listed on seattlepi.com\t": "Ticket sales from event being automatically listed on seattlepi.com\t",
        "Ticket sales from event being automatically listed on theBlueUnderground": "Ticket sales from event being automatically listed on theBlueUnderground",
        "Ticket sales from integration with LinkedIn": "Ticket sales from integration with LinkedIn",
        "Ticket sales from links included in an Organization\u00e2\u20ac\u2122s email campaign created using Campaigns tool": "Ticket sales from links included in an Organisation\u00e2\u20ac\u2122s email campaign created using Campaigns tool",
        ...
        "Ticket sales from listing on Festicket": "Ticket sales from listing on Festicket",
        "Ticket sales generated from Reserve with Google listing": "Ticket sales generated from Reserve with Google listing",
        "Ticket sales generated using the Add to Facebook Integration tool (Native)": "Ticket sales generated using the Add to Facebook Integration tool (Native)",
        "Ticket sales generated using the Add to Facebook Integration tool (Redirect)": "Ticket sales generated using the Add to Facebook Integration tool (Redirect)",
        "Ticket sales generated using the YouTube Integration (Buy Tix button)\t": "Ticket sales generated using the YouTube Integration (Buy Tix button)\t",
        "Ticket sales generated using the YouTube Integration (Video Card)\t": "Ticket sales generated using the YouTube Integration (Video Card)\t",
        ...
        "Ticket visibility": "Ticket visibility",
        "Ticketfly Curated Regional Emails": "Ticketfly Curated Regional Emails",
        "Ticketfly Curated regional email sends": "Ticketfly Curated regional email sends",
        "Ticketing \u0026 registration essentials": "Ticketing \u0026 registration essentials",
        "Ticketing Provider": "Ticketing Provider",
        "Ticketing and registration": "Ticketing and registration",
        ...
        "Tickets \u003cspan class=\"price-text\"\u003e%(threshold)s\u003c/span\u003e and under have a service fee of \u003cspan class=\"price-text\"\u003e%(rate)s\u003c/span\u003e \u003ca href=\"%(link)s\" target=\"_blank\"\u003eplus VAT*\u003c/a\u003e": "Tickets \u003cspan class=\"price-text\"\u003e%(threshold)s\u003c/span\u003e and under have a service fee of \u003cspan class=\"price-text\"\u003e%(rate)s\u003c/span\u003e \u003ca href=\"%(link)s\" target=\"_blank\"\u003eplus VAT*\u003c/a\u003e",
        ...
        "Tickets and registrations handled on Facebook will be processed by Eventbrite.": "Tickets and registrations handled on Facebook will be processed by Eventbrite.",
        ...
        "Tickets will not be available on the event page until it is live. \u003ca href=${howToLink} class='js-learn-more' target='_blank'\u003eLearn More\u003c/a\u003e": "Tickets will not be available on the event page until it is live. \u003ca href=${howToLink} class='js-learn-more' target='_blank'\u003eLearn More\u003c/a\u003e",
        "Tier": "Tier",
        ...
        "To get started, tap the \"Create\" button up in the top right.": "To get started, tap the \"Create\" button up in the top right.",
        ...
        "Tokelau": "Tokelau",
        "Tomorrow": "Tomorrow",
        "ToneDen Facebook \u0026 Instagram Ads": "ToneDen Facebook \u0026 Instagram Ads",
        "Tonga": "Tonga",
        ...
        "Tracking traffic from Chicago consumer content articles and collections": "Tracking traffic from Chicago consumer content articles and collections",
        "Tracking traffic to events from DC consumer content articles": "Tracking traffic to events from DC consumer content articles",
        "Tradeshow, Consumer Show, or Expo": "Tradeshow, Consumer Show or Expo",
        "Traffic": "Traffic",
        "Traffic \u0026 sales driven by Social Wave": "Traffic \u0026 sales driven by Social Wave",
        ...
        "Traffic driven with Digital Manager Guru": "Traffic driven with Digital Manager Guru",
        "Traffic from Clipboard shares via share tools on Eventbrite pages": "Traffic from Clipboard shares via share tools on Eventbrite pages",
        "Traffic from Emails created using share tools on Eventbrite pages": "Traffic from Emails created using share tools on Eventbrite pages",
        "Traffic from Event Recommendations and Friends' Events in the Eventbrite Attendee Email Newsletter": "Traffic from Event Recommendations and Friends' Events in the Eventbrite Attendee Email Newsletter",
        "Traffic from Eventbrite Email Invitations sent out by the organizer": "Traffic from Eventbrite Email Invitations sent out by the organiser",
        "Traffic from Eventbrite Website Integration widgets and tools that have been added to external websites": "Traffic from Eventbrite Website Integration widgets and tools that have been added to external websites",
        "Traffic from Fomo website notifications": "Traffic from Fomo website notifications",
        "Traffic from Mailchimp emails sent by the event organizer": "Traffic from Mailchimp emails sent by the event organiser",
        "Traffic from Paperless Post Email Invtitations sent by the event organizer": "Traffic from Paperless Post Email Invtitations sent by the event organiser",
        "Traffic from RSS Feeds of upcoming events": "Traffic from RSS Feeds of upcoming events",
        "Traffic from a link to the event on the Eventbrite Organizer Profile Page": "Traffic from a link to the event on the Eventbrite Organiser Profile Page",
        "Traffic from a website using the Eventbrite SpaceCraft integration": "Traffic from a website using the Eventbrite SpaceCraft integration",
        "Traffic from a website using the Eventbrite Wordpress Plug-In": "Traffic from a website using the Eventbrite Wordpress Plug-In",
        "Traffic from advertising with Boostable": "Traffic from advertising with Boostable",
        "Traffic from advertising with Stagelink": "Traffic from advertising with Stagelink",
        "Traffic from attendees sharing to Snapchat from Eventbrite": "Traffic from attendees sharing to Snapchat from Eventbrite",
        "Traffic from auto-listing on AdHusky": "Traffic from auto-listing on AdHusky",
        "Traffic from auto-listing on Bandsintown": "Traffic from auto-listing on Bandsintown",
        "Traffic from auto-listing on Concert with Me": "Traffic from auto-listing on Concert with Me",
        "Traffic from auto-listing on Dandelion": "Traffic from auto-listing on Dandelion",
        "Traffic from auto-listing on Do415": "Traffic from auto-listing on Do415",
        "Traffic from auto-listing on Eventful": "Traffic from auto-listing on Eventful",
        "Traffic from auto-listing on Evvnt": "Traffic from auto-listing on Evvnt",
        "Traffic from auto-listing on Fundly": "Traffic from auto-listing on Fundly",
        "Traffic from auto-listing on Fwix": "Traffic from auto-listing on Fwix",
        "Traffic from auto-listing on Goby": "Traffic from auto-listing on Goby",
        "Traffic from auto-listing on Hangtime": "Traffic from auto-listing on Hangtime",
        "Traffic from auto-listing on Lanyrd": "Traffic from auto-listing on Lanyrd",
        "Traffic from auto-listing on Patch": "Traffic from auto-listing on Patch",
        "Traffic from auto-listing on Songkick": "Traffic from auto-listing on Songkick",
        "Traffic from auto-listing on Stubhub": "Traffic from auto-listing on Stubhub",
        "Traffic from auto-listing on Stubhub Music": "Traffic from auto-listing on Stubhub Music",
        "Traffic from auto-listing on Zvents": "Traffic from auto-listing on Zvents",
        "Traffic from direct to event listing autocomplete suggestions on Eventbrite home page (v2)": "Traffic from direct to event listing autocomplete suggestions on Eventbrite home page (v2)",
        "Traffic from direct to event listing autocomplete suggestions on Eventbrite search.": "Traffic from event listing autocomplete suggestions on Eventbrite search.",
        "Traffic from direct to event listing displayed in calendar section on Eventbrite home page (v2)": "Traffic from direct to event listing displayed in calendar section on Eventbrite home page (v2)",
        "Traffic from direct to event listing displayed in moods section on Eventbrite home page (v2)": "Traffic from direct to event listing displayed in moods section on Eventbrite home page (v2)",
        "Traffic from emails that were automatically sent by Eventbrite to alert users when their Facebook friends are going to events": "Traffic from emails that were automatically sent by Eventbrite to alert users when their Facebook friends are going to events",
        "Traffic from emails that were automatically sent by Eventbrite to alert users when they did not complete their event registrations": "Traffic from emails that were automatically sent by Eventbrite to alert users when they did not complete their event registrations",
        "Traffic from event listings curated by the Eventbrite team around specific themes (New Year's Eve, Turkey Trots, St. Patty's Day, etc. )": "Traffic from event listings curated by the Eventbrite team around specific themes (New Year's Eve, St. Patrick's Day, etc. )",
        "Traffic from event listings that were found or searched for in the Eventbrite event directories": "Traffic from event listings that were found or searched for in the Eventbrite event directories",
        "Traffic from event listings that were specifically curated by Eventbrite City Marketing Managers": "Traffic from event listings that were specifically curated by Eventbrite City Marketing Managers",
        "Traffic from event listings within the Eventbrite Android Mobile App": "Traffic from event listings within the Eventbrite Android Mobile App",
        "Traffic from event listings within the Eventbrite Mobile Browser": "Traffic from event listings within the Eventbrite Mobile Browser",
        "Traffic from event listings within the Eventbrite iOS Mobile App": "Traffic from event listings within the Eventbrite iOS Mobile App",
        "Traffic from events featured on Rating Landing Page.": "Traffic from events featured on Rating Landing Page.",
        "Traffic from events featured on the Eventbrite Homepage.": "Traffic from events featured on the Eventbrite Homepage.",
        "Traffic from events that were found using the events discovery web map.": "Traffic from events that were found using the events discovery web map.",
        "Traffic from links to events that a user's Facebook friends are going to": "Traffic from links to events that a user's Facebook friends are going to",
        "Traffic from links to events that were recommended by Eventbrite based on a user's preferences": "Traffic from links to events that were recommended by Eventbrite based on a user's preferences",
        "Traffic from links to the event on social media sites (Facebook, Twitter, LinkedIn, etc.) that were created using the Eventbrite Text Link tool": "Traffic from links to the event on social media sites (Facebook, Twitter, LinkedIn, etc.) that were created using the Eventbrite Text Link tool",
        "Traffic from listings on Eventbrite Partner websites and emails": "Traffic from listings on Eventbrite Partner websites and emails",
        "Traffic from promoting your upcoming events on Event Pages and Order Confirmation Pages": "Traffic from promoting your upcoming events on Event Pages and Order Confirmation Pages",
        "Traffic from referrals through the Eventbrite Affiliate Program": "Traffic from referrals through the Eventbrite Affiliate Programme",
        "Traffic from shares to Facebook via share tools on Eventbrite pages": "Traffic from shares to Facebook via share tools on Eventbrite pages",
        "Traffic from shares to LinkedIn via share tools on Eventbrite pages": "Traffic from shares to LinkedIn via share tools on Eventbrite pages",
        "Traffic from shares to Twitter via share tools on Eventbrite pages": "Traffic from shares to Twitter via share tools on Eventbrite pages",
        "Traffic from the Eventbrite attendee newsletter subscribenewsletter confirmation email": "Traffic from the Eventbrite attendee newsletter subscribenewsletter confirmation email",
        "Traffic from the Eventbrite order confirmation email": "Traffic from the Eventbrite order confirmation email",
        "Traffic from the Eventbrite reminder emails": "Traffic from the Eventbrite reminder emails",
        "Traffic from the share tools within the Eventbrite Mobile Browser": "Traffic from the share tools within the Eventbrite Mobile Browser",
        "Traffic from visitors saving the event using the 'Save Event' button": "Traffic from visitors saving the event using the 'Save Event' button",
        ...
        "Treat yourself right: health and wellness events": "Treat yourself right: health and wellness events",
        "Trending searches in %(city)s, %(region)s": "Trending searches in %(city)s, %(region)s",
        "Trigger": "Trigger",
        "Trinidad and Tobago": "Trinidad and Tobago",
        "Trouble loading reports": "Trouble loading reports",
        ...
        "Try again": "Try again",
        "Try another date, or if you\u2019re feeling adventurous, let us surprise you.": "Try another date, or if you\u2019re feeling adventurous, let us surprise you.",
        ...
        "Try using another mood, or let yourself be surprised with the best events in your area.": "Try using another mood, or let yourself be surprised with the best events in your area.",
        "Tue": "Tue",
        "Tuesday": "Tuesday",
        "Tunisia": "Tunisia",
        "Turkey": "Turkey",
        ...
        "Twitter Share Tools": "Twitter Share Tools",
        ...
        "Unable to add any more events to this collection": "Unable to add any more events to this collection",
        "Unable to add event to collection": "Unable to add event to collection",
        ...
        "Unable to remove event from collection": "Unable to remove event from collection",
        ...
        "Unlink from Facebook": "Unlink from Facebook",
        ...
        "Upload CSV List": "Upload CSV List",
        ...
        "Use these settings to auto-publish all my events to %(eventHostName)s going forward (you can come back and change these settings at anytime)": "Use these settings to auto-publish all my events to %(eventHostName)s going forward (you can come back and change these settings at any time)",
        ...
        "User was redirected to listing on Eventbrite because checkout widget was not supported for this event": "User was redirected to listing on Eventbrite because checkout widget was not supported for this event",
        ...
        "View Offer Status": "View Offer Status",
        ...
        "View profile": "View profile",
        "View role": "View role",
        "View sales and attendee data from Facebook on your Eventbrite analytics dashboard.": "View sales and attendee data from Facebook on your Eventbrite analytics dashboard.",
        ...
        "Views": "Views",
        "Views from the Eventbrite recs section of the attendee newsletter": "Views from the Eventbrite recs section of the attendee newsletter",
        "Views from the editorial content section (Articles) of the attendee newsletter": "Views from the editorial content section (Articles) of the attendee newsletter",
        "Views from the promoted events of the attendee newsletter": "Views from the promoted events of the attendee newsletter",
        "Views from the saved events section of the attendee newsletter": "Views from the saved events section of the attendee newsletter",
        "Views from the top free events section of the attendee newsletter": "Views from the top free events section of the attendee newsletter",
        "Views from the weekend events of the attendee newsletter": "Views from the weekend events of the attendee newsletter",
        ...
        "Want to create an\u0026nbsp;\u003cspan class=\"eds-text-color--edgy-yellow\"\u003eevent\u003c/span\u003e?": "Want to create an\u0026nbsp;\u003cspan class=\"eds-text-color--edgy-yellow\"\u003eevent\u003c/span\u003e?",
        ...
        "Washington DC Directory Promoted Listings": "Washington DC Directory Promoted Listings",
        "Washington DC Homepage Promoted Listings": "Washington DC Homepage Promoted Listings",
        "Washington DC Related Events (expired listing) Promoted Listings": "Washington DC Related Events (expired listing) Promoted Listings",
        ...
        "We can\u2019t find exactly what you\u2019re looking for.": "We can\u2019t find exactly what you\u2019re looking for.",
        ...
        "We encountered an error while trying to preview your campaign.": "We encountered an error while trying to preview your campaign.",
        ...
        "We have auto filled some fields based on your selected payout method.": "We have auto-filed some fields based on your selected payout method.",
        ...
        "We have partnered with Facebook to help promote your event and allow your customers to purchase directly from your Facebook page. ": "We have partnered with Facebook to help promote your event and allow your customers to purchase directly from your Facebook page. ",
        ...
        "We have successfully sent %(ticketsCount)s ticket to %(guestName)s.": [
            "We have successfully sent %(ticketsCount)s ticket to %(guestName)s.",
            "We have successfully sent %(ticketsCount)s tickets to %(guestName)s."
        ],
        "We invite you to review the updated terms and policies here.": "We invite you to review the updated terms and policies here.",
        ...
        "We were not able to process your payment. Do not try again.": "We were not able to process your payment. Do not try again.",
        "We were not able to process your payment. Please re-enter your payment information.": "We were not able to process your payment. Please re-enter your payment information.",
        ...
        "We were unable to match your event's address to a known physical location. Please update the address and try again.": "We were unable to match your event's address to a known physical location. Please update the address and try again.",
        ...
        "We will process your payouts every day.": "We will process your payouts every day.",
        ...
        "We're creating your event on Facebook": "We're creating your event on Facebook",
        "We're setting the world's stage for live experiences.": "We're setting the world's stage for live experiences.",
        "We're testing out a new event page! Want the old event page? Contact us at \u003ca href=\"mailto:v1@eventbrite.com\"\u003ev1@eventbrite.com\u003c/a\u003e": "We're testing out a new event page! Want the old event page? Contact us at \u003ca href=\"mailto:v1@eventbrite.com\"\u003ev1@eventbrite.com\u003c/a\u003e",
        ...
        "We've changed some of our Legal Terms, including our Terms of Service, Privacy Policy and Merchant Agreement.": "We've changed some of our Legal Terms, including our Terms of Service, Privacy Policy and Merchant Agreement.",
        "We've sent your offer to the event owner and will email you with their response.": "We've sent your offer to the event owner and will email you with their response.",
        "Webhooks": "Webhooks",
        "Website": "Website",
        ...
        "Weekly payouts start to transfer every %(week_day)s. Bank transfers take up to %(days)s business days.": "Weekly payouts start to transfer every %(week_day)s. Bank transfers take up to %(days)s business days.",
        "Welcome": "Welcome",
        "Welcome back": "Welcome back",
        "Welcome back!": "Welcome back.",
        "Welcome to Eventbrite Sponsorships!": "Welcome to Eventbrite Sponsorships!",
        "Welcome to Professional Plus! Your subscription is now active.": "Welcome to Professional Plus! Your subscription is now active.",
        ...
        "When do you want to publish event on Facebook?": "When do you want to publish event on Facebook?",
        ...
        "Where to send your payouts": "Where to send your payouts",
        ...
        "Who is the lucky one?": "Who is the lucky one?",
        ...
        "Would you like to create a new Facebook event, or add tickets to an existing event?": "Would you like to create a new Facebook event, or add tickets to an existing event?",
        "Would you like to turn on auto-renewal?": "Would you like to turn on auto-renewal?",
        "Wristband Number": "Wristband Number",
        "Write a description about your event.": "Write a description about your event.",
        ...
        "Yes, I am tax exempt and/or charitable oranization": "Yes, I am tax exempt and/or charitable organisation",
        ...
        "Yoga": "Yoga",
        "You": "You",
        "You Facebook account is now connected. Please review the privacy agreement to continue.": "Your Facebook account is now connected. Please review the privacy agreement to continue.",
        ...
        "You are about to send an offer for \"%(eventName)s\" at a cost of \u003cspan class=\"confirm-panel__price-callout eds-bg-color--grey-200\"\u003e%(formattedGrossValue)s\u003c/span\u003e for the %(packageName)s package.": "You are about to send an offer for \"%(eventName)s\" at a cost of \u003cspan class=\"confirm-panel__price-callout eds-bg-color--grey-200\"\u003e%(formattedGrossValue)s\u003c/span\u003e for the %(packageName)s package.",
        ...
        "You can add tickets to an existing Facebook event. Select which Facebook event you'd like to add tickets to.": "You can add tickets to an existing Facebook event. Select which Facebook event you'd like to add tickets to.",
        ...
        "You can only link an event if it has one or more tickets available to purchase.": "You can only link an event if it has one or more tickets available to purchase.",
        "You can only upload 2.000 contacts at the same time": "You can only upload 2,000 contacts at the same time",
        "You can publish now or continue customizing your event listing.": "You can publish now or continue customising your event listing.",
        ...
        "You do not have access to complete this purchase. Please re-enter your payment information.": "You do not have access to complete this purchase. Please re-enter your payment information.",
        ...
        "You don't have any artists yet.": "You don't have any artists yet.",
        ...
        "You have denied permission for Eventbrite to access your location. You will need to update your browser settings to re-enable.": "You have denied permission for Eventbrite to access your location. You will need to update your browser settings to re-enable.",
        ...
        "You may be required by local regulations to charge tax. You should consult with your tax advisor about your tax obligations.": "You may be required by local regulations to charge tax. You should consult with your tax advisor about your tax obligations.",
        "You may be required by state or local regulations to charge tax. We encourage you to consult a tax professional to ensure you understand you tax obligations.": "You may be required by state or local regulations to charge tax. We encourage you to consult a tax professional to ensure you understand you tax obligations.",
        ...
        "You must provide a valid youtube url.": "You must provide a valid youtube url.",
        ...
        "You're just one step away from working smarter, not harder on all of your events.": "You're just one step away from working smarter, not harder on all of your events.",
        "You're minutes away from creating your event!": "You're minutes away from creating your event!",
        "You're now following this organizer. See more in your \u003ca className=\"eds-link\" href=\"/mytickets/\"\u003eprofile\u003c/a\u003e": "You're now following this organiser. See more in your \u003ca className=\"eds-link\" href=\"/mytickets/\"\u003eprofile\u003c/a\u003e",
        ...
        "You're ready to publish.": "You're ready to publish.",
        "You've Declined the Offer.": "You've Declined the Offer.",
        "You've Successfully Accepted the Offer!": "You've Successfully Accepted the Offer!",
        ...
        "You've got an offer!": "You've got an offer!",
        ...
        "Your Facebook publish settings. ": "Your Facebook publish settings. ",
        ...
        "Your event is added to the Facebook Page you select, not your personal profile.": "Your event is added to the Facebook Page you select, not your personal profile.",
        ...
        "Your event is protected. Users buying tickets from your site will be redirected to eventbrite.com": "Your event is protected. Users buying tickets from your site will be redirected to eventbrite.com",
        ...
        "Your followed events": "Your followed events",
        ...
        "Your main image can help you get surfaced more on Eventbrite and sell 1.3X more tickets on average, so make sure yours is high-resolution, and minimize overlapping text. Get more tips ": "Your main image can help you get surfaced more on Eventbrite and sell 1.3X more tickets on average, so make sure yours is high-resolution, and minimize overlapping text. Get more tips ",
        ...
        "Your music lineup": "Your music lineup",
        ...
        "Your subscription will automatically renew with payments of %(amount)s each %(planInterval)s.": "Your subscription will automatically renew with payments of %(amount)s each %(planInterval)s.",
        ...
        "Your tickets don't qualify to be sold directly on Facebook. Don't worry! You can still create an event on Facebook with a link to your Eventbrite ticketing page. \u003ca href=${howToLink} class='js-learn-more' target='_blank'\u003eLearn More\u003c/a\u003e": "Your tickets don't qualify to be sold directly on Facebook. Don't worry! You can still create an event on Facebook with a link to your Eventbrite ticketing page. \u003ca href=${howToLink} class='js-learn-more' target='_blank'\u003eLearn More\u003c/a\u003e",
        "Your tickets qualify. Allow your attendees to buy tickets and register without leaving Facebook. \u003ca href='%(howToLink)s' class='js-learn-more' target='_blank'\u003eLearn More\u003c/a\u003e": "Your tickets qualify. Allow your attendees to buy tickets and register without leaving Facebook. \u003ca href='%(howToLink)s' class='js-learn-more' target='_blank'\u003eLearn More\u003c/a\u003e",
        ...
        "Zoom": "Zoom",
        "Zoom to see %(eventCount)s events": "Zoom to see %(eventCount)s events",
        "Zvents": "Zvents",
        ...
        "draft": "draft",
        "due": "due",
        "e.g. \"New Years Parties\"": "e.g. \"New Years Parties\"",
        ...
        "example of how the spreedshet should look": "example of how the spreedshet should look",
        ...
        "iOS attendee Deep Link": "iOS attendee Deep Link",
        "iOS attendee Feed": "iOS attendee Feed",
        "iOS attendee liked events": "iOS attendee liked events",
        "iOS attendee search": "iOS attendee search",
        "in": "in",
        ...
        "to": "to",
        "to %(num)s recipients": "to %(num)s recipients",
