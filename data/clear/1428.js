Function && Function.prototype && Function.prototype.bind && (/MSIE ([6789]|10)/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function(t) {
            ...
            if (n) e.push(n[2]);
                ...
                u.charset = "utf-8", u.timeout = 120, i.nc && u.setAttribute("nonce", i.nc), u.src = function(t) {
                    return i.p + "js/" + ({
                        ...
                        0: "6e5b62723488aee38af0c77681396a5b",
                        2: "99e9148e484a390e1d647eee5044edf6",
                        3: "dd024c345fc26f7c7a8d9938b67e5d3d",
                        4: "f261877d67dc45f3972d303d6b32c138",
                        5: "e04767addb099c02bdaf25f1a5a1c428",
                        6: "4c6ab682148a0366f9efb1647a3f4799",
                        7: "2b7769d244a8dfeb3ab9d97583412dec"
                    } [t] + ".js"
                }(t), s = function(e) {
        ...
        return t = t || [], e = e || {}, u = "ƒ(" + t.join(", ") + ", target, [options]);",
            function() {
                ...
                return p.forEach(function(t) {
                    t && (t.nodeType !== Node.ELEMENT_NODE ? a.isType("function", t) ? c = t : a.isType("object", t) && (d = t) : l = t)
                }), h.length !== t.length || 0 === p.length ? (c && a.async(function() {
                    c(!1)
                }), r.reject(new Error("Not enough parameters. Expected: " + u))) : l ? (d = a.aug({}, d || {}, e), t.forEach(function(t) {
                    d[t] = h.shift()
                }), s.asBoolean(d.dnt) && o.setOn(), f = i.addWidget(n(d, l)), c && f.then(c, function() {
                    c(!1)
                }), f) : (c && a.async(function() {
                    c(!1)
    ...
    t.exports = {
        tweetButtonHtmlPath: "/widgets/tweet_button.2e9f365dae390394eb8d923cba8c5b11.{{lang}}.html",
        followButtonHtmlPath: "/widgets/follow_button.2e9f365dae390394eb8d923cba8c5b11.{{lang}}.html",
        hubHtmlPath: "/widgets/hub.html",
        widgetIframeHtmlPath: "/widgets/widget_iframe.2e9f365dae390394eb8d923cba8c5b11.html",
    ...
    var r, i = n(2),
        ...
        p = n(159),
        m = n(28);
    n(160), m.emitter.trigger(m.START), u.set("widgets.init", !0), a.set("init", !0), p(), r = new i, s.exposeReadyPromise(r.promise, a.base, "_e"), a.set("widgets", f), a.set("widgets.load", l.load), a.set("events", d), h(function() {
    ...
    function g(t) {
        var e, n;
        return t = (t = t || r.body).length ? f.toRealArray(t) : [t], c.pause(), n = t.reduce(function(t, e) {
    ...
    t.exports = {
        load: function() {
            var t, e, n, s;
            if (c.ie9() || c.ie10() || "http:" !== l.protocol && "https:" !== l.protocol) return f.devError("Using default settings due to unsupported browser or protocol."), r = _(), void b().resolve();
            t = {
                origin: l.origin,
    ...
    i(function(t, e, n) {
        ...
        t.overrideProperty("id", {
            ...
            return e = d.aug({
                id: t
            }, e), n = d.aug({}, l, n), this._iframe = s(e, n), h[t] = this, this.onResize(o(function() {
                a.makeVisible()
    ...
    var r = n(0);
    t.exports = r.aug({}, n(151), n(152), n(153), n(154), n(155), n(156), n(157))
}, function(t, e, n) {
    var r = n(56),
        i = n(16)(["userId"], {}, r);
    t.exports = {
