...
(function($) {
    var methods = {
        ...
        init: function(options) {
            ...
            return this.each(function() {
                ...
                if (settings.disableOnTouchDevice) {
                    ...
                    $target.bind('touchstart.tooltip', function(e) {
                        $target.data('inTouchEvent', true);
                    });
                    $target.bind('mouseup.tooltip', function(e) {
                        $target.data('inTouchEvent', false);
                    });
                }
        ...
        show: function(event) {
            ...
            var tipElem = this;
            toolDiv.find('img').on('load', function() {
                jQuery.proxy(methods.updateposition, tipElem)()
            });
            ...
            if (settings.inheritParentMinWidth) {
                ...
                toolDiv.css({
                    'min-width': +(parentWidth - localPadding) + "px"
                });
            }
        ...
        hide: function(event) {
            ...
            if (settings.fadeSpeed > 0 && toolDiv.is(':visible')) {
                ...
                toolDiv.fadeTo(settings.fadeSpeed, 0, function() {
                    if (settings.destroyWhenDone) methods.destroytooltip(toolDiv)
                });
