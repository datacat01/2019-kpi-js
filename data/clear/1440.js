...
if (typeof gigya.partnerSettings == 'undefined') {
    gigya.partnerSettings = {
        ...
        "baseDomains": "redcross.org,redcrossblood.org"
    };
}
...
if (gigya.canary && gigya.canary.isActive) {} else if (gigya.__initialized) {
        ...
        ! function(t) {
            ...
            ! function(i) {
                ...
                ! function(i) {
                    ...
                    ! function(i) {
                        function o(o, r) {
                            if (!e.partnerSettings.ssoKey) return void(r && r.callback && r.callback({}));
                            var s;
                            s = r ? e.utils.object.clone(r) : {};
                            var a, c, u = function(t) {
                                e.logger.debug("cleaning sso iframe"), a.parentNode.removeChild(a), clearTimeout(c), t && (t.errorCode && "string" == typeof t.errorCode && (t.errorCode = Number(t.errorCode)), t.expires_in && "string" == typeof t.expires_in && (t.expires_in = Number(t.expires_in))), r && r.callback && r.callback(t)
                            };
                            s.m = o, s.d = e.localInfo.protocol + "://" + document.location.hostname, document.location.port && (s.d += ":" + document.location.port), s.callbackID = "gig_sso_cb" + (new Date).getTime() + "_" + f++, e.utils.xd.addMessageListener(s.callbackID, {}, !1, u, t.MessagingMethod.PostMessage), s.sAPIKey = e.thisScript.APIKey, s[e.logger.configKey] = JSON.stringify(e.logger.getConfig());
                            var l = e.utils.keyValue.serialize(s);
                            a = n(s.callbackID);
                            var g = function() {
                                c = setTimeout(function() {
                                    e.logger.error("SSO Communication Timeout", {
                                        IE11PrivateMode: e.localInfo.isIE11 && !window.indexedDB
                                    })
                                }, i._requestTimeout);
                                ...
                                a.src = "https://" + (e.thisScript.globalConf.storageDomainOverride || e._.getGigyaDomain("cdns")) + "/gs/sso.htm?" + t + "#" + l, e.utils.DOM.removeEventListener(a, "load", g)
                            };
                            e.utils.DOM.addEventListener(a, "load", g), e.logger.debug("opening sso iframe", s), document.body ? e.utils.DOM.appendToBody(a) : e.utils.functions.invokeOnPageLoad(function() {
                                return e.utils.DOM.appendToBody(a)
                            })
                        }
                        ...
                        function r(t) {
                            e.logger.info("trying to get sso group login token"), i._request("getToken", {
                                callback: function(e) {
                                    i._storedLoginTokenExp = e.gltexp, t && t.callback && t.callback(e)
                                }
                            })
                        }
                        ...
                        function s(e, t, o) {
                            var n;
                            if (t = "string" == typeof t && t ? Number(t) : t, 0 === t) n = 0;
                            else {
                                var r = void 0;
                        ...
                        function a(t) {
                            t.gltexp || (t.gltexp = e.utils.cookie.get("gltexp_" + e.thisScript.APIKey)), i._request("setToken", t)
                        }
                        ...
                        function u(e) {
                            i._request("removeToken", e)
                        }

                        function l(e, t) {
                            return void 0 === t && (t = !0), t && i._storedLoginTokenExp && e.loginTokenExp === i._storedLoginTokenExp ? void(e.callback && e.callback({
                                gltexp: i._storedLoginTokenExp
                            })) : (i._storedLoginTokenExp = e.loginTokenExp, void i._request("setLoginTokenExp", e))
                        }

                        function g(e) {
                            i._request("getLoginTokenExp", e)
                        }

                        function p(t) {
                            e.logger.info("verifying login token with sso group"), i._request("checkTokenRenew", t)
                        }

                        function d(e) {
                            i._request("syncCanaryIndication", e)
                        }
                        var f = 0;
                        i._requestTimeout = 3e3, i._request = o, i.getGroupToken = r, i.setGroupTokenFromResponse = s, i.setGroupToken = a, i.logout = c, i.removeGroupToken = u, i.setLoginTokenExp = l, i.getLoginTokenExp = g, i.checkTokenRenew = p, i.syncCanaryIndication = d
                    }(o = i.sso || (i.sso = {}))
                }(o = i.web || (i.web = {}))
                        ...
                        function g(t, o) {
                            if (void 0 === o && (o = e.thisScript.APIKey), t) switch (t.errorCode) {
                                case 403005:
                                    ...
                                    break;
                                case 403025:
                                    e.logger.info("existing group session was revoked"), i.remove(o), e.events.global.dispatchWhenHandlerAdded({
                    ...
                    var o = function(i) {
                        ...
                        return __extends(o, i), o.prototype.beforeRequest = function() {}, o.prototype.afterResponse = function(t) {
                            ...
                            return e.localInfo.isIE11 && window.indexedDB && (n.messaging = t.MessagingMethod.LocalStorageListener), e.localInfo.isAndroid && this.params.provider && "line" == this.params.provider.toLowerCase() && (n.messaging = t.MessagingMethod.LocalStorageListener), "redirect" === o && (n.sourceURL = window.top.document.location.href, this.params.redirectURL ? (n.redirectURL = e.utils.URL.addParamsToURL(this.params.redirectURL, {
                                ...
                                gig_events: e.events.global.getEventsForOperation(this.methodName)
                            })), this.params.provider && "facebook" == this.params.provider.toLowerCase() && (n.invite = this.params.invite), e.utils.keyValue.serialize(n)
    ...
    ! function(e) {
        ...
        function m(e, t) {
            t._state === te ? k(e, t._result) : t._state === ie ? b(e, t._result) : T(t, void 0, function(t) {
                return y(e, t)
            }, function(t) {
                return b(e, t)
            })
        ...
        function k(e, t) {
            e._state === ee && (e._result = t, e._state = te, 0 !== e._subscribers.length && B(S, e))
        }
        ...
        function T(e, t, i, o) {
            var n = e._subscribers,
                r = n.length;
            e._onerror = null, n[r] = t, n[r + te] = i, n[r + ie] = o, 0 === r && e._state && B(S, e)
        }
        ...
        function D(e, t) {
            this._instanceConstructor = e, this.promise = new e(g), this.promise[$] || C(this.promise), q(t) ? (this._input = t, this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? k(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && k(this.promise, this._result))) : b(this.promise, E())
        }
        ...
        var M = function(e, t, i, o) {
            ...
            U = function(e) {
                this[$] = P(), this._result = this._state = void 0, this._subscribers = [], g !== e && ("function" != typeof e && G(), this instanceof U ? x(this, e) : L())
            },
            F = void 0;
            ...
            var o = function() {
                ...
                return o.prototype.getApiDomain = function(t) {
                    ...
                    return __gig_awaiter(this, void 0, e.Promise, function() {
                        var i;
                        return __gig_generator(this, function(o) {
                            return i = e._.getBaseDomain(e.partnerSettings.baseDomains.split(","), this._domainResolver.originDomain, ["gigya.com", "gigya-api.cn", e.defaultApiDomain]), i === e.defaultApiDomain && this._groupApiDomainService.set(t), [2]
                        })
                    })
                    ...
                    return __gig_awaiter(this, void 0, e.Promise, function() {
                        ...
                        return __gig_generator(this, function(s) {
                            switch (s.label) {
                                ...
                                case 1:
                                    if (n = s.sent(), !n.gcid || !n.ucid) throw "ApiService getIDs: the request to the endpoint failed";
                                    return e.logger.info("setting gmid in storage"), this._storage.setItem(t.TokenKeys.GMID, n.gcid), this._storage.setItem(t.TokenKeys.UCID, n.ucid), r = this.createTicketResponse(n.gmidTicket), this.updateGmidTicket(r), [3, 3];
                                case 2:
                                    e.utils.validation.isLaterThanNow(o) ? e.logger.info("already has gmid in storage") : this.refreshGmidTicketFromServer(), s.label = 3;
                                case 3:
                                    return [2]
                            }
                        })
                    ...
                    return __gig_awaiter(this, void 0, e.Promise, function() {
                        ...
                        return __gig_generator(this, function(o) {
                            switch (o.label) {
                                ...
                                case 1:
                                    return i = o.sent(), i && i.gmidTicket && this.updateGmidTicket(i), [2, i]
                            }
                        })
                    })
                    ...
                    return t && (n.gmid = t), this.sendRequest({
                        ...
                        return t && t.gmidTicket ? o.createTicketResponse(t.gmidTicket) : (e.logger.error("Failed to establish gmidTicket", {
                            response: JSON.stringify(t),
                            method: "socialize.getGmidTicket"
                        }), void o.deleteGmidTicket())
                    })
    ...
    ! function(e, t) {
        ...
        function v(e, t) {
            t._state === te ? w(e, t._result) : t._state === ie ? S(e, t._result) : I(t, void 0, function(t) {
                return y(e, t)
            }, function(t) {
                return S(e, t)
            })
        ...
        function m(e, i, n) {
            i.constructor === e.constructor && n === l && i.constructor.resolve === u ? v(e, i) : n === ne ? S(e, ne.error) : void 0 === n ? w(e, i) : t(n) ? h(e, i, n) : w(e, i)
        }

        function y(t, i) {
            t === i ? S(t, d()) : e(i) ? m(t, i, f(i)) : w(t, i)
        }
        ...
        function P(e, i, n, o) {
            var r = t(n),
                ...
                l = void 0;
            if (r) {
                if (a = C(n, o), a === oe ? (l = !0, s = a.error, a = null) : c = !0, i === a) return void S(i, p())
            } else a = o, c = !0;
            i._state !== ee || (r && c ? y(i, a) : l ? S(i, s) : e === te ? w(i, a) : e === ie && S(i, a))
        }
        ...
        function x(e, t) {
            this._instanceConstructor = e, this.promise = new e(g), this.promise[Z] || D(this.promise), B(t) ? (this._input = t, this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? w(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && w(this.promise, this._result))) : S(this.promise, E())
        }
        ...
        var M = function(e, t, i, n) {
            ...
            j = function(e) {
                this[Z] = k(), this._result = this._state = void 0, this._subscribers = [], g !== e && ("function" != typeof e && N(), this instanceof j ? L(this, e) : R())
            },
            F = void 0;
        F = Array.isArray ? Array.isArray : function(e) {
            return "[object Array]" === Object.prototype.toString.call(e)
        ...
        return x.prototype._enumerate = function() {
            ...
            var n = this.promise;
            n._state === ee && (this._remaining--, e === ie ? S(n, i) : this._result[t] = i), 0 === this._remaining && w(n, this._result)
        ...
        }, j.all = U, j.race = O, j.resolve = u, j.reject = T, j._setScheduler = i, j._setAsap = n, j._asap = K, j.prototype = {
            constructor: j,
            then: l,
            catch: function(e) {
                return this.then(null, e)
    ...
    ! function(e) {
        ...
        ! function(t) {
            ...
            ! function(i) {
                ...
                function u(t) {
                    e.utils.DOM._removeDialogBackListener(), j = function(i) {
                        i && i.newURL && i.newURL.indexOf("|gigyaMobileDialog") == -1 && (t(i), e.utils.DOM._removeDialogBackListener())
                    }, window.setTimeout(function() {
                        window.location.hash.indexOf("|gigyaMobileDialog") == -1 && (window.location.hash = window.location.hash + "|gigyaMobileDialog"), e.utils.DOM.addEventListener(window, "hashchange", j)
                    }, 50)
                }

                function g() {
                    j && (e.utils.DOM.removeEventListener(window, "hashchange", j), j = null, window.location.hash = window.location.hash.replace("|gigyaMobileDialog", ""))
                }
                ...
                function L(e, t, i) {
                    if (void 0 === i && (i = !1), e) {
                        for (var n = k(e), o = n.length - 1; o >= 0; o--)(n[o] === t || i && n[o].indexOf(t) !== -1) && n.splice(o, 1);
                        e.className = n.join(" ")
                    }
                }
                ...
                function D(e, t) {
                    ...
                    for (var i = !1, n = k(e), o = 0; o < n.length; o++)
                        if (n[o] === t) {
                            i = !0;
                            break
                        } return i
    ...
    ! function(e) {
        ...
        ! function(t) {
            ...
            ! function(t) {
                ...
                function u(e, t, i) {
                    void 0 === i && (i = !1);
                    for (var n = i ? e[0] : {}, o = 0; o < e.length; o++)
                        if (e[o] && e[o].length)
                            for (var r = 0; r < e[o].length; r++)
                                for (var a in e[o][r]) n[a] = e[o][r][a];
                        else if (t)
                        for (var a in e[o]) "object" != typeof n[a] || n[a] instanceof Array ? n[a] = e[o][a] : n[a] = u([n[a], e[o][a]], !0);
                    else
                        for (var a in e[o]) n[a] = e[o][a];
                    return n
                }
    ...
    ! function(e) {
        ...
        ! function(t) {
            ...
            ! function(t) {
                ...
                function r(i, r, a, u, g) {
                    if (s[i] = {
                            callback: u,
                            context: r,
                            t: (new Date).getTime()
                        }, g || (g = e.localInfo.messagingMethod, e.localInfo.isIE11 && a && window.indexedDB && (g = e._.MessagingMethod.LocalStorageListener), e.localInfo.isAndroid && r && r.provider && "line" == r.provider.toLowerCase() && (g = e._.MessagingMethod.LocalStorageListener)), g == e._.MessagingMethod.LocalStorageListener || g == e._.MessagingMethod.PostMessage) {
        ...
        ! function(t) {
            ...
            ! function(t) {
                function i(t, i, n, o, r) {
                    if (void 0 === r && (r = window.document), n && "post" == n.toLowerCase()) {
                        ...
                        a.innerHTML = s.join(""), a.style.display = "none", e.utils.DOM.appendToBody(a, r), a.submit()
                    } else {
                        ...
                        u.addToSearch(g), r.location.href = u.toString()
                    }
                }
                t.redirect = i
            }(i = t.HTTP || (t.HTTP = {}))
                    ...
                    for (var s = 0; s < a.length; s++) {
                        ...
                        for (var m = 0; m < v.length; m++)
                            for (var y = v[m], b = 0; b < f.length; b++) {
                                var w = f[b];
                                if (w.type == y) {
                                    var S = e.utils.object.clone(h);
                                    null == S.context && null != w.context && (S.context = w.context), null == S.context && delete S.context, "component" != y && (o++, e._.handleSpecialFields(S)), w.params && w.params.signKey && (S.UIDSignature = t.signKeysUIDSignature[w.params.signKey], delete S.signKeysUIDSignature);
                                    try {
                                        w.handler(S)
                                    } catch (i) {
                        ...
                        var I = window.GenesisExchange_Gigya,
                            A = window.gigya_omniture_conf,
                            _ = window.myOmnitureIntegrationFunc;
                        if (!r && "undefined" != typeof I && "undefined" != typeof A && "socialize" == u) {
                            var C = new I(A);
        ...
        ! function(t) {
            ...
            var a = [{
                ...
                s = function() {
                    ...
                    return s.prototype.start = function() {
                    ...
                    }, s.prototype.beforeRequest = function(t, i) {
                        var o = this;
                        e._.logoutMethods[this.api.methodName] && (!t && !this.params.regToken || e.partnerSettings.ssoLogoutUrl && document.location.href == e.partnerSettings.ssoLogoutUrl) && i(n(null)), this.handleDeprecatedParams(), this.handleCollections(), this.handleConnectWithoutLoginBehavior(t);
                        var r = this.params[this.params.provider + "ExtraPermissions"];
                        this.params.extraPermissions = r || this.params.permissions, this._initialMethod = this.params.initialMethod, this.api.preprocessRequest(this.params, function() {
                            o.setOverridableParams(function() {
                                o.setNonOverridableParams(t, function() {
                                    o.filterParams(o.params), e.log.logCall(o.api.methodName, o.originalParams, o.originalParams.lastSource), i()
                                })
                            })
                        })
                        ...
                        0 === this.api.methodName.indexOf("accounts.") && (e.events.global._activeNamespaces.socialize && null == this.params.includeUserInfo && (this.params.includeUserInfo = !0), this.params.include = this.params.include ? this.params.include + "," : "profile,data"), "accounts.getSchema" === this.api.methodName && (this.params.includeDynamicSchema = "clientOnly"), this.params.targetEnv = "jssdk", n()
                        ...
                        isNaN(Number(e.thisScript.globalConf.verifyLoginInterval)) || "accounts.verifyLogin" !== this.api.methodName || 0 === i.errorCode || t.apiAdapter.clearSession({
                            ...
                            i = a, i = r.preprocessServerResponse(i), 403005 == i.errorCode && (i = r.getExpiredSessionResponse(i)), 0 == i.errorCode && (n || t.loginMethods[r.api.methodName]) && e.utils.cookie.remove("_gigRefUid_" + r.originalParams.APIKey), r.handleMethodResponse(i, function(a) {
                        ...
                        if (t.logoutMethods[this.api.methodName] && 0 == s) {
                            ...
                            if (l.length) {
                                ...
                                window.setTimeout(I, u);
                                for (var A = function() {
                                        w++, w === l.length && window.setTimeout(I, g)
                ...
                n = function(n) {
                    ...
                    return __extends(o, n), o.getApiName = function(e, t, i) {
                        ...
                        if (e.log.logCall(r, i), e.reports.reportLoad(r, i), this.pluginType) {
                            ...
                            if (t.plugins.setPluginInstance(i, this.injectionInfo, s), s.onDisposedEvent().add(function() {
    ...
    ! function(e) {
        ...
        ! function(t) {
            ...
            t.arApiList = [new t.ServerApi("socialize.login", t.defaultOauthSchema, (!1), {
                ...
                forceHttps: !0
            }), new t.ServerApi("accounts.tfa.finalizeTFA", "gigyaAssertion|providerAssertion|tempDevice|regToken", (!0), {}, {}, "regToken"), new t.ServerApi("accounts.tfa.deactivateProvider", "provider", (!0)), new t.ServerApi("accounts.tfa.unregisterDevice", "allDevices", (!0)), new t.ServerApi("accounts.tfa.backupcodes.get", "gigyaAssertion", (!0)), new t.ServerApi("accounts.tfa.backupcodes.create", "gigyaAssertion", (!0)), new t.ServerApi("accounts.tfa.backupcodes.verify", "gigyaAssertion|code|regToken", (!1)), new t.ServerApi("accounts.tfa.phone.getRegisteredPhoneNumbers", "gigyaAssertion", (!1), {
                preprocessor: o
            }, {
                forceHttps: !0
                ...
                forceHttps: !0
            }), new t.ServerApi("accounts.sa.delegatedAdminLogin", "orgId", (!0), {}, {
                forceHttps: !0
        ...
        ! function(t) {
            function i(t) {
                if (t && t.orgId) {
                    ...
                    e.accounts.sa.delegatedAdminLogin({
                        orgId: t.orgId,
                        callback: function(n) {
                            0 !== n.errorCode ? (i.close(), "function" == typeof t.onError && t.onError(n)) : n.targetUrl && n.id_token ? e.utils.HTTP.redirect(n.targetUrl, [{
                                id_token: n.id_token
                            }], "POST", void 0, i.document) : (i.close(), e.logger.error("accounts.sa.delegatedAdminLogin - missing required params", {
                                targetURL: n.targetUrl,
                                id_token: n.id_token
                            }))
                        }
                    })
                } else e.logger.warn("gigya.accounts.sa.openDelegatedAdminLogin - missing orgId parameter.")
            }
            ...
            e.socialize.trackReferrals = function() {
                var i = e.utils.object.merge([e.thisScript.globalConf, arguments]),
                    ...
                    a = {},
                    s = {};
                document.location.href.indexOf("#") != -1 && (s = e.utils.keyValue.deserialize(document.location.href.split("#")[1])), document.location.href.indexOf("?") != -1 && (a = e.utils.keyValue.deserialize(document.location.href.split("?")[1].split("#")[0])), e.socialize.updateRefUID(i.APIKey, s, a);
                var c = null != s._gus || null != a._gus;
                if (c && (r.CID = s._gucid || a._gucid, r.shortCode = s._gsc || a._gsc, r.provider = s._gup || a._gup), !n) {
                    var l, u = {
                    ...
                    if (a.fb_ref) {
                        ...
                        0 == d.indexOf("www.") && (d = d.split("www.")[1]), o[d] && (r.provider = u.sn = o[d])
                    }
                    if (!u.sn && (!document.referrer || document.referrer.indexOf("http://soc.li") == -1 && document.referrer.indexOf("https://shr.gs") == -1)) {
                        ...
                        if (p.length > 1) {
                            ...
                            f != t.apiAdapter.getTokenParam(i.APIKey, "UUID") && (u.sn = "AddressBarShares", u.uuid = f, "_" == f && delete u.uuid, document.location.replace("#"), e.reports.trackAddressBarShares(), u.url = document.location.href.split("#")[0])
                        }
                    }
                    u.uuid && e.utils.cookie.set("_gigRefUid_" + i.APIKey, u.uuid), u.sn && !c && e.reports.report("linkback", i.APIKey, i.cid, l, null, u), (u.sn || c) && e.events.global.dispatch(e.utils.object.removeUndefined(r)), n = !0
                }
            ...
            }, e.utils.functions.createAlias("gigya.accounts.sa.openDelegatedAdminLogin", i), e.utils.functions.createAlias("gigya.accounts.setSSOToken", e.setSSOToken)
        }(t = e._ || (e._ = {}))
    }(gigya || (gigya = {}));
    var gigya;
    ! function(e) {
            ...
            ! function(i) {
                ...
                function l(t) {
                    ...
                    if (n && !window.__gig_hidescript) {
                        ...
                        e.utils.object.merge([e.thisScript, {
                            scriptElement: n,
                            ...
                            URLParams: o
                        }], !1, !0), e.thisScript.globalConf.lang = e.thisScript.lang.langCode, !e.thisScript.APIKey && "object" == typeof console && console.warn ? console.warn("**** WARNING - Loading socialize.js without an APIKey parameter is unsupported and may result in an unexpected behavior.  ****") : e.thisScript.globalConf.APIKey = e.thisScript.APIKey, t()
                    } else i.parseScriptRetries < 10 ? (i.parseScriptRetries++, window.setTimeout(function() {
                        l(t)
                    }, 200)) : (e.utils.object.merge([e.thisScript, {
                        scriptElement: null,
