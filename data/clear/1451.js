...
(function($) {
    Drupal.behaviors.xmlsitemapchoose = {
        attach: function(context, settings) {
            // Code to be run on page load, and
            // on ajax load added here

            $("#form-choose-nodes").click(function() {

                var nodes_data = $("form").serializeArray();

                $.post("/xmlsitemap-choose/ajax", {
                    "nodes": nodes_data
                }, function(data) {
                    console.log(data);

                    $('#console').html(
                        '<div class="messages success"><ul><li>' + data + '</li></ul></div>'
                    );
                    return false;
                });
                return false;
