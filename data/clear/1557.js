...
jQuery(document).ready(function() {
    ...
    if (jQuery.fn.avia_menu_helper)
        jQuery(".main_menu .menu").avia_menu_helper({
    ...
    if (jQuery.fn.avia_fancy_buttons)
        jQuery(".social_bookmarks li").avia_fancy_buttons({
            target: 'a'
        });
...
function avia_ajax_call(container) {
    ...
    if (jQuery.fn.avia_sc_slider)
        jQuery(".content_slider", container).avia_sc_slider({
            appendControlls: {}
        });
    ...
    if (jQuery.fn.avia_sc_tabs) {
        ...
        jQuery('.sidebar_tabcontainer', container).avia_sc_tabs({
            heading: '.sidebar_tab',
            content: '.sidebar_tab_content',
            active: 'sidebar_active_tab',
            sidebar: true
        });
    }
...
(function($) {
    ...
    $.fn.avia_fancy_buttons = function(passed_options) {
        ...
        return this.each(function() {
            ...
            if (!$.avia_utilities.supports('transition', ['Khtml', 'Ms', 'Moz', 'Webkit'])) {
                return false;
            }
        ...
        return this.each(function() {
            ...
            methods = {
                ...
                show_item: function(post_id, clickedIndex) {
                    ...
                    if (false === is_open) {
                        ...
                        target_wrap.css({
                            ...
                            if (ajax_call) {
                                avia_ajax_call(content_retrieved[post_id]);
                                ajax_call = false;
                            }
                        ...
                        content_retrieved[is_open].avia_animate({
                            ...
                            target_container.avia_animate({
                                height: content_retrieved[post_id].outerHeight()
                ...
                ajax_get_contents: function(post_id, clickedIndex) {
                    ...
                    var url_params = methods.getUrlVars(),
                        add_params = "";
                ...
                control_click: function() {
                    ...
                    switch (this.hash) {
                        case '#next':
                            ...
                            if (!showItem.length) {
                                showItem = $('.post-entry:not(.isotope-hidden):eq(0)', container).find('a:eq(0)');
                            }
                        ...
                        case '#prev':
                            ...
                            if (!showItem.length) {
                                showItem = $('.post-entry:not(.isotope-hidden):last', container).find('a:eq(0)');
                            }
                            showItem.trigger('click');
            ...
            if (jQuery.support.leadingWhitespace) {
                win.bind('smartresize', methods.resize_reset);
            }
    ...
    $.fn.avia_iso_sort = function(options) {
        ...
        return this.each(function() {
            ...
            var container = $(this),
                ...
                filter = parentContainer.prev('.sort_width_container').find('#js_sort_items').css({
                    visibility: "visible",
                    opacity: 0
                }),
                links = filter.find('a'),
    ...
    $.fn.avia_menu_helper = function(variables) {
        ...
        return this.each(function() {
            ...
            menuItems.each(function() {
                var item = $(this),
                    normalDropdown = item.find("li>ul").css({
                        display: "none"
                    });
    ...
    $.fn.avia_sc_tabs = function(options) {
        ...
        return this.each(function() {
            ...
            if (!options.sidebar) {
                ...
                var click_container = $("<div class='sidebar_tab_wrap'></div>").prependTo(container),
                    min_height;
            ...
            function set_size(click_container, sidebar_shadow) {
                ...
                content.css({
                    'min-height': (min_height - parseInt(content.css('padding-top'), 10) - parseInt(content.css('padding-bottom'), 10) - parseInt(content.css('border-top-width'), 10) - parseInt(content.css('border-bottom-width'), 10))
                });
            ...
            function open_content(tab, i, alternate_tab) {
                if (!tab.is('.' + options.active)) {
                    ...
                    setTimeout(function() {
                        avia_small_fixes($('.' + options.active + '_content', container));
                    }, 10);
...
function avia_small_fixes(container) {
    if (!jQuery.support.opacity) {
        jQuery('.image_overlay_effect', container).css({
        ...
        adjust_iframes = function() {
            ...
            iframes.each(function() {
                ...
                var iframe = jQuery(this),
                    frame_parent_w = iframe.parent().width(),
                    proportions = 16 / 9;

                if (this.width && this.height) {
                    proportions = Math.round(this.width / this.height * 1000) / 1000;
                    iframes.css({
                        width: frame_parent_w,
                        height: frame_parent_w / proportions
                    });
                }
...
(function($) {
    ...
    $.fn.avia_sc_slider = function(variables, callback) {
        ...
        return this.each(function() {
            ...
            if (optionWrap.data('interval')) {
                options.autorotationInterval = optionWrap.data('interval') * 1000;
            }
            if (optionWrap.data('interval') === 0) options.autorotation = false;

            if (options.group) {
                var container_new = $('<div>').addClass(container.attr('class')).css({
                        overflow: 'hidden',
                        width: '100%',
                        position: 'relative'
            ...
            container.methods = {
                ...
                init: function() {
                    if (slideCount > 1) {
                        ...
                        slides.wrapAll('<div class="inner_slide_container" />').css({
                            float: 'left',
                ...
                change: function() {
                    ...
                    innerContainer.stop().animate({
                        left: moveTo
                    }, options.transitionDuration, options.transitionEasing, function() {
                        container.animating = false;
                    });
                    ...
                    }, options.transitionDuration, options.transitionEasing);
                ...
                appenControlls: function() {
                    ...
                    if (options.appendControlls && slideCount > 1) {
                        ...
                        slides.each(function(i) {
                            var link = $('<a ' + firstClass + ' href="#">' + (i + 1) + '</a>').appendTo(controlls);
                            firstClass = "";
                            link.bind('click', {
                                show: i
                    ...
                    if (options.arrowControll && slideCount > 1) {
                        ...
                        nextArrow = $('<a class="arrow_controll arrow_controll_next" href="#next">+</a>').appendTo(arrowControlls).bind('click', {
                            show: 'next'
                        }, container.methods.setSlideNumber).css({
                            visibility: 'visible',
                            opacity: 0
                        });
                        prevArrow = $('<a class="arrow_controll arrow_controll_prev" href="#prev">-</a>').appendTo(arrowControlls).bind('click', {
                            show: 'prev'
                        }, container.methods.setSlideNumber).css({
                            visibility: 'visible',
                            opacity: 0
                    ...
                    if (!isMobile) {
                        arrowControlls.parent().hover(function() {
                                prevArrow.stop().animate({
                                    opacity: 0.7
                                }, 400);
                                nextArrow.stop().animate({
                                    opacity: 0.7
                                }, 400);
                            },
                            function() {
        ...
        return this.each(function() {
            ...
            function send_ajax_form() {
                ...
                responseContainer.load(form.attr('action') + ' ' + options.responseContainer, send.dataObj, function() {
                    responseContainer.find('.hidden').css({
                        display: "block"
                    });
