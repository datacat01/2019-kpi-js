            ...
            methods = {
                ...
                *************************************************************************/
                ...
                css3_check: function(slider, property) {
                    if (slider.isMobile) {
                        slider.parents(':eq(0)').addClass('slideshow_mobile');
                    }
                ...
                *************************************************************************/
                ...
                bind_events: function(slider) {
                    ...
                    slider.bind('switch.' + slider.options.pluginNameSpace, function(e, target) {
                        methods.try_slide_transition(e, target, slider);
                    });
                ...
                *************************************************************************/
                ...
                pause_slider: function(slider) {
                    if (slider.pauseButton.length) {
                        slider.pauseButton.removeClass('ctrl_active_rotation').text('Play');
                    }
                ...
                unpause_slider: function(slider) {
                    if (slider.pauseButton.length) {
                        slider.pauseButton.addClass('ctrl_active_rotation').text('Pause');
                    }
                ...
                *************************************************************************/
                ...
                set_video_slides: function(slider) {
                    ...
                    slider.slides.each(function(i) {
                        var currentslide = $(this),
                            ...
                            imageslide, videoslide, iframe, src;
                ...
                showvideo: function(clicked_item, slider) {
                    ...
                    clicked_item.find('.slideshow_overlay').stop().animate({
                        opacity: 0
                    }, function() {
                        $(this).css({
                            zIndex: 0,
                    ...
                    if (!clicked_item.is('.small_image')) {
                        clicked_item.find('.' + slider.options.captionClass).stop().animate({
                            opacity: 0
                        }, function() {
                            $(this).css({
                                zIndex: 0,
                    ...
                    setTimeout(function() {
                        clicked_item.find('img, canvas').stop().animate({
                            opacity: 0
                        }, function() {
                            $(this).css({
                                zIndex: 0,
                ...
                *************************************************************************/
                ...
                calculate_target: function(target, slider) {
                    if (typeof target === 'object') {
                        target = $(target).data('show-slide');
                    }
                    switch (target) {
                        case 'next':
                            target = slider.currentIndex + 1;
                            slider.moveDirection = 1000;
                            break;
                        case 'previous':
                            target = slider.currentIndex - 1;
                            slider.moveDirection = -1000;
                ...
                fade: function(slider) {
                    ...
                    slider.nextSlide.css({
                        display: 'block',
                        zIndex: 2,
                        opacity: 0
                    }).avia_animate({
                        opacity: 1
                    }, options.transitionSpeed / 2, 'linear');

                    slider.currentSlide.avia_animate({
                        opacity: 0
                ...
                move: function(slider) {
                    ...
                    if (slider.currentIndex > slider.nextIndex) {
                        modifier = 1;
                    }
                    ...
                    if (slider.css_active) {
                        ...
                        slider.nextSlide.css({
                            left: sliderWidth * modifier * -1
                        });
                        transition.left = sliderWidth * modifier;
                        transition2.left = 0;
                    }

                    slider.nextSlide.avia_animate(transition2, options.transitionSpeed, options.easing, function() {
                        methods.change_finished(slider);
                    });
                ...
                change_finished: function(slider) {
                    ...
                    slider.currentSlide = slider.nextSlide.css({
                        display: 'block',
                        zIndex: 3,
                        left: 0,
                        top: 0,
                ...
                display_caption: function(slide) {
                    ...
                    title.stop().attr('style', "").css({
                        opacity: 0
                    });
                    excerpt.stop().attr('style', "").css({
                        opacity: 0
                    });
                    buttons.stop().attr('style', "").css({
                        opacity: 0
                    });
                    ...
                    setTimeout(function() {
                        ...
                        excerpt.avia_animate({
                            opacity: 1,
                            left: 0,
                            top: 0
                        }, 1000, easing);
                        buttons.avia_animate({
                            opacity: 1,
                            left: 0,
                            top: 0
                        }, 1300, easing);
                ...
                set_slide_proportions: function(event, callback, slider) {
                    ...
                    var wrap = slider.currentSlide.find('.slideshow_media_wrap'),
                        ...
                        properties = {
                            height: Math.round(((slider.width() / modifier) / slider.proportions) + border) + "px"
                        },
                        options = slider.options;
                ...
                *************************************************************************/
                ...
                show_first_slide: function(slider) {
                    var firstSlide = slider.slides.slice(0, 1).css({
                            visibility: 'visible',
                            opacity: 0,
                            zIndex: 3
                        }),
                ...
                append_controls: function(slider) {
                    if (slider.count > 1) {
                        ...
                        var active_class = "class='active_item'",
                            x, extra_class, labels = ['previous', 'pause_play', 'next'];

                        slider.controls.numeric = $('<div class="numeric_controls slide_controls"></div>').insertAfter(slider);

                        slider.slides.each(function(i) {
                            $('<a ' + active_class + ' href="#" data-show-slide="' + i + '" >' + (i + 1) + '</a>').appendTo(slider.controls.numeric);
                            active_class = "";
                        });
                ...
                activate_controls: function(slider) {
                    slider.pauseButton.bind('click', function() {
                        methods.toogle_autorotation(slider);
                        return false;
                    });

                    slider.controls.numeric.find('a').bind('click', function() {
                        methods.pause_slider(slider);
                        slider.trigger('switch.' + slider.options.pluginNameSpace, this);
                        return false;
                    });
                ...
                activate_touch_control: function(slider) {
                    if (slider.css_active && slider.isMobile) {
                        ...
                        if (slider.options.forceMobile) {
                            slider.options.transition = 'move';
                        }
                ...
                *************************************************************************/
                ...
                fx: function(slider) {
                    ...
                    //fire the transition
                    setTimeout(function() {
                        methods.start_block_transition(slider);
                    }, 100);
                },

                set_slide_option: function(slider) {
                    var cur_height, cur_width, slideWidth = slider.width(),
                ...
                perpare_blocks: function(slider) {
                    ...
                    switch (slider.currentOptions.order) {
                        case 'diagonal':
                            slider.blocks = methods.diagonal(slider.blocks, slider);
                            break;
                        case 'random':
                            slider.blocks = methods.fyrandomize(slider.blocks, slider);
                            break;
                    }
                },
                ...
                generate_blocks: function(slider) {
                    ...
                    while (generateBlocks) {
                        ...
                        if (nextImage) {
                            imagestring = '<img src="' + nextImage + '" title="" alt="" />';
                        }
                ...
                use_preset_animation: function(slider, animation) {
                    ...
                    if (!slider.css_active) {
                        randomCount -= 3;
                    } //subtract the css3 transitions 
                    if (animation === 'random') {
                        animation = animationOptions[Math.floor(Math.random() * randomCount)];
                    }
                    ...
                    switch (animation) {
                        ...
                        case "square":
                            options = {
                                blockHeight: Math.ceil(x / squares),
                                blockWidth: Math.ceil(x / squares),
                                transitionFx: 'slide',
                                betweenBlockDelay: 50,
                                transitionSpeed: 600,
                                order: 'diagonal'
                ...
                clean_up_hook_fx: function(slider) {
                    if (!slider.blocks || !slider.blocks.length) {
                        return;
                    }
        ...
        return this.each(function() {
            function show_it() {
                ...
                if (controls['prev'].length) {
                    ...
                    controls['next'] = container.find('.slide_controls a.ctrl_next').stop().css({
                        display: 'block',
                        opacity: 0
                    }).animate({
                        opacity: 0.9,
            ...
            function hide_it() {
                ...
                controls['prev'].stop().animate({
                    opacity: 0,
                    left: -310
                }, duration, easing);
                controls['next'].stop().animate({
                    opacity: 0,
                    right: -310
        ...
        var win = $(window),
            ...
            methods = {
                ...
                init: function(slider) {
                    ...
                    slider.bind('moveTo', function(e, target, index) {
                        methods.moveTo(slider, target, index);
                    });

                    slider.control.next.on('click.' + namespace, function(e, trigger) {
                        methods.transition(slider, 1);
                        methods.setMoveTo(slider, e, trigger);
                        return false;
                    });
                    slider.control.prev.on('click.' + namespace, function(e, trigger) {
                        methods.transition(slider, -1);
                        methods.setMoveTo(slider, e, trigger);
                        return false;
                    });

                    slider.avia_swipe_trigger({
                        next: slider.control.next,
                        prev: slider.control.prev
                    });

                    if (slider.isMobile) {
                        slider.options.endless = false;
                    }
                },
                ...
                transition: function(slider, direction) {
                    if (slider.animating && !slider.isMobile) {
                        return false;
                    }
                    ...
                    if (skip) {
                        ...
                        if (slider.noscroll === true && options.center === true) {
                            ...
                            slider.slide.avia_animate(property, speed, easing, function() {
                                slider.animating = false;
                            });
                        }
                    }
