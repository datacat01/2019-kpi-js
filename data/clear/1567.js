(function() {
    ...
    if (!window.liveAgentDeployment) {
        ...
        ra.prototype.map = function(a, b, c, e, d) {
            ...
            "undefined" == typeof e && (e = !0);
            "undefined" == typeof d && (d = !0);
            this.getEntityFieldsMaps().push(new sa(a,
                b, c, e, d))
        };
        ...
        q.connection.messageHandler = function(a, b) {
            switch (a) {
                ...
                case "Settings":
                    ...
                    for (var c = 0; c < b.buttons.length; c++) switch (b.buttons[c].type) {
                        ...
                        case "Invite":
                            ...
                            null == g ? fa("Warning: Button " + e.id + " disabled because HTML element was not found") : (d = u(e.id), d.addTracker(new A(e.id, g, e.inviteRenderer, e.inviteStartPosition, e.inviteEndPosition, e.hasInviteAfterAccept, e.hasInviteAfterReject, e.inviteRejectTime)), g = f.jsonDecode(e.inviteRules), d.setRules(g.rules,
                                g.filter), wa(d, e))
                    }
                    break;
                case "Availability":
                ...
                case q.SystemMessage.SWITCH_SERVER:
                    c = b.newUrl;
                    if ("string" === typeof c) m.url =
                        c, f.log("Received updated LiveAgent server url: " + c + "! Consider updating this site's deployment code.");
