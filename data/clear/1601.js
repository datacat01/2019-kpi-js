...
(function($, Drupal, window, document, undefined) {
    ...
    $(function() {
        $("#block-fcc-blocks-browse-by > div.item-list").tabsAria({
            "trackstate": false
        });
                ...
                $(attachments).each(function() {
                    hideLink = $('<a>', {
                        ...
                        click: function() {
                            ...
                            $(this).parent().siblings('.edoc-details').show("slide", {
                                direction: "right"
                            }, "100");
                    ...
                    showLink = $('<a>', {
                        ...
                        click: function() {
                            ...
                            $(this).parent().siblings('.edoc-attachments').show("slide", {
                                direction: "left"
                            }, "100");
                            return false;
                        }
    ...
    Drupal.behaviors.accessibility = {
        attach: function(context) {
            ...
            $('.ui-tabs .ui-tabs-paging .ui-button .ui-button-text').each(function() {
            ...
            if (el.length > 0) {
                ...
                el.find("a").click(function() {
                    ...
                    if (tabId === "0") {
                        ...
                        console.log("No tab Id value", tabId);
                    }
                })
            }
        }
    ...
    Drupal.behaviors.dailyDigestYearFilter = {
        attach: function(context, settings) {
            if ($('body').hasClass('page-edocs-daily-digest')) {
                var container = $('.daily-digest-year nav ul');
                container.slick({
                    infinite: false,
                    slidesToShow: 5,
                    slidesToScroll: 5,
    ...
    Drupal.behaviors.expandCollapseAll = {
        attach: function(context, settings) {
            ...
            obj.prepend('<p class="toggall closed">Expand All</p>');
