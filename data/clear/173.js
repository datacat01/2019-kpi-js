/*! Raven.js 3.22.1 (7584197) | github.com/getsentry/raven-js */ ! function(a) {
    ...
    return function a(b, c, d) {
        ...
        3: [function(a, b, c) {
            (function(c) {
                ...
                f.prototype = {
                    ...
                    uninstall: function() {
                        return g.report.uninstall(), this.O(), this.P(), Error.stackTraceLimit = this.o, this.n = !1, this
                    },
                    captureException: function(a, b) {
                        var c = !k(a),
                            d = !m(a),
                            e = m(a) && !a.error;
                        if (c && d || e) return this.captureMessage(a, t({
                            trimHeadFrames: 1,
                            stacktrace: !0
                        }, b));
                    ...
                    setExtraContext: function(a) {
                        return this.T("extra", a), this
                    },
                    setTagsContext: function(a) {
                        return this.T("tags", a), this
                    },
                    ...
                    X: function() {
                        ...
                        return function(c) {
                            ...
                            if (f && ("INPUT" === f || "TEXTAREA" === f || d.isContentEditable)) {
                                var g = a.W;
                                g || a.V("input")(c), clearTimeout(g), a.W = setTimeout(function() {
                                    a.W = null
                                }, b)
                            }
                        }
                    ...
                    B: function() {
                        var a = this;
                        a.Z = Function.prototype.toString, Function.prototype.toString = function() {
                            return "function" == typeof this && this.L ? a.Z.apply(this.N, arguments) : a.Z.apply(this, arguments)
                        }
                    },
                    O: function() {
                        this.Z && (Function.prototype.toString = this.Z)
                    },
                    C: function() {
                        function a(a) {
                            return function(b, d) {
                        ...
                        function b(a) {
                            ...
                            b && b.hasOwnProperty && b.hasOwnProperty("addEventListener") && (E(b, "addEventListener", function(b) {
                                return function(d, f, g, h) {
                                    ...
                                    var j, k, l;
                                    return e && e.dom && ("EventTarget" === a || "Node" === a) && (k = c.V("click"), l = c.X(), j = function(a) {
                                        if (a) {
                                            var b;
                                            try {
                                                b = a.type
                    ...
                    D: function() {
                        ...
                        if (c.xhr && "XMLHttpRequest" in J) {
                            ...
                            E(e, "open", function(a) {
                                return function(c, d) {
                                    return p(d) && d.indexOf(b.h) === -1 && (this.$ = {
                                        method: c,
                                        url: d,
                                        status_code: null
                        ...
                        }, d), c.dom && this.b && (K.addEventListener ? (K.addEventListener("click", b.V("click"), !1), K.addEventListener("keypress", b.X(), !1)) : (K.attachEvent("onclick", b.V("click")), K.attachEvent("onkeypress", b.X())));
                        var f = J.chrome,
                        ...
                        if (c.location && h) {
                            ...
                            J.onpopstate = function() {
                                var a = b.w.href;
                                if (b.Y(b.x, a), i) return i.apply(this, arguments)
                            };
                            var j = function(a) {
                                return function() {
                                    var c = arguments.length > 2 ? arguments[2] : void 0;
                                    return c && b.Y(b.x, c + ""), a.apply(this, arguments)
                                }
                            };
                    ...
                    A: function() {
                        this.m || this.Q.apply(this, arguments)
                    },
                    Q: function(a, b) {
                        var c = this.R(a, b);
                        this.U("handle", {
                            stackInfo: a,
                            options: b
                        }), this._(a.name, a.message, a.url, a.lineno, c, b)
                    },
                    R: function(a, b) {
                        var c = this,
                            d = [];
                    ...
                    ba: function(a) {
                        ...
                        var d = a.request;
                        return d && (d.url && (d.url = u(d.url, this.k.maxUrlLength)), d.Referer && (d.Referer = u(d.Referer, this.k.maxUrlLength))), a.breadcrumbs && a.breadcrumbs.values && this.ca(a.breadcrumbs), a
                    },
                    ca: function(a) {
                    ...
                    y: function() {
                        this.ea = 0, this.fa = null
                    },
                    ga: function() {
                        return this.ea && d() - this.fa < this.ea
                    },
                    ha: function(a) {
                        var b = this.e;
                    ...
                    ia: function(a) {
                        if (!this.ga()) {
                            ...
                            if (400 === b || 401 === b || 429 === b) {
                                ...
                                this.ea = c ? c : 2 * this.ea || 1e3, this.fa = d()
                            }
                        }
                    },
                    S: function(a) {
                        ...
                        if (e && (c.request = e), a.trimHeadFrames && delete a.trimHeadFrames, a = t(c, a), a.tags = t(t({}, this.j.tags), a.tags), a.extra = t(t({}, this.j.extra), a.extra), a.extra["session:duration"] = d() - this.s, this.u && this.u.length > 0 && (a.breadcrumbs = {
                            ...
                            }), o(b.dataCallback) && (a = b.dataCallback(a) || a), a && !r(a) && (!o(b.shouldSendCallback) || b.shouldSendCallback(a))) return this.ga() ? void this.z("warn", "Raven dropped error due to backoff: ", a) : void("number" == typeof b.sampleRate ? Math.random() < b.sampleRate && this.ja(a) : this.ja(a))
                    },
                    ka: function() {
                        return z()
                    },
                    ja: function(a, b) {
                        var c = this,
                            d = this.k;
                        if (this.isSetup()) {
                            if (a = this.ba(a), !this.k.allowDuplicates && this.ha(a)) return void this.z("warn", "Raven dropped repeat event: ", a);
                            this.f = a.event_id || (a.event_id = this.ka()), this.e = a, this.z("debug", "Raven about to send:", a);
                            var e = {
                                sentry_version: "7",
                            ...
                            (d.transport || this.la).call(this, {
                                ...
                                onError: function(d) {
                                    c.z("error", "Raven transport failed to send: ", d), d.request && c.ia(d.request), c.U("failure", {
                                        data: a,
                                        src: g
                    ...
                    la: function(a) {
                        var b = a.url + "?" + y(a.auth),
                            c = null,
                            d = {};
                        if (a.options.headers && (c = this.ma(a.options.headers)), a.options.fetchParameters && (d = this.ma(a.options.fetchParameters)), F()) {
                            d.body = h(a.data);
                            var e = t({}, this.l),
                                f = t(e, d);
        ...
        5: [function(a, b, c) {
            (function(a) {
                ...
                var E = "undefined" != typeof window ? window : "undefined" != typeof a ? a : "undefined" != typeof self ? self : {};
                b.exports = {
                    isObject: c,
                    isError: d,
                    isErrorEvent: e,
