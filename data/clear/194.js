...
$_mod.def("/raptor-util$3.2.0/makeEnum", function(c, k, f) {
    var h = c("/raptor-util$3.2.0/makeClass"),
        i = c("/raptor-util$3.2.0/extend"),
...
$_mod.installed("site-speed-ebay$4.0.10", "cookies-browser", "0.0.2");
$_mod.installed("site-speed-ebay$4.0.10", "raptor-pubsub", "1.0.5");
...
$_mod.installed("site-speed-ebay$4.0.10", "core-site-speed-ebay", "1.0.7");
...
$_mod.def("/core-site-speed-ebay$1.0.7/SiteSpeed", function(t, u, n) {
    n.exports = function(o, n, r, s) {
            ...
            m = new function(f) {
                function g() {
                    ...
                    b.forEach(function(a) {
                        ...
                        if (!(0 != a.name.indexOf("http://") && 0 != a.name.indexOf("https://"))) {
                            ...
                            e.hasOwnProperty(h) && !(c > a.responseEnd) && (k[b] = k[b] || {}, k[b][h] = k[b][h] || [], k[b][h].push([c, a.responseEnd]), k[b].all = k[b].all || [], k[b].all.push([c, a.responseEnd]), d[h] = d[h] || [], d[h].push([c, a.responseEnd]), d.all = d.all || [], d.all.push([c, a.responseEnd]), -1 < b.indexOf("ebay") ? (f[h] = f[h] || [], f[h].push([c, a.responseEnd]), f.all = f.all || [], f.all.push([c, a.responseEnd])) : (g[h] = g[h] || [], g[h].push([c, a.responseEnd]), g.all = g.all || [], g.all.push([c,
                                a.responseEnd
                            ])))
                        }
                    });
                ...
                this.init = function() {
                    ...
                    if ("undefined" != typeof a) {
                        ...
                        a.bRsTiming && "getEntriesByType" in c && (c.setResourceTimingBufferSize = c.setResourceTimingBufferSize || c.webkitSetResourceTimingBufferSize || c.mozSetResourceTimingBufferSize || c.msSetResourceTimingBufferSize ||
                            c.oSetResourceTimingBufferSize || c.webkitSetResourceTimingBufferSize, "function" === typeof c.setResourceTimingBufferSize && c.setResourceTimingBufferSize(300))
                    }
                };
                this.onLoad = function() {
                    ...
                    if ("undefined" != typeof a) {
                        ...
                        e = p();
                        c = f.beacon;
                        e && (c.add("ex3", b - e.navigationStart), c.add("jseaa", b - e.responseStart), c.add("jseap", e.responseStart -
                            e.navigationStart), c.add("ct1chnk", e.domComplete - e.responseStart), c.add("jsljgr3", e.domainLookupEnd - e.domainLookupStart), c.add("svo", e.connectEnd - e.connectStart), c.add("jsljgr1", e.responseStart - e.requestStart), c.add("slo", e.responseEnd - e.responseStart), e.secureConnectionStart && (b = e.connectEnd - e.secureConnectionStart, 0 < b && c.add("i_ssl", b)));
                        var d;
                        if (e && e.msFirstPaint) d = e.msFirstPaint - e.responseStart;
                        else if (window.chrome && window.chrome.loadTimes && (e = window.chrome.loadTimes())) d = e.firstPaintTime + "",
                            d = d.split(".")[0], d = parseInt(d, 10), ltsltsec = e.startLoadTime + "", ltsltsec = ltsltsec.split(".")[0], ltsltsec = parseInt(ltsltsec, 10), d -= ltsltsec, d *= 1E3;
                        0 < d && c.add("i_firstpaint", d);
                        d = 0;
                        a.deferExecInMs && (d = a.deferExecInMs);
                        c = j();
                        a.bRsTiming && "getEntriesByType" in c && (c.setResourceTimingBufferSize = c.setResourceTimingBufferSize || c.webkitSetResourceTimingBufferSize || c.mozSetResourceTimingBufferSize || c.msSetResourceTimingBufferSize || c.oSetResourceTimingBufferSize || c.webkitSetResourceTimingBufferSize, "function" ===
                            typeof c.setResourceTimingBufferSize && (a = c.getEntriesByType("resource").length, c.setResourceTimingBufferSize(0 < a - 1 ? a - 1 : 0)));
                        var g = this;
                        setTimeout(function() {
                            g.sendBeacon("onload", !1, "sendBeacon" in navigator)
                        }, d)
                    }
                };
                ...
                this.sendBeacon = function(a, c, e) {
                    ...
                    if ("undefined" != typeof b && 1 != b.sent) {
                        ...
                        if (c) {
                            ...
                            if ((a = f.errors) && a.getLength()) d.add("sgbld", a.getLength()),
                                d.add("emsg", a.getString());
                            ...
                            if (a = f.metrics) {
                                var a = a.getEntries(),
                                    j;
                                for (j in a) d += "&" + a[j].key + "=" + a[j].value
                            }
                            e ? navigator.sendBeacon(d) : (new Image).src = d;
                            b.sent = 1
                        } else if (b.ld) {
                            if (b.bf) d.add("ex1", "1");
                                ...
                                j = "jseo jsllib1 jsllib2 jsllib3 jslpg jslss jslsys".split(" ");
                                for (var c = b.aChunktimes.length, i = 0, k; i < c; i++)(k = j[i]) && d.add(k, b.aChunktimes[i])
                            }
                    ...
                    getUrl: function() {
                        for (var f in i.params)
                            if (Array.isArray(i.params[f])) {
                                var g =
                                    i.params[f].indexOf(void 0); - 1 < g && i.params[f].splice(g, 1)
                            } return i.getUrl()
                    }
                },
                errors: {
                    ...
                    getString: function() {
                        for (var f = [], g = 0, i = l.length; g < i; g++) {
                            var j = l[g];
                            f.push("js-err-line-" + j.lineNumber + "-msg-" + j.message + "-url-" + j.url)
                        }
                        return f.join("|")
                    }
                },
        ...
        window.addEventListener("unload", function() {
            if (!q) m.onBeforeunload()
        })
    }
});
$_mod.installed("site-speed-ebay$4.0.10", "raptor-util", "1.1.2");
...
$_mod.def("/site-speed-ebay$4.0.10/client/uri", function(k, d, l) {
    var g = "function" === typeof Symbol && "symbol" === typeof Symbol.iterator ? function(a) {
        ...
        m = (d = (d = d("http-equiv", "Content-Type") || d("httpEquiv", "Content-Type")) ? d.getAttribute("content") :
            null) && d.match(/utf/gi) ? encodeURI : window.escape,
        n = d && d.match(/utf/gi) ? decodeURI : window.unescape,
        i = d && d.match(/utf/gi) ? encodeURIComponent : window.escape,
        j = d && d.match(/utf/gi) ? decodeURIComponent : window.unescape,
        o = /(([^:]*):\/\/([^:/?]*)(:([0-9]+))?)?([^?#]*)([?]([^#]*))?(#(.*))?/,
        f = function(a) {
            this.params = {};
            a = a.match(o);
            null !== a && (this.protocol = this.match(a, 2), this.host = this.match(a, 3), this.port = this.match(a, 5), this.href = this.match(a, 6), this.query = this.match(a, 8), this.href.match(/eBayISAPI.dll/i) ? this.decodeIsapi(this.query) :
                this.decodeParams(this.query), this.href = n(this.href), this.hash = this.match(a, 10))
        };
    k("/raptor-util$1.1.2/raptor-util").extend(f.prototype, {
        match: function(a, c) {
        ...
        appendParam: function(a, c) {
            var b = this.params;
            b[a] ? "object" === g(b[a]) ? b[a].push(c) : b[a] = [b[a], c] : b[a] = c
        },
        appendParams: function(a) {
            for (var c in a) {
                var b = a[c];
                if ("object" !== ("undefined" === typeof b ?
                        "undefined" : g(b))) this.appendParam(c, b);
                else
        ...
        decodeParams: function(a) {
            for (var a = a ? a.split("&") : [], c = 0; c < a.length; c++) {
                var b = a[c].split("="),
                    e = j(b[0]),
                    b = 1 < b.length ? j(b[1].replace(/\+/g, "%20")) : "";
                e && this.appendParam(e, b)
            }
        },
        encodeParam: function(a, c) {
            var b = i(a);
            return c ? b.concat("=", i(c)) : b
        },
        encodeParams: function(a) {
            ...
            for (b in a)
                if (a.hasOwnProperty(b))
                    if ("object" !== g(a[b])) c.push(this.encodeParam(b, a[b]));
                    else
                        for (var e =
                                a[b], e = "undefined" !== typeof e ? e.length : 0, d = 0; d < e; d++) a[b][d] && c.push(this.encodeParam(b, a[b][d]));
            return c.join("&")
        },
        ...
        getUrl: function() {
            ...
            this.href && (a = a.concat(m(this.href)));
...
$_mod.def("/site-speed-ebay$4.0.10/client/metrics", function(d, g, e) {
...
$_mod.def("/site-speed-ebay$4.0.10/client/sitespeed", function(a) {
    window.$ssg = function(b) {
        var c = a("/site-speed-ebay$4.0.10/client/metrics")(),
            d = a("/site-speed-ebay$4.0.10/client/uri"),
            e = a("/cookies-browser$0.0.2/index");
        return a("/core-site-speed-ebay$1.0.7/SiteSpeed")(b, d, e, c)
    }
});
$_mod.run("/site-speed-ebay$4.0.10/client/sitespeed");
