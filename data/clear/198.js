...
BigInteger.parse = function(a, b) {
    ...
    if (d) {
        ...
        var g = d[2] || "",
            d = d[3] ||
            "";
        if ("undefined" === typeof b) "0" === g ? 0 === d.length ? (b = 10, d = "0") : b = 8 : b = "0x" === g || "0X" === g ? 16 : "0b" === g || "0B" === g ? 2 : 10;
...
BigInteger.prototype.subtract = function(a) {
    ...
    var b = this;
    if (0 > this._s) var e = b,
        b = new BigInteger(a._d, 1),
        a = new BigInteger(e._d, 1);
...
BigInteger.prototype.divRemSmall = function(a) {
    ...
    if (1 === this._d.length) {
        var e = BigInteger.small[this._d[0] / a | 0],
    ...
    for (var d = this._d.slice(), e = Array(d.length),
            g = 0, f = 0, j = 0; d.length;)
        if (g = 10 * g + d[d.length - 1], g < a) e[j++] = 0, d.pop(), f = 10 * f + g;
        else {
            var c = 0 === g ? 0 : g / a | 0,
                f = g - a * c;
...
function PlsUBTURLTemplate(a, b, e) {
    var d = "";
    if (null != a.serverUrl) d = a.serverUrl;
    else {
