var DFP = function(e) {
    ...
    b.prototype.getHTML5Tag = function(a) {
        var c =
            null,
            d;
        for (d in this.HTML5_GET_METHOD_LIST)
            if (this.HTML5_GET_METHOD_LIST.hasOwnProperty(d) && (c = this.HTML5_GET_METHOD_LIST[d](a), !DFP.isNullOrEmpty(c))) {
                this.storageMediaPresent[d] = 1;
                break
            } return c
    };
    b.prototype.setHTML5Tag = function(a, c) {
        for (var d in this.HTML5_SET_METHOD_MAP)
            if (this.HTML5_SET_METHOD_MAP.hasOwnProperty(d) && 1 !== this.storageMediaPresent[d]) this.HTML5_SET_METHOD_MAP[d](b.HTML5_TAG_KEY, c)
    };
    ...
    b.prototype.setTagToDBStorage = function(a, c) {
        try {
            window.openDatabase && window.openDatabase("ebay", "1.0", "ebay database storage", 1048576).transaction(function(d) {
                d.executeSql("CREATE TABLE IF NOT EXISTS kg (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, key TEXT NOT NULL, value TEXT NOT NULL, UNIQUE (key))", [], function() {}, function() {});
                d.executeSql("INSERT OR REPLACE INTO kg(key, value) VALUES(?, ?)", [a, c], function() {}, function() {})
            })
        } catch (d) {}
    };
    ...
    b.prototype.getTag = function() {
        var a = this.getHTML5Tag(b.HTML5_TAG_KEY),
            c = {};
    ...
    DFP.isInValidCharSet = function(a) {
        for (var c = 0; c < a.length; c++) {
            ...
            if (!(65 <= b && 91 > b || 97 <= b && 123 > b || 48 <= b && 58 > b))
                if (b = a.charAt(c), !("+" == b || "*" == b || "/" == b || "=" == b)) return !0
        }
        return !1
    };
    return this
...
window.addEventListener("load", function() {
    setTimeout(function() {
        var e = new DFP(globalDfpContext),
            f = 10;
        dfpsvcAjaxCall = window.rInterval(function() {
            f--;
            var b = e.getFingerPrintDetails(),
                b = b && b.tagInfo;
