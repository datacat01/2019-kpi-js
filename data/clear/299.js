define("@ta/overlays.toast", ["@ta/common.error-handling", "@ta/overlays.pieces", "@ta/styleguide.icon", "@ta/common.global"], function(e, t, n, o) {
    return function(e) {
        var t = {};
        ...
        }, n.p = "", n(n.s = "./packages/overlays/toast/toast.jsx")
    }({
        ...
        "./node_modules/fbjs/lib/invariant.js": function(e, t, n) {
            "use strict";
            e.exports = function o(e, t, n, r, s, i, a, u) {
                if (!e) {
                    var l;
        ...
        "./node_modules/react-transition-group/CSSTransition.js": function(e, t, n) {
            ...
            var o = Object.assign || function(e) {
                ...
                u = p(n("./node_modules/react/index.js")),
                l = p(n("./node_modules/react-transition-group/Transition.js")),
            ...
            var f = function e(t, n) {
                ...
                h = (o({}, l.default.propTypes, {
                    ...
                    return function n(e, t) {
                        ...
                        var t = o({}, this.props);
                        return delete t.classNames, u.default.createElement(l.default, o({}, t, {
        ...
        "./node_modules/react-transition-group/ReplaceTransition.js": function(e, t, n) {
            ...
            var l = function(e) {
                    function t() {
                        ...
                        for (var s = arguments.length, i = Array(s), a = 0; a < s; a++) i[a] = arguments[a];
                        return n = o = u(this, e.call.apply(e, [this].concat(i))), c.call(o), u(o, n)
                    }
                    return function n(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                        e.prototype = Object.create(t && t.prototype, {
                        ...
                        var i, a = this.props.children,
                            u = r.default.Children.toArray(a)[n];
                        u.props[t] && (i = u.props)[t].apply(i, o), this.props[t] && this.props[t]((0, s.findDOMNode)(this))
                    }, t.prototype.render = function e() {
                        var t = this.props,
                            n = t.children,
                            o = t.in,
                            ...
                            u = r.default.Children.toArray(n),
                            l = u[0],
                            c = u[1];
                        return delete s.onEnter, delete s.onEntering, delete s.onEntered, delete s.onExit, delete s.onExiting, delete s.onExited, r.default.createElement(i.default, s, o ? r.default.cloneElement(l, {
                            key: "first",
                ...
                f = function(e) {
                    function t(n, o) {
                        ...
                        var s = function i(e, t) {
                            ...
                            f = void 0;
                        return s.nextStatus = null, n.in ? d ? (f = l, s.nextStatus = c) : f = p : f = n.unmountOnExit || n.mountOnEnter ? u : l, s.state = {
                            status: f
                    ...
                    return function n(e, t) {
                        ...
                        Object.keys(i).forEach(function(e) {
                            ...
                            if ((0, s.isValidElement)(a)) {
                                ...
                                !l || u && !p ? l || !u || p ? l && u && (0, s.isValidElement)(c) && (i[e] = (0, s.cloneElement)(a, {
        ...
        "./packages/overlays/toast/toast.jsx": function(e, t, n) {
            "use strict";
            n.r(t);
            var o = n("./node_modules/@babel/runtime/helpers/esm/classCallCheck.js"),
                ...
                d = n("./node_modules/react-transition-group/index.js"),
                f = n("@ta/common.error-handling"),
                m = n("./packages/common/state/state.jsx"),
                h = n("@ta/overlays.pieces"),
                y = n("@ta/styleguide.icon"),
                b = function e(t) {
                    var n = t.toast;
                    return c.createElement("div", {
                        className: "overlays-toast-ToastItem__toast_wrap--1rDju"
                    }, c.createElement("div", {
                        className: "overlays-toast-ToastItem__toast--ObFmm"
                    }, c.createElement("div", {
                        className: "overlays-toast-ToastItem__toast_text--1Mk2G"
                    }, n.iconName && c.createElement("div", {
                        className: "overlays-toast-ToastItem__toast_icon--3Dgfn"
                    }, c.createElement(y.Icon, {
                        name: n.iconName
                    })), c.createElement("div", {
                        className: "overlays-toast-ToastItem__node_wrap--3nvQo"
                    }, n.node)), n.actionText && n.actionCallback && c.createElement("div", {
                        onClick: n.actionCallback,
                        className: "overlays-toast-ToastItem__toast_action--3ZOL2"
                    }, n.actionText)))
                },
                E = 4e3,
                v = function(e) {
                    function t(e) {
                        var n;
                        return Object(o.a)(this, t), n = Object(s.a)(this, Object(i.a)(t).call(this, e)), Object(l.a)(Object(u.a)(Object(u.a)(n)), "removalTimeouts", []), Object(l.a)(Object(u.a)(Object(u.a)(n)), "clearTimeouts", function() {
                            n.removalTimeouts.forEach(function(e) {
                                return clearTimeout(e)
                            }), n.removalTimeouts = []
                        }), Object(l.a)(Object(u.a)(Object(u.a)(n)), "launchToast", function(e, t) {
                            var o = "toast_".concat(Math.random().toString(36).replace(/[^a-z]+/g, "")),
                                r = e.actionCallback;
                            if (e.closeOnAction && r) {
                                var s = r;
                                r = function e(t) {
                                    n.removeToast(o), s(t)
                                }
                            ...
                            n.clearTimeouts(), n.setState({
                                toasts: [{
                                    toast: i,
                                    wrapper: t
                                }]
                            }), n.removalTimeouts.push(setTimeout(function() {
                                n.removeToast(o)
                            }, i.timeout || E)), Object(m.getStore)().dispatch(m.actions.overlays.launchExclusiveToast(o))
                        }), Object(l.a)(Object(u.a)(Object(u.a)(n)), "removeToast", function(e) {
                            n.setState({
                                toasts: n.state.toasts.filter(function(t) {
                                    return t.toast.id !== e
                                })
                            }), Object(m.getStore)().dispatch(m.actions.overlays.removeToast(e))
                        }), n.state = {
                            toasts: []
                        }, n
                    }
                    return Object(a.a)(t, e), Object(r.a)(t, [{
                        ...
                        value: function e() {
                            var t = this;
                            return c.createElement(c.Fragment, null, this.props.children(this.launchToast.bind(this)), c.createElement(f.ErrorBoundary, null, c.createElement(d.TransitionGroup, {
                                component: null,
                                enter: !0,
                                exit: !0
                            }, this.state.toasts.filter(function(e) {
                                return t.props.toasts.includes(e.toast.id)
                            }).map(function(e) {
                                var t = e.toast,
                                    n = e.wrapper;
                                return c.createElement(d.CSSTransition, {
                                    timeout: 300,
                                    key: t.id,
                                    classNames: {
                                        enter: "overlays-toast-Toaster__fadeInEnter--3Lm2-",
                                        enterActive: "overlays-toast-Toaster__fadeInEnterActive--3Gfp0",
                                        enterDone: "overlays-toast-Toaster__fadeInEnterDone--1sv4e",
                                        exit: "overlays-toast-Toaster__fadeOutExit--3iK4m",
                                        exitActive: "overlays-toast-Toaster__fadeOutExitActive--K5YMm",
                                        exitDone: "overlays-toast-Toaster__fadeOutExitDone--3TRsj"
                                    }
                                }, c.createElement(h.Overlay, {
                                    perspective: "300px",
                                    position: {
                                        position: "fixed",
                                        bottom: "0",
...
//# sourceMappingURL=overlays.toast.41ab2553e1.js.map