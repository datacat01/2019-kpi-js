...
var processJsonData = {
                    ...
                    if (serviceItem.length > 0) {
                        ...
                        for (var j = 0; j < serviceItem.length - 1; j++) {
                            ...
                            if (serviceItem[j] !== "0") {
                                ...
                                panelTextToPass += "<a href=\"javascript:confirmRedirect('external','" + serviceItemParts[3] + "');\" class=\"btn btn-default btn-block-xs\" aria-label=\"Launch the " + serviceItemParts[2] + " service. \"><span class=\"ca-gov-icon-computer\"></span> Launch Service</a>";
        ...
        function loadResults() {
            ...
            if (loadFlag === false) {
                ...
                if (loadCount < 1000) {
                    ...
                    textToDisplay += "<p class=\"lead\"><a href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\">";
                    ...
                    textToDisplay += "<a href=\"javascript:confirmRedirect('external','" + dataToProcess[0].ServiceUrl + "');\" class=\"btn btn-primary btn-block-xs\"><span class=\"ca-gov-icon-computer\"></span>";
                    textToDisplay += " &nbsp; <span>Launch Service</span>";
                    textToDisplay += "</a>&nbsp;";

                    textToDisplay += "<a href=\"javascript:confirmRedirect('external','" + dataToProcess[0].ContactUrl + "');\"  class=\"btn btn-primary btn-block-xs\">";
                    ...
                    if (arrayLength > 1) {
                        for (var i = 0; i < arrayLength; i++) {
                            if (!(this.apiData[i].ServiceName === currentService)) {
                                ...
                                texttopass += "<a href=\"" + serviceLandingPage + "?item=" + serviceNameToPass + "\" class=\"btn btn-default btn-xs\">" + this.apiData[i].ServiceName + "</a>";
                            }
                        }
                    }
                    ...
                    if (arrayLength > 1) {
                        for (var i = 0; i < arrayLength; i++) {
                            ...
                            if (isCurrentServiceFlag === true) {
                                ...
                                textToDisplay += "<a href=\"javascript:centerIt(" + dataToProcess.QueryResults[i].Id + "," + lngValue + "," + latValue + ");\" style=\"text-decoration: none;\"><div style=\"padding: 5px; margin:0px; background-color: #FFFFFF; border-bottom: 1px solid #E9E9E9;font-size:0.8em;\" onMouseOver=\"this.style.backgroundColor = '#F3F3F3'\" onMouseOut=\"this.style.backgroundColor = '#FFFFFF'\">" + dataToProcess.QueryResults[i].LocationName + "</div></a>";
                            }
                        }
    ...
    showServiceMap: function (idOfTextDivFill, idOfMapDivFill, containingSection, searchvalue, lang) {
        var data = JSON.stringify([
            searchvalue
        ]);

        if (lang === "") { lang = "en"; }
        var builtApiUrl = apiLocation + "GetLocationsByServiceIds?lang=" + lang;
        var loadFlag = false;
        var loadCount = 0;
        function loadResults() {
            if (loadCount === 0) {
            ...
            if (loadFlag === false) {
                ...
                if (loadCount < 500) {
                    ...
                    if (arrayLength > 1) {
                        for (var i = 0; i < arrayLength; i++) {
                            var latlng = dataToProcess[i].PointLocation.Geography.WellKnownText;
                            latlng = latlng.replace("POINT (", "");
                            latlng = latlng.replace(")", "");
                            var latlngArray = latlng.split(" ");
                            var latValue = latlngArray[0];
                            ...
                            mapDataToDisplay += "^" + latValue;
                            mapDataToDisplay += "|" + lngValue;
                            mapDataToDisplay += "|" + dataToProcess[i].LocationName;
                            mapDataToDisplay += "|" + dataToProcess[i].Id;
                            mapDataToDisplay += "|" + dataToProcess[i].StreetAddress;
                            mapDataToDisplay += "|" + dataToProcess[i].City;
                            mapDataToDisplay += "|" + dataToProcess[i].State;
                            mapDataToDisplay += "|" + dataToProcess[i].ZipCode;
                            textToDisplay += "<a href=\"javascript:centerIt(" + dataToProcess[i].Id + "," + lngValue + "," + latValue + ");\" style=\"text-decoration: none;\"><div style=\"padding: 5px; margin:0px; background-color: #FFFFFF; border-bottom: 1px solid #E9E9E9;font-size:0.8em;\" onMouseOver=\"this.style.backgroundColor = '#F3F3F3'\" onMouseOut=\"this.style.backgroundColor = '#FFFFFF'\">" + dataToProcess[i].LocationName + "</div></a>";
                        }
    ...
    */
        ...
        function loadResults() {
            ...
            if (loadFlag === false) {
                ...
                if (loadCount < 50) {
                    ...
                    var textToDisplay = "";
                    if (arrayLength > 1) {
                        textToDisplay += "<div class=\"panel-group\" id=\"faq-accordion\" role=\"tablist\" aria-multiselectable=\"true\">";

                        for (var i = 0; i < arrayLength; i++) {
                            textToDisplay += "<div class=\"panel panel-default\">";
                            textToDisplay += "  <div class=\"panel-heading\" role=\"tab\" id=\"faq-" + i + "\">";
                            textToDisplay += "    <h4 class=\"panel-title\">";
                            textToDisplay += "<a class=\"collapsed\" role=\"button\" data-toggle=\"collapse\" data-parent=\"#faq-accordion\" href=\"#collapse-" + i + "\" aria-expanded=\"false\" aria-controls=\"collapse-" + i + "\">";
    ...
    buildServiceCard: function(serviceId, serviceImage, serviceAgencyFriendlyName, serviceAgencyAcronym, serviceName, serviceUrl, serviceDescription, serviceContactPhone, lang, serviceLandingPage, agencyLandingPage) {
        ...
        cardToBuild += "\" alt=\"\" class=\"img-responsive\">";
        cardToBuild += "</div>";
        ...
        cardToBuild += "<span id=\"toggle-" + serviceId + "-" + serviceAgencyAcronym + "\" style=\"color: #666666; font-size: 24px;\" class=\"ca-gov-icon-plus-fill\"></span><span class=\"sr-only\">Open</span>";
        cardToBuild += "</a>";
        cardToBuild += "</div>";
        cardToBuild += "</div>";
        cardToBuild += "</div>";
        ...
        function loadResults() {
            ...
            if (loadFlag === false) {
                ...
                if (loadCount < 1000) {
                    ...
                    textToDisplay += "<a href=\"javascript:confirmRedirect('external','" + this.apiData[r].WebsiteURL + "');\" class=\"btn btn-default\"><span class=\"ca-gov-icon-computer\"></span> &nbsp;<span> Website</span></a>";
                    textToDisplay += "<a href=\"javascript:confirmRedirect('external','" + this.apiData[r].ContactURL + "');\"  class=\"btn btn-default\"><span class=\"ca-gov-icon-contact-us\"></span> &nbsp;<span> Contact</span></a>";
                    textToDisplay += "</div>";
                    textToDisplay +=
                    ...
                    if (this.apiData[r].TwitterAccount) {
                        ...
                        textToDisplay += "<a href=\"javascript:confirmRedirect('external','https://twitter.com/" +
                            twitterItem + "');\"><span class=\"ca-gov-icon-twitter\" aria-hidden=\"true\"><span class=\"sr-only\">Twitter</span></span></a>";
                        textToDisplay += "</li>";
                    }
                    if (this.apiData[r].Facebook) {
                        ...
                        textToDisplay += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
                        textToDisplay += "<a href=\"javascript:confirmRedirect('external','https://www.facebook.com/" +
                            facebookItem + "');\"><span class=\"ca-gov-icon-facebook\" aria-hidden=\"true\"><span class=\"sr-only\">Facebook</span></span></a>";
                        textToDisplay += "</li>";
                    }
                    if (this.apiData[r].YouTube) {
                        ...
                        textToDisplay += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
                        textToDisplay += "<a href=\"javascript:confirmRedirect('external','https://www.youtube.com/" +
                            youTubeItem + "');\"><span class=\"ca-gov-icon-youtube\" aria-hidden=\"true\"><span class=\"sr-only\">YouTube</span></span></a>";
                        textToDisplay += "</li>";
                    }
                    textToDisplay += "</ul>";
                    textToDisplay += "</div>";
                ...
                if (loadCount < 50) {
                    ...
                    if (arrayLength > 0) {
                        ...
                        for (var i = 0; i < arrayLength; i++) {
                            ...
                            textToDisplayTiles += "<div class=\"teaser\">";
                            textToDisplayTiles += "<h4 class=\"title\">" + this.apiData[i].ServiceName + "</h4>";
                            textToDisplayTiles += "</div>";
                            ...
                            panelTextToPass += "<p class=\"lead\"><a href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\">" + this.apiData[i].FriendlyName + "</a></p>";
                            panelTextToPass += "<p>" + holderDescription + "</p><br>";
                            panelTextToPass += "<div class=\"btn-row m-b\">";
                            panelTextToPass += "<a href=\"javascript:confirmRedirect('external','" +
                                this.apiData[i].ServiceUrl + "');\" class=\"btn btn-default btn-block-xs\"><span class=\"ca-gov-icon-computer\"></span> Launch Service</a>";
                            panelTextToPass += "<a href=\"" + serviceLandingPage + "?item=" + serviceNameToPass + "\" class=\"btn btn-default btn-block-xs\"><span class=\"ca-gov-icon-info\"></span> See Details</a>";
                            panelTextToPass += "                            </div>";
                            panelTextToPass += "<div class=\"location\" itemscope itemtype=\"http://schema.org/Organization\">";
                            ...
                            panelTextToPass += "\" class=\"img-responsive m-t-md\" alt=\"Selected Logo for " + this.apiData[i].FriendlyName + "\">";
                            panelTextToPass += "</div>";
                            panelTextToPass += "</div>";
                            panelTextToPass += "</div>";
                            panelTextToPass += "</div>";
    ...
    buildAgencyCard: function(agencyId, agencyLogo, agencyFriendlyName, agencyName, agencyAcronym, agencyUrl, agencyDescription, agencyContactPhone, agencyHearingImpairedPhone, agencyFaxNumber, PhoneHours, agencyContactUrl, agencyTwitterAccount, agencyFacebook, agencyYouTube, agencyContactEmail, agencyLiveChat, lang, agencyLandingPage) {
        ...
        cardToBuild += "<div class=\"card card-default\">";
        cardToBuild += "<div class=\"card-body\">";
        cardToBuild += "<div class=\"card-block card-body\" id=\"collapse-" + agencyId + "-" + agencyAcronym + "\" itemscope itemtype=\"http://schema.org/Organization\">";
        cardToBuild += "<div class=\"row\">";
        cardToBuild += "<div class=\"col-lg-3\">";
        ...
        cardToBuild += "<div class=\"collapse collapse-" + agencyId + "-" + agencyAcronym + "\">";
        cardToBuild += "<a aria-label=\"View Contact page for " + agencyFriendlyName + "\" href=\"javascript:confirmRedirect('external','" + agencyContactUrl + "');\" class=\"btn btn-secondary btn-block btn-sm\">Contact Agency</a>";
        if (agencyLiveChat) {
            cardToBuild += "<a aria-label=\"Live Chat Information for " + agencyFriendlyName + " \" href=\"javascript:confirmRedirect('external','" + agencyLiveChat + "');\" class=\"btn btn-secondary btn-block btn-sm\">Live Chat</a>";
        }
        ...
        if (agencyTwitterAccount) {
            ...
            cardToBuild += "<a aria-label=\"Twitter Information  for " + agencyFriendlyName + "\" href=\"javascript:confirmRedirect('external','https://twitter.com/" + thisitem1 + "');\"><span class=\"ca-gov-icon-twitter\" aria-hidden=\"true\"><span class=\"sr-only\">Twitter</span></span></a>";
            cardToBuild += "</li>";
        }
        if (agencyFacebook) {
            ...
            cardToBuild += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
            cardToBuild += "<a aria-label=\"Facebook Information for " + agencyFriendlyName + "\" href=\"javascript:confirmRedirect('external','https://www.facebook.com/" + thisitem2 + "');\"><span class=\"ca-gov-icon-facebook\" aria-hidden=\"true\"><span class=\"sr-only\">Facebook</span></span></a>";
            cardToBuild += "</li>";
        }
        if (agencyYouTube) {
            ...
            cardToBuild += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
            cardToBuild += "<a aria-label=\"YouTube Information for " + agencyFriendlyName + " \" href=\"javascript:confirmRedirect('external','https://www.youtube.com/" + thisitem3 + "');\"><span class=\"ca-gov-icon-youtube\" aria-hidden=\"true\"><span class=\"sr-only\">YouTube</span></span></a>";
            cardToBuild += "</li>";
        }
