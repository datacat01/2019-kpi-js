...
if ("" !== args.caweb_multi_ga) {
    _gaq.push(["b._setAccount", args.caweb_multi_ga]);
    _gaq.push(["b._setDomainName", ".ca.gov"]);
    _gaq.push(["b._trackPageview"])
}(function() {
...
(function() {
    ...
    function d() {
        var e = $("#head-search");
        var f = e.find(".gsc-input");
        var j = $(".search-results-container");
        var g = $("body");
        if (4 == args.ca_site_version) {
            f.attr("placeholder", "Search")
        }
        ...
        f.blur(function() {
            e.removeClass("search-freeze-width")
        });
        $("div.gsc-clear-button").on("click", function() {
            h()
        });
        $(".top-level-nav .nav-item .ca-gov-icon-search, #nav-item-search").parents(".nav-item").on("click", function(k) {
            f.focus().trigger("focus");
    ...
    if ("" !== args.ca_google_search_id) {
        var a = args.ca_google_search_id;
