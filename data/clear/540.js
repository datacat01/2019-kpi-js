! function() {
    ...
    ! function(h) {
        ...
        function u(e, t) {
            var n, r, i, o, a, u, s, c, f, l, h, p = t && t.split("/"),
                d = m.map,
                v = d && d["*"] || {};
            if (e && "." === e.charAt(0))
                if (t) {
                    for (p = p.slice(0, p.length - 1), a = (e = e.split("/")).length - 1, m.nodeIdCompat && y.test(e[a]) && (e[a] = e[a].replace(y, "")), e = p.concat(e), f = 0; f < e.length; f += 1)
        ...
        p = function(e, t) {
            var n, r, i = s(e),
                o = i[0];
            return e = i[1], o && (n = k(o = u(o, t))), o ? e = n && n.normalize ? n.normalize(e, (r = t, function(e) {
                return u(e, r)
            })) : u(e, t) : (o = (i = s(e = u(e, t)))[0], e = i[1], o && (n = k(o))), {
                f: o ? o + "!" + e : e,
                n: e,
                pr: o,
                p: n
            ...
            if (r = r || e, "undefined" === l || "function" === l) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, s = 0; s < t.length; s += 1) "require" === (o = (u = p(t[s], r)).f) ? f[s] = d.require(e) : "exports" === o ? (f[s] = d.exports(e), c = !0) : "module" === o ? i = f[s] = d.module(e) : b(v, o) || b(_, o) || b(g, o) ? f[s] = k(o) : u.p ? (u.p.load(u.n, T(r, !0), E(o), {}), f[s] = v[o]) : w(e + " missing " + o, "almond");
                a = n ? n.apply(v[e], f) : void 0, e && (i && i.exports !== h && i.exports !== v[e] ? v[e] = i.exports : a === h && c || (v[e] = a))
            } else e && (v[e] = n)
    ...
    function(n, r) {
        "use strict";
        if (r.jstmpl) return;
        var i, a, u, o, e, t, s, c, f, l, h, p, d, v, _, m, g, y, w, b, T, E, k, x, B = [];
        o = function(e, t) {
            ...
            if ("" === e) return null;
            return x("Attempting to use non-numeric value '" + e + "' for translation tag '" + n + "'"), 0
        }, x = function(e, t) {
        ...
        }, p = new Array(42), h = function(e, t, n) {
            var r = 0;
            for (t.length;;) {
                var i = t.indexOf("{", r);
                if (-1 === i) {
            ...
            if (0 < n) {
                ...
                if (t === p[n - 1]) return console.warn("Detected self-referential tag '%s', returning '%s'", value, value), void e.push(t)
            }
            p[n] = t;
            for (var r = 0, i = a.length; r < i; ++r)
                if (t in a[r]) {
                    var o = a[r][t];
                    return void("string" == typeof o && -1 !== o.indexOf("{") ? h(e, o, n + 1) : e.push(o))
                } if (u && t in u) return void("string" == typeof(o = u[t]) && -1 !== o.indexOf("{") ? h(e, o, n + 1) : e.push(o));
            e.push("")
        }, T = function(e) {
            ...
            fn: {
                ...
                STATIC_HOSTNAME: function(e, t, n, r) {
                    x("to use TMPL_STATIC_URL/TMPL_SCRIPT_URL, pass 'get_static_hostname' to setup()")
                },
                ...
                MO: s,
                VP: function(e, t) {
                    x("to use TMPL_VAR, with N attribute, pass 'get_var_plural' to setup()")
                },
                SV: function(e) {
                    return a = e
                },
                seq: function(e, t, n) {
                    ...
                    if (e = e || 0, t = t || 0, n = Math.abs(n || 1), "string" != typeof e || isNaN(e) || (e = Number(e)), "string" != typeof t || isNaN(t) || (t = Number(t)), /^[A-Za-z]$/.exec(e) || /^[A-Za-z]$/.exec(t))
                        if ((1 !== e.length || 1 !== t.length || /[a-z]/.exec(e) && !/[a-z]/.exec(t) || /[A-Z]/.exec(e) && !/[A-Z]/.exec(t)) && x("Invalid range '" + e + "'-'" + t + "' in seq()"), (e = e.charCodeAt(0)) <= (t = t.charCodeAt(0)))
                            for (; e <= t;) r.push({
    ...
    function(i) {
        ...
        var o, r = i.jstmpl,
            ...
            p = function(e, t, n, r, i) {
                ...
                if (o = d(a[0], a[1], a[2]), i && (o = v(a, r) || o), o) {
                    ...
                    for (u = 0, s = f.length; u < s; ++u) {
                        var l, h = f[u];
                        l = -1 === h.indexOf("/") ? t(h.substr(1, h.length - 2)) : p(h.substr(1, h.length - 2), t, n, r, i), o = o.split(h).join(l)
                    }
                }
                return o || ""
            },
            d = function(e, t, n) {
                if ("private" === e) {
                    var r = (o && o.private || {})[t];
                    return r && "string" != typeof r && r.experiment_hash && r.value && (i.et && i.et.stage(r.experiment_hash, 1), r = r.value), r
                }
    ...
    function(t) {
        "use strict";
        if (!t.jstmpl) return;
        var n, r, i, o, a, u, e, s, c, f, l, h, p, d, v, _, m, g, y, w, b, T, E, k = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
                '"': "&quot;",
    ...
    function(s) {
        ...
        c = function(e) {
            ...
            if (s && s.env && s.env.static_hostnames && s.env.static_hostnames.length)
                ...
                } else i = s.env.static_hostnames[0];
            ...
            if (!d && void 0 !== typeof XMLSerializer) {
                ...
                d = "";
                for (var _ = u.childNodes, m = 0; m < _.length; m++) d += v.serializeToString(_[m])
            }
            return "<svg " + p + ">" + d + "</svg>"
        }, f = function(e, t, n, r) {
            try {
    ...
    function(e, n) {
    ...
    }), B.define("formatting/date", function(e, r, t) {
        ...
        h[0] = h[7], r.format = function(e, t) {
            ...
            t = t || "short_date", e = r.breakdown(n);
            try {
                return r.format(e, t)
            } catch (e) {
                return !1
        ...
        r.locale_format = function(e) {
            var t = "object" == typeof e ? e.date : e,
                n = e.time,
                o = e.date_until,
                r = e.time_until;
            if (!t) throw new Error("formatting/date: no date provided");
            if (!(t = t.replace(d, function(e, t) {
                    return t
                })).match(d)) throw new Error("formatting/date: invalid date provided — " + t);
            if (o && !(o = o.replace(d, function(e, t) {
                    return t
                })).match(d)) throw new Error("formatting/date: invalid date_until provided — " + o);
            ...
            return [a].concat(o ? [u] : []).forEach(function(n, r) {
                var e = (r ? o : t).split(/-0*/),
                    i = {
                        ...
                        weekday: h[new Date(Date.UTC(+e[0], +e[1] - 1, +e[2], 0, 0, 0, 0)).getUTCDay()]
                    };
            ...
            return r.format(r.breakdown(e), "{full_year}-{zero_padded_month}-{zero_padded_day_of_month} {time}")
        }
        ...
        (function() {
            ...
            a.prototype.addListener = function(e, t, n) {
                ...
                return r.strict && h(this, "addListener", e), (r.events[e] || (r.events[e] = [])).push(n ? {
                    fn: t,
                    context: n
                } : t), this
                ...
                t.strict && h(this, "emit", e), t.debug && this.tick(), void 0 !== window.booking_extra && B && B.env && B.env.b_log_last_custom_event && (window.booking_extra.custom_events_triggered = e);
                var n = t.events[e];
                if (!n) return this;
                n = l.call(n, 0);
        ...
        function n(e) {
            ...
            var n, r, i, o, a, u, s, c, f = {
                ...
                l = p.all(t.resolved).then(function(e) {
