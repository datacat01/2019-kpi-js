...
var Sentry = function(t) {
    ...
    function $(t, e, n) {
        if (void 0 === e && (e = 1 / 0), void 0 === n && (n = new j), 0 === e) return M(t);
        var r = H(t);
        if (m(r)) return r;
    ...
    var V = function() {
        ...
        return t.prototype.addScopeListener = function(t) {
            ...
            return B(n, e, {
                scopeListeners: []
            }), e && (n.extra = B(e.extra), n.tags = B(e.tags), n.breadcrumbs = l(e.breadcrumbs), n.eventProcessors = l(e.eventProcessors)), n
        ...
        ut = function() {
            ...
            return t.prototype.toString = function(t) {
                ...
                var n = c(e.slice(1), 6),
                    ...
                    f = n[5],
                    h = f.split("/");
                h.length > 1 && (p = h.slice(0, -1).join("/"), f = h.pop()), B(this, {
                    host: a,
                    pass: s,
                    path: p,
                    projectId: f,
    ...
    function Pt(t, e, n, r, o, i) {
        return Dt((s = Dt(Dt(e, t), Dt(r, i))) << (a = o) | s >>> 32 - a, n);
        var s, a
    }

    function Nt(t, e, n, r, o, i, s) {
        return Pt(e & n | ~e & r, t, e, o, i, s)
    }

    function Ut(t, e, n, r, o, i, s) {
        return Pt(e & r | n & ~r, t, e, o, i, s)
    }

    function Lt(t, e, n, r, o, i, s) {
        return Pt(e ^ n ^ r, t, e, o, i, s)
    }

    function Mt(t, e, n, r, o, i, s) {
        return Pt(n ^ (e | ~r), t, e, o, i, s)
    }
    ...
    function Vt(t, e) {
        return function(t, e) {
            ...
            return r = At(i.concat(Ht(e)), 512 + 8 * e.length), Bt(At(s.concat(r), 640))
        }(Wt(t), Wt(e))
    }

    function zt(t, e, n) {
        return e ? n ? Vt(e, t) : $t(Vt(e, t)) : n ? qt(t) : $t(qt(t))
    }
    var Yt = _(),
        Gt = {
            wrap: function() {
    ...
    Gt.wrap = function(t) {
        ...
        function c(e, n, r, o, s) {
            var c = null;
            if (s = f(s) ? s.error : s, e = f(e) ? e.message : e, a) Gt.computeStackTrace.augmentStackTraceWithInitialElement(a, n, r, e), h();
            else if (s && p(s))(c = Gt.computeStackTrace(s)).mechanism = "onerror", u(c, !0, s);
            else {
                var l, d = {
                        url: n,
                        line: r,
                ...
                d.func = Gt.computeStackTrace.guessFunctionName(d.url, d.line), d.context = Gt.computeStackTrace.gatherContext(d.url, d.line), u(c = {
                    name: l,
                    message: v,
                    mode: "onerror",
                    mechanism: "onerror",
        ...
        return d.subscribe = function(t) {
            ...
            0 === o.length && (e && (Yt.onerror = t, e = !1), r && (Yt.onunhandledrejection = n, r = !1))
        }, d.installGlobalHandler = function() {
            !0 !== e && (t = Yt.onerror, Yt.onerror = c, e = !0)
        }, d.installGlobalUnhandledRejectionHandler = function() {
            !0 !== r && (n = Yt.onunhandledrejection, Yt.onunhandledrejection = l, r = !0)
        }, d
    }(), Gt.computeStackTrace = function() {
        var t = !1,
            e = {};
        ...
        function n(t) {
            ...
            if (!Zt(e, t)) {
                var n = "",
                    r = "";
                try {
                    r = Yt.document.domain
                } catch (t) {}
                var o = /(.*)\:\/\/([^:\/]+)([:\d]*)\/{0,1}([\s\S]*)/.exec(t);
                o && o[2] === r && (n = function(t) {
                    if (!Gt.remoteFetching) return "";
                    try {
                        var e = function() {
                            try {
                                return new Yt.XMLHttpRequest
                            } catch (t) {
                                return new Yt.ActiveXObject("Microsoft.XMLHTTP")
                            }
                        }();
        ...
        function o(t, e) {
            ...
            var o = [],
                i = Math.floor(Gt.linesOfContext / 2),
                s = i + Gt.linesOfContext % 2,
                a = Math.max(0, e - i - 1),
        ...
        function c(t) {
            if (!d(Yt && Yt.document)) {
                for (var e, n, r, o, u = [Qt()], c = Yt.document.getElementsByTagName("script"), l = "" + t, p = 0; p < c.length; ++p) {
                    var f = c[p];
                    f.src && u.push(f.src)
                }
        ...
        function l(t) {
            ...
            for (var e, n, i, s = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[a-z]:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, a = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, c = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, l = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, p = /\((\S*)(?::(\d+))(?::(\d+))\)/, f = t.stack.split("\n"), h = [], v = /^(.*) is undefined$/.exec(t.message), g = 0, m = f.length; g < m; ++g) {
                ...
                if (!i.func && i.line && (i.func = r(i.url, i.line)), Gt.remoteFetching && i.url && "blob:" === i.url.substr(0, 5)) {
        ...
        function f(t, e) {
            for (var n, o, i, s = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, a = [], l = {}, d = !1, v = f.caller; v && !d; v = v.caller)
                if (v !== h && v !== Gt.report) {
                    ...
                    if (i = c(v)) {
                        o.url = i.url, o.line = i.line, o.func === Jt && (o.func = r(o.url, o.line));
            ...
            try {
                if (u = function(t) {
                        ...
                        var i, u = /^\s*Line (\d+) of linked script ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i,
                            ...
                            p = [],
                            f = Yt && Yt.document && Yt.document.getElementsByTagName("script"),
                            h = [];
                        for (var d in f) Zt(f, d) && !f[d].src && h.push(f[d]);
    ...
    }(), Gt.extendToAsynchronousCallbacks = function() {
        var t = function(t) {
            var e = Yt[t];
            Yt[t] = function() {
                var t = Xt.call(arguments),
                    n = t[0];
                return "function" == typeof n && (t[0] = Gt.wrap(n)), e.apply ? e.apply(this, t) : e(t[0], t[1])
            }
        };
        t("setTimeout"), t("setInterval")
    }, Gt.remoteFetching = !1, Gt.collectWindowErrors = !0, Gt.linesOfContext = 11;
    var te = Gt.report.subscribe,
        ee = Gt.report.installGlobalHandler,
        ne = Gt.report.installGlobalUnhandledRejectionHandler,
        re = Gt.computeStackTrace,
        oe = 50;
    ...
    var le, pe, fe = function() {
            ...
            return n(r, e), r.prototype.sendEvent = function(e) {
                return s(this, void 0, void 0, function() {
                    ...
                    return a(this, function(r) {
                        ...
                        }, [2, this.buffer.add(he.fetch(this.url, n).then(function(e) {
                            return {
        ...
        me = function(e) {
            ...
            return n(r, e), r.prototype.install = function() {
                ...
                return this.options.transport ? new this.options.transport(t) : Ct() ? new de(t) : new ve(t)
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return a(this, function(a) {
                        switch (a.label) {
                            case 0:
                                return f(e) && e.error ? (e = (u = e).error, r = ae(re(e)), [3, 7]) : [3, 1];
                            case 1:
                            ...
                            case 2:
                                return ce(r = a.sent(), s), [3, 7];
                            case 3:
                                return p(e) ? (r = ae(re(e)), [3, 7]) : [3, 4];
                            case 4:
                                return b(e) && n && n.syntheticException ? (ce(r = se(u = e, n.syntheticException), "Custom Object"), [3, 7]) : [3, 5];
                            case 5:
                                return u = e, [4, this.eventFromMessage(u, void 0, n)];
                            case 6:
                                ce(r = a.sent(), "" + u), a.label = 7;
                            case 7:
                                return [2, r = i({}, r, {
                ...
                return void 0 === n && (n = t.Severity.Info), s(this, void 0, void 0, function() {
                    ...
                    return a(this, function(s) {
                        return t = {
                            ...
                            level: n,
                            message: e
                        }, this.options.attachStacktrace && r && r.syntheticException && (o = re(r.syntheticException), i = ue(o.stack), t.stacktrace = {
                            frames: i
                        }), [2, t]
                    })
                })
    ...
    function _e(t, e, n) {
        ...
        var sentryWrapped = function() {
            ...
            try {
                ...
                throw xe += 1, setTimeout(function() {
                    xe -= 1
                }), it(function(n) {
                    return s(r, void 0, void 0, function() {
                        var r = this;
    ...
    function we() {
        return function(t) {
            ...
            var n = e && e.tagName;
            n && ("INPUT" === n || "TEXTAREA" === n || e.isContentEditable) && (le || Se("input")(t), clearTimeout(le), le = setTimeout(function() {
                le = void 0
            }, Ee))
        }
    }
    var ke = function() {
            ...
            return t.prototype.setupOnce = function() {
                ...
                }), this.options.onerror && (X.log("Global Handler attached: onerror"), ee()), this.options.onunhandledrejection && (X.log("Global Handler attached: onunhandledrejection"), ne())
                ...
                return ce(r, void 0 !== t.original ? "" + I(C(q(t.original)), 300) : "", "onunhandledrejection" === t.mechanism ? "UnhandledRejection" : "Error"), r
            ...
            return t.prototype.wrapTimeFunction = function(t) {
                ...
                n && n.hasOwnProperty && n.hasOwnProperty("addEventListener") && (D(n, "addEventListener", function(e) {
                    return function(n, r, o) {
                        ...
                        var i, s, a;
                        return "EventTarget" !== t && "Node" !== t || (s = Se("click"), a = we(), i = function(t) {
                            if (t) {
                                var e;
                                try {
                                    e = t.type
    ...
    var je, Ie = _(),
        Re = function() {
            ...
            return e.prototype.instrumentConsole = function() {
                "console" in Ie && ["debug", "info", "warn", "error", "log"].forEach(function(n) {
                    n in Ie.console && D(Ie.console, n, function(r) {
                        return function() {
                            ...
                            "assert" === n && !1 === o[0] && (s.message = "Assertion failed: " + (R(o.slice(1), " ") || "console.assert"), s.data.extra.arguments = q(o.slice(1), 3)), e.addBreadcrumb(s, {
                                input: o,
                                level: n
                            }), r && Function.prototype.apply.call(r, Ie.console, o)
                        }
                    })
                })
            }, e.prototype.instrumentDOM = function() {
                "document" in Ie && (Ie.document.addEventListener("click", Se("click"), !1), Ie.document.addEventListener("keypress", we(), !1))
            }, e.prototype.instrumentFetch = function() {
                Ct() && -1 !== _().fetch.toString().indexOf("native") && D(Ie, "fetch", function(n) {
                    return function() {
                        for (var r = [], o = 0; o < arguments.length; o++) r[o] = arguments[o];
                        var i, s = r[0],
                            a = "GET";
                        "string" == typeof s ? i = s : "Request" in Ie && s instanceof Request ? (i = s.url, s.method && (a = s.method)) : i = String(s), r[1] && r[1].method && (a = r[1].method);
                        var u = tt().getClient(),
                            c = u && u.getDsn();
                        if (c) {
                            var l = new ct(c).getStoreEndpoint();
                            if (l && F(i, l)) return "POST" === a && r[1] && r[1].body && Fe(r[1].body), n.apply(Ie, r)
                        }
                        var p = {
                            method: a,
                            url: i
                        };
                        return n.apply(Ie, r).then(function(t) {
                ...
                if (n = _(), r = n.chrome, o = r && r.app && r.app.runtime, i = "history" in n && !!n.history.pushState && !!n.history.replaceState, !o && i) {
                    var n, r, o, i, s = function(t, n) {
                            var r = k(Ie.location.href),
                                o = k(n),
                                i = k(t);
                            i.path || (i = r), je = n, r.protocol === o.protocol && r.host === o.host && (n = o.relative), r.protocol === i.protocol && r.host === i.host && (t = i.relative), e.addBreadcrumb({
                                category: "navigation",
                                data: {
                                    from: t,
                                    to: n
                    ...
                    Ie.onpopstate = function() {
                        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
                        var r = Ie.location.href;
                        if (s(je, r), a) return a.apply(t, e)
                    }, D(Ie.history, "pushState", u), D(Ie.history, "replaceState", u)
                }
                ...
                function u(t) {
                    return function() {
                        ...
                        return r && s(je, String(r)), t.apply(this, e)
                    }
                }
                ...
                if ("XMLHttpRequest" in Ie) {
                    ...
                    D(t, "open", function(t) {
                        ...
                        return function() {
                            ...
                            return o.__sentry_own_request__ && Fe(n[0]), ["onload", "onerror", "onprogress"].forEach(function(t) {
                                ! function(t, e) {
    ...
    var Ce, De = "cause",
        ...
        Ne = function() {
            function t(e) {
                void 0 === e && (e = {}), this.name = t.id, this.key = e.key || De, this.limit = e.limit || Pe
            }
            return t.prototype.setupOnce = function() {
                var e = this;
                Y(function(n, r) {
            ...
            return t.prototype.setupOnce = function() {
                ...
                Y(function(n) {
                    return s(e, void 0, void 0, function() {
                        var e;
                        return a(this, function(r) {
                            return tt().getIntegration(t) && Ue.navigator && Ue.location ? ((e = n.request || {}).url = e.url || Ue.location.href, e.headers = e.headers || {}, e.headers["User-Agent"] = Ue.navigator.userAgent, [2, i({}, n, {
                                request: e
                            })]) : [2, n]
                        })
                    })
    ...
    var Be = function() {
            function t(e) {
                void 0 === e && (e = {
                    types: [Ce.Crash, Ce.Deprecation, Ce.Intervention]
                }), this.options = e, this.name = t.id
            }
            return t.prototype.setupOnce = function() {
                    ...
                    var o = function(t) {
                        it(function(e) {
                            ...
                            if (t.body) {
                                ...
                                if (e.setExtra("body", i), t.type === Ce.Crash) r = [(o = t.body).crashId || "", o.reason || ""].join(" ").trim() || r;
        ...
        He = Object.freeze({
            ...
            Ember: Me,
            Vue: Ae,
            ReportingObserver: Be
        }),
        $e = [new bt, new St, new Et, new wt, new Oe, new Re, new ke, new Ne, new Le];
    var We = i({}, Ft, He);
    return t.Integrations = We, t.Transports = ge, t.addGlobalEventProcessor = Y, t.addBreadcrumb = function(t) {
        ot("addBreadcrumb", t)
        ...
        ot("configureScope", t)
    }, t.withScope = it, t.getHubFromCarrier = nt, t.getCurrentHub = tt, t.Hub = K, t.Scope = V, t.BrowserBackend = me, t.BrowserClient = be, t.defaultIntegrations = $e, t.forceLoad = function() {}, t.init = function(t) {
        void 0 === t && (t = {}), void 0 === t.defaultIntegrations && (t.defaultIntegrations = $e),
            function(t, e) {
                !0 === e.debug && X.enable();
                var n = new t(e);
    ...
    }, t.SDK_NAME = ye, t.SDK_VERSION = "4.6.5", t
}({});
