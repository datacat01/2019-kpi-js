...
var a2a = a2a || {
    ...
    kit: function(o, e) {
        var a, t, n, i, l, d = o.type,
            ...
            m = function() {
                A = o.linkurl = a2a.getData(h)["a2a-url"] || A, C = o.linkname = a2a.getData(h)["a2a-title"] || C, S = o.linkmedia = a2a.getData(h)["a2a-media"] || S, a2a.linker(this)
            },
            f = function(e, a, t) {
                var n = {
                        node: a,
            ...
            v = h.className,
            y = h.a2a_follow,
            k = a2a.HTMLcollToArray(h.getElementsByTagName("a")),
            w = k.length,
            ...
            B = (S && x(o.linkmedia).replace(/'/g, "%27"), g["a2a-icon-color"] || a2a.c.icon_color),
            T = B ? B.split(",", 2) : B,
            F = T ? T[0] : T,
            L = T ? T[1] : T,
        ...
        z && !isNaN(z) && (a2a.svg.load(), B && "unset" != B && a2a.svg.works() && (F && "unset" != F && (M.backgroundColor = F), L && "unset" != L.trim() && (L = L.trim())), h.style.lineHeight = j.height = j.lineHeight = D, j.width = 2 * z + "px", j.fontSize = "16px", O && (j.height = j.lineHeight = z / 2 + "px", j.fontSize = "10px", j.width = z + "px"), H && a2a.scrollToggle(h, H), 32 != z && (M.backgroundSize = M.height = M.lineHeight = M.width = D, j.borderRadius = M.borderRadius = (.14 * z).toFixed() + "px", j.fontSize = (parseInt(j.height, 10) + (O ? 4 : 0)) / 2 + "px")), a2a.kit.facebook_like = function() {
            ...
            window.fbAsyncInit || (window.fbAsyncInit = function() {
                FB.init({
                    ...
                    a2a.GA.track("Facebook Like", "facebook_like", e, "pages", "AddToAny Share/Save Button"), f("Facebook Like", G)
                })
                ...
                twttr.ready(function(e) {
                    a2a.twitter_bind || (e.events.bind("click", function(l) {
                        if (l && "tweet" == l.region) {
                            ...
                            e && e.url && (a2a.GA.track("Twitter Tweet", "twitter_tweet", unescape(e.url), "pages", "AddToAny Share/Save Button"), f("Twitter Tweet", G))
                        }
            ...
            "beside" == ue["pin-config"] && "buttonPin" == ue["pin-do"] && (G.style.width = "76px"), n.href = "https://www.pinterest.com/pin/create/button/?url=" + ue.url + (ue.media ? "&media=" + ue.media : "") + (ue.description ? "&description=" + encodeURIComponent(ue.description).replace(/'/g, "%27") : ""), a2a.add_event(G, "click", function() {
                a2a.GA.track("Pinterest Pin", "pinterest_pin", A, "pages", "AddToAny Share/Save Button"), f("Pinterest Pin", G)
            ...
            a2a.kit.linkedin_share_event = function() {
                a2a.GA.track("LinkedIn Share", "linkedin_share", A, "pages", "AddToAny Share/Save Button"), f("LinkedIn Share", G)
        ...
        for (var R = 0; R < w; R++) {
            ...
            if (X && !se) {
                if (K || (G.target = te, !y || !r[X] && u(X, !0) ? "feed" == X ? G.href = G.href || o.linkurl : (G.href = "/#" + X, "js" === le ? a2a.add_event(G, "click", m) : (a2a.add_event(G, "mousedown", m), a2a.add_event(G, "keydown", m)), G.rel = "nofollow" + ae) : G.href = (t = X, l = n = void 0, i = p(a = G, {})["a2a-follow"], l = r[t], i && l && (n = l.url.replace("${id}", i)), n || a.href), G.a2a = {}, G.a2a.customserviceuri = re, G.a2a.stype = le, G.a2a.linkurl = o.linkurl, G.a2a.servicename = ee, G.a2a.safename = X, oe.src && (G.a2a.js_src = oe.src), oe.url && (G.a2a.url = oe.url), oe.pu && (G.a2a.popup = 1), oe.media && (G.a2a.media = 1), h.a2a_codes = h.a2a_codes || [], h.a2a_codes.push(X), y || a2a.add_event(G, "click", function(o, l, r, s, c) {
                    ...
                    for (var pe, me, fe, _e = 0, he = Q.length; _e < he; _e++)
                        if (fe = (me = "string" == typeof(pe = Q[_e].className)) && ("a2a_label" === pe || 0 <= pe.indexOf("a2a_ignore")), 1 == Q[_e].nodeType && (fe || (q = !0), me && 0 <= pe.indexOf("a2a_count"))) {
                            W = !0;
                            break
                        } if (!q) {
                        for (var ge in ($ = document.createElement("span")).className = I + ne + " a2a_img_text", ie && ($.style.backgroundColor = "#" + ie), "pending" !== (U = a2a.svg.get(ne, $, L)) && ($.innerHTML = U), M) $.style[ge] = M[ge];
                        G.insertBefore($, Q[0])
                    }
                } else {
                    for (var ge in ($ = document.createElement("span")).className = I + ne, ie && ($.style.backgroundColor = "#" + ie), "pending" !== (U = a2a.svg.get(ne, $, L)) && ($.innerHTML = U), M) $.style[ge] = M[ge];
                ...
                if (O && z && z < 20 && (ce = !1), ce && !W) {
                    for (var ge in ($ = document.createElement("span")).className = "a2a_count", $.a2a = {}, $.a2a.kit = h, j) $.style[ge] = j[ge];
                    G.appendChild($), K ? ($.a2a.is_a2a_dd_counter = 1, h.a2a_dd_counter = $, a2a.counters.get("facebook", $, P)) : a2a.counters.get(X, $, P)
                }
                "a2a_dd" != V && a2a.kit_services.push(G)
            }
        }
        0 <= v.indexOf("a2a_default_style") && (b.style.clear = "both", h.appendChild(b))
    },
    counters: {
    ...
    overlays: function() {
        ...
        function o(e, a, t, n) {
            ...
            if (a2a.matches(m, n) && "false" !== m.getAttribute("data-a2a-overlay")) {
                ...
                o = a2a.getPos(m), a.style.display = "", s = a.clientHeight || a.offsetHeight, c = a.clientWidth || a.offsetWidth, t[0] && ("bottom" === t[0] ? h = m.height - s : "center" === t[0] && (h = x((m.height - s) / 2))), t[1] && ("right" === t[1] ? _ = m.width - c : "center" === t[1] && (_ = x((m.width - c) / 2))), d = o.left + _, u = o.top + h, a.style.left = d + "px", a.style.top = u + "px", a.setAttribute("data-a2a-media", m.src), (a.a2a_mediaNode = m).alt ? a.setAttribute("data-a2a-title", m.alt) : a.setAttribute("data-a2a-title", b), !g || "#" !== g.substr(0, 1) && "http" !== g.substr(0, 4) ? a.setAttribute("data-a2a-url", w) : (p = "#" === g.substr(0, 1) ? w.split("#")[0] + m.longDesc : g, a.setAttribute("data-a2a-url", p))
        ...
        for (var l = 0, r = e.length; l < r; l++) {
            var s, c = e[l],
                ...
                h = c.target,
                x = Math.round;
            if (m = m && 2 < m.length ? m.split(" ") : ["top", "left"], f = !f || "horizontal" !== f && "default" !== f ? "vertical" : "default", h = h || "img", p) document.body.insertAdjacentHTML("beforeend", p), s = document.body.lastChild;
            else {
                for (var g = 0, v = d.length; g < v; g++) {
                    u += '<a class="a2a_button_' + d[g] + '"></a>'
    ...
    linker: function(e) {
        var a, t, n = location.href,
            ...
            h = !l.track_links || "page" != r && "mail" != r ? "" : "&linktrack=" + l.track_links + "&linktrackkey=" + encodeURIComponent(l.track_links_key),
        ...
        else if (k && (s != A || s == A && a2a.is_mobile) && !h) {
        ...
        } else g && "undefined" != g && (a = g.replace(/A2A_LINKNAME_ENC/, p).replace(/A2A_LINKURL_ENC/, d).replace(/A2A_LINKNOTE_ENC/, _));
        return e.href = a || "http" + a2a.c.http_s + "://www.addtoany.com/add_to/" + s + "?linkurl=" + d + "&linkname=" + p + (f ? "&linkmedia=" + f : "") + h + function S() {
            var e = "";
    ...
    show_menu: function(e, a) {
        ...
        var t, n, i, o, l, r, s, c, d, u, p = a2a["n" + a2a.n],
            m = a2a.type = p.type,
            f = "a2a" + m,
            _ = a2a.gEl(f + "_dropdown"),
            h = a2a.has_touch,
            g = h ? "touchstart" : "click",
            v = !(!h || !a2a.evOpts()) && {
                passive: !0
            };
        ...
        }), a2a.show_menu["doc_click_listener_" + m] = a2a.add_event(document, g, a2a[m].doc_click_close_mini, v)), a2a.show_menu.key_listener = a2a.show_menu.key_listener || {}, a2a.show_menu.key_listener[m] = a2a.add_event(document, "keydown", function(e) {
    ...
    top_services: function(e, a, t) {
        ...
        if (e) {
            ...
            if (0 < u.length) {
                var f, _, h;
                for (p = 0, t = t; p < u.length; p++) h = (f = i(u[p].a2a.safename, d, !0, "a2a", "safename")) ? f : o((_ = u[p].a2a).servicename, _.safename, _.serviceIcon, _.serviceColor, {
                    src: _.js_src,
                    url: _.url,
                    type: _.serviceType,
                    pu: _.popup,
                    media: _.media
                }), t && (h.className = h.className + t), s.insertBefore(h, s.firstChild);
                if ((d = a2a.getByClass("a2a_i", s, "a")).length > l) {
                    p = 0;
                    for (var g = d.length; p < g - l; p++) s.removeChild(s.lastChild)
                }
            }
        }
    },
    ...
    make_service: function(c, d, e, a, t, n, i) {
        var o, l, u = document.createElement("a"),
            ...
            h = _ ? _[0] : _,
            g = _ ? _[1] : _;
        return u.rel = "nofollow noopener", u.className = "a2a_i", u.href = "/#" + d, u.target = "_blank", u.a2a = {}, u.a2a.safename = d, u.a2a.servicename = c, u.a2a.serviceNameLowerCase = c.toLowerCase(), u.a2a.serviceIcon = e, u.a2a.serviceColor = a, u.a2a.serviceType = t.type, u.innerHTML = "<span></span>" + c + " ", o = u.firstChild, t.type && (u.a2a.stype = t.type), t.src && (u.a2a.js_src = t.src), t.url && (u.a2a.url = t.url), t.pu && (u.a2a.popup = 1), t.media && (u.a2a.media = 1), n && (u.a2a.customserviceuri = n), i ? (o.style.backgroundImage = "url(" + i + ")", o.className = m) : f && a2a.svg.works() ? (o.className = m + " a2a_s_" + e, h && "unset" != h ? o.style.backgroundColor = h : a && (o.style.backgroundColor = "#" + a), g && (g = g.trim())) : e ? (o.className = m + " a2a_s_" + e, a && (o.style.backgroundColor = "#" + a)) : o.className = m, i || "pending" !== (l = a2a.svg.get(e, o, g)) && (o.innerHTML = l), "js" === u.a2a.stype ? a2a.add_event(u, "click", s) : (a2a.add_event(u, "mousedown", s), a2a.add_event(u, "keydown", s)), a2a.add_event(u, "click", function(e) {
            var a = a2a["n" + a2a.n],
                t = {
                    node: u,
                    service: c,
...
a2a.c = a2a_config, a2a.make_once = function(e) {
        if (a2a.type = a2a.c.menu_type || e, !a2a[a2a.type] && !window["a2a" + a2a.type + "_init"]) {
            a2a[a2a.type] = {}, window.a2a_show_dropdown = a2a.show_menu, window.a2a_miniLeaveDelay = a2a.miniLeaveDelay, window.a2a_init = a2a.init, a2a["create_" + a2a.type + "_html"] = function(e, a) {
                ...
                if (s.id != F && (s.style.position = "static", _ && _ < 9 ? document.body.insertBefore(s, document.body.firstChild) : document.body.insertBefore(s, null)), (o = u(m + "_dropdown")) && h && (a2a.add_event(o, "mouseenter", a2a.miniEnterStay), a2a[p].onclick || a2a.add_event(o, "mouseleave", a2a.miniLeaveDelay)), (r = u(m + "_find")) && (a2a.add_event(u(m + "_find_icon"), "click", a2a.focus_find), a2a.add_event(r, "click", a2a.focus_find), a2a.add_event(r, "keyup", a2a.do_find)), (l = u("a2a_copy_link_icon")) && a2a.add_event(l, "click", function() {
                ...
                t = u(m + "_full_services"), g.className = "a2a_i", n = g.cloneNode(), t.appendChild(g), t.appendChild(n);
                N = 0;
