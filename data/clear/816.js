...
ABC.Stats = function() {
    ...
    function getProfile() {
        ...
        switch (host) {
            ...
            case 'thestrangecalls.abc.net.au':
                profile = 'tv';
                break;

            case 'iview.abc.net.au':
                profile = 'iview';
                break;
            ...
            case 'hottest100.triplej.net.au':
                profile = 'triplej';
                break;

            case 'digmusic.net.au':
                profile = 'digmusic';
                break;
            ...
            case 'rantang.net.au':
            case 'bayvut.com.au':
            case '24hdanslepacifique.com':
                profile = 'radioaustralia';
                break;

            case 'australianetwork.com':
                profile = 'australianetwork';
                break;

            case 'abcaustralia.net.au':
                profile = 'australiaplus';
                break;

            case 'heywire.abc.net.au':
                profile = 'local';
                break;

            case 'shop.abc.net.au':
                profile = 'shop';
                break;

            case 'abccommercial.com':
            case 'abccommercial.com.au':
            case 'abcmusic.com.au':
            case 'abcmusicpublishing.com.au':
            case 'organicgardener.com.au':
                profile = 'commercial';
                break;

            case 'myabcforkids.abc.net.au':
                profile = 'kids';
                break;
            ...
            case 'multitaskingtest.net.au':
                profile = 'science';
                break;

            case 'fantasycricket.abc.net.au':
            case 'tipping.abc.net.au':
                profile = 'grandstand';
                break;

            case 'campaignpulse.abc.net.au':
            case 'livenews.abc.net.au':
            case 'votecompass.abc.net.au':
                profile = 'news';
                break;

            case 'roadtrip.abcopen.net.au':
            case 'open.abc.net.au':
                profile = 'open';
                break;

            case 'splashlive.abc.net.au':
            case 'zoom.abc.net.au':
            case 'splash.abc.net.au':
                profile = 'splash';
                break;

            case 'theoperahouseproject.com':
                profile = 'soh';
                break;

            case 'spoke.abc.net.au':
                profile = 'spoke';
                break;
            ...
            default:
                switch (directories[1]) {
                    ...
                    case 'tv':
                        profile = 'tv';
                        if (directories[2] == 'qanda') {
                            profile = 'currentaffairs'; // should catch '/tv/qanda'
                        }
                        break;
    ...
    s.async = true;
    s.src = "https://res.abc.net.au/libraries/stats/webtrends-bundle/webtrends.load." + window.abcContentProfile + mobileStr + ".js";
