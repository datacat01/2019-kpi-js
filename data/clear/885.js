! function(a) {
    "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = function(b, c) {
        return "undefined" == typeof c && (c = "undefined" != typeof window ? require("jquery") : require("jquery")(b)), a(c), c
    } : a(jQuery)
}(function(a) {
    "use strict";
    ...
    function c(b) {
        ...
        if (f.clk = c, "image" === c.type)
            if ("undefined" != typeof b.offsetX) f.clk_x = b.offsetX, f.clk_y = b.offsetY;
    ...
    var e = /\r?\n/g,
        f = {};
    f.fileapi = void 0 !== a('<input type="file">').get(0).files, f.formdata = "undefined" != typeof window.FormData;
    var g = !!a.fn.prop;
    a.fn.attr2 = function() {
        ...
        function k(c) {
            ...
            function f() {
                function b() {
                    try {
                        ...
                        d("Server abort: ", c, " (", c.name, ")"), h(C), w && clearTimeout(w), w = void 0
                    }
                }
                ...
                try {
                    if (k.extraData)
                        for (var m in k.extraData) k.extraData.hasOwnProperty(m) && (a.isPlainObject(k.extraData[m]) && k.extraData[m].hasOwnProperty("name") && k.extraData[m].hasOwnProperty("value") ? j.push(a('<input type="hidden" name="' + k.extraData[m].name + '">', z).val(k.extraData[m].value).appendTo(x)[0]) : j.push(a('<input type="hidden" name="' + m + '">', z).val(k.extraData[m]).appendTo(x)[0]));
            ...
            function h(b) {
                if (!r.aborted && !H) {
                    if (G = e(q), G || (d("cannot access response document"), b = C), b === B && r) return r.abort("timeout"), void y.reject(r, "timeout");
                    if (b === C && r) return r.abort("server abort"), void y.reject(r, "error", "server abort");
                    if (G && G.location.href !== k.iframeSrc || v) {
                        ...
                        try {
                            ...
                            if (d("isXml=" + g), !g && window.opera && (null === G.body || !G.body.innerHTML) && --I) return d("requeing onLoad callback, DOM not available"), void setTimeout(h, 250);
                            var i = G.body ? G.body : G.documentElement;
                            r.responseText = i ? i.innerHTML : null, r.responseXML = G.XMLDocument ? G.XMLDocument : G, g && (k.dataType = "xml"), r.getResponseHeader = function(a) {
                                var b = {
                            ...
                            } else "xml" === j && !r.responseXML && r.responseText && (r.responseXML = J(r.responseText));
                            try {
                                F = L(r, j, k)
                            } catch (t) {
            ...
            if (y.abort = function(a) {
                ...
                for (j = 0; j < s.length; j++) i = a(s[j]), g ? i.prop("disabled", !1) : i.removeAttr("disabled");
            ...
            E && D && (k.extraData = k.extraData || {}, k.extraData[E] = D), k.forceSync ? f() : setTimeout(f, 10);
            var F, G, H, I = 50,
                J = a.parseXML || function(a, b) {
                ...
                L = function(b, c, d) {
                    ...
                    return f && "parsererror" === g.documentElement.nodeName && a.error && a.error("parsererror"), d && d.dataFilter && (g = d.dataFilter(g, c)), "string" == typeof g && (("json" === c || !c) && e.indexOf("json") >= 0 ? g = K(g) : ("script" === c || !c) && e.indexOf("javascript") >= 0 && a.globalEval(g)), g
                };
            return y
        }
        ...
        "function" == typeof b ? b = {
            ...
            data: c,
            dataType: e
        }, "function" == typeof h && (b.success = h)) : "undefined" == typeof b && (b = {}), l = b.method || b.type || this.attr2("method"), m = b.url || this.attr2("action"), n = "string" == typeof m ? a.trim(m) : "", n = n || window.location.href || "", n && (n = (n.match(/^([^#]+)/) || [])[1]), b = a.extend(!0, {
            url: n,
        ...
        var g, h = this[0],
            i = this.attr("id"),
            j = b || "undefined" == typeof h.elements ? h.getElementsByTagName("*") : h.elements;
        if (j && (j = a.makeArray(j)), i && (b || /(Edge|Trident)\//.test(navigator.userAgent)) && (g = a(':input[form="' + i + '"]').get(), g.length && (j = (j || []).concat(g))), !j || !j.length) return e;
        a.isFunction(d) && (j = a.map(j, d));
        var k, l, m, n, o, p, q;
        for (k = 0, p = j.length; k < p; k++)
            if (o = j[k], m = o.name, m && !o.disabled)
                if (b && h.clk && "image" === o.type) h.clk === o && (e.push({
                    name: m,
                    value: a(o).val(),
                    type: o.type
                }), e.push({
            ...
            for (c && c.push(o), l = 0, q = n.length; l < q; l++) e.push({
                name: m,
                value: n[l]
            });
        ...
        } else null !== n && "undefined" != typeof n && (c && c.push(o), e.push({
            name: m,
            value: n,
            type: o.type,
            required: o.required
        ...
        if (!b && h.clk) {
            var s = a(h.clk),
                t = s[0];
            m = t.name, m && !t.disabled && "image" === t.type && (e.push({
                name: m,
                value: s.val()
            }), e.push({
                name: m + ".x",
        ...
        if ("undefined" == typeof c && (c = !0), c && (!d || b.disabled || "reset" === f || "button" === f || ("checkbox" === f || "radio" === f) && !b.checked || ("submit" === f || "image" === f) && b.form && b.form.clk !== b || "select" === g && b.selectedIndex === -1)) return null;
        if ("select" === g) {
            ...
            for (var i = [], j = b.options, k = "select-one" === f, l = k ? h + 1 : j.length, m = k ? h : 0; m < l; m++) {
                ...
                if (n.selected && !n.disabled) {
                    var o = n.value;
                    if (o || (o = n.attributes && n.attributes.value && !n.attributes.value.specified ? n.text : n.value), k) return o;
                    i.push(o)
                }
            }
            return i
        ...
        return "undefined" == typeof a && (a = !0), this.each(function() {
            this.disabled = !a
        })
    }, a.fn.selected = function(b) {
        return "undefined" == typeof b && (b = !0), this.each(function() {
            var c = this.type;
