    ...
    (function(v, m) {
        ...
        (function(a) {
            ...
            a.b.as = function() {
                ...
                return function(b) {
                    ...
                    var d = a.g.a([5, 1, 0, 21]),
                        ...
                        h = a.g.a([24, 30, 37, 41]);
                    a.b.forEach([d, g, f, e, l, h], function(a) {
                ...
                if (!a.c.h) {
                    ...
                    a: {
                        for (var d = document.getElementsByTagName("script"), g = d.length - 1; - 1 < g; g--)
                            if ((b = d[g]) && b.src && b.src.indexOf && (-1 !== b.src.indexOf("mansuetoprebidheader15141606144/yi.js") || -1 !== b.src.indexOf("mansuetoprebidheader15141606144%2Fyi.js")) && ("undefined" === typeof b[MOATALREADYFOUND] || !0 !== b[MOATALREADYFOUND])) {
            ...
            a.b.bo = function(c, b) {
                ...
                if (a.b.hasChildNodes(d)) {
                    var g = d.childNodes[m.max(0,
                        d.childNodes.length - 1)] || null;
                    d.insertBefore(c, g)
            ...
            a.b.bc = function(c) {
                if (!(!c || c && c.CLIPCHECKINGTARGET)) {
                    var b = a.b.an(c, 3),
                        d;
                    b && 0 <
                        b.length && (a.b.forEach(b, function(a) {
            ...
            a.b.cb = function(c, b) {
                ...
                d = c.style && c.style.opacity ?
                    parseFloat(c.style.opacity) : a.b.ca(c);
            ...
            a.b.cm = function(c, b, d, g) {
                ...
                if (!l) {
                    ...
                    if (!b) return !1;
                    for (var h = 0, k = b.length; h < k && (e = b[h], l = f(c, e), "undefined" ===
                            typeof l); h++);
                }
                return d ? [l, e] : l
            };
            ...
            a.b.cq = function(c, b, d) {
                return a.b.cc(c) && a.b.cc(b) && a.b.cc(d) ? m.abs(c - b) <= d : !1
            };
            a.b.cc = function(a) {
        ...
        (function(a) {
            ...
            a.d.c = function(h, e) {
                ...
                for (e = e || 10; f < e;) {
                    f++;
                    try {
                        if (h = (k = h.frameElement) && a.b.al(k), k && h && !a.d.d(h)) l.push(h);
                        else return l
                    } catch (c) {
                        break
                    }
            ...
            a.d.l = [];
            a.d.j = function(h) {
                for (var e, f = 0, l = a.d.l.length; f < l; f++) a.d.l[f].win == h && (e = a.d.l[f]);
                if (!e) {
                    e = {
                        win: h,
                        friendly: !1
        ...
        (function(a) {
                        ...
                        try {
                            ...
                            if (!e) {
                                ...
                                if (!b && 10 > window["Moat#EMC"]) {
                                    window["Moat#EMC"]++;
                                    try {
                                        var g = "https://px.moatads.com/pixel.gif?e=24&d=data%3Adata%3Adata%3Adata&i=" +
                                            escape("MANSUETODFPCW_PREBID_HEADER1") + "&ac=1&k=" + escape(d) + "&ar=" + escape("bc6efc1-clean") + "&j=" + escape(document.referrer) + "&cs=" + (new v).getTime(),
                                            q = new Image(1, 1);
                                        q.src = g
                                    } catch (x) {}
                                } else if (b) {
                                    ...
                                    window["Moat#ETS"] = c;
                                    try {
                                        g = "https://px.moatads.com/pixel.gif?e=24&d=data%3Adata%3Adata%3Adata&i=" + escape("MANSUETODFPCW_PREBID_HEADER1") + "&ac=1&k=" + escape(d) + "&ar=" + escape("bc6efc1-clean") + "&j=" + escape(document.referrer) + "&cs=" + (new v).getTime(), q = new Image(1, 1), q.src = g
                                    } catch (x) {}
                                }
                            }
                        }
            ...
            a.k.e = function(f, e) {
                f = h(f);
                var k;
                window && window.setInterval && (k = window.setInterval(f, e), 1 == k && (a.b.ck(k), k = window.setInterval(f, e)), D.push(k));
                return k
            };
            a.k.f = function(f, e) {
                f = h(f);
                var k;
                window && window.setTimeout && (k = window.setTimeout(f, e), 1 == k && (a.b.cj(k), k = window.setTimeout(f, e)), C.push(k));
                return k
            };
        ...
        (function(a) {
            ...
            var x = function() {
                var b, c = function(c) {
                        return (b = a.b.br(c, ["amazonmobileadsviewablebridge"])) && "function" ===
                            typeof b.addEventListener && "function" === typeof b.getVersion ? !0 : b = !1
                    },
                    d = document,
                    g = window,
                    e = c(g),
            ...
            a.c.ch = function() {
                ...
                return function() {
                    ...
                    a.c.d.MoatMAK ? a.c.d.MoatMAK.namespace && (b = !1) : (g = a.c.d) && g.imraid && "function" === typeof g.imraid.getVendorName && "inmobi" === g.imraid.getVendorName() &&
                        (b = !1);
                    return b
                }
            }();
            ...
            a.c.cl = function() {
                return a.c.d.webkit &&
                    a.c.d.webkit.messageHandlers && a.c.d.webkit.messageHandlers.__z_moat_bridge__
            };
            a.c.ck = function() {
            ...
            a.c.cn = function() {
                var b = !1;
                return a.c.bo() ? !0 : a.c.b || a.c.bw ? b = (b = a.c.f() && a.c.ck()) || a.c.bw || a.c.cj() || a.c.bi() || a.c.cf() : b
            };
            a.c.protocol = a.b.bj();
            ...
            try {
                a.c.cu = a.c.d.history && a.c.d.history.length
            } catch (r) {}
            a.c.cv = function() {
                if (A)
                    for (var a in A)
            ...
            a.c["do"] = function() {
                return a.c.f() ? u || parseInt(a.c.dp("isNative")) ?
                    !0 : !!document.getElementById("mianahwvc") : !1
            };
            a.c.i = function() {
            ...
            a.c.ec = function() {
                ...
                return b ? a.c.ea(b) !== a.c.dz ? !0 : !1 : !1
            };
            a.c.ed = function() {
                if (!a.c.f()) return !1;
                var b = a.c.dt();
            ...
            a.c.k = function() {
                ...
                try {
                    if ("undefined" !== typeof a.c.d.eval &&
                        (a.c.d.eval("(function(win){ win['Moat#EVA'] = true; })(window)"), "undefined" !== typeof a.c.d["Moat#EVA"])) return !0
                } catch (b) {}
                return !1
            };
            a.c.l = function(a) {
        ...
        (function(a) {
            function h(a, f, h) {
                ...
                a && a.xa.sode || (a.xa.sode = function() {
                    ...
                    for (var g = this.xkcd[a], e = -1,
                            f = g && g.length, h = 0; h < f; h++)
                        if (g[h] === c) {
                            e = h;
                            break
                        } - 1 != e && g.splice(e, 1);
            ...
            a.i = {};
            a.i.b = function(e) {
                e.xa.sode || (e.xb == window ? h(a.c.ar,
                    window, m) : a.b.cl(h, "'" + a.c.ar + "',window, Math", e.xb));
                a.i.a = new e.xa.sode
            }
        })(n);
        (function(a) {
            function h(a, f) {
                ...
                b.xc.ynds = function(a, b, e, f) {
                    ...
                    if (a.addEventListener) f = "addEventListener",
                        h = "";
            ...
            a.q.c = function(e) {
                e == window ? h(a.c.ar, window) : a.b.cl(h,
                    "'" + a.c.ar + "',window", e);
                return a.q.b(e)
            };
            a.q.b = function(e) {
            ...
            function h(a, f) {
                ...
                function d(a) {
                    ...
                    if (b) {
                        ...
                        if ("boolean" !=
                            typeof b.sending || b.sending) b.sending = !1;
                        else return !1
                    }
                    0 < q && q--;
                    k()
        ...
        (function(a) {
            ...
            a.g.i = function(a) {
                ...
                for (var b = "", e = d = 0, h, l, k, u = 0; u < a.length; ++u)
                    for (k = a.charCodeAt(u), l = 255 < k ? 0 : 1; 2 > l; ++l) d = 0 === l ? d | (k & 65280) / 256 << e : d | (k & 255) << e, e += 8, 13 <
                        e && (h = d & 8191, 88 < h ? (d >>= 13, e -= 13) : (h = d & 16383, d >>= 14, e -= 14), b += f.charAt(h % 91), b += f.charAt(h / 91 | 0));
            ...
            a.g.a = function(a) {
                for (var b =
                        "", d = 0; d < a.length; d++) a.hasOwnProperty(d) && (b += f[a[d]]);
                return b
            };
            a.g.k = function() {
        ...
        (function(a) {
            ...
            var e = [0, 27,
                    ...
                    50, 44, 45, 30, 38, 20, 17, 11, 72, 39, 26, 38, 30, 71, 48, 30, 27, 36, 34, 45, 18, 41, 30, 30, 28, 33, 6, 43, 26, 38, 38, 26, 43, 72, 37, 30, 39, 32, 45, 33, 71, 50, 26, 39, 29, 30, 49, 72, 41, 46, 27, 37, 34, 28, 5, 30, 26, 45, 46, 43, 30, 72, 32, 30, 45, 8, 38, 26, 32, 30, 14, 43, 34, 32, 34, 39, 26, 37, 18, 34, 51, 30, 72, 37, 30, 39, 32, 45, 33
                ],
            ...
            a.t.a = function() {
                ...
                try {
                    var d = b.document,
                        ...
                        l = b.innerHeight ||
                        d.documentElement.clientHeight || g.clientHeight,
                        k = b.outerWidth || g.offsetWidth,
                ...
                var g = c,
                    p;
                try {
                    for (var y = [a.g.a([47, 30, 39, 29, 40, 43]), a.g.a([41, 37, 26, 45, 31,
                            40, 43, 38
                        ]), a.g.a([46, 44, 30, 43, 0, 32, 30, 39, 45])], r = {}, n = 0; n < y.length; n++) r[y[n]] = window.navigator[y[n]];
                    p = a.g.i(a.g.j(r))
                } catch (m) {
                    p = ""
                }
                ...
                if (document && document.body) {
                    ...
                    for (var g = a.g.a(e).split(a.g.a([71])),
                            r = g.length, t = [], n = 0; n < r; n++) t.push(h(g[n], y.contentWindow));
        ...
        (function(a) {
            ...
            a.g.r = function(b) {
                ...
                c.qr = a.g.u();
                e && "undefined" !== typeof e.charging && a.b.cc(e.level) && (c.vf = e.charging ? 1 : 0, c.vg = 100 * e.level);
                return c
            };
            ...
            a.g.w = function(b, c, e) {
                ...
                if (a.g.q.c in c) return 0 == a.g.z ?
                    ((new a.c.d.Image).src = b, !0) : !1;
            ...
            a.g.al = function() {
                return [a.g.a([30, 39,
                    28, 40, 29, 30, 20, 17, 8
                ]), a.g.a([29, 30, 28, 40, 29, 30, 20, 17, 8]), a.g.a([30, 39, 28, 40, 29, 30, 20, 17, 8, 2, 40, 38, 41, 40, 39, 30, 39, 45]), a.g.a([29, 30, 28, 40, 29, 30, 20, 17, 8, 2, 40, 38, 41, 40, 39, 30, 39, 45])]
            };
            a.g.am = function(d) {
        ...
        (function(a) {
            ...
            function e() {
                try {
                    a = window.__b, (0, window.__w)("INNER_FUNCTION"),
                        window.__w = void 0, window.__b = void 0
                } catch (c) {
                    var b = c.name + " in closure (moat.customIframe): " + c.message + ", stack=" + c.stack;
                    try {
                        var d = "https://px.moatads.com/pixel.gif?e=24&d=data%3Adata%3Adata%3Adata&i=" + escape("MANSUETODFPCW_PREBID_HEADER1") + "&ac=1&k=" + escape(b) + "&ar=" + escape("bc6efc1-clean") + "&j=" + escape(document.referrer) + "&cs=" + (new v).getTime();
                        (new Image(1, 1)).src = d
                    } catch (e) {}
                }
            }
            ...
            a.w.a = function(b, c, e, f) {
                ...
                try {
                    ...
                    if (!k) return !1;
                    l(k, f);
                    e ? (e = a.b.bp(e), a.b.bo(k, e)) : (e = a.c.d.document.body, e.insertBefore(k, e.insertBefore[0] || null));
                    c = {
                        id: m,
                        iframe: k,
            ...
            a.w.call = function(b, d, e, h, l, n) {
                if (!b || "undefined" === typeof d) return !1;
        ...
        (function(a) {
            ...
            a.x.b = function(h, e, f) {
                if (p && (e && (e += "_" + a.x.a), !p.jsonp || !p.jsonp[h])) {
                    ...
                    a.b.bq(f + "&callback=" + e, k, c)
                }
            };
            a.x.c = function(h, e) {
                p.jsonp && p.jsonp[h] && p.jsonp[h].cachedResponse ?
                    a.b.cf([p.jsonp[h].cachedResponse], e)() : p.swde.azsx(h + "JsonpReady", e, {
                        once: !0
                    })
            }
        })(n);
        (function(a) {
            ...
            a.y.j = function(a) {
                if (!a) return !1;
                for (var f = "function" === typeof a.getSlotElementId && a.getSlotElementId(), h = f && document.getElementById(f),
                        k = "function" === typeof a.getAdUnitPath && a.getAdUnitPath(), c = "function" === typeof a.getTargetingKeys && "function" === typeof a.getTargeting && a.getTargetingKeys(), b = {}, d = 0; d < c.length; d++) b[c[d]] = a.getTargeting(c[d]);
                return {
                    id: f,
                    element: h,
                    adUnitPath: k,
        ...
        (function(a) {
            ...
            function l() {
                ...
                function d(h) {
                    var l, k, r;
                    if (!n) return b("setMoatTargetingForSlot: No data mapping available, not setting targeting."), a.y.h(h, g.d, q.d), a.y.h(h, g.e, q.d),
                        !1;
                    ...
                    if (!h || "function" !== typeof h.getSlotElementId) return b("setMoatTargetingForSlot: Slot is missing, not setting targeting."), !1;
                    l = h.getSlotElementId();
                    if (a.b.b("adslot")) r = c("adslot");
                    else {
                        k = a.y.g(h, "adslot");
                        if (!k) return b("setMoatTargetingForSlot: slotId " + l + "; Failed to get adslot targeting array, not setting targeting."), !1;
                        r = k[0];
                        if ("undefined" === typeof r) return b("setMoatTargetingForSlot: slotId " +
                            l + "; No targeting data set for adslot, not setting targeting."), !1
                    }
                    k = n[r] && n[r][e];
                    if (!k) return b("setMoatTargetingForSlot: slotId " + l + "; No historical data found for adslot of " + r + ", not setting targeting."), a.y.h(h, g.d, q.f), a.y.h(h, g.e, q.f), !1;
                    for (var m in k)
                        if (a.b.bz(k, m)) {
                            var p = k[m];
                            if (a.b.cc(p)) {
                ...
                this.setMoatTargetingForAllSlots = function() {
                    a.y.a(function() {
                        var c = a.y.b();
                        if (!c) return b("setMoatTargetingForAllSlots: Failed to get slots from GPT, not setting targeting."),
                            !1;
                        a.b.forEach(c, function(a) {
                            d(a)
                        }, this)
                ...
                this.getMoatTargetingForSlot = function(d) {
                    ...
                    if ("object" === typeof g && "function" === typeof g.getTargeting) {
                        var k = "adslot";
            ...
            a.z.e = function() {
                var b = a.b.cf(["slotRenderEnded", function(b) {
                    if ("undefined" !==
                        typeof b && "undefined" !== typeof b.slot) {
            ...
            a.z.d = function(d, e, f) {
                ...
                f.t = a.c.ay;
                f.de = k;
                f.d = "MANSUETODFPCW_PREBID_HEADER1:" + (a.c.cp ? "Mobile" : "Desktop") + ":-:-";
                ...
                f.bq = a.c.as;
                f.f = Number(!E);
                (e = window.moatPrebidApi) && "function" === typeof e.slotDataAvailable && (f.zn = e.slotDataAvailable() ? 1 : 0);
                d = d && d - a.c.ay;
                a.b.cc(d) && (f["if"] = d);
                d = a.b.bw(f, !0);
                d += "&na=" + a.b.bx(d, f.i);
            ...
            u.url = a.b.u();
            u.confidence = a.b.w();
            u.pcode = "mansuetoprebidheader15141606144";
            u = a.b.bw(u, !0);
    ...
    if (!hourElapsed && 10 > window["Moat#EMC"]) {
        ...
        try {
            var pixelDomain = "px.moatads.com",
                pxSrc = "https://" + pixelDomain + "/pixel.gif?e=24&d=data%3Adata%3Adata%3Adata&i=" + escape("undefined" === typeof AD_VIEW_HASH ? "MANSUETODFPCW_PREBID_HEADER1" : AD_VIEW_HASH) + "&ac=1&k=" + escape(msg) + "&ar=" + escape("bc6efc1-clean") + "&j=" + escape(document.referrer) + "&cs=" + (new Date).getTime(),
                px = new Image(1, 1);
            px.src = pxSrc
        } catch (m) {}
    } else if (hourElapsed) {
        ...
        window["Moat#ETS"] = ct;
        try {
            pixelDomain = "px.moatads.com", pxSrc = "https://" + pixelDomain + "/pixel.gif?e=24&d=data%3Adata%3Adata%3Adata&i=" + escape("undefined" === typeof AD_VIEW_HASH ? "MANSUETODFPCW_PREBID_HEADER1" : AD_VIEW_HASH) + "&ac=1&k=" + escape(msg) + "&ar=" + escape("bc6efc1-clean") + "&j=" + escape(document.referrer) + "&cs=" + (new Date).getTime(), px = new Image(1, 1), px.src = pxSrc
        } catch (m) {}
    }
};