...
(function(Hatena) {
    ...
    var View = U.View = {
        ...
        getScrollByRoot: function() {
            return {
                x: this.root.scrollLeft,
                y: this.root.scrollTop
            };
        }
    };
    ...
    var Observer = U.Observer = function(target, type, handler, method) {
        ...
        if (method) {
            this.listener = (typeof method === 'string') ?
                function() {
                    return handler[method].apply(handler, arguments);
                } :
                function() {
                    return handler.apply(method, arguments);
                };
        }
    ...
    extend(WindowMessenger.prototype, {
        send: function(type, data) {
            ...
            var message = 'HBMessage@' + JSON.stringify({
                type: type,
                data: data
            });
    ...
    extend(B.BookmarkButton.prototype, {
        setup: function() {
            ...
            if (layout === 'simple') {
                ...
                this.frame = E('iframe', {
                    className: 'hatena-bookmark-button-frame',
    ...
    extend(B.BookmarkPanel, {
        ...
        getBasePosition: function() {
            ...
            return this.needsRebase ? View.getElementRect(document.body) : {
                x: 0,
                y: 0
            };
        }
    ...
    extend(B.BookmarkPanel.prototype, {
        setup: function() {
            ...
            var frameTitle = (this.title ? '\u300E' + this.title + '\u300F' : '\u3053\u306E\u30A8\u30F3\u30C8\u30EA\u30FC') + '\u3092\u306F\u3066\u306A\u30D6\u30C3\u30AF\u30DE\u30FC\u30AF\u306B\u8FFD\u52A0';
            this.panel = E('div', {
                    className: 'hatena-bookmark-bookmark-panel'
                },
                this.loading = E('div', null,
                    E('div', {
                            className: 'hatena-bookmark-panel-loading-wrapper',
                            style: 'background: #FFF url(' + B.staticOrigin + '/images/bg-entrybox@2x.png) repeat left top; background-size: 8px 8px;'
                        },
                        E('div', {
                                className: 'hatena-bookmark-panel-loading-container'
                            },
                            E('div', {
                                    className: 'hatena-bookmark-panel-loading-header'
                                },
                                E('a', {
                                    className: 'hatena-bookmark-panel-loading-header-icon-hatena',
                                    style: 'background: #00A3DE url(' + B.staticOrigin + '/images/icon_hatena_b.svg) no-repeat center center; background-size: 16px auto;'
                                }),
                                E('div', {
                                    className: 'hatena-bookmark-panel-loading-header-read'
                                })
                            ),
                            E('div', {
                                    className: 'hatena-bookmark-panel-loading-title'
                                },
                                E('span', {
                                    className: 'hatena-bookmark-panel-loading-placeholder',
                                ...
                                E('span', {
                                    className: 'hatena-bookmark-panel-loading-placeholder',
                                    style: 'height:14px; width:40%; margin-left:2px;'
                                })
                            ),
                            E('div', {
                                className: 'hatena-bookmark-panel-loading-form'
                            }),
                            E('div', {
                                    className: 'hatena-bookmark-panel-loading-bookmarks-header'
                                },
                                E('span', {
                                    className: 'hatena-bookmark-panel-loading-placeholder',
                            ...
                            E('div', {
                                    className: 'hatena-bookmark-panel-loading-bookmarks'
                                },
                                E('span', {
                                    className: 'hatena-bookmark-panel-loading-placeholder',
                                    style: 'height:32px; width: 32px; position: absolute; left: 8px; border-radius: 3px; padding: 0px;'
                                }),
                                E('span', {
                                    className: 'hatena-bookmark-panel-loading-placeholder',
                                    style: 'height:12px; display:block; padding-top: 0;'
                                }),
                                E('span', {
                                    className: 'hatena-bookmark-panel-loading-placeholder',
                                    style: 'height:12px; width:40%;'
