! function() {
    ...
    c.widgetId.get = function() {
        throw new Error("Method must be overridden")
    }, c.widgetUtmName.get = function() {
        return this.widgetId
    }, c.defaultSettings.get = function() {
        return a[this.widgetId]
    }, c.propertiesToWorkWith.get = function() {
        return []
    }, s.prototype.filterRawSettings = function(t) {
        var e = this,
            i = {};
        return Object.keys(t).forEach(function(r) {
            -1 !== e.propertiesToWorkWith.indexOf(r) && (i[r] = t[r])
        }), i
    }, c.propertiesToSkipInHash.get = function() {
        return ["customer", "locale"]
    }, s.prototype._getScriptsInfo = function() {
        var t = function() {
    ...
    }, s.prototype._replaceScript = function(t) {
        var i = this,
            r = t.scriptEnv,
            n = t.scriptHost,
            a = t.scriptElement;
    ...
    }, s.prototype._iframeSrcBase = function(t, e) {
    ...
    }, s.prototype._isValidSettings = function() {
        var t = function(t) {
    ...
    }, s.prototype._buildGetQueryString = function() {
        var t = this.settings.locale;
        return t ? "?locale=" + t : ""
    }, s.prototype._buildHashString = function(t) {
        var e = this,
            i = {};
    ...
    }, s.prototype._scriptContentToJSON = function() {
    ...
    }, s.prototype._createIframe = function(t, e, i, r, n) {
    ...
    }, Object.defineProperties(s.prototype, c), new(function(t) {
        function e() {
        ...
        return i.widgetId.get = function() {
            ...
            return ["arrowOnValue", "belowLineFillColorFalling", "belowLineFillColorGrowing", "customer", "gridLineColor", "height", "indexNameBold", "indexNonClickable", "isTransparent", "largeChartUrl", "locale", "plotLineColorFalling", "plotLineColorGrowing", "scaleFontColor", "showChart", "symbolActiveColor", "symbolDescriptionColor", "symbolSeparatorColor", "symbolShortNameColor", "tabs", "tickerColorFalling", "tickerColorGrowing", "valueBold", "valueTitleMarked", "whitelabel", "width"]
        }, e.prototype._createIframeWrap = function() {
            return t.prototype._createIframeWrap.call(this, this.settings.whitelabel)
