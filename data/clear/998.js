define("@ta/social.dates", ["@ta/common.global"], function(e) {
    return function(e) {
        var t = {};
        ...
        }, n.p = "", n(n.s = "./packages/social/dates/dates.jsx")
    }({
        ...
        "./packages/social/dates/dates.jsx": function(e, t, n) {
            "use strict";
            n.r(t);
            var o = n("./node_modules/@babel/runtime/helpers/esm/classCallCheck.js"),
                ...
                f = function e(t) {
                    if (t) {
                        var n = new Date(t);
                        return t.length < 11 && n.setMinutes(n.getMinutes() + n.getTimezoneOffset()), n
                    }
                    return null
                },
                m = function e(t) {
                    var n = new Date,
                        o = f(t);
                    return o ? o.getFullYear() === n.getFullYear() && o.getMonth() === n.getMonth() ? o.getDate() === n.getDate() ? Object(c.localize)("social_publish_date_Today") : o.getDate() === n.getDate() - 1 ? Object(c.localize)("social_publish_date_Yesterday") : c.globalize.formatDate("date_medium_month", o) : c.globalize.formatDate("date_medium_month_year", o) : null
                },
                b = function(e) {
                    function t() {
                    ...
                    return Object(i.a)(t, e), Object(r.a)(t, [{
                        key: "render",
                        value: function e() {
                            var t = this.props.dateStr;
                            return t ? m(t) : null
                        }
                    }]), t
                }(a.a.PureComponent);
            n.d(t, "ContentDisplayDate", function() {
                return b
            }), n.d(t, "getDateInBrowserTimezone", function() {
                return f
            }), n.d(t, "getDisplayDate", function() {
                return m
            })
        },
...
//# sourceMappingURL=social.dates.5aec9ca7ad.js.map