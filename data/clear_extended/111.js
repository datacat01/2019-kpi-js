...
window.orb.fig = function() {
        ...
        return l.load = function(e, n) {
            l.figFailed() ? n && "function" == typeof n && n(l) : l.isDefault() ? (e && "function" == typeof e && f.push(e), n && "function" == typeof n && o.push(n)) : e && "function" == typeof e && e(l)
        }, l.isDefault = function() {
            return u.df ? 1 : 0
        }, l.geo = {
            isUK: function() {
                return l("uk")
        ...
        }, l.updateCacheCookie = function(e) {
            r = !1;
            var n = new Date;
            ...
            u = e, l.redirect()
        }, l.figSuccess = function(e) {
            var n = p(e);
            l.updateCacheCookie(n), l.isCached() || l.setData(n);
            for (var t = 0, o = f.length; t < o; t++) f[t](l)
        }, l.figError = function() {
            if (t = !0, l.isDefault())
                for (var e = 0, n = o.length; e < n; e++) o[e](l)
        }, l.figFailed = function() {
            return t
        }, l.isOverridden = function() {
            return d
        }, l.isCached = function() {
            return a
        }, l.isStale = function() {
            ...
            if (e) {
                ...
                return e.replace(/([a-z]{2}):([0-9]+)/g, function(e, n, t) {
                    o[n] = +t
                }), u = o, l.redirect(), d = !0, l
            }
            d = !1;
            var n = h(s);
            if (n) try {
                var t = JSON.parse(n);
                u = t, l.redirect(), a = r = !0
            } catch (e) {
                u = i, a = !(jsonpTimeout = 3e3)
            } else u = i, a = !(jsonpTimeout = 3e3);
            return !window.orb_fig_blocking || e || n || (window.orb.orb_fig = function(e) {
                u = p(e || i), l.updateCacheCookie(u), l.redirect()
            }, document.write('<script src="' + window.orb.figUrl + '"><\/script>')), l
        }, l.init()
    ...
    function() {
                ...
                return new Promise(function(l, h) {
                    if (a() && ! function() {
                        ...
                        var e = new Promise(function(t, e) {
                                ! function n() {
                                    (new Date).getTime() - g >= b ? e() : document.fonts.load(x(p, '"' + p.family + '"'), m).then(function(e) {
                        ...
                        function t() {
                            var e;
                            (e = -1 != a && -1 != c || -1 != a && -1 != s || -1 != c && -1 != s) && ((e = a != c && a != s && c != s) || (null === E && (e = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent), E = !!e && (parseInt(e[1], 10) < 536 || 536 === parseInt(e[1], 10) && parseInt(e[2], 10) <= 11)), e = E && (a == n && c == n && s == n || a == d && c == d && s == d || a == u && c == u && s == u)), e = !e), e && (f.parentNode && f.parentNode.removeChild(f), clearTimeout(w), l(p))
                        }
                        var o = new v(m),
                            i = new v(m),
                            r = new v(m),
                        ...
                        f.dir = "ltr", y(o, x(p, "sans-serif")), y(i, x(p, "serif")), y(r, x(p, "monospace")), f.appendChild(o.a), f.appendChild(i.a), f.appendChild(r.a), document.body.appendChild(f), n = o.a.offsetWidth, d = i.a.offsetWidth, u = r.a.offsetWidth,
                            function e() {
                                ...
                                a = e, t()
                            }), y(o, x(p, '"' + p.family + '",sans-serif')), C(i, function(e) {
                                c = e, t()
                            }), y(i, x(p, '"' + p.family + '",serif')), C(r, function(e) {
                                s = e, t()
                            }), y(r, x(p, '"' + p.family + '",monospace'))
                    })
                })
        ...
        }!(-1 !== e.indexOf("msie") && parseInt(e.split("msie")[1], 10) <= 10) && (n("ReithSans", "b-reith-sans-font", "b-reith-sans-loaded"), n("ReithSerif", "b-reith-serif-font", "b-reith-serif-loaded"))
    }(),
    function() {
        "use strict";
        var n = ["GB", "IM", "JE", "GY"],
            t = ["AT", "BE", "BG", "CY", "CZ", "DE", "DK", "EE", "ES", "EU", "FI", "FR", "GB", "GR", "HU", "HR", "IE", "IT", "LT", "LU", "LV", "MT", "NL", "PL", "PT", "RO", "SE", "SI", "SK"],
            o = function(e, n) {
