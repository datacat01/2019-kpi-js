            ...
            if (typeof document.body.style.maxHeight != "undefined") {
                ...
                return this.each(function() {
                    ...
                    d.bind("update", function() {
                        d.change();
                        var h = parseInt(d.outerWidth()) - (parseInt(e.outerWidth()) - parseInt(e.width()));
                        e.css({
    ...
    function processDotDotDot() {
        ...
        if (!$.browser.msie || $.browser.version > 7.0) {
            if ($('.node-type-homepage').length !== 0) {
                ...
                $('.field-name-field-news-top-left .field-name-body').dotdotdot({
                    watch: true,
                    height: leftHeight
                });
                $('.field-name-field-news-top-right .field-name-body').dotdotdot({
                    watch: true,
                    height: topRightHeight
                });
                $('.field-name-field-news-middle-right .field-name-body').dotdotdot({
                    watch: true,
            ...
            $('.field-name-field-social-status .field-item').dotdotdot({
                watch: true
            });
            $('.related-news-footer .views-row').dotdotdot({
                watch: true
            });
        }
    }
