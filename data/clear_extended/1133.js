    ...
    Drupal.omega.checkLayout = function(layout) {
        if (Drupal.settings.omega.layouts.queries.hasOwnProperty(layout) && Drupal.settings.omega.layouts.queries[layout]) {
            ...
            if (!output && layout == Drupal.settings.omega.layouts.primary) {
                ...
                dummy.append('<!--[if (lt IE 9)&(!IEMobile)]><style media="all">#omega-check-query { z-index: 100 !important; }</style><![endif]-->');
    ...
    Drupal.behaviors.omegaMediaQueries = {
        attach: function(context) {
            $('body', context).once('omega-mediaqueries', function() {
                ...
                dummy.append('<!--[if (lt IE 9)&(!IEMobile)]><style media="all">#omega-media-query-dummy { z-index: ' + primary + ' !important; }</style><![endif]-->');
