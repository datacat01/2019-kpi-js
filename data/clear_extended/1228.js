...
! function(e) {
    var t = function() {
        ...
        return t.Initialize = function(t, i) {
            ...
            return e.Logger.context && (t.setProperty("ServerBuildDate", e.Logger.context.serverBuildDate), t.setProperty("ServerBuildId", e.Logger.context.serverBuildId)), window.prelaunchMode && t.setProperty("PrelaunchMode", "true"), t.setProperty("LoggerId", "Standalone"), t
            ...
            if (!(s > o || window.disableLogs && !a)) {
                ...
                u.setName(t), i && u.setProperty("EventName", i), u.setProperty("AppSecurityLevel", o), window.prelaunchMode && u.setProperty("PrelaunchMode", "true"), "Performance_Dump" === t && void 0 !== window.startedFromServiceWorker && u.setProperty("CachedPage", window.startedFromServiceWorker.toString()), e.Logger.ariaLogger.logEvent(u)
            }
        ...
        }, t.emailRegex = new RegExp("[a-zA-Z0-9_\\-\\.]+(@|%40|%2540)[a-zA-Z0-9_\\-\\.]+\\.[a-zA-Z]{2,63}", "g"), t.localFileRegex = new RegExp("file(:|%3A|%253A).*", "gi"), t.context = null, t.sessionActive = !1, t
    }();
    e.Logger = t
