! function() {
    ...
    var AbstractEvent = function() {
        ...
        LogLevel, d;
    d = LogLevel || (LogLevel = {}), d[d.Error = 0] = "Error", d[d.Warning = 1] = "Warning", d[d.Debug = 2] = "Debug";
    var CSS_LOG = ["color: #fff;", "background: #ff8f1c;", "display: inline-block;", "padding: 1px 4px;", "border-radius: 3px;"].join(" "),
        Log = function() {
            function r() {}
            return r.Log = function(t, e) {
                if (!(r.LOGLEVEL < t)) {
                    var n = LogLevel[t].toUpperCase(),
                        o = window.navigator.userAgent,
                        i = 0 < o.indexOf("MSIE ") || 0 < o.indexOf("Trident/");
                    window.console ? i ? console.log("[PubTag] " + n + ": " + e) : console.log("%cPubTag", CSS_LOG, n + ": " + e) : t <= LogLevel.Error && alert("[PubTag] " + n + ": " + e)
                }
            }, r.Debug = function(t) {
    ...
    var TimeMeasurer = function() {
        ...
        return n.CreateRunning = function() {
            var t = new n;
            return t.start(), t
    ...
    function retrieveGDPRConsent(t, n, e) {
        ...
        var o = TimeMeasurer.CreateRunning(),
            ...
            r = setTimeout(function() {
                i = !0, Log.Warning("Timeout: Unable to resolve GDPR consent after " + e + "ms"), n(void 0)
            }, e);
        executeCommand(t, "getVendorConsents", [CRITEO_VENDOR_ID], function(t, e) {
            i || (clearTimeout(r), e ? (Log.Debug("Consent retrieved in " + o.elapsed() + "ms"), getVendorConsentsCallback(t, n)) : (Log.Warning("Error retrieving GDPR consent data from CMP"), n(void 0)))
        })
    }
    ...
    function getVendorConsentsCallback(t, e) {
        if (t) {
            var n = {};
            void 0 !== t.metadata && (n.consentData = t.metadata), void 0 !== t.gdprApplies && (n.gdprApplies = !!t.gdprApplies), t.vendorConsents && void 0 !== t.vendorConsents[CRITEO_VENDOR_ID.toString()] && (n.consentGiven = !!t.vendorConsents[CRITEO_VENDOR_ID.toString()]), e(n)
    ...
    function executeCommand(t, e, n, o) {
        if (!cmpInFrame(t)) {
            ...
            t.__cmp = function(t, e, n) {
                if (!r) return Log.Warning("CMP not found"), void n({
                    msg: "CMP not found"
                }, !1);
                ...
                if (e && e.__cmpReturn && e.__cmpReturn.callId && e.__cmpReturn.returnValue) {
                    var n = e.__cmpReturn;
                    cmpCallbacks[n.callId](n.returnValue, n.success), delete cmpCallbacks[n.callId]
                }
            }, !1)
        }
        t.__cmp(e, n, o)
    ...
    var LocalStorageHelper = function() {
            function t(t) {
                this.EXPIRE_SUFFIX = "_expires", this.CHECK_STORAGE_KEY = "criteo_localstorage_check", this.localStorage = tryGetLocalStorage(t || window)
            }
            return t.prototype.checkLocalStorage = function() {
                ...
                var n = (new Date).getTime(),
                    ...
                    i = o ? parseInt(o, 10) : -1;
                return -1 !== i && i < n || e && (-1 === i || e < i - n) ? (this.removeItem(t), null) : this.localStorage.getItem(t)
        ...
        DirectBiddingSilentModeManager = function() {
            function n() {
                this.localStorageHelper = new LocalStorageHelper, this.localStorageEnabled = this.localStorageHelper.checkLocalStorage()
            }
            return n.prototype.silentModeEnabled = function() {
            ...
            }, n.SILENT_MODE_KEY = "criteo_silent_mode", n
        }();
    ...
    var Lock = function() {
            ...
            return t.prototype.get = function(t) {
                ...
                var o = this;
                void 0 === n && (n = 100), n <= 0 || this.tryAcquire(e) ? (t(), this.release()) : setTimeout(function() {
                    o.acquire(t, e, n - 10)
                }, 10)
        ...
        Qa, SlotKeyWithSize = function(i) {
            function t(t, e, n) {
                var o = i.call(this, t) || this;
                return o.size = e, o.networkId = n, o
            }
            return __extends(t, i), t.prototype.toString = function() {
                return i.prototype.toString.call(this) + "_Size" + this.size + "_NetworkId" + this.networkId
            }, t
        }(SlotKey),
        __extends$1 = (fb = function(t, e) {
            ...
            fb(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        fb, SlotKeyWithZoneId = function(o) {
            function t(t, e) {
                var n = o.call(this, t) || this;
                return n.zoneId = e, n
            }
            return __extends$1(t, o), t.prototype.toString = function() {
        ...
        SlotKeyFactory = function() {
            ...
            return t.prototype.createKeysFromSlotRequest = function(t) {
                if (this.useZoneIdIntegration) return [new SlotKeyWithZoneId(t.impId, t.zoneId)];
                ...
                return this.useZoneIdIntegration ? new SlotKeyWithZoneId(t.impid, t.zoneid) : new SlotKeyWithSize(t.impid, new Size(t.width, t.height), this.networkId)
            }, t.prototype.createKeyFromBid = function(t) {
                return this.useZoneIdIntegration ? new SlotKeyWithZoneId(t.impressionId, t.zoneId) : new SlotKeyWithSize(t.impressionId, new Size(t.width, t.height), this.networkId)
            }, t
        }(),
        DirectBiddingBidManager = function() {
            function l(t, e) {
                this.localStorageHelper = new LocalStorageHelper, this.localStorageEnabled = this.localStorageHelper.checkLocalStorage(), this.slotKeyFactory = new SlotKeyFactory(t, e)
            }
            return l.useZoneIdIntegration = function(t, e) {
                ...
                0 < e.bids.length || e.no_bid && e.no_bid > now() ? this.localStorageHelper.setItem(n, JSON.stringify(e)) : this.localStorageHelper.removeItem(n)
            }, l.prototype.filterNoBidSlots = function(t) {
                for (var e = [], n = 0, o = t; n < o.length; n++) {
                    for (var i = o[n], r = [], a = 0, s = this.slotKeyFactory.createKeysFromSlotRequest(i); a < s.length; a++) {
                        var d = s[a];
                        this.getBid(d, 0) !== l.NO_BID && (d instanceof SlotKeyWithSize ? r.push(d.size) : e.push(i))
                    }
                ...
                for (var n = [], o = 0, i = t; o < i.length; o++)
                    for (var r = i[o], a = 0, s = this.slotKeyFactory.createKeysFromSlotRequest(r); a < s.length; a++) {
                        var d = s[a],
                            c = this.getBid(d, e);
                ...
                if (void 0 === e && (e = 5e3), this.localStorageEnabled) {
                    ...
                    if (0 < e)
                        for (var o = 0, i = n.bids; o < i.length; o++) {
                            var r = i[o];
                            if (new Lock(l.BID_KEY_PREFIX + r.bid.slotid).tryAcquire(e)) return r.bid
                        }
                }
            }, l.prototype.storeRequestNoBid = function(t, e) {
                for (var n = 0, o = this.slotKeyFactory.createKeysFromSlotRequest(t); n < o.length; n++) {
                    var i = o[n];
                    this.storeNoBid(i, e)
                }
                ...
                this.modifyCache(t, function(t) {
                    for (var e = 0; e < t.bids.length; e++)
                        if (t.bids[e].bid.slotid === n.slotId) return void t.bids.splice(e, 1)
        ...
        DirectBiddingCache = function() {
            function t(t, e, n) {
                ...
                this.bidManager = new DirectBiddingBidManager(o, n), this.silentModeManager = new DirectBiddingSilentModeManager, this.context = t
            }
            return t.prototype.filterNoBidSlots = function(t) {
                ...
                0 < i && (Log.Debug("Global silent mode enabled for " + i + " seconds"), this.silentModeManager.enableSilentMode(1e3 * i));
                var r = {};
                if (n.slots)
                ...
                if (e.slots)
                    for (var d = 0, c = e.slots; d < c.length; d++) {
                        var l = 0;
                        (h = c[d]).slotid in r && (l = r[h.slotid], delete r[h.slotid]), o && 0 < l && (Log.Debug("Post-timeout bid for slot '" + h.impid + "' cached for " + l + " seconds"), this.bidManager.storeResponseBid(h, l))
                    }
                for (var u in r)
                    if (r.hasOwnProperty(u))
                        for (var p = 0, f = t; p < f.length; p++) {
                            ...
                            if ((h = f[p]).slotId === u) {
                                l = r[u];
                                Log.Debug("Silent mode for slot '" + h.impId + "' enabled for " + l + " seconds"), this.bidManager.storeRequestNoBid(h, l)
                            }
                        }
            }, t
        }(),
        AsyncRequest = function() {
            function a(t, e, n, o) {
                void 0 === o && (o = !0), this.url = t, this.data = e, this.contentType = n, this.withCredentials = o
            }
            return a.prototype.send = function(t, e, n, o) {
                ...
                if ("withCredentials" in r) return r.open(t, this.url, !0), r.timeout = i || a.LOCAL_PASSBACK_TIMEOUT, this.contentType ? r.setRequestHeader("Content-type", this.contentType) : "POST" === t && r.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), r.withCredentials = this.withCredentials, r.onload = function() {
                    4 === r.readyState && 200 === r.status ? e(r.responseText) : n(r.readyState, r.status)
                }, r.onerror = function() {
                    n(void 0, void 0)
                }, o && (r.ontimeout = o), r
                ...
                if ("undefined" != typeof XDomainRequest) {
                    ...
                    return r.timeout = i || a.LOCAL_PASSBACK_TIMEOUT, r.open(t, this.url), r.onload = function() {
                        void 0 !== r.responseText ? e(r.responseText) : n(void 0, void 0)
                    }, r.onerror && (r.onerror = function() {
                        n(void 0, void 0)
                    }), r.ontimeout && o && (r.ontimeout = o), r
                }
            }, a.LOCAL_PASSBACK_TIMEOUT = 3e4, a
        }();
    ...
    var PublisherTagVersion = 65,
        DirectBiddingMetric = function(t, e, n, o, i, r, a, s, d, c, l, u) {
            this.publisherTagVersion = t, this.slots = e, this.elapsed = n, this.isTimeout = o, this.pageLoadElapsed = i, this.adapterStartElapsed = r, this.cdbCallStartElapsed = a, this.cdbCallEndElapsed = s, this.adapterEndElapsed = d, this.setTargetingElapsed = c, this.adapterTimeout = l, this.adapterIsTimeout = u
        },
        DirectBiddingMetricSlot = function(t, e, n, o) {
            this.impressionId = t, this.zoneId = e, this.adUnitId = n, this.cachedBidUsed = o
        },
        DirectBiddingMetricBuilder = function() {
            ...
            return t.prototype.withElapsed = function(t) {
                ...
                var o = 0 < this.cachedBidsReturned.filter(function(t) {
                    return t.impid === n && t.zoneid === e
                }).length;
                return this.slots.push(new DirectBiddingMetricSlot(t, e, n, o)), this
            }, t.prototype.build = function() {
                var t;
                return void 0 !== this.adapterTimeout && (t = this.adapterEndElapsed > this.adapterTimeout), new DirectBiddingMetric(PublisherTagVersion, this.slots, this.elapsed, this.isTimeout, this.pageLoadElapsed, this.adapterStartElapsed, this.cdbCallStartElapsed, this.cdbCallEndElapsed, this.adapterEndElapsed, this.setTargetingElapsed, this.adapterTimeout, t)
            }, t
        }(),
        DirectBiddingMetricsManager = function() {
            ...
            return i.prototype.getMetrics = function(t) {
                if (this.localStorageEnabled) {
            ...
            }, i.METRICS_STORAGE_KEY = "criteo_pt_cdb_metrics", i
        }(),
        IntegrationMode, Ce;
    ...
    Ce = IntegrationMode || (IntegrationMode = {}), Ce[Ce.Unspecified = 0] = "Unspecified", Ce[Ce.AMP = 1] = "AMP";
    var DirectBiddingRequestBuilder = function() {
        function t(t, e, n, o, i, r, a, s, d, c) {
            this.slots = t, this.context = e, this.metricsManager = n, this.urlBuilder = o, this.profileId = i, this.integrationMode = r || IntegrationMode.Unspecified, this.networkId = a, this.adapterVersion = s, this.gdprConsent = d, this.wrapperVersion = c
        }
        return t.prototype.isValid = function() {
            ...
            for (var t = [], e = 0, n = this.slots; e < n.length; e++) {
                ...
                if (void 0 !== o.zoneId && (i.zoneid = o.zoneId), void 0 !== o.nativeCallback && (i.native = !0), void 0 !== o.transactionId && (i.transactionid = o.transactionId), void 0 !== o.publisherSubId && (i.publishersubid = o.publisherSubId), void 0 !== o.sizes) {
            ...
            return l.length && (c.previousBidFeedback = l), this.gdprConsent && (c.gdprConsent = this.gdprConsent), c
    ...
    function getPreciseRequestDuration(t) {
        if (window.performance && window.performance.getEntries)
            for (var e = window.performance.getEntries(), n = e.length - 1; 0 <= n; --n) {
                var o = e[n];
    ...
    var DirectBiddingTimer = function() {
            function t(t, e, n) {
                this.hasSetTargetingBeenCalled = !1, this.builder = t, this.timer = void 0 !== e ? TimeMeasurer.CreateWithStartTime(e) : TimeMeasurer.CreateRunning();
                var o = this.timer.elapsed();
                this.builder.withAdapterStartElapsed(o), this.builder.withPageLoadElapsed(TimeMeasurer.TimeSincePageLoad() - o), void 0 !== n && this.builder.withAdapterTimeout(n)
            }
            return t.prototype.sendRequest = function(t) {
                this.url = t, this.sendTime = TimeMeasurer.CreateRunning(), this.builder.withCdbCallStartElapsed(this.timer.elapsed())
            }, t.prototype.requestReceived = function(t) {
                void 0 === t && (t = !1), this.builder.withElapsed(getPreciseRequestDuration(this.url) || this.sendTime.elapsed()), this.builder.withCdbCallEndElapsed(this.timer.elapsed()), this.builder.withIsTimeout(t)
        ...
        __extends$2 = (qf = function(t, e) {
            ...
            qf(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        qf, DirectBiddingEvent = function(u) {
            function p(t, e, n, o, i, r, a, s, d, c) {
                var l = u.call(this, p.NAME) || this;
                return l.profileId = t, l.urlBuilder = e, l.slots = n, l.metricBuilder = new DirectBiddingMetricBuilder, l.metricsManager = new DirectBiddingMetricsManager, l.callbackSuccess = o, l.callbackError = i, l.callbackTimeout = r, l.timeout = a, l.networkId = s, l.integrationMode = d, l.adapterVersion = c, l
            }
            return __extends$2(p, u), p.prototype.setGDPRConsent = function(t) {
                this.gdprConsent = t
                ...
                var o = this,
                    ...
                    s = new DirectBiddingRequestBuilder(this.slots, t.context, this.metricsManager, this.urlBuilder, this.profileId, this.integrationMode, this.networkId, this.adapterVersion, this.gdprConsent);
                if (s.isValid() && "undefined" != typeof JSON) {
                    var d = s.getRequest(),
                        c = JSON.stringify(d),
                        l = s.getUrl(),
                        u = new AsyncRequest(l, c, "application/x-www-form-urlencoded");
                    a.sendRequest(l), u.send(function(t) {
                        a.requestReceived();
                        var e = tryParseJson(t) || {},
                            n = extractExtraData(e);
                        void 0 !== o.callbackSuccess && o.callbackSuccess(JSON.stringify(e), n), o.metricsManager.storeMetric(a.finish(n.slots))
                    }, function(t, e) {
                        a.requestReceived(), void 0 !== o.callbackError && o.callbackError(t, e), o.metricsManager.storeMetric(a.finish())
                    }, function() {
                        a.requestReceived(!0), void 0 !== o.callbackTimeout && o.callbackTimeout(), o.metricsManager.storeMetric(a.finish())
                    }, this.timeout)
        ...
        __extends$3 = (ig = function(t, e) {
            ...
            ig(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        ig, DirectBiddingEventWithCaching = function(p) {
            function f(t, e, n, o, i, r, a, s, d, c) {
                var l = p.call(this, f.NAME) || this,
                    u = Math.max(10 * (a || 3e3), 3e3);
                return l.cache = new DirectBiddingCache(window.criteo_pubtag.context, n, s), l.directBiddingEvent = new DirectBiddingEvent(t, e, l.cache.filterNoBidSlots(n), function(t, e) {
                    return l.onSuccess(t, e)
                }, function(t, e) {
                    return l.onError(t, e)
                }, function() {
                    return l.onHttpTimeout()
                }, u, s, d, c), l.slots = n, l.callbackSuccess = o, l.callbackError = i, l.callbackTimeout = r, l.timeout = a, l.hasTimeouted = !1, l.hasResponded = !1, l
            }
            return __extends$3(f, p), f.prototype.eval = function(e) {
                var n = this;
                hasCMP(window) ? retrieveGDPRConsent(window, function(t) {
                    n.evalWithCmp(e, t)
                }) : this.evalWithCmp(e, void 0)
            }, f.prototype.evalWithCmp = function(t, e) {
                var n = this;
                if (this.cache.silentModeEnabled()) return Log.Debug("Request ignored because the global silent mode is enabled"), void this.callbackSuccess("", void 0);
                setTimeout(function() {
                    return n.onTimeout()
                ...
                if (!this.hasResponded) {
                    ...
                    0 === t.length ? this.callbackTimeout() : (Log.Debug("Cached bids returned because of timeout: ['" + t.map(function(t) {
                        return t.impid
        ...
        DirectBiddingUrlBuilder = function() {
            ...
            return a.prototype.buildUrl = function(t, e, n, o, i) {
                void 0 === n && (n = IntegrationMode.Unspecified);
                var r = ("https:" === e.protocol ? "https:" : "http:") + a.CRITEO_BIDDER_URL + this.getHandlerPath();
                return r += "?ptv=" + PublisherTagVersion, r += "&profileId=" + String(t), r += e.ctoIdOnPublisherDomain ? "&idcpy=" + e.ctoIdOnPublisherDomain : "", r += e.idfs ? "&idfs=" + e.idfs : "", r += e.secureId ? "&sid=" + e.secureId : "", r += e.isOptOut ? "&optout=1" : "", n !== IntegrationMode.Unspecified && (r += "&im=" + n), void 0 !== o && (r += "&av=" + String(o)), void 0 !== i && (r += "&wv=" + encodeURIComponent(i)), r += e.silentModeIgnored ? "&smi=1" : "", r += "&cb=" + String(CacheBusterGenerator.generateCacheBuster()), r += e.getContextFlags()
            }, a.prototype.getHandlerPath = function() {
                return this.auditMode ? a.CRITEO_BIDDER_AUDIT_HANDLER : a.CRITEO_BIDDER_HANDLER
            }, a.CRITEO_BIDDER_URL = "//bidder.criteo.com/", a.CRITEO_BIDDER_HANDLER = "cdb", a.CRITEO_BIDDER_AUDIT_HANDLER = "prebid/audit", a
        }();
    ...
    function googleSlotsToDynamicSlots(t) {
        for (var e = [], n = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, o = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight, i = 0, r = t; i < r.length; i++) {
            for (var a = r[i], s = a.getSlotElementId(), d = [], c = 0, l = a.getSizes(n, o) || a.getSizes(); c < l.length; c++) {
                var u = l[c];
                "function" == typeof u.getWidth && u.getWidth() && "function" == typeof u.getHeight && u.getHeight() && d.push(u.getWidth() + "x" + u.getHeight())
            }
            s && 0 < d.length && e.push({
                slotId: s,
                sizes: d
    ...
    var DFPKeyValueTargeter = function() {
        function t() {
            void 0 === window.googletag && (window.googletag = {}), this.googletag = window.googletag, this.googletag.cmd = this.googletag.cmd || []
        }
        return t.prototype.setKeyValuesForAllSlots = function(e) {
            var n = this;
            this.googletag.cmd.push(function() {
                for (var t in e) e.hasOwnProperty(t) && (n.googletag.pubads().clearTargeting(t), n.googletag.pubads().setTargeting(t, e[t] + ""))
            })
        }, t.prototype.setKeyValuePerSlot = function(e, n) {
            var o = this.googletag.pubads().getSlots().filter(function(t) {
                return t.getSlotElementId() === e
            });
            0 === o.length ? Log.Warning("No googletag slot found for slotId: " + e) : 1 < o.length ? Log.Warning("More than one googletag slot found for slotId: " + e) : this.googletag.cmd.push(function() {
                for (var t in n) n.hasOwnProperty(t) && (o[0].clearTargeting(t), o[0].setTargeting(t, n[t] + ""))
            })
        }, t.prototype.resetKeyValuesForSlots = function(e) {
            var t = this,
                n = createEmptyDFPTargeting();
            this.googletag.pubads().getSlots().filter(function(t) {
    ...
    var BidEventTarget = function() {},
        __extends$4 = (Sh = function(t, e) {
            ...
            Sh(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        Sh, BidEventContainerTarget = function(_super) {
            function BidEventContainerTarget(t, e) {
                var n = _super.call(this) || this;
                n.containerId = e;
                var o = t.getElementById(e);
                return o ? n.element = o : Log.Error("Target element '" + e + "' not found in the document"), n
            }
            return __extends$4(BidEventContainerTarget, _super), BidEventContainerTarget.prototype.ResizeFrame = function(t, e) {}, BidEventContainerTarget.prototype.Write = function(t) {
                this.element && (this.element.innerHTML = t)
            }, BidEventContainerTarget.prototype.LoadScript = function(url) {
                url += -1 === url.indexOf("?") ? "?" : "&", url += "containerid=" + encodeURIComponent(this.containerId);
                var request = new AsyncRequest(url);
                request.send(function(responseText) {
                    eval(responseText)
                }, function() {}, function() {})
        ...
        __extends$5 = (ii = function(t, e) {
            ...
            ii(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        ii, BidEventDocumentTarget = function(n) {
            function t(t) {
                var e = n.call(this) || this;
                return e.document = t, e
            }
            return __extends$5(t, n), t.prototype.ResizeFrame = function(t, e) {
                ...
                this.Write("<script type='text/javascript' src='" + t + "'><\/script>")
            }, t
        }(BidEventTarget),
        ...
        Ci, Custom = function(n) {
            function o(t) {
                var e = n.call(this, o.NAME) || this;
                return e.callback = t, e
            }
            return __extends$6(o, n), o.prototype.eval = function(t) {
                this.callback && this.callback.apply(this)
            }, o.NAME = "genericEvent", o
        }(AbstractEvent),
        BidResponseSlot = function() {
            function t(t, e, n, o, i, r) {
                this.id = this.generateRandomId(), this.slotId = t, this.impressionId = e, this.cpm = n, this.width = o, this.height = i, this.zoneId = r
            }
            return t.prototype.generateRandomId = function() {
        ...
        __extends$7 = (Zi = function(t, e) {
            ...
            Zi(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        Zi, DisplayUrlBidResponseSlot = function(d) {
            function t(t, e, n, o, i, r, a) {
                var s = d.call(this, t, e, n, o, i, r) || this;
                return s.displayUrl = a, s
            }
            return __extends$7(t, d), t.prototype.GenerateEvent = function(t) {
                var e = this;
                return t.ResizeFrame(this.width, this.height), new Custom(function() {
        ...
        __extends$8 = (uj = function(t, e) {
            ...
            uj(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        uj, HtmlCreativeBidResponseSlot = function(d) {
            function t(t, e, n, o, i, r, a) {
                var s = d.call(this, t, e, n, o, i, r) || this;
                return s.creative = a, s
            }
            return __extends$8(t, d), t.prototype.GenerateEvent = function(t) {
                var e = this;
                return t.ResizeFrame(this.width, this.height), new Custom(function() {
        ...
        LineItemRange = function() {
            ...
            return f.createLineItemRangesFromString = function(t) {
                for (var e = [], n = 0, o = t.split(";"); n < o.length; n++) {
                    ...
                    var l = d - a,
                        u = l / c,
                        p = u === Math.floor(u);
                    d < a ? Log.Warning("Lower bound (" + a + ") greater than upper bound (" + d + ")") : p ? e.push(new f(a, d, c)) : Log.Warning("Range (" + l + ") is not divisible by increment (" + c + ")")
                }
                return e.sort(function(t, e) {
                    return t.upperBound > e.upperBound ? 1 : e.upperBound > t.upperBound ? -1 : 0
                }), e
            }, f.getDefaultDenseLineItemRanges = function() {
                return [new f(0, 3, .01), new f(3, 8, .05), new f(8, 20, .5)]
                ...
                return t < e[0].lowerBound ? void 0 : t === e[0].lowerBound ? f.formatPriceBand(e[0].lowerBound) : f.formatPriceBand(e[e.length - 1].upperBound)
        ...
        __extends$9 = (xk = function(t, e) {
            return (xk = Object.setPrototypeOf || {
                    __proto__: []
                }
                instanceof Array && function(t, e) {
                    t.__proto__ = e
            ...
            xk(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        xk, NativeBidResponseSlot = function(c) {
            function t(t, e, n, o, i, r, a, s) {
                var d = c.call(this, t, e, n, o, i, r) || this;
                return d.nativeCallback = a, d.nativePayload = s, d
            }
            return __extends$9(t, c), t.prototype.GenerateEvent = function(t) {
                var e = this;
                return "function" != typeof this.nativeCallback ? (Log.Error("'nativeCallback' parameter is not a function in placements object"), new Custom(void 0)) : "object" != typeof this.nativePayload ? (Log.Error("'nativePayload' parameter is not an object in placements object"), new Custom(void 0)) : new Custom(function() {
        ...
        InputParameters = function() {
            function t() {
                var e = this;
                this.integrationMode = IntegrationMode.Unspecified, this.paramParser = {}, this.addParameter("integrationMode", function(t) {
                    e.integrationMode = parse(t)
                })
            }
            return t.prototype.addParameter = function(t, e) {
                this.paramParser[t.toLowerCase()] = e
            }, t.prototype.tryFillParameters = function(t) {
                for (var e in t)
                    if (void 0 !== t[e]) {
                        var n = e.toLowerCase();
                        this.paramParser[n] ? this.paramParser[n](t[e]) : Log.Warning("Unknown parameter: " + e)
                    }
            }, t
        }(),
        __extends$10 = (bl = function(t, e) {
            ...
            bl(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        bl, RenderAdInputParameters = function(n) {
            function t(t) {
                var e = n.call(this) || this;
                return e.bidId = void 0, e.document = window.document, e.containerId = void 0, e.addParameter("bidId", function(t) {
                    e.bidId = t
                }), e.addParameter("document", function(t) {
                    e.document = t
                }), e.addParameter("containerId", function(t) {
                    e.containerId = t
                }), n.prototype.tryFillParameters.call(e, t), e
            }
    ...
    var DirectBiddingSlot = function(t, e, n, o, i, r) {
            this.slotId = generateUuid().replace(/-/g, ""), this.impId = t, this.zoneId = e, this.nativeCallback = n, this.transactionId = o, this.sizes = i, this.publisherSubId = r
        },
        __extends$11 = (Dl = function(t, e) {
            ...
            Dl(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        Dl, PlacementInputParameters = function(e) {
            function t(t) {
                var i = e.call(this) || this;
                return i.slotId = void 0, i.zoneId = void 0, i.sizes = [], i.nativeCallback = void 0, i.publisherSubId = void 0, i.addParameter("slotid", function(t) {
                    i.slotId = t
                    ...
                    i.publisherSubId = t
                }), e.prototype.tryFillParameters.call(i, t), i
            }
        ...
        _l, StandaloneInputParameters = function(n) {
            function t(t) {
                var e = n.call(this) || this;
                return e.placements = void 0, e.networkId = void 0, e.addParameter("networkId", function(t) {
                    e.networkId = t
                }), e.addParameter("placements", function(t) {
                    e.placements = e.deserializePlacementInput(t)
                }), n.prototype.tryFillParameters.call(e, t), e
            }
            return __extends$12(t, n), t.prototype.deserializePlacementInput = function(t) {
                for (var e = [], n = 0, o = t; n < o.length; n++) {
                    var i = o[n],
                        r = new PlacementInputParameters(i);
                    e.push(new DirectBiddingSlot(r.slotId, r.zoneId, r.nativeCallback, void 0, r.sizes, r.publisherSubId))
                }
                return e
            }, t
        }(InputParameters),
    ...
    function DiscoverTagsAndRequestBids(e, n, o) {
        retrieveGoogleTagPlacements(function(t) {
            t.length <= 0 ? Log.Warning("No Google tag placements have been retrieved, no bid will be requested.") : RequestBidsWithProfileId({
                networkId: e,
                placements: t
            }, standaloneProfileId, n, o)
        })
    }
    ...
    function RequestBidsOnGoogleTagSlots(t, e, n) {
        if ("number" == typeof t) {
            ...
            void 0 === i ? DiscoverTagsAndRequestBids(o, r, a) : RequestBidsWithProfileId({
                networkId: o,
                placements: googleSlotsToDynamicSlots(i)
            }, standaloneProfileId, r, a)
        }
    }
    var metricBuilders = {},
        bidCaches = {};
    ...
    function RequestBidsWithProfileId(t, e, v, n) {
        ...
        if (checkInputParameters(m)) {
            for (var o = function() {
                    void 0 !== v && v([])
                }, i = new DirectBiddingEventWithCaching(e, new DirectBiddingUrlBuilder(!1), m.placements, function(t) {
                    var e = tryParseJson(t);
                    if (void 0 !== e && void 0 !== e.slots) {
                        var a = {};
                        if (e.invocation_codes)
                            for (var n = 0, o = e.invocation_codes; n < o.length; n++)
                                for (var i = o[n], r = 0, s = i.slot_ids; r < s.length; r++) {
                                    var d = s[r];
                                    a[d] = i.invocation_code
                                }
                        for (var c = function(e) {
                                for (var t = void 0, n = 0, o = m.placements; n < o.length; n++) {
                                    var i = o[n];
                                    if (i.nativeCallback && i.impId === e.impid) {
                                        t = i.nativeCallback;
                                        break
                                    }
                                }!t && e.slotid in a && (t = function(t) {
                                    executeFunction(a[e.slotid], [t])
                                });
                                var r = GenerateBidResponseSlot(e.slotid, e.impid, e.cpm, e.width, e.height, e.zoneid, t, e.native, e.displayurl, e.creative);
                                void 0 !== r && (window.criteo_pubtag.standaloneBidder.bids[r.id] = r)
                            }, l = 0, u = e.slots; l < u.length; l++) c(u[l]);
                ...
                }, o, o, n || 3e3, m.networkId, m.integrationMode), r = [], a = 0, s = m.placements; a < s.length; a++) {
                var d = s[a];
                r.push(d.impId), metricBuilders[d.slotId] = i.getMetricBuilder(), bidCaches[d.slotId] = i.getBidCache()
            }
            window.criteo_pubtag.standaloneBidder.impIds = r, window.criteo_pubtag.push(i)
        }
    }
    ...
    function markSetTargetingMetrics() {
        for (var t = new DirectBiddingMetricsManager, e = t.getMetrics(!1), n = {}, o = 0; o < e.length; ++o)
    ...
    function ComputeStandaloneDFPTargeting(t, e) {
        return ComputeDFPTargeting(t, LineItemRange.createLineItemRangesFromString(e))
    }
    ...
    function RenderAd(t, e) {
        var n = new RenderAdInputParameters("string" == typeof t ? {
            bidId: t,
            document: e
        } : t);
        if (n.bidId) {
            var o = void 0 !== n.containerId ? new BidEventContainerTarget(n.document, n.containerId) : new BidEventDocumentTarget(n.document);
    ...
    function RenderAdOnTarget(t, e) {
        ...
        if (n.hasOwnProperty(t)) {
            var o = n[t],
                i = o.GenerateEvent(e);
            window.criteo_pubtag.push(i), o.slotId in bidCaches && bidCaches[o.slotId].removeBid(o), delete n[t]
    ...
    function GetBids(t) {
        ...
        for (var i in e)
            if (e.hasOwnProperty(i)) {
                var r = e[i];
                if (!t || !t.impressionIds || -1 !== t.impressionIds.indexOf(r.impressionId)) {
                    if (0 < n.length) {
    ...
    function checkInputParameters(t) {
        if (void 0 === t.placements) return Log.Error("Missing 'placements' parameter"), !1;
        if (0 === t.placements.length) return Log.Error("'placements' parameter is empty"), !1;
        for (var e = 0, n = t.placements; e < n.length; e++) {
            var o = n[e];
            if (IsEmptyOrUndefined(o.impId)) return Log.Error("Missing 'slotId' parameter in placements object"), !1;
            if (IsEmptyOrUndefined(o.zoneId) && (IsEmptyOrUndefined(o.sizes) || IsEmptyOrUndefined(t.networkId))) return Log.Error("Missing zone information: specify either a zoneId or a networkId and a zone size"), !1;
            if (void 0 !== o.nativeCallback && "function" != typeof o.nativeCallback) return Log.Error("'nativeCallback' parameter is not a function in placements object"), !1
        }
        return !0
    }
    ...
    function GetImpressionIdToBestBid() {
        ...
        for (var n in e)
            if (e.hasOwnProperty(n)) {
                var o = e[n];
                if (t.hasOwnProperty(o.impressionId)) t[o.impressionId].cpm < o.cpm && (t[o.impressionId] = o);
                else t[o.impressionId] = o
            } return t
    }

    function GenerateBidResponseSlot(t, e, n, o, i, r, a, s, d, c) {
        return void 0 !== a && void 0 !== s ? new NativeBidResponseSlot(t, e, n, o, i, r, a, s) : void 0 === d || void 0 !== c && "<script" !== c.substr(0, 7) ? void 0 !== c ? new HtmlCreativeBidResponseSlot(t, e, n, o, i, r, c) : void 0 : new DisplayUrlBidResponseSlot(t, e, n, o, i, r, d)
    }
    ...
    var AMP = function() {
            function s() {}
            return s.Standalone = function(i, r, a) {
                RequestBids({
                    integrationmode: "amp",
                    placements: [{
                        slotid: i.slot,
                    ...
                    if (e && e.bidId && t.source)
                        for (var n = 0, o = s; n < o.length; n++) {
                            ...
                            if (i.id === e.bidId) {
                                var r = t.source,
                                    a = i.GenerateMessage();
                                a.message = "Criteo creative", r.postMessage(JSON.stringify(a), "*")
                            }
                        }
                }, !1)
            }, s
        ...
        Prebid = function() {
            function o(t, e, n, o, i) {
                var r, a;
                this.timer = new DirectBiddingTimer(new DirectBiddingMetricBuilder, o.auctionStart, resolvePrebidTimeout(o.timeout)), this.auctionId = o.auctionId, this.bidRequests = n, this.slots = [];
                for (var s = 0, d = n; s < d.length; s++) {
                    var c = d[s];
                    this.slots.push(new DirectBiddingSlot(c.adUnitCode, c.params.zoneId, c.params.nativeCallback, c.transactionId, c.sizes.map(function(t) {
                        return new Size(t[0], t[1])
                    }), c.params.publisherSubId)), r = c.params.networkId || r, c.params.integrationMode && (a = parse(c.params.integrationMode))
                }
                var l = {};
                o.gdprConsent && (void 0 !== o.gdprConsent.consentString && (l.consentData = o.gdprConsent.consentString), void 0 !== o.gdprConsent.gdprApplies && (l.gdprApplies = !!o.gdprConsent.gdprApplies), o.gdprConsent.vendorData && o.gdprConsent.vendorData.vendorConsents && void 0 !== o.gdprConsent.vendorData.vendorConsents[CRITEO_VENDOR_ID.toString(10)] && (l.consentGiven = !!o.gdprConsent.vendorData.vendorConsents[CRITEO_VENDOR_ID.toString(10)])), this.metricsManager = new DirectBiddingMetricsManager, this.cache = new DirectBiddingCache(window.criteo_pubtag.context, this.slots, r), this.requestBuilder = new DirectBiddingRequestBuilder(this.cache.filterNoBidSlots(this.slots), window.criteo_pubtag.context, this.metricsManager, new DirectBiddingUrlBuilder(!1), t, a, r, e, l, i), this.url = this.requestBuilder.getUrl(), window.Criteo.prebid_adapters = window.Criteo.prebid_adapters || {}, window.Criteo.prebid_adapters[this.auctionId] = this
            }
            return o.prototype.buildCdbUrl = function() {
                return this.url
            }, o.prototype.buildCdbRequest = function() {
                if (this.cache.silentModeEnabled()) Log.Debug("Request ignored because the global silent mode is enabled");
                else {
                ...
                if (t.slots && Array.isArray(t.slots))
                    for (var s = 0, d = t.slots; s < d.length; s++) {
                        ...
                        if (l) {
                            var u = l.bidId,
                                p = c.native ? this.createNativeAd(u, c.native, l.params.nativeCallback) : c.creative,
                ...
                return this.cache.handleResponse(this.slots, t, n, !1), this.metricsManager.storeMetric(this.timer.finish(n.slots)), a
                ...
                for (var n = this.metricsManager.getMetrics(!1), o = 0; o < n.length; ++o)
    ...
    var AdBlocker = function() {
            ...
            return a.prototype.isAdBlocked = function(t, e) {
                ...
                o.src = t, o.height = 1, o.width = 1, o.style.display = "none", o.onload = e, o.onerror = n
            }, a.allowedPixelUrl = "//static.criteo.net/images/pixel.gif?ch=1", a.blockedPixelUrl = "//static.criteo.net/images/pixel.gif?ch=2", a
        }(),
        __extends$13 = (eq = function(t, e) {
            ...
            eq(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        eq, ConditionalEvent = function(r) {
            function a(t, e, n, o) {
                var i = r.call(this, a.NAME) || this;
                return i.condition = t, i.eventIfTrue = e, i.eventIfFalse = n, i.conditionRequirement = o, i
            }
            return __extends$13(a, r), a.prototype.canEval = function() {
                return void 0 === this.conditionRequirement || this.conditionRequirement.apply(this)
            }, a.prototype.eval = function(t) {
                this.condition.apply(this) ? this.eventIfTrue.eval(t) : this.eventIfFalse.eval(t)
            }, a.NAME = "conditionalEvent", a
        }(AbstractEvent),
        AdFormatType, xq;
    xq = AdFormatType || (AdFormatType = {}), xq[xq.Classic = 0] = "Classic", xq[xq.StickyFooter = 1] = "StickyFooter", xq[xq.ScrollingBanner = 2] = "ScrollingBanner";
    var CookieHelper = function() {
            function f() {}
            return f.SetCookie = function(t, e, n, o, i) {
                void 0 === i && (i = !1);
                var r = o || document,
                ...
                for (var n = 0, o = (e || document).cookie.split(";"); n < o.length; n++) {
                    var i = o[n],
                ...
                o && "" !== o && (r += "domain=." + o + ";"), i.cookie = r + "path=/"
            }, f
        }(),
        AdvancedAdFormats = function() {
            ...
            return t.prototype.CreateAdvancedAdFormatContainer = function(t) {
                return this.adFormat === AdFormatType.StickyFooter ? this.CreateStickyFooterContainer(t) : this.adFormat === AdFormatType.ScrollingBanner ? this.CreateScrollingBannerContainer(t) : void 0
            }, t.prototype.IsUserOptout = function() {
                return this.adFormat === AdFormatType.StickyFooter && "true" === CookieHelper.GetCookie("cto_sticky_closed")
            }, t.prototype.CreateStickyFooterContainer = function(t) {
                var e = document.createElement("div");
                e.style.position = "fixed", e.style.zIndex = "2147483646", e.style.bottom = "0", e.style.left = "0", e.style.padding = "0", e.style.borderColor = "rgb(196, 196, 196)", e.style.width = "100%", e.style.backgroundColor = "rgba(245, 245, 245, 0.54902)", e.style.borderStyle = "solid", e.style.borderWidth = "1px";
                ...
                e.appendChild(n), n.style.backgroundColor = "rgb(221, 221, 221)", n.style.backgroundImage = "url('//static.criteo.net/images/criteo/publishertag/close.png')", n.style.backgroundRepeat = "no-repeat", n.style.backgroundPosition = "center", n.style.display = "block", n.style.position = "absolute", n.style.left = "0", n.style.top = "-24px", n.style.width = "23px", n.style.height = "24px", n.style.borderBottomColor = "#6d6c71", n.style.cursor = "pointer", n.onclick = function() {
                    e.style.display = "none", CookieHelper.SetCookie("cto_sticky_closed", "true", 24)
                };
                var o = document.createElement("div");
                if (e.appendChild(o), o.id = "cto_sticky", o.style.margin = "0 auto", o.style.display = "table", void 0 === t || "" === t) document.body.appendChild(e);
                else {
                    var i = document.getElementById(t);
                    i ? i.appendChild(e) : Log.Error('Target element "' + t + '" not found in the document')
                }
                return o.id
            }, t.prototype.CreateScrollingBannerContainer = function(t) {
                var e, n = this;
                if (void 0 === t || "" === t)(e = document.createElement("div")).id = "cto_scrolling", document.body.appendChild(e);
                else {
                    var o = document.getElementById(t);
                    if (!o) return Log.Error('Target element "' + t + '" not found in the document'), t;
                    e = o
                }
                var i = e.offsetTop;
                return window.addEventListener ? window.addEventListener("scroll", function() {
                    n.SetScrollingContainerPosition(e, i)
                }, !1) : window.attachEvent("onscroll", function() {
                    n.SetScrollingContainerPosition(e, i)
                }), this.SetScrollingContainerPosition(e, i), e.id
                ...
                t.style.top = e - 10 <= n ? (t.style.position = "fixed", "10px") : (t.style.position = "static", "auto")
            }, t
        }(),
        DisplayContext, sr;
    sr = DisplayContext || (DisplayContext = {}), sr[sr.InFriendlyIframe = 1] = "InFriendlyIframe", sr[sr.InUnfriendlyIframe = 2] = "InUnfriendlyIframe", sr[sr.DirectIntegration = 3] = "DirectIntegration";
    var DomManipulationTools = function() {
        ...
        __extends$14 = (Sr = function(t, e) {
            ...
            Sr(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        Sr, DisplayEvent = function(i) {
            function t(t, e, n) {
                var o = i.call(this, t) || this;
                return o.displayParameters = n, o.urlBuilder = e, o
            }
            return __extends$14(t, i), t.prototype.eval = function(t) {
                this.displayParameters.atfRatio = ViewabilityComputer.GetAtfRatio(t.context, this.displayParameters.containerid)
        ...
        HandlerType, ps;
    ps = HandlerType || (HandlerType = {}), ps[ps.AFR = 0] = "AFR", ps[ps.AJS = 1] = "AJS";
    var __extends$15 = (qs = function(t, e) {
        ...
        qs, DisplayEventAFR = function(a) {
            function i(t, e, n) {
                var o = a.call(this, i.NAME, t, e) || this;
                return o.respectsEyeoDeal = n, o
            }
            return __extends$15(i, a), i.prototype.eval = function(e) {
                var n = this;
                ...
                }, e.context, HandlerType.AFR)
            }, i.prototype.loadIframe = function(t, e, n, o) {
                var i = document.createElement("iframe");
                i.src = t, i.id = e + "_cto_iframe", i.frameBorder = "0", i.setAttribute("hspace", "0"), i.setAttribute("vspace", "0"), i.marginWidth = "0px", i.marginHeight = "0px", i.width = "100%", i.height = "100%", i.scrolling = "no", n && (i.onload = n), o && (i.onerror = o);
                var r = document.getElementById(e);
                r ? r.appendChild(i) : Log.Error('Target element "' + e + '" not found in the document')
            }, i.NAME = "displayAfr", i
        }(DisplayEvent),
        ...
        Ts, DisplayEventAsync = function(_super) {
            function DisplayEventAsync(t, e) {
                return _super.call(this, DisplayEventAsync.NAME, t, e) || this
            }
            return __extends$16(DisplayEventAsync, _super), DisplayEventAsync.prototype.eval = function(e) {
                var n = this;
                ...
                if ("" === o || void 0 === o) Log.Error("No containerid provided");
                    ...
                    var c = DisplayEventAsync.CHAPI_NAME + "=" + encodeURIComponent(JSON.stringify(t)),
                        l = function() {
                            var t = n.getContainerSize(o, i, r);
                            n.buildCasUrl(function(t) {
                                n.loadScriptAsync(t, c, a, s, d)
                            }, e.context, void 0, t.width, t.height)
                        };
                    void 0 !== i && void 0 !== r ? l() : window.addEventListener ? window.addEventListener("load", l, !1) : window.attachEvent("onload", l)
                } else this.buildCasUrl(function(t) {
                    n.loadScriptAsync(t, void 0, a, s, d)
                }, e.context)
            }, DisplayEventAsync.prototype.loadScriptAsync = function(url, data, callBackSuccess, callbackFail, passbackCode) {
                var request = new AsyncRequest(url, data);
                request.send(function(responseText) {
                    var pb = passbackCode || function() {};
                    eval(responseText), void 0 !== callBackSuccess && callBackSuccess(responseText)
                }, function(t, e) {
                    void 0 !== passbackCode && passbackCode(), void 0 !== callbackFail && callbackFail(t, e)
                }, passbackCode)
        ...
        Bt, DisplayEventSync = function(n) {
            function o(t, e) {
                return n.call(this, o.NAME, t, e) || this
            }
            return __extends$17(o, n), o.prototype.eval = function(t) {
                var e = this;
                n.prototype.eval.call(this, t), this.buildCasUrl(function(t) {
                    e.loadScriptSync(t)
                }, t.context)
            }, o.prototype.loadScriptSync = function(t) {
                document.write("<script type='text/javascript' src='" + t + "'><\/script>")
            }, o.NAME = "displaySync", o
        }(DisplayEvent),
        ...
        Ut, DisplayInputParameters = function(n) {
            function t(t) {
                var e = n.call(this) || this;
                return e.zoneid = void 0, e.async = void 0, e.containerid = void 0, e.width = void 0, e.height = void 0, e.callbackSuccess = void 0, e.callbackError = void 0, e.callIfNotAdblocked = void 0, e.passbackCode = void 0, e.publisherUrl = void 0, e.overridenWpdt0 = void 0, e.overridenCt0 = void 0, e.layout = void 0, e.atfRatio = void 0, e.adFormat = AdFormatType.Classic, e.overrideZoneFloor = !0, e.collapseContainerIfNotAdblocked = !0, e.extraData = {}, e.addParameter("zoneId", function(t) {
                    e.zoneid = t
            ...
            return __extends$18(t, n), t.prototype.parseAdFormat = function(t) {
                switch (t.toLowerCase()) {
                    case "stickyfooter":
        ...
        DisplayUrlBuilder = function() {
            function l() {}
            return l.prototype.buildUrl = function(t, e, n, o, i, r) {
                var a;
                a = n === HandlerType.AFR ? l.CAS_URL_AFR : l.CAS_URL_AJS;
                var s = ("https:" === e.protocol ? "https:" : "http:") + a + "?ptv=" + PublisherTagVersion;
                if (!0 === e.isAdBlocked) {
                    var d = this.getAbpParameter(t, e);
                    s += "&abp=" + String(d)
                }
                for (var c in n !== HandlerType.AFR && (s += void 0 !== t.containerid && "" !== t.containerid ? "&containerid=" + encodeURIComponent(t.containerid) : ""), s += "&zoneid=" + String(t.zoneid), s += o ? "&width=" + o : "", s += i ? "&height=" + i : "", s += e.ctoIdOnPublisherDomain ? "&idcpy=" + e.ctoIdOnPublisherDomain : "", s += e.idfs ? "&idfs=" + e.idfs : "", s += e.secureId ? "&sid=" + e.secureId : "", s += e.isOptOut ? "&optout=1" : "", s += "&cb=" + String(CacheBusterGenerator.generateCacheBuster()), s += "&nodis=" + (e.dising ? "0" : "1"), s += e.charset ? "&charset=" + e.charset : "", s += t.overridenCt0 ? "&ct0=" + encodeURIComponent(t.overridenCt0) : e.ct0 ? "&ct0=" + encodeURIComponent(e.ct0) : "", s += t.overridenWpdt0 ? "&wpdt0=" + encodeURIComponent(t.overridenWpdt0) : e.wpdt0 ? "&wpdt0=" + encodeURIComponent(e.wpdt0) : "", t.publisherUrl && (s += "&publisherurl=" + encodeURIComponent(t.publisherUrl)), s += e.getContextFlags(), t.extraData) void 0 !== t.extraData[c] && (s += "&" + c + "=" + encodeURIComponent(t.extraData[c]));
                (s += t.passbackCode ? "&dlp=1" : "", t.integrationMode !== IntegrationMode.Unspecified && (s += "&im=" + t.integrationMode), s += "&dc=" + e.displayContext, void 0 !== t.atfRatio) && (s += "&atfr=" + Math.round(100 * t.atfRatio) / 100);
                return s += e.highestAccessibleUrl ? "&loc=" + encodeURIComponent(e.highestAccessibleUrl).substring(0, 1600) : "", r && (void 0 !== r.consentData && (s += r.consentData ? "&gdprDta=" + r.consentData : ""), void 0 !== r.consentGiven && (s += "&gdprGvn=" + (r.consentGiven ? "1" : "0")), void 0 !== r.gdprApplies && (s += "&gdprApp=" + (r.gdprApplies ? "1" : "0"))), s
            }, l.prototype.getAbpParameter = function(t, e) {
                return (e.isAdBlocked ? 1 : 0) | (t.overrideZoneFloor ? 0 : 2)
            }, l.CAS_URL_AJS = "//cas.criteo.com/delivery/ajs.php", l.CAS_URL_AFR = "//cas.criteo.com/delivery/afr.php", l
        }(),
        EyeoDealValidator = function() {
            function a() {}
            return a.prototype.respectsEyeoDeal = function(t) {
                var e = document.getElementById(t);
                if (!this.respectsSizeConstraints(e)) return Log.Debug("The element " + t + "does not respect Eyeo acceptable ads size constraints"), !1;
                var n = this.getNewRatiosFeatures(e),
                    o = n.respectsAdRatioConstraint;
                return o ? (a.atfRatio = n.newAtfRatio, a.btfRatio = n.newBtfRatio) : Log.Debug("The element " + t + "does not respect Eyeo acceptable ads ratio constraints"), o
                ...
                switch (e) {
                    ...
                    default:
                        return void 0 !== e && Log.Error("Unknown data-ad-loc attribute : " + e), !0
                }
                ...
                return {
                    respectsAdRatioConstraint: i <= .15 && r <= .25,
                    newAtfRatio: i,
                    newBtfRatio: r
                }
            }, a.atfRatio = 0, a.btfRatio = 0, a
        }();
    ...
    function DisplayAd(t) {
        ...
        if (e.async = !1 !== e.async, void 0 !== e.zoneid)
            if (void 0 === e.layout || !1 !== e.async)
                if (!0 !== e.async || void 0 !== e.containerid && "" !== e.containerid) {
                    if (!1 === e.async && void 0 !== e.passbackCode && (Log.Error("Criteo.DisplayAd does not support synchronous local passback"), e.passbackCode = void 0), e.adFormat !== AdFormatType.Classic) {
                        var n = new AdvancedAdFormats(e.adFormat);
                        if (n.IsUserOptout()) return void Log.Debug("The user has opted-out for 1 day when closing the sticky footer.");
                        e.containerid = n.CreateAdvancedAdFormatContainer(e.containerid)
                    }
                    var o;
                    o = e.async ? new DisplayEventAsync(new DisplayUrlBuilder, e) : new DisplayEventSync(new DisplayUrlBuilder, e), window.criteo_pubtag.push(o)
                } else Log.Error("Missing parameter 'containerid' for an async display");
        ...
        if (void 0 !== e.zoneid)
            if (void 0 !== e.containerid && "" !== e.containerid) {
                ...
                if (isVisible(n)) {
                    ...
                    if (void 0 === o.isAdBlocked)(new AdBlocker).isAdBlocked(o.protocol, function(t) {
                        o.isAdBlocked = t, window.criteo_pubtag.evalEvents()
                    });
                    var i, r, a = new EyeoDealValidator;
                    i = new DisplayEventAFR(new DisplayUrlBuilder, e, a.respectsEyeoDeal(e.containerid)), r = new Custom(function() {
                        e.collapseContainerIfNotAdblocked && (n.style.display = "none"), void 0 !== e.callIfNotAdblocked && e.callIfNotAdblocked()
                    });
                    var s;
                    s = new ConditionalEvent(function() {
                ...
                } else Log.Error("can't display acceptable ad : the container \"" + e.containerid + '" is not visible')
            } else Log.Error("missing parameter 'containerid' to display acceptable ads");
        else Log.Error("missing parameter 'zoneid'")
    }
    ...
    var Polyfills = function() {
            ...
            return t.LoadPolyfills = function() {
                ...
                Array.prototype.filter || (Array.prototype.filter = function(t) {
                    ...
                    for (var n = [], o = 2 <= arguments.length ? arguments[1] : void 0, i = 0; i < e; i++)
                        if (i in this) {
                            var r = this[i];
    ...
    Pv = StorageOrigin || (StorageOrigin = {}), Pv[Pv.None = 0] = "None", Pv[Pv.Cookie = 1] = "Cookie", Pv[Pv.LocalStorage = 2] = "LocalStorage";
    var CookieSynchronizer = function() {
            function o(t, e, n) {
                this.isDebug = e, this.topWin = t, this.topDoc = t.document, this.localStorageHelper = new LocalStorageHelper(this.topWin), this.localStorageEnabled = this.localStorageHelper.checkLocalStorage(), this.canWriteCookies = this.checkCookiesAreWriteable(), this.topUrl = n
            }
            return o.isSafariBrowser = function() {
                ...
                if ((t || o.isSafariBrowser() || o.isAndroidBrowser() || o.isFirefoxBrowser()) && this.topWin.addEventListener)
                    if ("complete" === this.topDoc.readyState) this.appendGumIframeIfDoesNotExist();
                        ...
                        var n = function() {
                            e.topDoc.removeEventListener("DOMContentLoaded", n), e.topWin.removeEventListener("load", n), e.appendGumIframeIfDoesNotExist()
                        };
                        this.topWin.addEventListener("load", n, !1), this.topDoc.addEventListener("DOMContentLoaded", n, !1)
                    }
                ...
                this.topDoc.getElementById(o.SYNCFRAME_ID) || (this.topWin.addEventListener("message", function(t) {
                    var e = t.data;
                    e && e.isCriteoMessage && (t.stopImmediatePropagation(), e.optout ? (n.setClientSideOptOut(), n.deleteClientSideUid(), n.deleteClientSideIdfs(), n.deleteClientSideSecureId()) : (e.uid && n.setClientSideUid(e.uid), e.idfs && n.setClientSideIdfs(e.idfs), e.removeSid ? n.deleteClientSideSecureId() : e.sid && n.setClientSideSecureId(e.sid)))
                ...
                if (this.canWriteCookies) {
                    var e = t.value;
                    e || (e = generateUuid()), this.writeOnAllStorages(o.LOCAL_WEB_ID_COOKIE_NAME, String(e), o.GUID_RETENTION_TIME_HOUR), t = this.getFromAllStorages(o.LOCAL_WEB_ID_COOKIE_NAME)
                }
                return t.value && t || {
                    value: "NA",
                    origin: StorageOrigin.None
                }
                ...
                this.localStorageEnabled && this.localStorageHelper.setItem(t, e), CookieHelper.SetCookie(t, e, n, this.topDoc, !0)
            }, o.prototype.getFromAllStorages = function(t) {
                var e, n = CookieHelper.GetCookie(t, this.topDoc);
                return this.localStorageEnabled && (e = this.localStorageHelper.getItem(t) || void 0), {
                    value: n || e,
                    origin: (n && StorageOrigin.Cookie) | (e && StorageOrigin.LocalStorage)
                }
            }, o.prototype.deleteFromAllStorage = function(t) {
                CookieHelper.DeleteCookie(t, this.topDoc, !0), this.localStorageEnabled && this.localStorageHelper.removeItem(t)
            }, o.prototype.getTld = function() {
                var t = CookieHelper.SetCookie(o.TLD_TEST_COOKIE_NAME, "test", 1, this.topDoc, !0);
                return CookieHelper.DeleteCookie(o.TLD_TEST_COOKIE_NAME, this.topDoc, !0), t
                ...
                var t = this.getClientSideUid(),
                    ...
                    d = "https://gum.criteo.com/syncframe?topUrl=" + a + (this.isDebug ? "&debug=1" : "");
            ...
            }, o.GUID_COOKIE_NAME = "cto_idcpy", o.GUID_RETENTION_TIME_HOUR = 9360, o.IDFS_COOKIE_NAME = "cto_idfs", o.SECURE_ID_COOKIE_NAME = "cto_sid", o.LOCAL_WEB_ID_COOKIE_NAME = "cto_lwid", o.OPTOUT_COOKIE_NAME = "cto_optout", o.OPTOUT_RETENTION_TIME_HOUR = 43200, o.TLD_TEST_COOKIE_NAME = "cto_pub_test_tld", o.SYNCFRAME_ID = "criteo-syncframe", o.SAFARI_CHECK_REGEX = /^Mozilla\/5\.0 \([^)]+\) AppleWebKit\/[^ ]+ \(KHTML, like Gecko\) Version\/([^ ]+)( Mobile\/[^ ]+)? Safari\/[^ ]+$/i, o
        }(),
        Context = function() {
            function t(t, e) {
                this.charset = t.charset || t.characterSet || "";
                var n = DomManipulationTools.getHighestAccessibleWindow(e);
                this.displayContext = this.getDisplayContext(n), this.highestAccessibleUrl = DomManipulationTools.getHighestAccessibleUrl(n), this.synchronizeCriteoUid(n, this.highestAccessibleUrl);
                var o = this.getQueryStringParams(this.highestAccessibleUrl);
                this.debugMode = "1" === o.pbt_debug || !1, this.noLog = "1" === o.pbt_nolog || !1, this.shouldIgnoreSilentMode = this.computeShouldIgnoreSilentMode(), this.silentModeIgnored = !1, this.debugMode && SetLogLevel(LogLevel.Debug), this.location = e.location, this.protocol = e.location.protocol, this.dising = !1, this.ct0 = void 0, this.wpdt0 = void 0, this.isAdBlocked = void 0, this.rtaVarNames = []
            }
            return t.prototype.getContextFlags = function() {
                ...
                return DomManipulationTools.inIframe() ? t.err ? DisplayContext.InUnfriendlyIframe : DisplayContext.InFriendlyIframe : DisplayContext.DirectIntegration
                ...
                this.ctoIdOnPublisherDomain = o.getClientSideUid().value, this.isOptOut = o.getClientSideOptOut().value, this.idfs = o.getClientSideIdfs().value, this.secureId = o.getClientSideSecureId().value, o.synchronizeCriteoUid()
    ...
    var PublisherTag = function() {
        function t() {
            this.standaloneBidder = new StandaloneDirectBidder, this.events = [], this.context = new Context(document, window), Log.Debug("Publisher Tag loaded")
        }
            ...
            for (var t = 0; t < this.events.length;) {
                ...
                if (isConditionalEvent(e) && !e.canEval()) t++;
                    ...
                    try {
                        ...
                        Log.Error("An exception occurred processing an event: " + t.toString())
                    }
                }
            }
        }, t.VERSION = PublisherTagVersion, t
    }();
    ...
    function safeFunction(t) {
        ...
        for (var o in n.prototype = e.prototype, e) e.hasOwnProperty(o) && (n[o] = e[o]);
        return n
    }
    ...
    function safeObject(t) {
        for (var e in t)
            if (t.hasOwnProperty(e)) {
                var n = t[e];
                "function" == typeof n ? t[e] = safeFunction(n) : "object" == typeof n && (t[e] = safeObject(n))
            } return t
    }
    ...
    var __extends$19 = (zx = function(t, e) {
            ...
            zx(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        zx, DefaultCrtgContentName = "crtg_content",
        DefaultCrtgRtaCookieName = "crtg_rta",
        RtaInputParameters = function(n) {
            function t(t) {
                var e = n.call(this) || this;
                return e.networkId = void 0, e.crtgContentName = void 0, e.crtgRtaCookieName = void 0, e.adserver = void 0, e.addParameter("networkId", function(t) {
                    e.networkId = t
        ...
        __extends$20 = (Sx = function(t, e) {
            ...
            Sx(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        Sx, RtaEvent = function(_super) {
            function RtaEvent(t, e) {
                var n = _super.call(this, RtaEvent.NAME) || this;
                return n.urlBuilder = t, n.parameters = e, n
            }
            return __extends$20(RtaEvent, _super), RtaEvent.prototype.eval = function(t) {
                _super.prototype.eval.call(this, t);
                var e = this.urlBuilder.buildUrl(this.parameters, t.context),
                    n = new AsyncRequest(e),
                    o = this.parameters.crtgContentName || DefaultCrtgContentName; - 1 === t.context.rtaVarNames.indexOf(o, 0) && t.context.rtaVarNames.push(o), n.send(this.executeScript, function() {
                    return Log.Error("An error occured while calling " + e)
                })
            }, RtaEvent.prototype.executeScript = function(responseText) {
                eval(responseText)
            }, RtaEvent.NAME = "rtaEvent", RtaEvent
        }(AbstractEvent);
    ...
    var __extends$21 = (ty = function(t, e) {
            ...
            ty(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
        }),
        ty, RtaTargetingEvent = function(o) {
            function i(t, e) {
                var n = o.call(this, i.NAME) || this;
                return n.adserver = t, n.targetingValues = e, n
            }
            return __extends$21(i, o), i.prototype.eval = function(t) {
                if (void 0 !== this.adserver) switch (this.adserver.toLowerCase()) {
                    case "dfp":
    ...
    function CallRTA(t) {
        ...
        if (void 0 !== e.networkId) {
            var n = e.crtgContentName ? e.crtgContentName : DefaultCrtgContentName,
                o = e.crtgRtaCookieName ? e.crtgRtaCookieName : DefaultCrtgRtaCookieName;
    ...
    function SetTargeting(t) {
        ...
        if (void 0 !== e.adserver) {
            ...
            if (void 0 !== e.crtgContentName) n.push(e.crtgContentName);
                ...
                for (var o = 0, i = window.criteo_pubtag.context.rtaVarNames; o < i.length; o++) {
                    var r = i[o];
                    n.push(r)
            ...
            for (var a = 0, s = n; a < s.length; a++) {
                ...
                window.criteo_pubtag.push(l), RemoveCrtgContentNameFromPublisherTagContext(d)
            }
    ...
    function RemoveCrtgContentNameFromPublisherTagContext(t) {
        var e = window.criteo_pubtag.context.rtaVarNames.indexOf(t, 0); - 1 < e && window.criteo_pubtag.context.rtaVarNames.splice(e, 1)
    }
    var passbackProfileId = 206;

    function SetupPassbackEventQueue() {
        window.Criteo.passbackEvents = createEventProcessor(window.Criteo.passbackEvents)
    }
    ...
    function RenderAdPassback(t, e, n, o) {
        var i;
        "string" == typeof t ? i = t : (i = getParam(t, "adUnit", "string"), e = getParam(t, "passback", "function"), n = getParam(t, "customRenderFunction", "function"), o = getParam(t, "minimumBidPrice", "number")), void 0 !== i ? void 0 !== e ? ("function" != typeof n && (n = function(t) {
            RenderAd({
                bidId: t.id,
                containerId: i
            })
        }), window.Criteo.passbackEvents = window.Criteo.passbackEvents || [], window.Criteo.passbackEvents.push(function() {
            var t = GetBidsForAdUnit(i)[0];
            t && (void 0 === o || t.cpm > o) ? n(t) : e(i)
        })) : Log.Error("A passback callback should be provided") : Log.Error("An adUnit string parameter should be provided")
    }
    window.criteo_pubtag || (Polyfills.LoadPolyfills(), window.criteo_pubtag = new PublisherTag), window.Criteo = safeObject({
        CallRTA: CallRTA,
