...
var jwDefaults = {
    "advertising": {
        ...
        "adscheduleid": "DZ7ojElU",
        "client": "googima",
        "cuetext": "Advertisement",
        "schedule": [{
            "offset": "pre",
            "tag": "https://pubads.g.doubleclick.net/gampad/ads?sz=16x9&iu=/89446989/digg.preroll.homepage.inline&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=__page-url__&description_url=__page_url__&correlator=__timestamp__&tags=__item-tags__",
            "type": "linear"
        }],
    ...
    "height": 260,
    "key": "9oGJBHydhbdUmSB+Dtd2+fBEv3aLNj6Vs2hQenzbCrLwu5YzkMfudqfbkdqDsf+R",
    "logo": {
        "file": "https://assets-jpcust.jwpsrv.com/watermarks/0HUtJlGq.png",
        "hide": true,
        "margin": "10",
        "position": "top-left"
    },
