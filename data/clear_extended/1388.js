...
/* Source and licensing information for the line(s) below can be found at https://www.bmj.com/sites/all/modules/highwire/highwire/js/highwire.equal-heights.js. */
(function($) {
    $.fn.highwireEqualHeights = function() {
        if (Drupal.behaviors.hasOwnProperty('omegaEqualHeights')) $(window).trigger('resize.omegaequalheights')
    }
})(jQuery);;
/* Source and licensing information for the above line(s) can be found at https://www.bmj.com/sites/all/modules/highwire/highwire/js/highwire.equal-heights.js. */
/* Source and licensing information for the line(s) below can be found at https://www.bmj.com/sites/all/modules/highwire/highwire/js/highwire.panels-ajax-tab.js. */
(function($) {
    var hwsettings = {};
    $(document).on("panelsAjaxTabsPreLoad", function(e) {
        if (typeof(Drupal.settings.highwire) != "undefined") hwsettings = Drupal.settings.highwire
    });
    $(document).on("panelsAjaxTabsPreBehavior", function(e) {
        $.extend(Drupal.settings.highwire, hwsettings, Drupal.settings.highwire)
    })
})(jQuery);;
/* Source and licensing information for the above line(s) can be found at https://www.bmj.com/sites/all/modules/highwire/highwire/js/highwire.panels-ajax-tab.js. */
/*!
	Colorbox 1.6.1
	license: MIT
...
/* Source and licensing information for the line(s) below can be found at https://www.bmj.com/sites/all/modules/contrib/colorbox/js/colorbox.js. */
(function($) {
    Drupal.behaviors.initColorbox = {
        attach: function(context, settings) {
            if (!$.isFunction($('a, area, input', context).colorbox) || typeof settings.colorbox === 'undefined') return;
...
/* Source and licensing information for the above line(s) can be found at https://www.bmj.com/sites/all/modules/contrib/colorbox/js/colorbox.js. */
/* Source and licensing information for the line(s) below can be found at https://www.bmj.com/sites/all/modules/contrib/colorbox/styles/default/colorbox_style.js. */
(function($) {
    Drupal.behaviors.initColorboxDefaultStyle = {
        attach: function(context, settings) {
            $(context).bind('cbox_complete', function() {
                ...
                } else $('#cboxTitle', context).hide()
            })
        }
    }
})(jQuery);;
/* Source and licensing information for the above line(s) can be found at https://www.bmj.com/sites/all/modules/contrib/colorbox/styles/default/colorbox_style.js. */