...
/* <a href="FLIPBOARD_URL" data-flip-widget="pro|mag">Text</a> */
var FlipboardWidgets;
FlipboardWidgets = function() {
        function a() {}
        var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p;
        return g = ["pro", "mag", "flipit", "flipit2", "shareflip"], e = "data-flip-", p = {
            ...
            return c = document, i = window, e = (new Date).getTime(), d = (null != a ? a.utm_medium : void 0) || "article-share", b = (null != a ? a.utm_campaign : void 0) || "tools", f = (null != a ? a.utm_source : void 0) || encodeURIComponent(j()), g = (null != a ? a.title : void 0) || c.title, k = (null != a ? a.url : void 0) || i.location.href, h = "https://share.flipboard.com/bookmarklet/popout?v=2&title=" + encodeURIComponent(g) + "&url=" + encodeURIComponent(k) + "&t=" + e, h += "&utm_campaign=" + b + "&utm_medium=" + d + "&utm_source=" + f
        }, l = function(a, c) {
            var d, e, f, g, h, i, j, k, l;
            return d = document, l = window, f = (new Date).getTime(), i = 535, h = 565, j = (l.screenTop || l.screenY) + 50, e = (l.screenX || l.screenLeft) + (l.innerWidth || d.documentElement.offsetWidth || 0) / 2 - i / 2, k = function(a) {
                return b(a)
            }(c), g = "width=" + i + ",height=" + h + ",top=" + j + ",left=" + e + ",location=no,resizable=yes,status=no,scrollbars=no,personalbar=no,toolbar=no,menubar=no", l.__flipboard = l.open(k, "__flipboard_flipit", g), i = d.createElement("script"), i.setAttribute("type", "text/javascript"), i.setAttribute("src", "https://d2jsycj2ly2vqh.cloudfront.net/bookmarklet/js/popout-helper.min.js?t=" + f), d.body.appendChild(i), setTimeout(function() {
                return l.__flipboard.focus()
            }, 50), !1
        }, n = {
            ico: function(a) {
                var b;
                b = h(a, "href").replace(/\?.*/, ""), b += "?utm_campaign=tools&utm_medium=follow", b += "&action=follow", b = b + "&utm_source=" + encodeURIComponent(j()), o(a, "href", b), o(a, "target", "_blank")
            },
            pro: function(a) {
                var b, c;
            ...
            flipit: function(a) {
                var c;
                a.onclick = l, a.innerHTML = "Flip", o(a, "class", "fl_flip_button"), o(a, "title", "Add this page to a Flipboard Magazine"), o(a, "href", b()), o(a, "target", "_blank"), c = k({
                    I: {}
                }), a.appendChild(c), c = k({
                    B: {}
                }), a.appendChild(c)
            ...
            flipit2: function(a) {
                ...
                }, a.innerHTML = "", c = h(a, "class"), o(a, "class", "" + c + " fl_flip_logo"), o(a, "title", "Add this page to a Flipboard Magazine"), o(a, "href", b({
                    utm_source: "flipit2"
                })), o(a, "target", "_blank"), e = function() {
                    switch (i(a, "size")) {
                        case "small":
                            return "http://cdn.flipboard.com/badges/flipboard_srsw.png";
                        case "medium":
                            return "http://cdn.flipboard.com/badges/flipboard_mrsw.png";
                        case "large":
                            return "http://cdn.flipboard.com/badges/flipboard_lrsw.png";
                        default:
                            return "http://cdn.flipboard.com/badges/flipboard_srsw.png"
                    }
                }(), d = k({
            ...
            shareflip: function(a) {
                a.onclick = l, o(a, "href", b())
            }
        }, m = function(a, b) {
            ...
            }), b.styleSheet ? b.styleSheet.cssText = d : b.appendChild(document.createTextNode(d)), a = document.getElementsByTagName("HEAD")[0], a.insertBefore(b, a.firstChild), c()
        }, a
    }.call(this),
    function() {
        var a, b, c;
        c = encodeURIComponent(window.location.href), b = "https://fpn.flipboard.com/pix/__fpn.gif", a = document.createElement("IMG"), a.src = "" + b + "?utm_source=" + c, FlipboardWidgets.widgetize()
    }();