...
(elcm = elcm || {}).ffConfig = {
    ...
    features: [{
        id: "global-header",
        name: "Global Header",
        description: "Production version of the new Global Header. The old header is hidden and the new one is mounted in its place",
        activeHosts: []
    }]
...
document.addEventListener("readystatechange", function() {
    if ("complete" === document.readyState && document.querySelectorAll(iframeSelector).length) {
