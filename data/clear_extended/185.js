...
ModalShare.prototype.init = function() {
    ...
    function(e, t, a) {
        ...
        i.prototype = {
            ...
            _init: function() {
                ...
                this.downloadAction.on("click", function(o) {
                    var n = e.location;
                    o.preventDefault(), a || o.stopPropagation(), n.origin || (n.origin = n.protocol + "//" + n.hostname + (n.port ? ":" + n.port : "")), t.user && i.postDownloadRequest($(this).attr("href"))
                })
            },
            bindEvents: function() {
            ...
            if (a.isUserAuthenticated()) {
                var o = $(".j-action-download, .j-download, .j-save").attr("href");
                i.postDownloadRequest(o)
            } else e && e.url && (i.downloadFile(e.url), e.record_url && $.ajax({
                url: e.record_url,
                type: "POST",
                complete: function(e) {
                    t.dev && console.log(e)
        ...
        }, i.postDownloadRequest = function(t) {
            $.post(t, function(t) {
                var a;
                t.success ? i.downloadFile(t.download_ss_url) : (a = $("#alert-modal"), a.find("p").text(t.notice), a.foundation("reveal", "open"), e._gaq.push(["_trackEvent", "savedfiles", "download_validation_failed"]))
            })
