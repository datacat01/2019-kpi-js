...
(function() {
    ...
    c(d.prototype, {
        ...
        click: function(b) {
            for (var a = $trk, b = a.target(b), g = null; b && b.tagName; b = b.parentNode)
                if (g = g || a.trackable(b), a.attrib(b,
        ...
        track: function(b, a) {
            ...
            for (var f = TaaSDynamicObj.readCookie("ds2", "sotr"), e = c.chars(f && "b" == f.charAt(0) ? f : "bzzzzzzzzzzz"), i = 0, l = d.length; i < l; i++) {
                ...
                if (null != h)
                    for (var o = h[1], f = c.sizes[o], o = c.start[o], h = c.chars(c.encode(h[2], f)), k = 0; k < f; k++) e[o +
                        k] = h[k]
            }
            i = 0;
            l = e.length;
        ...
        onRover: function(b,
            a) {
            if (void 0 != b.detail && null != b.detail) a = b.detail;
            else if (!a || "object" !== typeof a) return;
            var c = $trk,
                d = a.imp,
                f = c.rover.uri + (d ? c.rover.imp : c.rover.clk),
                n, i;
            delete a.imp;
            d && (i = e(d, "&", !0));
...
tracking.roversync = tracking.roversync && void 0 === QUnit || function() {
    function c(a) {
        for (var b = a + "=", c = document.cookie.split(";"), d = 0; d < c.length; d++)
            if (a = c[d], a = a.trim(), 0 == a.indexOf(b)) return b = a.indexOf("="), a.substring(b + 1);
        return null
    }
    ...
    function d() {
        ...
        for (var b = document.body.lastChild, c = /^(http|https):\/\/rover.*.ebay.*\/roversync\/*/i, d = 0; 40 >= d && null != b; d++)
            if (null != b) {
                if (null != b.src && c.test(b.src)) return a = b, {
                    img: a,
                    method: "sibling"
                };
                b = b.previousSibling
    ...
    var b, a = Date.now(),
        g, q, f, n = window.location.hostname,
        i, l, h, o, k;
    var m = 100,
        m = c("roversyncSampling"),
