...
Reuters.share = {
    ...
    configureSharetools: function(el) {
        ...
        } else if (this.edition == "BETALTA" || Reuters.info.edition == "BETALTA") {
            var twitterHandle = "ReutersLatam";
        } else {
        ...
        if (this.edition == "BETACN" || this.edition == "CN" || Reuters.info.edition == "BETACN") {
            ...
            this.mailTxtLink = '';
        } else if (this.edition == "BETALTA" || this.edition == "BETALTA") {
            this.mailTxtBody = 'Pensé que te interesaría conocer lo siguiente:';
            this.mailTxtLink = '';
        } else {
            this.mailTxtBody = 'I thought you would be interested in the following:';
