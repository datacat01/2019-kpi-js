! function(e) {
    ...
    var K = {};
    Object.defineProperty(K, "getCanonicalLocales", {
        enumerable: !1,
        configurable: !0,
        writable: !0,
        value: function(e) {
    ...
    var U, Y = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        return typeof e
    } : function(e) {
        return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    };
    ...
    var X = (W(U = {
        ...
        LAK: 0,
        IRR: 0
    }, "IQD", 0), W(U, "IDR", 0), W(U, "GYD", 0), W(U, "COP", 0), W(U, "AMD", 0), W(U, "ALL", 0), W(U, "AFN", 0), U);

    function H() {
        var e = null !== this && "object" === Y(this) && x(this);
    ...
    function Q(e, n) {
        ...
        for (var B = 0; B < l.length - 1; B++)
            if ("integer" === l[B]["[[type]]"] && "currency" === l[B + 1]["[[type]]"] && /^[A-Z]/.test(l[B + 1]["[[value]]"]) || "currency" === l[B]["[[type]]"] && /[A-Z]$/.test(l[B]["[[value]]"]) && "integer" === l[B + 1]["[[type]]"]) {
                for (var Z = new b, $ = 0; $ < l.length; $++) m.call(Z, l[$]), $ === B && m.call(Z, {
                    "[[type]]": "literal",
                    "[[value]]": " "
                });
                l = Z;
    ...
    s(K, "NumberFormat", {
        ...
        value: function() {
            var e = arguments[0],
                n = arguments[1];
            return this && this !== K ? function(e, n, r) {
                var t = x(e),
                    a = w();
                ...
                r = void 0 === r ? {} : M(r);
                var l = new p,
                    c = $(r, "localeMatcher", "string", new b("lookup", "best fit"), "best fit");
                l["[[localeMatcher]]"] = c;
                ...
                var m = g["[[dataLocale]]"],
                    d = $(r, "style", "string", new b("decimal", "percent", "currency"), "decimal");
                t["[[style]]"] = d;
                var f, h = $(r, "currency", "string");
                ...
                "currency" === d && (h = h.toUpperCase(), t["[[currency]]"] = h, E = function(e) {
                    return void 0 !== X[e] ? X[e] : 2
                }(h));
                var F = $(r, "currencyDisplay", "string", new b("code", "symbol", "name"), "symbol");
                "currency" === d && (t["[[currencyDisplay]]"] = F),
                    function(e, n, r) {
                        var t = J(n, "minimumIntegerDigits", 1, 21, 1),
                            a = J(n, "minimumFractionDigits", 0, 20, r),
                            i = J(n, "maximumFractionDigits", a, 20),
                            o = n.minimumSignificantDigits,
                            s = n.maximumSignificantDigits;
                        e["[[minimumIntegerDigits]]"] = t, e["[[minimumFractionDigits]]"] = a, e["[[maximumFractionDigits]]"] = i, (void 0 !== o || void 0 !== s) && (o = J(n, "minimumSignificantDigits", 1, 21, 1), s = J(n, "maximumSignificantDigits", o, 21, 21), e["[[minimumSignificantDigits]]"] = o, e["[[maximumSignificantDigits]]"] = s)
                ...
                var D = $(r, "useGrouping", "boolean", void 0, !0);
                t["[[useGrouping]]"] = D;
                var z = u[m].patterns[d];
                return t["[[positivePattern]]"] = z.positivePattern, t["[[negativePattern]]"] = z.negativePattern, t["[[boundFormat]]"] = void 0, t["[[initializedNumberFormat]]"] = !0, i && (e.format = H.call(e)), a(), e
            }(M(this), e, n) : new K.NumberFormat(e, n)
        }
    }), s(K.NumberFormat, "prototype", {
        writable: !1
    }), y.NumberFormat = {
        "[[availableLocales]]": [],
        "[[relevantExtensionKeys]]": ["nu"],
        "[[localeData]]": {}
    }, s(K.NumberFormat, "supportedLocalesOf", {
        configurable: !0,
        writable: !0,
    ...
    }), s(K.NumberFormat.prototype, "format", {
        configurable: !0,
        get: H
    }), Object.defineProperty(K.NumberFormat.prototype, "formatToParts", {
        configurable: !0,
        enumerable: !1,
        writable: !0,
        value: function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0,
                n = null !== this && "object" === Y(this) && x(this);
    ...
    s(K.NumberFormat.prototype, "resolvedOptions", {
        configurable: !0,
        writable: !0,
        value: function() {
            var e = void 0,
                ...
                t = null !== this && "object" === Y(this) && x(this);
    ...
    function be() {
        ...
        return this && this !== K ? function(e, n, r) {
            ...
            var g = new p,
                m = $(r, "localeMatcher", "string", new b("lookup", "best fit"), "best fit");
            g["[[localeMatcher]]"] = m;
            ...
            if (m = $(r, "formatMatcher", "string", new b("basic", "best fit"), "best fit"), k.formats = j, "basic" === m) S = function(e, n) {
                var r = -1 / 0,
                    t = void 0,
                    a = 0,
                    i = n.length;
            ...
            return a(), e
        }(M(this), e, n) : new K.DateTimeFormat(e, n)
    }
    s(K, "DateTimeFormat", {
        configurable: !0,
        writable: !0,
    ...
    function Ee(e, n) {
        ...
        w();
        for (var t, a, i, o, s = r["[[locale]]"], l = new K.NumberFormat([s], {
                useGrouping: !1
            }), c = new K.NumberFormat([s], {
    ...
    y.DateTimeFormat = {
            ...
            "[[localeData]]": {}
        }, s(K.DateTimeFormat, "supportedLocalesOf", {
            configurable: !0,
            writable: !0,
            value: h.call(function(e) {
                if (!o.call(this, "[[availableLocales]]")) throw new TypeError("supportedLocalesOf() is not a constructor");
        ...
        }), s(K.DateTimeFormat.prototype, "format", {
            configurable: !0,
            get: Me
        }), Object.defineProperty(K.DateTimeFormat.prototype, "formatToParts", {
            enumerable: !1,
            writable: !0,
            configurable: !0,
            value: function() {
        ...
        }), s(K.DateTimeFormat.prototype, "resolvedOptions", {
            writable: !0,
            configurable: !0,
            value: function() {
                var e = void 0,
        ...
        date: {
            ...
            formats: {
                ...
                availableFormats: {
                    ...
                    E: "ccc",
                    LLLLy: "MMMM y",
                    EEEEMMddyy: "EEEE, MM/dd/yy",
                    LLLy: "MMM y",
                    EMMddyyyy: "EEE, MM/dd/yyyy",
                    yMMMMd: "MMMM d, y",
                    yMd: "M/d/y",
                    MMddyy: "MM/dd/yy",
                    MMMd: "MMM d",
                    EEEEMMMMdy: "EEEE, MMMM d, y",
                    Md: "M/d",
                    MMddyyyy: "MM/dd/yyyy",
                    EMMddyy: "EEE, MM/dd/yy",
                    EEEEMMMd: "EEEE, MMM d",
                    yMMMd: "MMM d, y",
                    EMd: "EEE, M/d",
                    hm: "h:mm a",
                    yMMMdhm: "MMM d, y, h:mm a",
                    EMdhm: "EEE, M/d, h:mm a",
                    yMMMMdhm: "MMMM d, y, h:mm a",
                    yMdhm: "M/d/y, h:mm a",
                    hms: "h:mm:ss a"
                },
                dateFormats: {},
