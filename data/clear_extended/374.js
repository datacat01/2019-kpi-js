!(function(e) {
    ...
    function i() {
        function e(e) {
            var t = n(148),
                i = [t];
            i.push(n(150)), i.push(n(156)), i.push(n(159)), i.push(n(162)), i.push(n(164)), i.push(n(174)), i.push(n(177)), i.push(n(180)), i.push(n(183)), i.push(n(187)), i.push(n(190)), i.push(n(194)), i.push(n(198)), i.push(n(203)), i.push(n(204)), i.push(n(205)), i.push(n(206)), i.push(n(209)), i.push(n(211)), i.push(n(218)), i.push(n(219)), i.push(n(221)), p.initialize({
                clientData: e,
                plugins: i
            })
        }
            ...
            g = {
                "layers": [{
                    ...
                    "integrationSettings": {
                        "adobe_analytics": {
                            "sVariable": "",
                            "site_catalyst_eVar": "5",
                            "site_catalyst_prop": "5"
                        }
                    },
                        ...
                        "variations": [{
                            ...
                            "actions": [{
                                ...
                                "changes": [{
                                    "dependencies": [],
                                    "type": "custom_code",
                                    "id": "7B86AD56-9EB0-4C09-A94A-83FBCBBC39B8",
                                    "value": function($) {
                                        var promo, wrapper,
                                            width,
                                            ctct = window.ctct || {},
                                            geoLocationString = ctct.sourceJsonData.geolocatedCountryNameWithPrefixOfTheIfNeeded,
                                            onWindowResize = debounce(function owr() {
                                                if (window.innerWidth !== width) {

                                                    wrapper.style.marginTop = promo.offsetHeight + 'px';
                                                }
                                        ...
                                        function addMarkuptoPage(cb) {
                                            var markup = '<div class="small-business-promo-container"><div class="small-business-promo-images"><img class="small-business-promo-screen" width="548" height="487" src="https://static.ctctcdn.com/lp/images/standard/partners/optinmonster_hero.jpg" alt="" role="presentation"><img class="small-business-promo-sayed" width="264" height="249" src="https://static.ctctcdn.com/lp/images/standard/web-11004/syed-balkhi.png" alt="" role="presentation"></div><div class="small-business-promo-content"><p class="small-business-promo-headline">Save 20% for the first 3 months</p><p class="small-business-promo-subhead">Special offer for OptinMonster <br>users in <span id="promo-locale">France</span>.</p><p class="small-business-promo-text">"We rate Constant Contact the best email marketing service for WordPress users. They make it easy to create templates, send emails, and manage your contact lists. Plus, each account comes with tracking and reporting, social sharing tools, and more."</p><div class="small-business-promo-footer"><p class="small-business-promo-citation"><strong>&ndash;Syed Balkhi</strong>, Founder of OptinMonster</p><img width="342" height="30" src="//static.ctctcdn.com/lp/images/standard/bv2/web-11007/wpbeginner-affiliate-lockup.svg" alt="Constant Contact and WP Beginner logos, side by side"><a  class="small-business-promo-cta" data-tracked-action="buy-today-and-save" href="/buynow/start-now/affiliate/signup.jsp">Buy Today &amp; Save 20%</a></div></div></div>';

                                            loadCss('//static.ctctcdn.com/lp/optimizely/web11004/web11004-affiliate-banner.css');

                                            var wrap = document.createElement('div'),
                                                s = document.createElement('section');

                                            wrap.setAttribute('class', 'small-busines-promo-wrapper');
                                            wrap.setAttribute('id', 'promo-wrapper');

                                            s.setAttribute('class', 'small-business-promo');
                                            s.setAttribute('id', 'promo');
                                            s.setAttribute('data-sct-link-location', 'wpb-affiliate-banner');
                                            s.innerHTML = markup;

                                            document.body.innerHTML = '<div class="small-business-promo-wrapper" id="promo-wrapper">' + document.body.innerHTML + '</div>';
                                            document.body.insertBefore(s, document.getElementById('promo-wrapper'));
                                        ...
                                        function onMarkupAdded() {
                                            promo = document.getElementById('promo');
                                            wrapper = document.getElementById('promo-wrapper');

                                            window.addEventListener('scroll', handleScroll);

                                            window.addEventListener('resize', onWindowResize);

                                            document.getElementById('promo-locale').innerHTML = geoLocationString;

                                            setTimeout(animateMargin, 1500);
                                        }

                                        function animateMargin() {
                                            wrapper.style.transition = 'margin 0.4s';
                                            wrapper.style.marginTop = promo.offsetHeight + 'px';
                                        }

                                        function handleScroll() {
                                            var contentPos = wrapper.getClientRects()[0].top;

                                            if (contentPos <= 0) {
                                                promo.classList.add('invisible');
                                            } else {
                                                promo.classList.remove('invisible');
                                            }
                                        }
                                        ...
                                        function onDocumentReady() {
                                            ...
                                            addMarkuptoPage(onMarkupAdded);
                                        }

                                        onDocumentReady();
                                    }
                                }, {
                                    "selector": ".small-business-promo-footer > img",
                                    "dependencies": [],
                                    "attributes": {
                                        "src": "https://static.ctctcdn.com/lp/images/standard/logos/ctct_optinmonster-affiliate-lockup.svg"
                                    },
                                    "type": "attribute",
                                    "id": "6A890101-E962-4A45-AFD4-A1679A791C7B",
                                    "css": {}
                                }]
                            }],
                            "name": null
                        }],
                        "audienceIds": ["and", "13030240221"],
                        "changes": null,
                        "id": "13011290170",
                    ...
                    "integrationStringVersion": 2,
                    "viewIds": ["13009740178", "13030170106", "13030280177"],
                    "experiments": [{
                        "weightDistributions": [{
                            "entityId": "13007550160",
                            "endOfRange": 10000
                        }],
                        "audienceName": null,
                        "name": null,
                        ...
                        "variations": [{
                            ...
                            "actions": [{
                                ...
                                "changes": [{
                                    ...
                                    "type": "redirect",
                                    "id": "6D6BC8D8-85B7-4962-BCBD-C1FF0F057A85"
                                }]
                            }, {
                                "viewId": "13009740178",
                                "changes": [{
                                    "dest": "/start-now/email-plan/account",
                                    "allowAdditionalRedirect": false,
                                    "dependencies": [],
                                    "preserveParameters": true,
                                    "type": "redirect",
                                    "id": "77FA6E94-5CB1-4EFB-B581-4C5C527A41EA"
                                }]
                            }, {
                                "viewId": "13030170106",
                                "changes": [{
                                    ...
                                    "preserveParameters": true,
                                    "type": "redirect",
                                    "id": "DE248FFB-F5C8-47A4-8B71-0E3C55F2FA8C"
                                }]
                            }],
                            "name": null
                        }],
                        "audienceIds": ["and", "13005510267"],
                        "changes": null,
                        "id": "13018870408",
                        "integrationSettings": null
                    }],
                    ...
                    "experiments": [{
                        ...
                        "variations": [{
                            ...
                            "actions": [{
                                "viewId": "13012960317",
                                "changes": [{
                                    "dest": "https://www.constantcontact.com/start-now/email-plan/account",
                                    "allowAdditionalRedirect": false,
                                    "dependencies": [],
                                    "preserveParameters": true,
                                    "type": "redirect",
                                    "id": "FD8F3DAB-083D-4DC9-891E-F9055E664F01"
                                }]
                            }],
                            "name": null
                        }],
                        "audienceIds": ["and", "13009280228"],
                        "changes": null,
                        "id": "13007300421",
                        "integrationSettings": null
                    }],
                    ...
                    "integrationStringVersion": 2,
                    "viewIds": ["12996030116", "13009740178", "13030170106", "13030280177"],
                    "experiments": [{
                        "weightDistributions": [{
                            "entityId": "13022480250",
                            "endOfRange": 10000
                        }],
                        "audienceName": null,
                        "name": null,
                        ...
                        "variations": [{
                            ...
                            "actions": [{
                                ...
                                "changes": [{
                                    ...
                                    "preserveParameters": true,
                                    "type": "redirect",
                                    "id": "4b6a466458ee407daf492e69e0bfb521"
                                }]
                            }, {
                                "viewId": "13009740178",
                                "changes": [{
                                    ...
                                    "preserveParameters": true,
                                    "type": "redirect",
                                    "id": "50373bb4748f414d9447ae7be6ad5b41"
                                }]
                            }, {
                                "viewId": "13030170106",
                                "changes": [{
                                    ...
                                    "preserveParameters": true,
                                    "type": "redirect",
                                    "id": "05aa54c6ce09499d8a3e6ee11d74119a"
                                }]
                            }],
                            "name": null
                        }],
                        "audienceIds": ["and", "13002020265"],
                        "changes": null,
                        "id": "13030290236",
                        "integrationSettings": null
                    }],
                        ...
                        "variations": [{
                            ...
                            "actions": [{
                                ...
                                "changes": [{
                                    "dependencies": [],
                                    "type": "custom_code",
                                    "id": "3AE8817D-E083-441F-8E4D-747E78AA746B",
                                    "value": function($) {
                                        var promo, wrapper,
                                            width,
                                            ctct = window.ctct || {},
                                        ...
                                        function addMarkuptoPage(cb) {
                                            var markup = '<div class="small-business-promo-container"><div class="small-business-promo-images"><img class="small-business-promo-screen" width="548" height="487" src="https://static.ctctcdn.com/lp/images/standard/web-11004/wpbeginner_wp.jpg" alt="" role="presentation"><img class="small-business-promo-sayed" width="264" height="249" src="https://static.ctctcdn.com/lp/images/standard/web-11004/syed-balkhi.png" alt="" role="presentation"></div><div class="small-business-promo-content"><p class="small-business-promo-headline">Save 20% for the first 3 months</p><p class="small-business-promo-subhead">Special offer for WPBeginner <br>users in <span id="promo-locale">France</span>.</p><p class="small-business-promo-text">"We rate Constant Contact the best email marketing service for WordPress users. They make it easy to create templates, send emails, and manage your contact lists. Plus, each account comes with tracking and reporting, social sharing tools, and more."</p><div class="small-business-promo-footer"><p class="small-business-promo-citation"><strong>&ndash;Syed Balkhi</strong>, Founder of WPBeginner</p><img width="342" height="30" src="//static.ctctcdn.com/lp/images/standard/bv2/web-11007/wpbeginner-affiliate-lockup.svg" alt="Constant Contact and WP Beginner logos, side by side"><a  class="small-business-promo-cta" data-tracked-action="buy-today-and-save" href="/buynow/start-now/affiliate/signup.jsp">Buy Today &amp; Save 20%</a></div></div></div>';
                        ...
                        "variations": [{
                            ...
                            "actions": [{
                                ...
                                "changes": [{
                                    ...
                                    "preserveParameters": true,
                                    "type": "redirect",
                                    "id": "212b0ce6720743968c869734fb14ed0d"
                                }]
                            }],
                            "name": null
                        }],
                        "audienceIds": ["and", "13005550122"],
                        "changes": null,
                        "id": "13003670325",
                        "integrationSettings": null
                    }],
                ...
                "views": [{
                    ...
                    "name": null,
                    "apiName": "13001720089_affiliate_international",
                    "tags": [],
                    ...
                    "staticConditions": ["or", ["or", {
                        "type": "url",
                        "value": "https://www.constantcontact.com/index.jsp",
                        "match": "simple"
                    }]],
                    "name": null,
                    "apiName": "13001720089_index",
                    "tags": [],
                    "undoOnDeactivation": false,
                    "deactivationEnabled": false,
                    "id": "12996030116"
                    ...
                    "staticConditions": ["or", ["or", {
                        "type": "url",
                        "value": "/co/start-now/email-plan/signup.jsp",
                        "match": "substring"
                    }, {
                        "type": "url",
                        "value": "/es/start-now/email-plan/signup.jsp",
                        "match": "substring"
                    }, {
                        "type": "url",
                        "value": "/mx/start-now/email-plan/signup.jsp",
                        "match": "substring"
                    }]],
                    "name": null,
                    "apiName": "13001720089_spanish_language_email_signup_forms",
                    "tags": [],
                    "undoOnDeactivation": false,
                    "deactivationEnabled": false,
                    "id": "13009740178"
                    ...
                    "staticConditions": ["or", ["or", {
                        "type": "url",
                        "value": "/start-now/email-plan/signup.jsp",
                        "match": "substring"
                    }, {
                        "type": "url",
                        "value": "/start-now/email-plus/signup.jsp",
                        "match": "substring"
                    }, {
                        "type": "url",
                        "value": "/start-now/email-lite/signup.jsp",
                        "match": "substring"
                    }]],
                    "name": null,
                    "apiName": "13001720089_pages_for_ecom_abandoner_redirects",
                    "tags": [],
                    "undoOnDeactivation": false,
                    "deactivationEnabled": false,
                    "id": "13012960317"
                    ...
                    "staticConditions": ["or", ["or", {
                        "type": "url",
                        "value": "/co/start-now/email-plus/signup.jsp",
                        "match": "substring"
                    }, {
                        "type": "url",
                        "value": "/es/start-now/email-plus/signup.jsp",
                        "match": "substring"
                    }, {
                        "type": "url",
                        "value": "/mx/start-now/email-plus/signup.jsp",
                        "match": "substring"
                    }]],
                    "name": null,
                    "apiName": "13001720089_spanish_language_email_plus_signup_forms",
                    "tags": [],
                    "undoOnDeactivation": false,
                    "deactivationEnabled": false,
                    "id": "13030170106"
                    ...
                    "name": null,
                    "apiName": "13001720089_spanish_language_trial_home_page_for_redirects_to_ho",
                    "tags": [],
                    "undoOnDeactivation": false,
                    "deactivationEnabled": false,
                    "id": "13030280177"
                }],
                "projectId": "13001720089",
                "namespace": "13001720089",
                "integrationSettings": [{
                    "functions": {
                        fetchData: function() {
                            var data = {
                ...
                "audiences": [{
                    ...
                    "conditions": ["and", ["or", ["or", {
                            ...
                            ["or", {
                                "value": "email-conv_email_email-cartab-msg1",
                                "type": "cookies",
                                "name": "cclp_rmc",
                                "match": "substring"
                            }],
                            ["or", {
                                "value": "email-conv_email_email-cartab-msg2",
                                "type": "cookies",
                                "name": "cclp_rmc",
                                "match": "substring"
                            }],
                            ["or", {
                                "value": "email-conv_email_email-cartab-msg3",
                                "type": "cookies",
                                "name": "cclp_rmc",
                                "match": "substring"
                            }],
                            ["or", {
                                "value": "email-conv_email_email-cartab-autoreply",
                                "type": "cookies",
                                "name": "cclp_rmc",
                                "match": "substring"
                            }]
        ...
        if (s.shouldLoadInnie()) l.registerFunction("getProjectId", (function() {
            ...
            h = s.isSlave() ? window.optimizely : window.optimizely = window.optimizely || [], h.push({
                ...
                return g.projectId
            })), f.addScriptSync("https://cdn-assets-prod.s3.amazonaws.com/js/preview2/13001720089.js"))
    ...
    t.initialize = function() {
        ...
        return V.getSampleRum() ? (S.isLoaded() ? O.setTimeout(g, B) : O.addEventListener("load", g), new R(function(e, t) {
    ...
    (function(e, n) {
        (function() {
            ...
            })), b.prototype.toJSON = b.prototype.valueOf = b.prototype.value = gt, (Ii || yi || {})._ = b, vi && _i && (mi && ((_i.exports = b)._ = b), vi._ = b)
        }).call(this)
    ...
    (function(t, i) {
        ...
        !(function(t, n) {
            ...
            function T(e, t, n) {
                t.constructor === e.constructor && n === p && t.constructor.resolve === h ? S(e, t) : n === ce ? (R(e, ce.error), ce.error = null) : void 0 === n ? b(e, t) : r(n) ? I(e, t, n) : b(e, t)
            }
    ...
    t.event = function(e) {
        ...
        t < F && (A.error('Argument "cookieExpirationDays"=', t, "less than minimum days:", F, ", setting to minimum."), t = F), A.log("API / Setting cookie age to", t, "days."), I.dispatch(c.SET_COOKIE_AGE, t * V)
    ...
    function a() {
        ...
        E.some(t, n) && (b.log("Directive / Disabling tracking"), w.dispatch(y.LOAD_DIRECTIVE, {
            trackingDisabled: !0
        }))
    }
    ...
    function u() {
        ...
        e && b.log("Directive / Is legacy preview mode"), w.dispatch(y.LOAD_DIRECTIVE, {
            isLegacyPreview: !!e
        })
    }
    ...
    function f() {
        ...
        t && b.log("Directive / Is running in desktop app editor"), w.dispatch(y.LOAD_DIRECTIVE, {
    ...
    function g() {
        ...
        e && b.log("Directive / Is running in editor"), w.dispatch(y.LOAD_DIRECTIVE, {
    ...
    function i() {
        var e = null;
        b.isNumber(e) && 0 === ve.getCount() ? (Q.log("Activating after delay of", e, "ms because no Experiments are running"), Y.dispatch(C.SET_RUM_DATA, {
            data: {
                activateDfd: !0
            }
    ...
    function l(e, t, n) {
        e = e || [];
        var i = Ee.getAllPlugins(z.PluginTypes.visitorProfileProviders),
            r = pe.getGlobalHoldbackThreshold(),
    ...
    function E(e, t, n) {
        var i = b.map(e.audienceIds, b.bind(le.get, le)),
    ...
    function S(e, t, n) {
        ...
        return i = n.length ? U.getDummyLayerDecision(e, n) : U.decideLayer(e, t), Q.log("Recording decision for Campaign", r, t, "->", i), W.recordLayerDecision(e.id, t, i), i.variationId && i.experimentId && oe.updateVariationIdMap(e.id, i.experimentId, i.variationId), e.groupId && oe.updatePreferredLayerMap(e.groupId, e.id), i
    }
    ...
    function A(e, t, n) {
        ...
        if (!n && pe.isGlobalHoldback()) return Q.log(r, i, "(visitor is in global holdback)"), null;
    ...
    var b = n(2),
        ...
        ce = n(125),
        G = n(16),
        ue = G.get("stores/session"),
        le = G.get("stores/audience_data"),
        de = G.get("stores/action_data"),
        fe = G.get("stores/cleanup"),
        ge = G.get("stores/directive"),
        pe = G.get("stores/global"),
        he = G.get("stores/group_data"),
        ve = G.get("stores/layer_data"),
        _e = G.get("stores/layer"),
        me = G.get("stores/pending_events"),
        Ee = G.get("stores/plugins"),
        ye = G.get("stores/visitor"),
        Ie = G.get("stores/view_data"),
        Se = G.get("stores/view"),
        Te = G.get("stores/visitor_id"),
        Ae = G.get("stores/visitor_bucketing"),
    ...
    t.initialize = function(e) {
        ...
        De.queueBeacons(), B.isReady() ? Y.dispatch(C.SET_DOMCONTENTLOADED) : B.addReadyHandler((function() {
        ...
        })), b.each(pe.getPlugins() || [], (function(e) {
            try {
                K.apply(e, [Z])
            } catch (e) {
                V.emitError(e)
        ...
        var f = j.on({
            ...
            handler: function() {
                ye.observe(oe.persistVisitorProfile), _e.observe(oe.persistLayerStates), ue.observe(oe.persistSessionState), me.observe($.persistPendingEvents), Ae.observe(oe.persistVisitorBucketingStore), j.off(f)
            }
        });
        j.on({
            filter: {
        ...
        try {
            var e = [];
            Q.log("Activated client"), b.forEach(Se.getActiveViewStates(), (function(e) {
            ...
            var n = Ie.getAll();
            ae.registerViews(n), oe.setId(oe.getIdFromCookies()), e.push(P.trackPostRedirectDecisionEvent()), Y.dispatch(C.MERGE_VARIATION_ID_MAP, {
                variationIdMap: oe.getVariationIdMap()
            }), Y.dispatch(C.MERGE_PREFERRED_LAYER_MAP, {
                preferredLayerMap: oe.getPreferredLayerMap()
            }), T(z.Lifecycle.postVisitorProfileLoad), e.push(u(Ee.getAllPlugins(z.PluginTypes.visitorProfileProviders)).then((function() {
            ...
            return Ne ? ae.activateMultiple(o) : b.each(o, (function(e) {
        ...
        var t = [];
        return b.each(e, (function(e) {
            ae.shouldTriggerImmediately(e.activationType) ? t.push(e) : e.activationType === z.ViewActivationTypes.callback ? (Q.debug("Setting up conditional activation for Page", ae.description(e)), Ce.activateViewOnCallback(e)) : e.activationType === z.ViewActivationTypes.polling ? (Q.debug("Setting up polling activation for Page", ae.description(e)), ee.pollFor(b.partial(K.apply, e.activationCode), null, b.partial(re.isTimedOut, M.now())).then((function() {
                ae.activateMultiple([e])
            }))["catch"]((function(t) {
        ...
        try {
            ...
            var i = new D("(" + t.toString() + ") in activationCode for " + ae.description(e));
            V.emitError(i, {
                originalError: t,
                userError: !0
            })
        ...
        try {
            ...
            return t = te.all(b.map(n, (function(e) {
                var t = function() {
                    ...
                    t ? Q.log("Tracked activation for Page", ae.description(e), t) : Q.log("Not Tracking activation for Page", ae.description(e))
                };
                return B.isReady() ? te.resolve(t()) : ee.pollFor(B.isReady, Oe).then(t)
            }))), te.all([r, t])
        } catch (e) {
            V.emitError(e)
        }
                ...
                if (u.src) {
                    var v = "change_" + u.src,
                        E = c.makeAsyncRequest(v, (function() {
                            return h.addScriptAsync("https://cdn.optimizely.com/public/2125675982/data" + u.src, (function() {
                                c.resolveRequest(v)
                            }))
                        })).then((function() {
    ...
    var a = n(2),
        ...
        I = ["stores/layer_data", function(e) {
            return function(t) {
                var n = t.decision.layerId,
                    ...
                    c = e.get(n),
                    u = a.find(c.experiments, {
                        id: i
                    });
                if (u) {
                    var l = u["integrationSettings"] || c["integrationSettings"] || {},
                        d = l[h];
                    if (d) {
                        var f = a.find(u.variations, {
                            id: o
                        });
                        if (f) {
                            var p = E.generateAnalyticsString(c, u, f, r, g, !0);
                            if (p) return T(p, d)["catch"]((function(e) {
        ...
        S = function(e) {
            ...
            if (t && t[h] && e.experimentId && e.variationId) {
                var n = {
                    ...
                    a = e.isLayerHoldback,
                    o = E.generateAnalyticsString(n, i, r, a, g, !0);
        ...
        T = function(e, t) {
            ...
            return c.pollFor((function() {
                ...
                i && (e = e.substring(0, g), t[i] = e, l.indexOf(i) === -1 && l.push(i)), o && (t[o] = e, l.indexOf(o) === -1 && l.push(o));
                var d = u.getReferrer();
    ...
    e.exports = function(e) {
        e.registerApiModule("recommender", n(210))
    }
}), (function(e, t, n) {
    function i(e) {
    ...
    function _() {
        ...
        return I.debug("recommender / fetching recommended items for", this.targetId, "from recommender", this.recommender.id), r(this.recommenderService.serviceVersion) ? g(this._globalStore, this.targetId, this.recommenderSettings).then(E.bind((function(t) {
    ...
    function m(e) {
        ...
        var c = e.recosSoFar;
        return I.debug("recommender / fetching metadata for", s, "from recommender", this.recommender.id), p(this._globalStore, s, this.recommenderSettings).then(E.bind((function(i) {
    ...
    var r = n(2),
        ...
        _ = "COOKIE";
    i.prototype.apply = function() {
        if (this.reasonShouldNotRedirect) return g.warn("Redirect change is not being applied because: " + this.reasonShouldNotRedirect), a.resolve(l.changeState.IGNORED);
        if (this.reasonInvalid) return g.error("Redirect change cannot be applied because:", this.reasonInvalid), a.reject(this.reasonInvalid);
        try {
            this.jt(this.Ht())
        } catch (e) {
            return a.reject(e)
        ...
        if (!_) {
            ...
            n && (t = n.variationId);
            var i = (t || "unknown variation") + "|" + u.getReferrer();
            g.debug("Change / Redirect / Setting redirect data:", i), c.set(s.COOKIES.REDIRECT, i, {
                maxAge: 5
            })
        }
        var r = !this.change.hasOwnProperty("hidePage") || this.change.hidePage;
        r && this.Kt(), p.setLocation(e)
