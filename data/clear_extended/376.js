(function() {
    ...
    function F(a) {
        ...
        if (0 == a.indexOf("AND(")) return c = F(a.substring(4, b)), a = F(a.substring(b + 1, a.length - 1)),
            new X(c, a);
    ...
    function va() {
        ...
        for (c in k) k.hasOwnProperty(c) &&
            k[c].getType() == l.TYPE.STANDARD && (b[c] = k[c]);
    ...
    if (!window.liveAgentDeployment) {
        ...
        var f = {
                ...
                setCookie: function(a, b, c) {
                    a = a + "\x3d" + b + ";";
                    c && (c = new Date, c.setFullYear(c.getFullYear() + 10), a += "expires\x3d" +
                        c.toGMTString() + ";");
                ...
                log: function(a) {
                    S && window.console && window.console.log && window.console.log("LIVE AGENT: " + a)
                },
                logGroupStart: function(a) {
                    S && window.console && (window.console.group ? window.console.groupCollapsed("LIVE AGENT: " + a) : f.log(a))
                },
                logGroupEnd: function() {
                    S && window.console && window.console.group &&
                ...
                getCssAnimation: function(a) {
                    ...
                    for (var c = 0; c < b.length; c++)
                        if (void 0 !==
                            a.style[b[c] + "AnimationName"]) return b[c].toLowerCase();
                    return null
                },
                ...
                escapeToHtml: function(a) {
                    return null === a || void 0 === a || "" === a ? "" : a = a.replace(/[&<>"'\u00a9\u2028\u2029]/g, Ca)
                },
        ...
        l.prototype.getEndpoint = function(a) {
            ...
            var c = null,
                c = null == this.prechat ? b.call(this) : this.prechat + "?endpoint\x3d" +
                encodeURIComponent(b.call(this));
        ...
        l.prototype.startChat = function(a) {
            return this.dispatchEvent(l.EVENT.BUTTON_ACCEPTED) ? (ya(this.buttonId, a), !0) : !1
        };
        ...
        la.prototype = new l;
        T.prototype = new l;
        T.prototype.startChat = function(a, b) {
                ...
                for (var c in a) {
                    ...
                    switch (e.type) {
                        ...
                        case h.TYPE.SECONDS_ON_PAGE:
                            d =
                                new O(e.order, this.buttonId, (new Date).getTime(), e.operator, 1E3 * parseInt(e.value, 10));
                            break;
                        case h.TYPE.SECONDS_ON_SITE:
                            d = new O(e.order, this.buttonId, parseInt(B.getSessionStart(), 10), e.operator, 1E3 * parseInt(e.value, 10));
                            break;
                        case h.TYPE.CUSTOM_VARIABLE:
                            d = new W(e.order, this.buttonId, e.name, e.operator, e.value), H.hasOwnProperty(e.name) || (H[e.name] = []), H[e.name].push(this.buttonId)
                    }
        ...
        n.prototype.trigger = function() {
            ...
            var a = !0;
            null != this.ruleTree && (f.logGroupStart("Invite " + this.buttonId + " Rule Evaluation"), f.log("Filter Logic: " + this.filterLogic),
                a = this.ruleTree.evaluate(this), f.logGroupEnd());
        ...
        n.prototype.setAutoRejectTimeout =
            function(a) {
        ...
        r.prototype.init = function(a, b, c,
            e) {
        ...
        J.prototype.render = function() {
            ...
            var a = this.width *
                this.startPosition.xPosition + this.offset * this.startPosition.xOffset,
            ...
            g.innerHTML = "@" + d + "keyframes slide" + this.buttonId + "{from { margin-left: " + a + "px; margin-top: " +
                b + "px; left: " + 100 * this.startPosition.xPercent + "%; top: " + 100 * this.startPosition.yPercent + "%; }to { margin-left: " + c + "px; margin-top: " + e + "px; left: " + 100 * this.endPosition.xPercent + "%; top: " + 100 * this.endPosition.yPercent + "%; }}";
        ...
        J.prototype.remove = function(a) {
            ...
            a ? (this.element.style[b + "animation-play-state"] = "running", this.element.style.setProperty(b + "animation-play-state", "running", "")) : (this.element.style[b + "animation-name"] = "", this.element.style.setProperty(b + "animation-name",
        ...
        K.prototype.renderFinish = function() {
            var a = "";
            "" !== this.animationPrefix && (a = "-" + this.animationPrefix + "-");
            this.element.style[a + "animation-play-state"] =
                "paused";
            this.element.style.setProperty(a + "animation-play-state", "paused", "")
        };
            ...
            switch (this.operator) {
                ...
                case h.OPERATOR.START_WITH:
                    return f.log("Evaluate: " +
                        a + " indexOf " + b + " \x3d\x3d 0"), 0 == a.indexOf(b);
                ...
                case h.OPERATOR.LESS_OR_EQUAL:
                    return f.log("Evaluate: " +
                        parseFloat(a) + " \x3c\x3d " + parseFloat(b)), parseFloat(a) <= parseFloat(b);
        ...
        O.prototype.evaluate = function() {
            ...
            var a = (new Date).getTime() - this.compareFrom,
                b = h.prototype.evaluate.call(this,
                    a, this.compareTo);
        ...
        aa.prototype = new z;
        aa.prototype.evaluate = function(a) {
        ...
        ba.prototype.map = function(a, b, c, e, d) {
            "undefined" == typeof c && (c = !0);
            "undefined" == typeof e && (e = !0);
            "undefined" == typeof d && (d = !0);
            this.getEntityMaps().push(new pa(a, b, c, e, d))
        };
        ba.prototype.saveToTranscript = function(a) {
        ...
        (function() {
            ...
            (function() {
                ...
                d.handlePing = function(a) {
                    ...
                    b = !0;
                    a = a.messages;
                    for (var c = 0; c < a.length; c++) d.messageHandler.call(window, a[c].type, a[c].message);
        ...
        var x = f.getCookie("liveagent_sid"),
            ca = f.getCookie("liveagent_chatted"),
            ta = !1,
            S = !1,
            k = {},
            za = [],
                ...
                case "Settings":
                    ...
                    for (var c = 0; c < b.buttons.length; c++) switch (b.buttons[c].type) {
                        ...
                        case "Invite":
                            var e = b.buttons[c],
                                g = null,
                                g = e.inviteImageUrl ? Da(e.id, e.inviteImageUrl, e.inviteImageWidth, e.inviteImageHeight) : document.getElementById("liveagent_invite_button_" + e.id);
                            null == g ? fa("Warning: Button " + e.id + " disabled because HTML element was not found") : (d = u(e.id), d.addTracker(new A(e.id, g, e.inviteRenderer, e.inviteStartPosition,
                                e.inviteEndPosition, e.hasInviteAfterAccept, e.hasInviteAfterReject, e.inviteRejectTime)), g = f.jsonDecode(e.inviteRules), d.setRules(g.rules, g.filter), xa(d, e))
                    }
                    break;
                case "Availability":
                    c = {};
