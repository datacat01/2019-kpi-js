! function(e) {
    ...
    function f() {
        tt(rt(), this[Qe]) || nt.leaveBreadcrumb("XMLHttpRequest error", {
            request: this[et] + " " + this[Qe]
        }, Ze)
    }
    ...
    function h(e) {
        function t(e, i) {
            ...
            if (r++, i === undefined && (i = 0), i > Bt) return Lt;
            if (o()) return Lt;
            if (null === e || "object" != typeof e) return e;
            if (l(n, e)) return "[Circular]";
    ...
    var m = function(e, t, n) {
        ...
        w = {
            ...
            keys: function(e) {
                ...
                if (!v) return t;
                for (var r = 0, i = y.length; r < i; r++) Object.prototype.hasOwnProperty.call(e, y[r]) && t.push(y[r]);
                return t
            },
            isArray: function(e) {
                return "[object Array]" === Object.prototype.toString.call(e)
            ...
            isoDate: function() {
                var e = new Date;
                return e.getUTCFullYear() + "-" + b(e.getUTCMonth() + 1) + "-" + b(e.getUTCDate()) + "T" + b(e.getUTCHours()) + ":" + b(e.getUTCMinutes()) + ":" + b(e.getUTCSeconds()) + "." + (e.getUTCMilliseconds() / 1e3).toFixed(3).slice(2, 5) + "Z"
            }
        },
        S = w.isoDate,
        O = function() {
            function t() {
                var n = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "[anonymous]",
                    ...
                    i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "manual",
                    o = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : S();
    ...
    j.positiveIntIfDefined = function(e) {
        return E(["undefined", "number"], typeof e) && parseInt("" + e, 10) === e && e > 0
    ...
    var N = {},
        ...
        D = w.isArray,
        x = w.includes,
        L = j.positiveIntIfDefined,
        _ = j.stringWithLength;
    N.schema = {
        apiKey: {
        ...
        beforeSend: {
            ...
            validate: function(e) {
                return "function" == typeof e || D(e) && k(e, function(e) {
        ...
        endpoints: {
            ...
            validate: function(e, t) {
                return e && "object" == typeof e && _(e.notify) && (!1 === t.autoCaptureSessions || _(e.sessions)) && 0 === k(B(e), function(e) {
                    return !x(["notify", "sessions"], e)
                }).length
            }
        },
        autoCaptureSessions: {
        ...
        notifyReleaseStages: {
            ...
            validate: function(e) {
                return null === e || D(e) && k(e, function(e) {
        ...
        logger: {
            ...
            validate: function(e) {
                return !e || e && R(["debug", "info", "warn", "error"], function(t, n) {
    ...
    ! function(e, t) {
        ...
        for (var f = 0; f < o.length; f++) r.prototype["get" + t(o[f])] = n(o[f]), r.prototype["set" + t(o[f])] = function(t) {
            return function(n) {
                if (!e(n)) throw new TypeError(t + " must be a Number");
                this[t] = Number(n)
            }
        }(o[f]);
        for (var d = 0; d < a.length; d++) r.prototype["get" + t(a[d])] = n(a[d]), r.prototype["set" + t(a[d])] = function(e) {
            return function(t) {
                this[e] = String(t)
            }
        }(a[d]);
        ...
        U = function() {
            function e(n, r) {
                var i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [],
                    o = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : F();
    ...
    var X = U,
        ...
        z = "object" == typeof window ? window : self,
        G = 0;
    for (var W in z) Object.hasOwnProperty.call(z, W) && G++;
    var Y = navigator.mimeTypes ? navigator.mimeTypes.length : 0,
        Z = J((Y + navigator.userAgent.length).toString(36) + G.toString(36), 4),
        Q = function() {
            return Z
        },
        ee = 0,
    ...
    var ie = i,
        ...
        pe = function() {
            function e(t) {
                var n = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : N.schema,
                    r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
                if (a(this, e), !(t && t.name && t.version && t.url)) throw new Error("`notifier` argument is required");
            ...
            return e.prototype.configure = function() {
                ...
                if (!0 == !t.valid) throw new Error(ve(t.errors));
        ...
        he = function(e, t, n) {
            ...
            switch (typeof e) {
                ...
                case "function":
                    ...
                    break;
                case "object":
                    if (null !== e && (se(e) || e.__isBugsnagReport)) r = e;
                    else if (null !== e && me(e))(r = new Error(e.message || e.errorMessage)).name = e.name || e.errorClass, i += 2;
                    else {
        ...
        ke = {
            ...
            logger: je({}, Ee.logger, {
                defaultValue: function() {
                    return "undefined" != typeof console && "function" == typeof console.debug ? Re() : undefined
                }
            })
        },
        Re = function() {
            var e = {},
                t = console.log;
            return Ne(["debug", "info", "warn", "error"], function(n) {
                var r = console[n];
    ...
    var _e = Le(["log", "debug", "info", "warn", "error"], function(e) {
            ...
            init: function(e) {
                ...
                t = r(), document.onreadystatechange = function() {
                    ...
                    var a = ["\x3c!-- DOC START --\x3e"].concat(t.split("\n")),
                        s = Ue(a, o.lineNumber - 1),
                        u = s.script,
                        c = s.start,
                        f = Pe(u, function(e, t, n) {
                            return Math.abs(c + n + 1 - o.lineNumber) > 10 ? e : (e["" + (c + n + 1)] = t, e)
                        }, {});
                    o.code = f, e.updateMetaData("script", {
                        content: u.join("\n")
                    })
                })
            }
        }).extractScriptContent = function(e, t) {
            for (var n = t; n < e.length && !He.test(e[n]);) n++;
            for (var r = n; n > 0 && !Ve.test(e[n]);) n--;
            var i = n,
                o = e.slice(i, r + 1);
    ...
    var Je = function(e) {
        ...
        Ge = function(e, t, n) {
            var r = t[n];
            t[n] = function(i, o, a) {
                e.leaveBreadcrumb("History " + n, ze(i, o, a), "navigation"), "function" == typeof e.refresh && e.refresh(), e.session && e.startSession(), r.apply(t, [i, o].concat(a !== undefined ? a : []))
        ...
        nt = void 0,
        rt = function() {
            return [nt.config.endpoints.notify, nt.config.endpoints.sessions]
        };
    Ye.init = function(e) {
        nt = e, it(), ot()
    }, Ye.configSchema = {
    ...
    var it = function() {
        ...
        st = function(e, t) {
            nt.leaveBreadcrumb("fetch() error", {
                request: e + " " + t
            }, Ze)
        },
        ...
        ct = {
            init: function(e) {
                e.config.beforeSend.unshift(function(e) {
                    e.request && e.request.url || (e.request = ut({}, e.request, {
    ...
    wt.init = function(e) {
        var t = function(t) {
            ...
            var i = {
                ...
                o = void 0;
            if (n && q(n)) o = new e.BugsnagReport(n.name, n.message, A.parse(n), i), r && (o.stacktrace = St(o.stacktrace, Et(n), []));
            else {
    ...
    var jt = function(e) {
                ...
                window.onerror = function(n, r, i, o, a) {
                    if (0 === i && /Script error\.?/.test(n)) e._logger.warn("Ignoring cross-domain or eval script error. See docs: https://tinyurl.com/y94fq5zm");
                        ...
                        var s = {
                            ...
                            u = void 0;
                        if (a) a.name && a.message ? u = new e.BugsnagReport(a.name, a.message, kt(e.BugsnagReport.getStacktrace(a), r, i, o), s) : (u = new e.BugsnagReport("window.onerror", String(a), kt(e.BugsnagReport.getStacktrace(a, 1), r, i, o), s)).updateMetaData("window onerror", {
                            error: a
                        });
                        else if ("object" != typeof n || null === n || r || i || o || a)(u = new e.BugsnagReport("window.onerror", String(n), kt(e.BugsnagReport.getStacktrace(a, 1), r, i, o), s)).updateMetaData("window onerror", {
                            event: n
                        });
                        else {
                            var c = n.type ? "Event: " + n.type : "window.onerror",
                                f = n.message || n.detail || "";
                            (u = new e.BugsnagReport(c, f, e.BugsnagReport.getStacktrace(new Error, 1).slice(1), s)).updateMetaData("window onerror", {
                                event: n
                            })
                        }
        ...
        _t = function(e) {
            ...
            if (t.length > 1e6 && (delete e.events[0].metaData, e.events[0].metaData = {
                ...
                }, (t = Rt(e)).length > 1e6)) throw new Error("payload exceeded 1MB limit");
            return t
        },
        Ct = {},
        qt = w.isoDate;
    ...
    var Tt = function(e, t, n) {
        ...
        Pt = {
            ...
            sendSession: function(e, t, n) {
                ...
                try {
                    ...
                    o.onreadystatechange = function() {
                        o.readyState === window.XMLHttpRequest.DONE && r(null, o.responseText)
                    }, o.open("POST", i), o.setRequestHeader("Content-Type", "application/json"), o.setRequestHeader("Bugsnag-Api-Key", t.apiKey), o.setRequestHeader("Bugsnag-Payload-Version", "1.0"), o.setRequestHeader("Bugsnag-Sent-At", Mt()), o.send(Rt(n))
                } catch (a) {
                    e.error(a)
                }
            }
        ...
        It = w.reduce,
        $t = Ht({}, N.schema, ke),
        Ft = [Nt, wt, Ae, Ce, ct, Oe, Be, Ye, Xe, Ie, Me, pt, Ke, mt];
    Vt = function(e) {
        var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
        "string" == typeof e && (e = {
            apiKey: e
...
//# sourceMappingURL=bugsnag.v4.7.2.min.js.map