        ...
        (function(n) {
            ...
            t.exports = function(e, t, l, u) {
                ...
                function v(e) {
                    if (!S.isInvalid(e)) {
                        var t = S.parse(e);
                        b = !1, n.clearTimeout(this.timeout), n.removeEventListener("message", v), d(new i(y)), n.addEventListener("message", g), y.setStateAndPublish(t.state), y.callbackRegistry.hasCallbacks() && f(c.GETSTATE)
                    }
                }

                function m() {
                    D && postMessage ? (n.addEventListener("message", v), f(c.HANDSHAKE), this.timeout = setTimeout(h, 250)) : h()
                }
...
function(e, t, n) {
    ...
    function i() {
        E.addEventHandler(e, "orientationchange", i.orientationChange)
    }
    ...
    function f(e) {
        E.BaseTool.call(this, e), this.defineListeners(), this.beaconMethod = "plainBeacon", this.adapt = new f.DataAdapters, this.dataProvider = new f.DataProvider.Aggregate
    }
    ...
    var b, S, T, C = Object.prototype.toString,
        ...
        E = {
            ...
            cssQuery: (b = t, b.querySelectorAll ? function(e, t) {
                var n;
                try {
                    n = b.querySelectorAll(e)
                } catch (a) {
                    n = []
                }
                t(n)
    ...
    E.availableTools = {}, E.availableEventEmitters = [], E.fireOnceEvents = ["condition", "elementexists"], E.initEventEmitters = function() {
    ...
    }, e._satellite = E, a.prototype.getStringifiedValue = e.JSON && e.JSON.stringify || E.stringify, a.prototype.initPolling = function() {
    ...
    }, E.availableEventEmitters.push(a), i.orientationChange = function(t) {
    ...
    }, E.availableEventEmitters.push(o), c.offset = function(n) {
        var a = null,
            i = null;
        try {
    ...
    }, E.availableEventEmitters.push(p), g.prototype = {
        initialize: function() {
    ...
    }, E.availableEventEmitters.push(g), E.ecommerce = {
        addItem: function() {
    ...
    }, E.inherit(f, E.BaseTool), E.extend(f.prototype, {
        name: "Nielsen",
        ...
        initializeDataProviders: function() {
            ...
            this.dataProvider.register(new f.DataProvider.VisitorID(E.getVisitorId())), t ? (e = new f.DataProvider.Generic("rsid", function() {
        ...
        human: !0,
        magicConst: 2e6
    }), f.DataProvider = {}, f.DataProvider.Generic = function(e, t) {
        this.key = e, this.valueFn = t
    }, E.extend(f.DataProvider.Generic.prototype, {
        isReady: function() {
            return !0
        },
        getValue: function() {
        ...
        provide: function() {
            this.isReady() || f.prototype.notify("Not yet ready to provide value for: " + this.key, 5);
            var e = {};
            return e[this.key] = this.getValue(), e
        }
    }), f.DataProvider.VisitorID = function(e, t, n) {
        this.key = t || "uuid", this.visitorInstance = e, this.visitorInstance && (this.visitorId = e.getMarketingCloudVisitorID([this, this._visitorIdCallback])), this.fallbackProvider = n || new f.UUID
    }, E.inherit(f.DataProvider.VisitorID, f.DataProvider.Generic), E.extend(f.DataProvider.VisitorID.prototype, {
        isReady: function() {
    ...
    }, E.extend(f.DataProvider.Aggregate.prototype, {
        register: function(e) {
    ...
    }), f.UUID = function() {}, E.extend(f.UUID.prototype, {
        generate: function() {
    ...
    }), f.DataAdapters = function() {}, E.extend(f.DataAdapters.prototype, {
    ...
    }), E.availableTools.nielsen = f, E.extend(h.prototype, {
    ...
    }), E.availableTools.sc = v, E.inherit(m, E.BaseTool), E.extend(m.prototype, {
        name: "Default",
    ...
    }), E.availableTools["default"] = m, E.inherit(_, E.BaseTool), E.extend(_.prototype, {
        name: "tnt",
        endPLPhase: function(e) {
    ...
    }), E.availableTools.am = k, E.availableTools.adlens = k, E.availableTools.aem = k, E.availableTools.__basic = k;
    var I = {
    ...
    E.inherit(y, E.BaseTool), E.extend(y.prototype, {
        name: "GAUniversal",
        endPLPhase: function(e) {
    ...
    }), E.availableTools.ga_universal = y, E.inherit(D, E.BaseTool), E.extend(D.prototype, {
        name: "GA",
        initialize: function() {
            var t = this.settings,
                n = e._gaq,
            ...
            if (n || (_gaq = []), this.isSuppressed()) E.notify("GA: page code not loaded(suppressed).", 1);
                ...
                if (!n && !D.scriptLoaded) {
                    ...
                    t.url && (s = r ? t.url.https : t.url.http), E.loadScript(s), D.scriptLoaded = !0, E.notify("GA: page code loaded.", 1)
                }
                t.domain;
                var o = t.trackerName,
                    c = I.allowLinker(),
    ...
    }), E.availableTools.ga = D, _satellite.init({
        tools: {
            "30bfce2d8cbf6eb7f37078f4a8eb3dac": {
                engine: "sc",
                loadOn: "pagebottom",
                account: "elsevier-sd-prod,elsevier-global-prod",
                euCookie: !1,
                sCodeURL: "376c5346e33126fdb6b2dbac81e307cbacfd7935/s-code-contents-9c0358adbc3b5986e210099b3bf1d427fc5bd286.js",
                initVars: {
                    charSet: "UTF-8",
                ...
                customInit: function(a) {
                    ...
                    for (var c = ["com", "edu", "gov", "ac", "org", "net", "co", "go"], l = 0; l < c.length; l++)
                        ...
                        if (e.pageData && "true" != pageData.page.noTracking && e.pageData_isLoaded || (a.abort = !0, e.pageData)) {
                            ...
                            a.eVar21 = _satellite.getVar("Promo - Clicked ID"), a.eVar21 && (a.list3 = a.eVar21 = a.productPrefix(a.eVar21), a.linkTrackVars = a.apl(a.linkTrackVars, "eVar21", ",", 2), e.clickedPromoId && (e.clickedPromoId = n)), a.account = a.getCustomReportSuites(), a.tpEls = a.getTimeParting("n", "-5").split("|"), a.prop5 = a.tpEls[0] + " " + a.tpEls[1], a.prop9 = a.version, a.prop32 = t.location.protocol.replace(/\:/g, ""), a.eVar8 = a.getDaysSinceLastVisit("v8");
                            var s, o = Visitor.getInstance("4D6368F454EC41940A4C98A6@AdobeOrg");
                            if (a.eVar50 = o.getMarketingCloudVisitorID(), a.prop12) {
                                var c = 0;
                                a.eVar33 && null !== a.eVar33.match(/(reg(-|_|:))|registered/gi) && (c = 1), o.setCustomerIDs({
                                    userid: {
                                        id: a.prop12,
                                        authState: c
                                    }
                            ...
                            if (e.pageData && pageData.page && "cert" == pageData.page.environment && (a.account = a.account.replace(/\-(dev|prod)/gi, "-cert")), a.campaign && a.prop2 && 0 != a.campaign.indexOf(a.prop2 + ":") && (a.campaign = a.prop2 + ":" + a.campaign), a.campaign && (a.eVar108 = "D=v0", a.linkTrackVars = a.apl(a.linkTrackVars, "eVar108", ",", 2)), a.events = a.events ? a.events : "", a.products = pageDataTracker.setProductsVariable(), !a.pageLoaded && a.pageName) {
                                ...
                                var _ = _satellite.getVar("Page - Load Timestamp"),
                                    ...
                                    y = a.c_r("v31") || _;
                                if (_) try {
                                    var D = new Date(parseInt(_)),
                                        b = D.getTime(),
                                        S = this.isDST(D);
                                    a.eVar113 = (Math.floor((b / 1e3 - 18e3 + 3600 * S) % 86400) + 1).toString(), a.linkTrackVars = a.apl(a.linkTrackVars, "eVar113", ",", 2)
                                } catch (H) {
                                    _satellite.notify("Error setting s.eVar113: " + H.message)
                                }
                                if (_ && k) try {
                                ...
                                for (var L = ["utm_campaign", "dgcid", "utm_dgroup", "utm_in", "utm_medium", "utm_acid", "cmx_id", "sis_id", "utm_source", "utm_term", "utm_content"], P = "", A = !1, O = 0; O < L.length; O++) {
                                    var M = a.Util.getQueryParam(L[O]) || "";
                                    M && (A = !0), P += M + "|"
                                }
                                A && (a.eVar125 = P), a.prop14 && !isNaN(parseFloat(a.prop14)) && isFinite(a.prop14) && (a.events = a.apl(a.events, "event229=" + a.prop14, ",", 2), a.events = a.apl(a.events, "event230", ",", 2)), e.pageDataTracker_ec && pageDataTracker_ec > 0 && (a.events = a.apl(a.events, "event227=" + pageDataTracker_ec, ",", 2), pageDataTracker_ec = 0), e.pageDataTracker_wc && pageDataTracker_wc > 0 && (a.events = a.apl(a.events, "event228=" + pageDataTracker_wc, ",", 2), pageDataTracker_wc = 0), a.pageLoaded = !0
                            }
                    ...
                    a.isTracked = function(e) {
                            ...
                            for (var e = {
                                    ...
                                    "default": ["3", "37", "6", "5", "39", "19", "25", "48", "9", "12", "23", "2", "22"]
                                }, t = {
                                    2: "registration",
                                    3: "search",
                                    5: "content view",
                                ...
                                }, n = a.prop2 && e[a.prop2] ? e[a.prop2] : e["default"], i = 0; i < n.length; i++) {
                                var r = n[i],
                                    s = new RegExp("event" + r + "(,|$)", "g");
                                if (t[r] && a.events.match(s)) return t[r]
                            }
                            return ""
            ...
            "7c98db61eb93bbca53ce8cfcb6993d3ad8ac3fff": {
                engine: "visitor_id",
                loadOn: "pagetop",
                name: "VisitorID",
        ...
        pageLoadRules: [{
            ...
            trigger: [{
                ...
                arguments: [{
                    sequential: !0,
                    scripts: [{
                        src: "satellite-565e008964746d4385002642.js"
                    }]
                }]
            }, {
                command: "loadScript",
                arguments: [{
                    sequential: !1,
                    scripts: [{
                        src: "satellite-5b3b560664746d57b70018c6.js"
                    }]
                }]
            }],
            event: "pagetop"
        ...
        rules: [{
            ...
            trigger: [{
                ...
                arguments: [{
                    ...
                    customSetup: function(t, n) {
                        n.eVar124 = this.getAttribute("data-aa-button"), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar124", ",", 2), e.s_objectID = e.s_objectID ? e.s_objectID : "test"
                    },
                    addEvent: ["event204"]
                }]
            }],
            ...
            trigger: [{
                ...
                arguments: [{
                    sequential: !1,
                    scripts: [{
                        src: "satellite-565e007b64746d25a90001e6.js"
                    }]
                }]
            }],
        ...
        directCallRules: [{
            ...
            trigger: [{
                ...
                arguments: [{
                    ...
                    linkName: "cta click",
                    customSetup: function() {
                        e.eventData && eventData.cta && eventData.cta.ids && eventData.cta.ids.length > 0 && (e.clickedPromoId = eventData.cta.ids[0])
                    },
                    addEvent: ["event22"]
                }]
            }]
            ...
            trigger: [{
                ...
                arguments: [{
                    ...
                    customSetup: function(e, t) {
                        t.list2 = _satellite.getVar("Page - Widget Names"), t.linkTrackVars = t.apl(t.linkTrackVars, "list2", ",", 2)
                    },
                    addEvent: ["event182", "event19"]
                }]
            }]
        }, {
            name: "contentDownloadStart",
            trigger: [{
                engine: "sc",
                command: "trackLink",
                arguments: [{
            ...
            trigger: [{
                ...
                arguments: [{
                    type: "o",
                    linkName: "content view",
                    addEvent: ["event5"]
                }]
            }]
        }, {
            name: "conversionDriverClick",
            trigger: [{
                engine: "sc",
                command: "trackLink",
                arguments: [{
                    ...
                    linkName: "conversion driver click",
                    customSetup: function(e, t) {
                        t.eVar103 = _satellite.getVar("Event - Conversion Driver"), t.linkTrackVars = t.apl(t.linkTrackVars, "eVar103", ",", 2), t.eVar110 = "D=pageName", t.linkTrackVars = t.apl(t.linkTrackVars, "eVar110", ",", 2)
                    }
                }]
            }]
        }, {
        ...
        settings: {
            ...
            libraryName: "satelliteLib-b7cfe8df39a4e5eec5536bba80e13f4b6fa0dd7c",
            isStaging: !1,
            allowGATTcalls: !1,
        ...
        dataElements: {
            ...
            "Event - Alert Type": {
                customJS: function() {
                    return e.eventData && eventData.alert && (eventData.alert.frequency || eventData.alert.type) ? (eventData.alert.frequency || "no frequency") + "|" + (eventData.alert.type || "no type") : ""
                },
                storeLength: "pageview",
                forceLowerCase: !0
            },
            ...
            "Event - Conversion Driver": {
                jsVariable: "eventData.conversionDriver.name",
                storeLength: "pageview",
                forceLowerCase: !0,
                cleanText: !0
            },
            ...
            "Event - Share Platform": {
                jsVariable: "eventData.sharePlatform",
                storeLength: "pageview",
                forceLowerCase: !0
            },
            ...
            "Page - Business Unit": {
                customJS: function() {
                    return (e.pageData && pageData.page && pageData.page.businessUnit ? pageData.page.businessUnit : "").replace(/RAP\:/g, "RP:")
                },
                storeLength: "pageview",
                forceLowerCase: !0
            },
            ...
            "Page - Product Application Version": {
                jsVariable: "pageData.page.productAppVersion",
                storeLength: "pageview",
                forceLowerCase: !0
            },
            ...
            "Page - Product Name": {
                customJS: function() {
                    return e.pageData && pageData.page && pageData.page.productName && pageData.page.productName.length < 3 ? pageData.page.productName : ""
                },
                storeLength: "pageview",
                forceLowerCase: !0
            },
            ...
            "Page - Test ID": {
                customJS: function() {
                    var t = [];
                    if (e.pageDataTracker) {
                        var n = pageDataTracker.getCookie("id_ab");
                        n && t.push("cookie-" + n)
                    }
                    e.pageData && pageData.page && pageData.page.testId && t.push(pageData.page.testId);
                    try {
                        tests = e.optimizely ? optimizely.data.state.activeExperiments : [];
                        var a = pageData.page.productName.toLowerCase();
                        if (tests.length > 0)
                            for (var i = 0; i < tests.length; i++) {
                                var r = a + "-optimizely-" + tests[i],
                                    s = optimizely.data.state.variationIdsMap[tests[i]];
                                t.push(r + ":" + s)
                            }
                    } catch (o) {
                        _satellite.notify("Page - Test ID: Error capturing Optimizely experiments " + o.message)
                    }
                    return t.join("|")
                },
                storeLength: "pageview"
            ...
            "Page - Website Extensions": {
                customJS: function() {
                    var t = e.pageData && pageData.savedEvents && pageData.savedEvents.wx ? pageData.savedEvents.wx.split("|") : [];
                    return e.ga && t.push("3"), e.pendo && t.push("4"), e.usabilla_live && t.push("5"), e.optimizely && t.push("6"), t.join("|")
                },
                storeLength: "pageview"
            },
            "Page - Widget Names": {
                customJS: function() {
                    return e.eventData && eventData.link && eventData.link.widgetName ? eventData.link.widgetName : e.pageData && pageData.page && pageData.page.widgetNames ? pageData.page.widgetNames.join("|") : void 0
                },
                storeLength: "pageview",
                forceLowerCase: !0
            },
            "Promo - Clicked ID": {
                customJS: function() {
                    return e.clickedPromoId ? e.clickedPromoId : ""
                },
                storeLength: "pageview",
                forceLowerCase: !0
            },
            "Promo - IDs": {
                customJS: function() {
                    for (var n = t.getElementsByTagName("a"), a = [], i = 0; i < n.length; i++) {
                        var r = n[i].getAttribute("data-sc-promo-id");
                        r && a.push(r)
                    }
                    if (e.eventData && eventData.cta && eventData.cta.ids)
                        for (i = 0; i < eventData.cta.ids.length; i++) a.push(eventData.cta.ids[i]);
                    return a.join("|")
                },
                storeLength: "pageview",
                forceLowerCase: !0
            ...
            "Search - Advanced Criteria": {
                jsVariable: "pageData.search.advancedCriteria",
                storeLength: "pageview",
                forceLowerCase: !0
            },
            "Search - Criteria": {
                customJS: function() {
                    var t = "";
                    return e.pageData && (pageData.search && (t = pageData.search.criteria || ""), !t && pageData.savedEvents && (t = pageData.savedEvents.autoSuggestSearchTerm || ""), !t && e.eventData && eventData.search && eventData.search.criteria && (t = eventData.search.criteria)), t
                },
                storeLength: "pageview"
            },
            "Search - Current Page": {
            ...
            "Search - Type": {
                jsVariable: "pageData.search.type",
                storeLength: "pageview",
                forceLowerCase: !0
            },
            ...
            "Visitor - Access Type": {
                customJS: function() {
                    var e = "";
                    return pageData && pageData.visitor && pageData.visitor.accessType && (e = pageData.visitor.accessType.toLowerCase()), "ae:anon-ip" == e && (e = "ae:anon_ip"), "ae:anon-guest" == e && (e = "ae:anon_guest"), e
                },
                storeLength: "pageview",
                forceLowerCase: !0
            },
            ...
            "Visitor - Account Name": {
                customJS: function() {
                    return e.pageData && pageData.visitor && pageData.visitor.accountName && "ae:" != pageData.visitor.accountName && "AE:" != pageData.visitor.accountName ? pageData.visitor.accountName : ""
                },
                storeLength: "pageview",
                forceLowerCase: !0
            },
            "Visitor - App Session ID": {
                customJS: function() {
                    if (pageData && pageData.visitor && pageData.visitor.appSessionId) return pageData.visitor.appSessionId;
                    var t = pageDataTracker.getCookie("sd_session_id");
                    if (!t) {
                        t = navigator.userAgent, e.pageData && pageData.visitor && pageData.visitor.ipAddress && (t += "|" + pageData.visitor.ipAddress);
                        var n = new Date;
                        t += "|", t += n.getFullYear(), t += n.getMonth(), t += n.getDate(), t += n.getHours()
                    }
                    return t
                },
                storeLength: "pageview"
        ...
        appVersion: "7QN",
        buildDate: "2019-03-26 08:53:37 UTC",
        publishDate: "2019-03-26 08:53:36 UTC"
    })
}(window, document);