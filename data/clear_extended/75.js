(function() {
    ...
    jQuery('#ShortenedForm').on('change keyup', function() {
        ...
        bitlink = jQuery('#shortened_url').val();
    ...
    function checkHistory() {
        ...
        if (localStorage.getObj('hashes') !== null) {
            ...
            for (var i = 0; i < arrayLength; i++) {
                ...
                row = '<li class="link"><span class="long-link">' + longLink + '</span><span><span class="short-link"><a href="' + shortLink + '" target="_blank">' + shortLink + '</a></span><span class="copy"><button class="button button-secondary">Copy</button></span></span></li>';
    ...
    function shortenError(res) {
        ...
        row = '<ul class="error-list" style="display:none"><li class="error text-center align-center"><span>' + message + '</span></li></ul>';
    ...
    jQuery('#unAuthShortenForm').on('submit', function(e) {
        ...
        BITLY.shorten(longUrl, shortenSuccess, shortenError);
