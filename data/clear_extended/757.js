webpackJsonp([6], {
    102: function(module, exports, __webpack_require__) {
        ...
        (function($) {
            ...
            var _whenVisible2 = _interopRequireDefault(__webpack_require__(26)),
                _tracking2 = _interopRequireDefault(__webpack_require__(17)),
                _trendingTopics2 = _interopRequireDefault(__webpack_require__(103)),
                _hotBlock2 = _interopRequireDefault(__webpack_require__(104)),
                _quickLinks2 = _interopRequireDefault(__webpack_require__(105));
            ...
            exports.default = {
                init: function() {
                    _trendingTopics2.default.init(), _hotBlock2.default.init(), _quickLinks2.default.init(), ["in-area-left", "in-area-main", "in-area-right"].forEach(function(className) {
                        $(".trending-topics." + className + ":visible").length && _whenVisible2.default.once(".trending-topics." + className, {
                            visible: function() {
                                _tracking2.default.track({
                                    action: "view",
                                    category: "interrupt",
                                    label: "view.all-topics"
                                })
                            }
                        }), $(".featured-block." + className + ":visible").length && _whenVisible2.default.once(".featured-block." + className, {
                            visible: function() {
                                _tracking2.default.track({
                                    action: "view",
                                    category: "interrupt",
                        ...
                        }), $(".topic_explore-wikis." + className + ":visible").length && _whenVisible2.default.once(".topic_explore-wikis." + className, {
                            visible: function() {
                                _tracking2.default.track({
                                    action: "view",
                                    category: "topic",
    ...
    103: function(module, exports, __webpack_require__) {
        ...
        (function($) {
            ...
            var obj, _hasRail = __webpack_require__(24),
                _stickyModule = __webpack_require__(58),
                _stickyModule2 = (obj = _stickyModule) && obj.__esModule ? obj : {
                    default: obj
                };
            exports.default = {
                init: function() {
                    ...
                    }), new _stickyModule2.default(".trending-topics.in-area-left", _hasRail.hasLeftRail)
                }
            }
        }).call(exports, __webpack_require__(0))
    },
    104: function(module, exports, __webpack_require__) {
        ...
        (function($, log) {
            ...
            var _whenVisible2 = _interopRequireDefault(__webpack_require__(26)),
                _tracking2 = _interopRequireDefault(__webpack_require__(17)),
                _accessors = __webpack_require__(5);
            ...
            exports.default = {
                init: function() {
                    $.ajax({
                        url: _accessors.state.get("feed.hotContentModuleUrl")
                    }).then(function(response) {
                        log.debug("Hot content loaded " + response.length + " bytes"), response.length && ($(".hot-block.is-placeholder").html(response).removeClass("is-placeholder"), ["in-area-left", "in-area-main", "in-area-right"].forEach(function(className) {
                            $(".hot-block." + className + ":visible").length && _whenVisible2.default.once(".hot-block." + className, {
                                visible: function() {
                                    _tracking2.default.track({
                                        action: "view",
                                        category: "interrupt",
        ...
        }).call(exports, __webpack_require__(0), __webpack_require__(3))
    },
    105: function(module, exports, __webpack_require__) {
        ...
        exports.default = {
            init: function() {
                new _stickyModule2.default(".quick-links.in-area-right", _hasRail.hasRightRail, 5)
            }
        }
    },
    106: function(module, exports, __webpack_require__) {
        ...
        (function($) {
            ...
            var _dialogs2 = _interopRequireDefault(__webpack_require__(7)),
                _tracking2 = _interopRequireDefault(__webpack_require__(17)),
                _lightbox2 = _interopRequireDefault(__webpack_require__(107));
            ...
            exports.default = {
                init: function() {
                    $(".feed-layout__container").on("click", ".card__social-image", function(e) {
                        ...
                        _dialogs2.default.openEmptyModal({
                            content: (0, _lightbox2.default)({
                                source: src
                            }),
                        ...
                        _dialogs2.default.remove(lightboxId), $("body").removeClass("has-lightbox")
                    })
                }
            }
        }).call(exports, __webpack_require__(0))
    ...
    108: function(module, exports, __webpack_require__) {
        ...
        (function($) {
            ...
            var _throttleDebounce = __webpack_require__(12),
                _hasRail = __webpack_require__(24);
            exports.default = {
                init: function() {
                    if ((0, _hasRail.hasRightRail)()) {
                        var $win = $(window),
                            $boxad = $(".feed-bottom-boxad"),
                            $rail = $(".feed-layout__right-rail");
                        $win.on("scroll", (0, _throttleDebounce.throttle)(10, function() {
                            ! function($win) {
    ...
    11: function(module, exports, __webpack_require__) {
        ...
        (function($) {
            ...
            var obj, _loadingIndicator = __webpack_require__(36),
                _loadingIndicator2 = (obj = _loadingIndicator) && obj.__esModule ? obj : {
                    default: obj
                };
            exports.default = {
                show: function() {
                    var options = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        outerStyle = {},
                        innerStyle = {
                            "border-width": (context.size <= 36 ? 2 : 3) + "px",
                    ...
                    $container.is("body") ? outerStyle["z-index"] = 501e4 : options.fullScreen || (outerStyle.position = "absolute"), options.background && (outerStyle["background-color"] = options.background), Object.keys(outerStyle).forEach(function(key) {
                        context.outerStyle = "" + context.outerStyle + key + ": " + outerStyle[key] + ";"
                    }), Object.keys(innerStyle).forEach(function(key) {
                        context.innerStyle = "" + context.innerStyle + key + ": " + innerStyle[key] + ";"
                    }), $container.prepend((0, _loadingIndicator2.default)(context))
                },
                hide: function() {
                    var context = {
    ...
    24: function(module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.hasRightRail = hasRightRail, exports.hasLeftRail = hasLeftRail, exports.default = {
            hasLeftRail: hasLeftRail,
    ...
    26: function(module, exports, __webpack_require__) {
        ...
        function register(element, options) {
            events || (events = ["load", "resize", "scroll"]).forEach(function(event) {
                return window.addEventListener(event, (0, _throttleDebounce.throttle)(250, !1, checkVisibility))
    ...
    300: function(module, exports, __webpack_require__) {
        ...
        (function($, log) {
            ...
            var _throttleDebounce = __webpack_require__(12),
                _tracking2 = _interopRequireDefault(__webpack_require__(17)),
                _loadingIndicator2 = _interopRequireDefault(__webpack_require__(11)),
                _cameFromHomePage2 = _interopRequireDefault(__webpack_require__(301)),
                _helper2 = _interopRequireDefault(__webpack_require__(66)),
                _accessors = __webpack_require__(5),
                _hasRail = __webpack_require__(24),
                _feed2 = _interopRequireDefault(__webpack_require__(85)),
                _whenVisible2 = _interopRequireDefault(__webpack_require__(26));
            ...
            function lazyLoadFeed(topics) {
                ...
                $feedPlaceholder.length && $.ajax({
                    data: {
                        articleSlug: _accessors.state.get("article.slug", ""),
                        cameFromHomePage: (0, _cameFromHomePage2.default)(),
                        topics: topics
                    },
                    url: url
                }).then(function(response) {
                    $feedPlaceholder.replaceWith(response), _feed2.default.init(), isLongEnough || function() {
                        log.debug("Insert feed ad");
                        var insertMethod = void 0;
                        insertMethod = (0, _hasRail.hasRightRail)() ? function(content) {
                            return $(".featured-block.in-area-right").before(content)
                        } : function(content) {
                            return $(".feed-layout__container .feed-item").eq(3).before(content)
                        }, _helper2.default.insertAd("feed_boxad", insertMethod, "feed-block-ad feed-boxad")
                    }()
                }, function(data) {
                    log.error(data)
                })
            ...
            function loadVideoClip(selector) {
                $(selector).each(function(index, element) {
                    var videoId = element.getAttribute("data-jwplayer-id"),
                        $element = $(element);
                    videoId ? $.ajax({
                        url: "https://cdn.jwplayer.com/v2/media/" + videoId,
                        success: function(response) {
                            var sources = response.playlist && response.playlist[0] && response.playlist[0].sources;
                            if (sources) {
                                ...
                                sources.some(function(source) {
                                ...
                                }), videoFile ? ($element.html('<video class="fandom-video-clip__video" src="' + videoFile + '" loop muted\n\t\t\t\t\t\t\tposter="https://cdn.jwplayer.com/thumbs/' + videoId + '-720.jpg"></video>'), _whenVisible2.default.always(".fandom-video-clip__video", {
                                    ...
                                    amount: .2
                                })) : log.error("No video file found for ID " + videoId)
                            } else log.error("No video sources found for ID " + videoId)
                        },
                        error: function() {
                            $element.remove()
                        }
            ...
            exports.default = {
                init: function() {
                    var $nav, plusNavigationCheckStyles, $selectedHeader;
                    loadVideoClip(".article-plus-header__video"), $(".article-content .embedded-article").each(function(index, element) {
                        var slug = element.getAttribute("data-slug"),
                            $element = $(element);
                        slug ? (_loadingIndicator2.default.show({
                            background: "#f2f5f5",
                            container: element
                        }), $.ajax({
                            url: "/f2/api/article/embed/" + slug,
                            success: function(response) {
                    ...
                    }), loadVideoClip(".article-content figure.video-clip"), $(".pull-quote").css("background-image", "url(" + _accessors.state.get("article.featuredImage") + ")"), $("body.article-show").on("mousedown", ".article p a", function() {
                        _tracking2.default.track({
                            action: _accessors.state.get("article.id", ""),
                            label: "link.click",
                            category: "article"
                        })
                    }), ($("body").hasClass("article-show") || $("body").hasClass("article-preview")) && (_accessors.state.get("article.isArticlePlus") ? ($nav = $(".article-plus-nav"), plusNavigationCheckStyles = (0, _throttleDebounce.throttle)(10, function() {
                    ...
                    }), $(window).on("scroll resize", plusNavigationCheckStyles), plusNavigationCheckStyles()) : (function() {
                        if ("article" === _accessors.state.get("pageType")) {
                            var insertMethod = void 0;
                            insertMethod = (0, _hasRail.hasRightRail)() ? function(content) {
                            ...
                            }, log.debug("Inserting top-boxad", insertMethod), _helper2.default.insertAd("top_boxad", insertMethod, "article-layout__top-box-ad")
                        }
                    }(), ($selectedHeader = $(".article-content h2, .article-content h3").eq(2)).length && $(".article-content").height() > longArticleMinHeight && (log.debug("Inserting in-content ad"), _helper2.default.insertAd("incontent_boxad", function(content) {
                        return $selectedHeader.before(content)
                    }, "article-layout__incontent-ad"), $(".article-layout__rail").addClass("has-incontent-ad"))), $("body").hasClass("article-preview") || lazyLoadFeed(["united-kingdom" === _accessors.state.get("user.region") ? "home-page-uk" : "home-page"]))
                }
            }
        }).call(exports, __webpack_require__(0), __webpack_require__(3))
    },
    ...
    303: function(module, exports, __webpack_require__) {
        ...
        }, __WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(304)], void 0 === (__WEBPACK_AMD_DEFINE_RESULT__ = "function" == typeof(__WEBPACK_AMD_DEFINE_FACTORY__ = factory) ? __WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__) : __WEBPACK_AMD_DEFINE_FACTORY__) || (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)
    },
    ...
    306: function(module, exports, __webpack_require__) {
        var is = __webpack_require__(307),
            delegate = __webpack_require__(308);
    ...
    53: function(module, exports, __webpack_require__) {
        ...
        (function($, log) {
            Object.defineProperty(exports, "__esModule", {
                value: !0
            }), exports.setUpJwplayerVideo = setUpJwplayerVideo, exports.removeVideo = removeVideo;
            var _adEngine = __webpack_require__(23),
                _adProducts = __webpack_require__(51),
                _tracking2 = _interopRequireDefault(__webpack_require__(17)),
                _googleAnalytics2 = _interopRequireDefault(__webpack_require__(83)),
                _getInitialMute2 = _interopRequireDefault(__webpack_require__(60)),
                _accessors = __webpack_require__(5);
            ...
            var videoEventCategory = "fandom-video";
            var playerList = {};

            function setUpJwplayerVideo(videoContainer, videoId, options) {
                if (!0 == (void 0 !== (trackingOptIn = _accessors.state.get("trackingOptIn")) && void 0 !== trackingOptIn.hasUserConsented())) {
                    var trackingOptIn, containerId = "jwplayer-video-" + videoId,
                    ...
                    "0" === _adEngine.utils.queryString.get("autoplay") && (setupOptions.autoplay = !1), videoContainer.setAttribute("id", containerId),
                        function(videoId) {
                            _accessors.state.has("jwVideoPlaylist") || _accessors.state.set("jwVideoPlaylist", {});
                            var jwVideoPlaylist = _accessors.state.get("jwVideoPlaylist");
                            return jwVideoPlaylist[videoId] ? Promise.resolve(jwVideoPlaylist[videoId]) : $.ajax({
                                dataType: "json",
                                method: "GET",
                                url: _accessors.state.get("endpoints.getVideoPlaylist"),
                                data: {
                                    videoId: videoId
                                }
                            }).then(function(response) {
                                return response.playlist ? response.playlist : (log.error("Invalid response for video playlist (ID: " + videoId + ")"), null)
                            }).catch(function() {
                                return log.error("Unable to get video playlist (ID: " + videoId + ")"), null
                            })
                                ...
                                var playerOptions = {
                                    ...
                                    tracking: {
                                        ...
                                        track: function(data) {
                                            ...
                                            }(data.videoId, (title = video.title, image = video.image, (metadata = {}).title = title, metadata.image_url = image, "article" === _accessors.state.get("pageType") && (metadata.section = _accessors.state.get("article.topicNames.0", ""), metadata.tags = _accessors.state.get("article.tags"), metadata.pub_date_tmsp = Date.parse(_accessors.state.get("article.publishedTime"))), metadata)), "paused" === data.label && function(videoId) {
                                            ...
                                            }(data.videoId), _googleAnalytics2.default.setCategoryDimension(videoEventCategory, "9", videoId), _googleAnalytics2.default.setCategoryDimension(videoEventCategory, "10", playlist[0].title), _tracking2.default.track(data))
                                        },
                                        setCustomDimension: function(dimension, value) {
                                            _googleAnalytics2.default.setCategoryDimension(videoEventCategory, dimension, value)
                                        }
                                    }
                                };
                                wikiaJWPlayer(containerId, playerOptions, function(player) {
                                    playerList[videoId] = player, setupOptions.onReady(player), _adEngine.context.get("state.isSteam") || _adEngine.context.push("state.userConsentQueue", function() {
                                        _adProducts.jwplayerAdsFactory.create({
                            ...
                            } else log.error("Unable to load video (ID: " + videoId + ")")
                        })
            ...
            function setUpVideos($videos) {
                $videos.each(function(index, video) {
                    var videoContainer = video.querySelector(".fandom-video__container"),
                        ...
                        shouldMute = autoplay;
                    featured && (shouldMute = (0, _getInitialMute2.default)()), videoId && setUpJwplayerVideo(videoContainer, videoId, {
                        autoplay: autoplay,
                        featured: featured,
                        mute: shouldMute
                    })
            ...
            function removeVideo(videoId) {
                ...
                player ? (log.debug("Removing video (ID: " + videoId + ")"), mute && player.setMute(!0), player.stop(), player.remove()) : log.error("Can't remove video (ID: " + videoId + ")")
            }
            exports.default = {
                init: function() {
    ...
    58: function(module, exports, __webpack_require__) {
        ...
        (function($) {
            ...
            exports.default = function SetUpStickyModule(stickyModule, isRailFn) {
                var _this = this,
                ...
                new MutationObserver(function() {
                    $body.hasClass("has-bfaa") && (position = "top", $stickyModule.removeClass("is-sticky is-bottom"), _this.adjustPosition())
                ...
                }, $window.on("scroll resize", (0, _throttleDebounce.throttle)(20, this.adjustPosition)), $.subscribe("global-navigation-loaded", function() {
                    navOffset = getGlobalNavOffset()
                })
            }
        }).call(exports, __webpack_require__(0))
    ...
    60: function(module, exports, __webpack_require__) {
        ...
        (function(log) {
            Object.defineProperty(exports, "__esModule", {
                ...
                return log.debug((muted ? "Muting" : "Unmuting") + " video player", referrer), muted
            };
        ...
        (function(log) {
            ...
            exports.default = {
                insertAd: function(slotName, insertMethod) {
                    ...
                    log.debug("Inserting ad " + slotName), insertMethod('<div class="' + wrapperClass + '"><div class="gpt-ad" id="' + slotName + '"></div></div>'), _accessors.state.get("ads.adStack").push(slotName)
                }
            }
        }).call(exports, __webpack_require__(3))
    },
    ...
    85: function(module, exports, __webpack_require__) {
        ...
        (function($, log) {
            ...
            var _objectFitImages2 = _interopRequireDefault(__webpack_require__(122)),
                _helper2 = _interopRequireDefault(__webpack_require__(66)),
                _hasRail = __webpack_require__(24),
                _accessors = __webpack_require__(5),
                _whenVisible2 = _interopRequireDefault(__webpack_require__(26)),
                _tracking2 = _interopRequireDefault(__webpack_require__(17)),
                _feedBlocks2 = _interopRequireDefault(__webpack_require__(102)),
                _lightbox2 = _interopRequireDefault(__webpack_require__(106)),
                _regionSwitcher2 = _interopRequireDefault(__webpack_require__(146)),
                _feedBottomBoxad2 = _interopRequireDefault(__webpack_require__(108));
            ...
            function loadCard($card) {
                if ($card.hasClass("is-placeholder") && !$card.hasClass("is-loading")) {
                    ...
                    $.ajax({
                        ...
                        $card.replaceWith(response), (0, _objectFitImages2.default)()
                    }, function(data) {
            ...
            exports.default = {
                init: function() {
                    var pageType;
                    "home" !== (pageType = _accessors.state.get("pageType")) && "topic" !== pageType || ((0, _hasRail.hasRightRail)() ? (_helper2.default.insertAd("top_boxad", function(content) {
                        return $(".feed-layout__right-rail").prepend(content)
                    }, "feed-block-ad feed-top-boxad"), _helper2.default.insertAd("feed_boxad", function(content) {
                        return $(".feed-layout .feed-item").eq(10).before(content)
                    }, "feed-block-ad feed-bottom-boxad"), _feedBottomBoxad2.default.init()) : (_helper2.default.insertAd("top_boxad", function(content) {
                        return $(".feed-layout .feed-item").eq(1).before(content)
                    }, "feed-block-ad feed-top-boxad"), _helper2.default.insertAd("feed_boxad", function(content) {
                        return $(".feed-layout .feed-item").eq(6).before(content)
                    }, "feed-block-ad feed-bottom-boxad"))), _whenVisible2.default.once(".feed-item", {
                        visible: function(element) {
                            ! function(element) {
                                var $element = $(element),
                                    currentIndex = parseInt($element.attr("data-feed-index"), 10),
                                    $forwardFeedItems = $element.nextUntil("[data-feed-index=" + (currentIndex + 5) + "]"),
                                    $backFeedItems = $element.prevUntil("[data-feed-index=" + (currentIndex - 5) + "]");
                            ...
                            function(element) {
                                ...
                                _tracking2.default.track({
                                    ...
                                    c_loc: index,
                                    category: "card",
                                    label: "view.item-" + index,
                                    nonInteraction: parseInt(index, 10) < 2
                                })
                            }(element)
                        },
                        amount: .3
                    }), _feedBlocks2.default.init(), _lightbox2.default.init(), _regionSwitcher2.default.init()
                }
            }
        }).call(exports, __webpack_require__(0), __webpack_require__(3))
    },
    861: function(module, exports, __webpack_require__) {
        __webpack_require__(13), __webpack_require__(14), __webpack_require__(862), module.exports = __webpack_require__(873)
    },
    862: function(module, exports, __webpack_require__) {
        "use strict";
        (function($) {
            __webpack_require__(71);
            var _ads2 = _interopRequireDefault(__webpack_require__(157)),
                _article2 = _interopRequireDefault(__webpack_require__(300)),
                _cardShare2 = _interopRequireDefault(__webpack_require__(863)),
                _feed2 = _interopRequireDefault(__webpack_require__(85)),
                _inlineVideoPlayer2 = _interopRequireDefault(__webpack_require__(864)),
                _iosCardSizeTweak2 = _interopRequireDefault(__webpack_require__(871)),
                _konami2 = _interopRequireDefault(__webpack_require__(872)),
                _smartBanner2 = _interopRequireDefault(__webpack_require__(201)),
                _videoPlayer2 = _interopRequireDefault(__webpack_require__(53));
            ...
            $(function() {
                $("body").hasClass("show-feed") && _feed2.default.init(), _iosCardSizeTweak2.default.init(), _inlineVideoPlayer2.default.init(), _article2.default.init(), _videoPlayer2.default.init(), _ads2.default.init(), _cardShare2.default.init(), _smartBanner2.default.init(), _konami2.default.init()
            })
        }).call(exports, __webpack_require__(0))
    },
    863: function(module, exports, __webpack_require__) {
        ...
        (function($, log) {
            ...
            var obj, _clipboard = __webpack_require__(302),
                _clipboard2 = (obj = _clipboard) && obj.__esModule ? obj : {
                    default: obj
                };
            var isTouchScreen = "ontouchend" in document,
                $body = $("body"),
            ...
            exports.default = {
                init: function() {
                    ...
                    }), (clipboard = new _clipboard2.default("[data-clipboard-text]")).on("success", function(event) {
    ...
    864: function(module, exports, __webpack_require__) {
        ...
        (function(log, $) {
            ...
            var _videoPlayer = __webpack_require__(53),
                _providers = __webpack_require__(865),
                _inlineVideoPlayerIframe2 = _interopRequireDefault(__webpack_require__(869)),
                _inlineVideoPlayerEmpty2 = _interopRequireDefault(__webpack_require__(870));
            ...
            function removePlayingVideo($videoWrapper) {
                ...
                if ("jwplayer" === $card.attr("data-video-provider")) {
                    ...
                    (0, _videoPlayer.removeVideo)(videoId)
                }
                ...
                $("body").on("click", ".card[data-video-provider] .fandom-video-button", function(ev) {
                    ...
                    $card.addClass("is-playing-video"),
                        function($card) {
                            ...
                            if (id || url) switch ((0, _providers.supportedStatus)(provider)) {
                                case "iframe":
                                    var iframeUrl = id ? (0, _providers.getIframeUrl)(provider, id) : url,
                                        html = (0, _inlineVideoPlayerIframe2.default)({
                                            url: iframeUrl
                                        });
                                    return void $card.append(html);
                                case "function":
                                    var elementId = "fandom-inline-video-" + Math.floor(1e7 + 89999999 * Math.random()).toString(36),
                                        _html = (0, _inlineVideoPlayerEmpty2.default)({
                                            elementId: elementId,
                                            providerName: provider
                                        });
                                    return $card.append(_html), void(0, _providers.handleVideo)(provider, elementId, id);
                                default:
        ...
        }).call(exports, __webpack_require__(3), __webpack_require__(0))
    },
    865: function(module, exports, __webpack_require__) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.getSupportedProvidersList = getSupportedProvidersList, exports.supportedStatus = supportedStatus, exports.getIframeUrl = getIframeUrl, exports.handleVideo = function(providerName, elementId, id) {
            providers.forEach(function(provider) {
                provider.name === providerName && provider.handle(elementId, id)
            })
        };
        var _fandomJwplayer2 = _interopRequireDefault(__webpack_require__(866)),
            _twitter2 = _interopRequireDefault(__webpack_require__(867)),
            _youtube2 = _interopRequireDefault(__webpack_require__(868));
        ...
        var providers = [_fandomJwplayer2.default, _twitter2.default, _youtube2.default];
        ...
        exports.default = {
            getSupportedProvidersList: getSupportedProvidersList,
        ...
        (function($) {
            ...
            exports.default = {
                ...
                handle: function(elementId, videoId) {
                    ...
                    }($("#" + elementId).closest(".inline-video-player__player"));
                    var playerWrapper = document.getElementById(elementId);
                    (0, _videoPlayer.setUpJwplayerVideo)(playerWrapper, videoId, {
                        autoplay: !0,
                        mute: !1
                    })
                }
    ...
    868: function(module, exports, __webpack_require__) {
        ...
        (function($) {
            Object.defineProperty(exports, "__esModule", {
                ...
                type: "iframe",
                getUrl: function(id) {
                    return "https://www.youtube.com/embed/" + id + "?" + $.param({
                        autoplay: 1,
                        iv_load_policy: 3,
                        modestbranding: 1,
                        playsinline: 1,
    ...
    871: function(module, exports, __webpack_require__) {
        ...
        (function($, log) {
            ...
            var _environment = __webpack_require__(40),
                $body = $("body"),
                $window = $(window);
            ...
            function recalculateHeight() {
                ...
                $fakeItemWell.remove();
                var extraCss = '<style id="ios-card-size-tweak">.feed-item__well { height: ' + height + "px; }</style>";
                $body.append(extraCss)
            }
            exports.default = {
                init: function() {
                    "iOS" === (0, _environment.getOS)() && (log.debug("detected iOS, applying the card size fix"), recalculateHeight(), $window.on("orientationchange", recalculateHeight))
                }
            }
        }).call(exports, __webpack_require__(0), __webpack_require__(3))
    },
