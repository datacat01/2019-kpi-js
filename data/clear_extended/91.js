/***
        ...
        (c) 1999-2019 StatCounter.  All rights Reserved.
...
jQuery.validator.addMethod("email", function(_1, _2) {
    return /^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,24})$/.test(_1);
...
jQuery(document).ready(function($) {
    ...
    $(function() {
        $(".mobile-sub-menu.accordion").accordion({
            collapsible: true,
            active: false,
            animate: "easeOutCubic",
            heightStyle: "content"
    ...
    $("#email-subscribe form :input").each(function(_5, _6) {
        var _7 = $(_6).attr("id");
        var _8 = null;
        if (_7 && (_8 = $(_6).parents("form").find("label[for=" + _7 + "]")).length == 1) {
            $(_6).attr("placeholder", $(_8).html());
            $(_8).remove();
        }
    });
...
jQuery(function($) {
    $(".feature-tooltip-icon").tooltipster({
        trigger: "click",
        side: "top",
        theme: ["sc-tooltip-white"]
    });
    $("#report_type_tooltip_trigger.tooltip-no-icon").tooltipster({
        functionBefore: function(_a, _b) {
            $.each($.tooltipster.instances(), function(i, _d) {
                _d.close();
            });
        },
        contentAsHTML: true,
    ...
    $("#report_options_tooltip_trigger.tooltip-no-icon").tooltipster({
        functionPosition: function(_e, _f, _10) {
            _10.coord.top += 85;
            _10.coord.left += 0;
            return _10;
        },
        functionBefore: function(_11, _12) {
            $.each($.tooltipster.instances(), function(i, _14) {
                _14.close();
            });
        },
        contentAsHTML: true,
